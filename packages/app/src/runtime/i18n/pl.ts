export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Drzewa robocze z niescalonymi zmianami, powiązanymi sesjami lub aktywnymi lokalizacjami zostaną zachowane.",
  ...
  "session.location.worktree": "Wybierz drzewo robocze",
  "session.location.worktreesFailed": "Nie udało się wczytać drzew roboczych",
  "session.location.moving": "Przenoszenie sesji…",
  "dialog.server.menu.hide": "Ukryj na liście projektów",
  "dialog.server.menu.show": "Pokaż na liście projektów",
  "session.queue.count.one": "{{count}} element w kolejce",
  "session.queue.count.few": "{{count}} elementy w kolejce",
  "session.queue.count.many": "{{count}} elementów w kolejce",
  "session.queue.count.other": "{{count}} elementu w kolejce",
  "session.queue.steer": "Steruj",
  "session.queue.send": "Wyślij",
  "session.queue.steerTooltip": "Wyślij bez przerywania",
  "session.queue.remove": "Usuń",
  "session.queue.reorder": "Zmień pozycję monitu w kolejce",
  "session.new.worktree.creating": "Tworzenie drzewa roboczego",
  "settings.backToApp": "Wróć do aplikacji",
  "settings.appearance.section.experimental": "Eksperymentalne",
  "settings.appearance.row.tabs.title": "Karty",
  "settings.appearance.row.tabs.description": "Wybierz układ kart sesji",
  "settings.appearance.row.tabs.horizontal": "Poziomo",
  "settings.appearance.row.tabs.vertical": "Pionowo",
  "settings.general.row.followUpBehavior.title": "Obsługa kolejnych wiadomości",
  "settings.general.row.followUpBehavior.description":
    "Wybierz, czy kolejne wiadomości mają trafiać do kolejki, czy sterować bieżącym krokiem. Użyj {{keybind}}, aby przełączyć tryb.",
  "settings.general.row.followUpBehavior.queue": "Dodaj do kolejki",
  "settings.general.row.followUpBehavior.steer": "Steruj",
  "settings.general.row.reasoningMode.title": "Wnioskowanie modelu",
  "settings.general.row.reasoningMode.description": "Wybierz sposób wyświetlania wnioskowania modelu na osi czasu",
  "settings.general.row.reasoningMode.hidden": "Ukryte",
  "settings.general.row.reasoningMode.compact": "Kompaktowe",
  "settings.general.row.reasoningMode.full": "Pełne",
  "session.new.workspace.createFrom": "Utwórz z gałęzi",
  "session.new.workspace.branch.search.placeholder": "Szukaj gałęzi",
  "desktop.onboarding.defaultProject": "Projekt domyślny",
  "toast.migration.progress.clearingOldEvents": "Usuwanie starych zdarzeń",
  "toast.migration.progress.migratingSessions": "Migrowanie sesji",
  "session.new.workspace.existingLabel": "Drzewo robocze",
  "session.review.change.few": "Zmiany",
  "session.review.change.many": "Zmian",
  "home.projects.all": "Wszystkie projekty",
  "session.tab.files": "Pliki",
  "session.files.openTabs": "Otwarte pliki",
  "session.tab.usage": "Użycie",
  "session.view.select": "Widok sesji",
  "session.background.moveTasks": "Przenieś {{tasks}} do tła",
  "session.background.moveRunning": "Przejdź do tła",
  "session.background.inBackground": "Działa {{tasks}} w tle",
  "session.background.tasksRunning.one": "{{count}} zadanie w tle jest wykonywane",
  "session.background.tasksRunning.other": "{{count}} zadania w tle jest wykonywane",
  ...
  "session.background.subagent.other": "{{count}} podagenta",
  "session.timeline.working": "Pracuje",
  "session.review.wrapLines": "Zawijaj wiersze",
  "session.websearch.title": "Wyszukiwarka internetowa innej firmy",
  "session.websearch.description": "Wybierz dostawcę wyszukiwania, którego używają agenci do przeszukiwania Internetu",
  "session.websearch.provider": "Dostawca wyszukiwania",
  "session.websearch.any": "Dowolny",
  "session.websearch.disable": "Nie używaj wyszukiwania",
  "session.websearch.enable": "Włącz",
  "session.websearch.loadFailed": "Nie można załadować dostawców wyszukiwania.",
  "session.websearch.empty": "Brak dostępnych dostawców wyszukiwania.",
  "session.websearch.failed": "Nie można zapisać Twojego wyboru. Spróbuj ponownie.",
  "session.websearch.retry": "Ponów próbę",
  "session.new.worktree.draftPlaceholder": "Napisz kolejną wiadomość podczas przygotowywania drzewa roboczego…",
  "session.search.placeholder": "Znajdź...",
  "session.search.noResults": "Brak dopasowań",
  "titlebar.tabs": "Zakładki",
  "titlebar.channel.local": "Lokalny",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Przełącz narzędzia debugowania",
  "settings.tab.experimental": "Eksperymentalny",
  "settings.experimental.description": "Wypróbuj funkcje eksperymentalne",
  "settings.tab.about": "Informacje",
  "settings.about.version": "Wersja {{version}}",
  "settings.about.devVersion": "Rozwój",
  "settings.about.license": "Wydany pod nazwą MIT License",
  "settings.about.writtenBy": "Napisane przez",
  "settings.about.illustratedBy": "Zilustrowane przez",
  "settings.about.and": "i",
  "settings.about.otherContributor.one": "{{count}} inny",
  "settings.about.otherContributor.other": "{{count}} innego",
  "settings.about.firstPublished": "Opublikowano po raz pierwszy w Missouri, USA",
  "settings.about.firstIllustrated": "Pierwsza ilustracja w Londynie, w Anglii",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, agent kodujący typu open source",
  "settings.about.trademark": "OpenCode jest zastrzeżonym znakiem towarowym firmy Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description": "Wybierz ilość aktywności wyświetlaną na osi czasu. Wiadomości pozostają widoczne.",
  "settings.timeline.preset.everything": "Wszystko",
  "settings.timeline.preset.detailed": "Szczegółowy",
  "settings.timeline.preset.compact": "Kompaktowy",
  "settings.timeline.preset.quiet": "Cichy",
  "settings.timeline.preset.text-only": "Tylko tekst",
  ...
  "settings.timeline.description.custom":
    "Użyj wybranego miejsca docelowego i szczegółów dla każdej kategorii aktywności.",
  "settings.timeline.custom": "Niestandardowe",
  "settings.timeline.advanced": "Zaawansowane",
  "settings.timeline.advanced.description": "Ustaw rozmieszczenie i szczegóły dla każdej kategorii aktywności.",
  "settings.timeline.category.shell": "Obudowa",
  "settings.timeline.category.edit": "Zmiany",
  "settings.timeline.category.thinking": "Myślenie",
  "settings.timeline.category.subagents": "Podagenci",
  "settings.timeline.category.notices": "Uwagi dotyczące",
  "settings.timeline.category.tools": "Inne narzędzia",
  "settings.general.row.mobileDiffWrap.description":
    "Zawijaj długie linie w różnicach mobilnych, zamiast przewijać w poziomie",
  "session.background.tasksRunning.few": "{{count}} zadania w tle są wykonywane",
  "session.background.tasksRunning.many": "{{count}} zadań w tle jest wykonywanych",
  "session.background.shell.few": "{{count}} powłoki",
  "session.background.shell.many": "{{count}} powłok",
  "session.background.subagent.few": "{{count}} podagenty",
  "session.background.subagent.many": "{{count}} podagentów",
  "settings.about.otherContributor.few": "{{count}} innych",
  "settings.about.otherContributor.many": "{{count}} innych",
  "provider.connect.error.unsupportedFields": "Ten formularz uwierzytelniania zawiera nieobsługiwane pola",
  "session.review.filesChangedCount.one": "{{count}} plik zmieniony",
  "session.review.filesChangedCount.few": "{{count}} pliki zmienione",
  "session.review.filesChangedCount.many": "{{count}} plików zmienionych",
  "session.review.filesChangedCount.other": "{{count}} pliku zmienionego",
  "settings.about.writtenByNames": "Autor: {{names}}",
  "settings.about.illustratedByNames": "Ilustracje: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Nie połączono z {{host}}. Twój projekt roboczy został zachowany; praca zdalna może wciąż być uruchomiona.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Dodaj serwer SSH",
  "ssh.server.menu.label": "Serwer SSH",
  "ssh.target": "Host lub polecenie SSH",
  "ssh.connect": "Połącz",
  "ssh.connectTo": "Połącz z {{host}}",
  "ssh.authenticate": "Uwierzytelnianie SSH",
  "ssh.action.authenticate": "Uwierzytelnij się",
  "ssh.session.disconnected": "Połączenie SSH nieaktywne",
  "ssh.session.connecting": "Łączenie z serwerem SSH",
  "ssh.session.reconnectDescription":
    "Ponownie połącz, aby wyświetlić tę sesję i kontynuować pracę. Twoja sesja zdalna została zachowana.",
  "ssh.session.reconnect": "Ponownie połącz",
  "ssh.authenticationRequired": "Wymagane uwierzytelnienie dla {{host}}",
  "ssh.trust": "Zaufaj i połącz",
  "ssh.continue": "Kontynuuj",
  "ssh.retry": "Spróbuj ponownie",
  "ssh.update": "Zaktualizuj i ponownie połącz",
  "ssh.openProject": "Otwórz projekt",
  "ssh.project": "Otwórz projekt na {{host}}",
  "ssh.disconnect": "Rozłącz",
  "ssh.forget": "Zapomnij połączenie",
  "ssh.stage.disconnected": "Rozłączono. Zdalny serwer nadal działa.",
  "ssh.stage.connecting": "Łączenie przez SSH…",
  "ssh.stage.checking": "Sprawdzanie OpenCode…",
  "ssh.stage.downloading": "Pobieranie serwera…",
  "ssh.stage.uploading": "Wgrywanie serwera…",
  "ssh.stage.starting": "Łączenie z OpenCode…",
  "ssh.stage.ready": "Połączono",
  "ssh.stage.authentication": "Wymagane uwierzytelnienie",
  "ssh.stage.incompatible": "Wymagana aktualizacja serwera",
  "ssh.stage.failed": "Połączenie nie powiodło się",
  "ssh.error.input":
    "Wprowadź hosta lub polecenie połączenia SSH. Polecenia zdalne i nieobsługiwane opcje SSH nie są dozwolone.",
  "ssh.error.connection": "Nie udało się nawiązać połączenia SSH. Sprawdź swoją sieć i konfigurację SSH.",
  "ssh.error.platform":
    "Ta zdalna platforma nie jest obsługiwana. Automatyczne ustawienia wymagają obecnie Linuxa lub macOS na x64 lub arm64.",
  "ssh.error.version": "Zdalna usługa musi pasować do tej wersji Desktop przed połączeniem.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH połączony, ale serwer OpenCode nie stał się gotowy.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "Nie znaleziono OpenSSH. Zainstaluj klienta OpenSSH i upewnij się, że ssh jest dostępne w PATH.",
  "command.browser.open": "Otwórz przeglądarkę",
  "command.browser.reload": "Przeładuj stronę przeglądarki",
  "command.session.summary.toggle": "Przełącz podsumowanie",
  "common.color.orange": "pomarańczowy",
  "common.color.yellow": "żółty",
  "common.color.cyan": "cyjan",
  ...
  "common.color.gray": "szary",
  "mcp.auth.interactiveForm": "Serwer MCP {{name}} wymaga interaktywnego formularza uwierzytelniania",
  "server.connect.title": "Połącz się z serwerem",
  "server.connect.description": "Wprowadź adres serwera i hasło, aby rozpocząć.",
  ...
  "server.connect.camera": "Łączenie aparatu",
  ...
  "dialog.server.menu.remove": "Usuń",
  "file.error.notFound": "Plik nie znaleziony: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Migracja sesji {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migracja sesji {{current}}/{{total}}",
  "toast.migration.progress.working": "Migracja danych",
  "toast.migration.progress.working.current": "Migracja danych {{current}}",
  "toast.migration.progress.working.progress": "Migracja danych {{current}}/{{total}}",
  "home.workspaceTip": "Rozpocznij następną sesję w nowym obszarze roboczym, aby zmiany były odizolowane",
  "session.tab.browser": "Przeglądarka",
  "session.tab.add": "Dodaj kartę",
  "session.queue.attachments.one": "Jeszcze {{count}} załącznik",
  "session.queue.attachments.other": "Jeszcze {{count}} załącznika",
  "session.browser.address": "Adres przeglądarki",
  "session.browser.replaced": "Kontrola przeglądarki została przeniesiona do innego okna pulpitu.",
  "session.browser.unsupported": "Ta aplikacja na pulpit nie obsługuje panelu przeglądarki.",
  "session.browser.suspended": "Przeglądarka zawieszona. Wejdź w interakcję z tą sesją, aby ponownie połączyć.",
  "session.browser.address.placeholder": "Wprowadź URL",
  "settings.backToSettings": "Powrót do ustawień",
  "settings.backToProjects": "Powrót do projektów",
  "settings.search.placeholder": "Szukaj",
  "settings.search.results": "Wyniki ustawień",
  "settings.search.group.pages": "Strony",
  "settings.search.group.settings": "Ustawienia",
  "settings.search.group.projects": "Projekty",
  "settings.search.group.servers": "Serwery",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Brak wyników dla {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Zawęź wyszukiwanie, aby zobaczyć bardziej szczegółowe wyniki.",
  "settings.server.description": "Zarządzaj połączeniem i preferencjami tego serwera",
  "settings.server.section.connection": "Połączenie",
  "settings.server.preferences.websearch.title": "Wyszukiwanie stron trzecich",
  "settings.server.preferences.websearch.description":
    "Wybierz dostawcę wyszukiwania, którego agenci używają do przeszukiwania internetu",
  "settings.projects.search.placeholder": "Projekty wyszukiwania",
  "project.settings.name.title": "Nazwa projektu",
  "project.settings.name.description": "Nazwa wyświetlana dla tego projektu w całym OpenCode",
  "project.settings.icon.description": "Zalecane: 128×128px. Kliknij lub przeciągnij, aby wgrać obraz.",
  "project.settings.color.description": "Używane jako ikona projektu, gdy nie ustawiono niestandardowego obrazu",
  "project.settings.worktree.startup.description": "Uruchamia się raz po utworzeniu nowego worktree",
  "project.settings.worktree.startup.hint.base": "Użyj $OPENCODE_WORKTREE_BASE jako bazowego worktree.",
  "project.settings.worktree.startup.hint.new": "Użyj $OPENCODE_WORKTREE_PATH dla nowego worktree.",
  "project.settings.extensions.empty.mcps.title": "Jeszcze brak MCP",
  "project.settings.extensions.empty.mcps.description": "MCP dostępne dla OpenCode pojawią się tutaj",
  "project.settings.extensions.empty.plugins.title": "Jeszcze brak wtyczek",
  "project.settings.extensions.empty.plugins.description": "Wtyczki dostępne dla OpenCode pojawią się tutaj",
  "project.settings.extensions.empty.skills.title": "Jeszcze brak umiejętności",
  "project.settings.extensions.empty.skills.description": "Umiejętności dostępne dla OpenCode pojawią się tutaj",
  "project.settings.extensions.lsp.configured": "Skonfigurowane serwery językowe",
  "project.settings.extensions.lsp.status.enabled": "Włączone w konfiguracji",
  "project.settings.extensions.lsp.status.disabled": "Wyłączone w konfiguracji",
  "project.settings.extensions.lsp.empty.title": "Nie skonfigurowano serwerów językowych",
  "project.settings.extensions.lsp.empty.description":
    "Serwery językowe skonfigurowane dla tego projektu pojawią się tutaj",
  "project.settings.extensions.lsp.disabled.title": "Serwery językowe wyłączone",
  "project.settings.extensions.lsp.disabled.description": "LSP jest wyłączone w konfiguracji tego projektu",
  "project.settings.extensions.lsp.loadFailed": "Nie można wczytać konfiguracji serwera językowego",
  "project.settings.extensions.lsp.retry": "Spróbuj ponownie",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Grupa",
  "settings.timeline.collapse": "Zwiń",
  "settings.timeline.visibility.show": "Pokaż",
  "settings.timeline.visibility.hide": "Ukryj",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} sesja",
  "settings.workspaces.sessions.filtered.other": "{{count}} sesji",
  "settings.workspaces.deleteAll.confirm.one": "Spowoduje to trwałe usunięcie {{count}} wybranego drzewa roboczego.",
  "settings.workspaces.deleteAll.confirm.other": "Spowoduje to trwałe usunięcie {{count}} wybranego drzewa roboczego.",
  "settings.workspaces.deleteWithoutSessions": "Usuń drzewa robocze bez sesji",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Spowoduje to trwałe usunięcie {{count}} drzewa roboczego bez powiązanych sesji.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Spowoduje to trwałe usunięcie {{count}} drzewa roboczego bez powiązanych sesji.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Drzewa robocze z nierozłączonymi zmianami lub aktywnymi lokalizacjami zostaną zachowane.",
  "settings.workspaces.delete.button": "Usuń drzewa robocze",
  "workspace.lifecycle.deleting": "Usuwanie…",
  "session.summary.tooltip": "Podsumowanie",
  "session.summary.server": "Rozszerzenia",
  "session.summary.chooseProject": "Wybierz projekt",
  "session.summary.mcp.onCreation": "Dotyczy w momencie tworzenia drzewa roboczego",
  "session.summary.mcp.prepareFailed": "Nie można przygotować serwerów MCP",
  "session.summary.mcp.unavailable": "Serwer MCP {{name}} nie jest dostępny w tym drzewie roboczym.",
  "session.summary.mcp.signInBeforeSend": "Zaloguj się do {{name}} przed wysłaniem polecenia.",
  "session.summary.mcp.notReady":
    "Serwer MCP {{name}} nie jest gotowy. Rozwiąż jego połączenie przed wysłaniem polecenia.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Skonfigurowane serwery MCP",
  "session.summary.plugins": "Wtyczki",
  "session.summary.plugins.configured": "Skonfigurowane wtyczki",
  "session.summary.skills": "Umiejętności",
  "session.summary.skills.configured": "Skonfigurowane umiejętności",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Nie powiodło się",
  "session.summary.retry": "Spróbuj ponownie",
  "session.summary.connecting": "Łączenie…",
  "session.summary.needsAuth": "Wymagane logowanie",
  "session.summary.configure": "Plik konfiguracyjny",
  "session.summary.copyConfigPath": "Skopiuj ścieżkę pliku konfiguracyjnego",
  "session.summary.configFileMissing": "Nie znaleziono pliku konfiguracyjnego",
  "session.summary.mcp.empty": "Brak skonfigurowanych serwerów MCP",
  "session.summary.mcp.add": "Dodaj serwery w opencode.json",
  "session.summary.plugins.manage": "Zarządzaj wtyczkami w opencode.json",
  "session.summary.plugins.empty": "Nie skonfigurowano żadnych wtyczek",
  "session.summary.plugins.add": "Dodaj wtyczki w opencode.json",
  "session.summary.skills.manage": "Zarządzaj umiejętnościami w opencode.json",
  "session.summary.skills.empty": "Nie skonfigurowano żadnych umiejętności",
  "session.summary.skills.add": "Dodaj umiejętności w opencode.json",
  "session.summary.lsp.configured": "Skonfigurowane LSP",
  "session.summary.lsp.empty": "Brak skonfigurowanych serwerów LSP",
  "session.summary.lsp.manage": "Zarządzaj LSP w opencode.json",
  "workspace.delete.location": "Lokalizacja",
  "session.queue.attachments.few": "Jeszcze {{count}} załączniki",
  "session.queue.attachments.many": "Jeszcze {{count}} załączników",
  "settings.workspaces.sessions.filtered.few": "{{count}} sesje",
  "settings.workspaces.sessions.filtered.many": "{{count}} sesji",
  "settings.workspaces.deleteAll.confirm.few": "Spowoduje to trwałe usunięcie {{count}} wybranych drzew roboczych.",
  "settings.workspaces.deleteAll.confirm.many": "Spowoduje to trwałe usunięcie {{count}} wybranych drzew roboczych.",
  "settings.workspaces.deleteWithoutSessions.confirm.few":
    "Spowoduje to trwałe usunięcie {{count}} drzew roboczych bez powiązanych sesji.",
  "settings.workspaces.deleteWithoutSessions.confirm.many":
    "Spowoduje to trwałe usunięcie {{count}} drzew roboczych bez powiązanych sesji.",
  "command.debugBar.toggle": "Przełącz pasek debugowania",
  "command.session.location.cycle": "Zmień lokalizację sesji",
  "dialog.provider.anthropic.note": "Bezpośredni dostęp do modeli Claude za pomocą klucza API",
  "provider.connect.title.anthropicProMax": "Zaloguj się przez Anthropic",
  "prompt.toast.uploading.cancel": "Anuluj przesyłanie",
  "prompt.toast.uploading.cancelFile": "Anuluj przesyłanie pliku {{filename}}",
  "prompt.toast.uploadFailed.title": "Przesyłanie nie powiodło się",
  "session.browser.empty.title": "Wprowadź adres URL",
  "session.browser.empty.description": "Lub wpisz polecenie „Otwórz w przeglądarce aplikacji”",
  "session.browser.failed.title": "Nie można otworzyć adresu URL",
  "session.browser.failed.description": "Sprawdź adres URL i połączenie, a następnie spróbuj ponownie.",
  "debugBar.providerAriaLabel": "Diagnostyka wydajności dostawcy",
  "debugBar.ttft.tip": "Czas od wysłania żądania do dostawcy do pierwszego wyniku modelu.",
  "debugBar.ttfa.tip": "Czas od wysłania żądania do dostawcy do pierwszego tekstu odpowiedzi.",
  "debugBar.tps.tip": "Liczba tokenów wyjściowych na sekundę po pierwszym wyniku modelu.",
  "debugBar.e2e.tip": "Czas od wysłania żądania do dostawcy do zakończenia strumienia odpowiedzi.",
  "settings.updates.action.download": "Pobierz OpenCode",
  "settings.updates.migration.title": "Przejdź z Beta na Stable",
