export const dict: Record<string, string> = {
  ...
  "session.location.unavailable": "सत्रको स्थान उपलब्ध छैन",
  "session.location.description": "यो सत्र जारी राख्न अर्को डाइरेक्टरी छान्नुहोस्।",
  "session.location.choose": "डाइरेक्टरी छान्नुहोस्",
  "session.location.worktree": "वर्कट्री छान्नुहोस्",
  "session.location.worktreesFailed": "वर्कट्रीहरू लोड गर्न सकिएन",
  "session.location.moving": "सत्र सारिँदै छ…",
  "dialog.server.menu.hide": "परियोजना सूचीबाट लुकाउनुहोस्",
  "dialog.server.menu.show": "परियोजना सूचीमा देखाउनुहोस्",
  "session.queue.count.one": "{{count}} पङ्क्तिमा",
  "session.queue.count.other": "{{count}} पङ्क्तिमा",
  "session.queue.steer": "दिशा दिनुहोस्",
  "session.queue.send": "पठाउनुहोस्",
  "session.queue.steerTooltip": "अवरोध नगरी पठाउनुहोस्",
  "session.queue.remove": "हटाउनुहोस्",
  "session.queue.reorder": "पङ्क्तिबद्ध प्रम्प्टको क्रम बदल्नुहोस्",
  "session.new.worktree.creating": "वर्कट्री सिर्जना हुँदै छ",
  "settings.backToApp": "एपमा फर्कनुहोस्",
  "settings.appearance.section.experimental": "प्रयोगात्मक",
  "settings.appearance.row.tabs.title": "ट्याबहरू",
  "settings.appearance.row.tabs.description": "सत्रका ट्याबहरू कसरी मिलाउने भन्ने छान्नुहोस्",
  "settings.appearance.row.tabs.horizontal": "तेर्सो",
  "settings.appearance.row.tabs.vertical": "ठाडो",
  "settings.general.row.followUpBehavior.title": "फलो-अप व्यवहार",
  "settings.general.row.followUpBehavior.description":
    "फलो-अपलाई पङ्क्तिमा राख्ने वा हालको पालोलाई दिशा दिने छान्नुहोस्। बदल्न {{keybind}} प्रयोग गर्नुहोस्।",
  "settings.general.row.followUpBehavior.queue": "पङ्क्तिमा राख्नुहोस्",
  "settings.general.row.followUpBehavior.steer": "दिशा दिनुहोस्",
  "settings.general.row.reasoningMode.title": "मोडेलको तर्क",
  "settings.general.row.reasoningMode.description": "समयरेखामा मोडेलको तर्क कसरी देखाउने भन्ने छान्नुहोस्",
  "settings.general.row.reasoningMode.hidden": "लुकाइएको",
  "settings.general.row.reasoningMode.compact": "सङ्क्षिप्त",
  "settings.general.row.reasoningMode.full": "पूर्ण",
  "session.new.workspace.createFrom": "यसबाट सिर्जना गर्नुहोस्",
  "session.new.workspace.branch.search.placeholder": "ब्रान्च खोज्नुहोस्",
  "toast.migration.progress.clearingOldEvents": "पुराना घटनाहरू हटाइँदै छन्",
  "toast.migration.progress.migratingSessions": "सत्रहरू माइग्रेट गरिँदै छन्",
  "session.new.workspace.existingLabel": "वर्कट्री",
  "desktop.onboarding.defaultProject": "पूर्वनिर्धारित परियोजना",

  "home.projects.all": "सबै परियोजनाहरू",
  "session.tab.files": "फाइलहरू",
  "session.files.openTabs": "खुला फाइलहरू",
  "session.tab.usage": "प्रयोग",
  ...
  "session.background.inBackground": "{{tasks}} पृष्ठभूमिमा चलिरहेका छन्",
  "session.background.tasksRunning.one": "{{count}} पृष्ठभूमि कार्य चलिरहेको छ",
  "session.background.tasksRunning.other": "{{count}} पृष्ठभूमि कार्यहरू चलिरहेका छन्",
  ...
  "session.websearch.any": "कुनै पनि",
  "session.websearch.disable": "खोज प्रयोग नगर्नुहोस्",
  "session.websearch.enable": "सक्षम गर्नुहोस्",
  "session.websearch.loadFailed": "खोज प्रदायकहरू लोड गर्न सकिएन।",
  "session.websearch.empty": "कुनै खोज प्रदायक उपलब्ध छैन।",
  "session.websearch.failed": "तपाईंको छनोट सुरक्षित गर्न सकिएन। फेरि प्रयास गर्नुहोस्।",
  "session.websearch.retry": "फेरि प्रयास गर्नुहोस्",
  "session.new.worktree.draftPlaceholder": "वर्कट्री तयार हुँदै गर्दा फलो-अपको मस्यौदा लेख्नुहोस्…",
  "session.search.placeholder": "खोज्नुहोस्...",
  "session.search.noResults": "कुनै मिलान छैन",
  "titlebar.tabs": "ट्याबहरू",
  "titlebar.channel.local": "स्थानीय",
  "titlebar.channel.dev": "डेभ",
  "titlebar.channel.beta": "बेटा",
  "titlebar.toggleDebugTools": "डिबग उपकरणहरू टगल गर्नुहोस्",
  "settings.tab.experimental": "प्रयोगात्मक",
  "settings.experimental.description": "प्रयोगात्मक सुविधाहरू चलाएर हेर्नुहोस्",
  "settings.tab.about": "बारेमा",
  "settings.about.version": "संस्करण {{version}}",
  "settings.about.devVersion": "विकास",
  "settings.about.license": "MIT इजाजतपत्रअन्तर्गत जारी",
  "settings.about.writtenBy": "लेखक",
  "settings.about.illustratedBy": "चित्रकार",
  "settings.about.and": "र",
  "settings.about.otherContributor.one": "अन्य {{count}}",
  "settings.about.otherContributor.other": "अन्य {{count}}",
  "settings.about.firstPublished": "पहिलो पटक मिसौरी, संयुक्त राज्य अमेरिकामा प्रकाशित",
  "settings.about.firstIllustrated": "पहिलो पटक लन्डन, इङ्ग्ल्यान्डमा चित्रित",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, खुला स्रोत कोडिङ एजेन्ट",
  "settings.about.trademark": "OpenCode, Anomaly Innovations, Inc. को दर्ता गरिएको ट्रेडमार्क हो।",
  "settings.about.typeset": "Inter र IBM Plex Mono मा अक्षर संयोजन",
  "settings.about.tagline": "तपाईंबिना AI ले उत्कृष्ट सफ्टवेयर बनाउन सक्दैन",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "परियोजना सम्पादन गर्नुहोस्",
  "settings.timeline.title": "समयरेखा",
  "settings.timeline.detail": "समयरेखा विवरण",
  "settings.timeline.description": "समयरेखामा कति गतिविधि देखाउने छान्नुहोस्। सन्देशहरू देखिइरहन्छन्।",
  "settings.timeline.preset.everything": "सबै कुरा",
  "settings.timeline.preset.detailed": "विस्तृत",
  "settings.timeline.preset.compact": "सङ्क्षिप्त",
  "settings.timeline.preset.quiet": "शान्त",
  "settings.timeline.preset.text-only": "पाठ मात्र",
  "settings.timeline.description.everything":
    "सबै गतिविधि छुट्टाछुट्टै देखाउनुहोस्। शेल आउटपुट, सम्पादन र सोचाइ विस्तार गर्नुहोस्।",
  "settings.timeline.description.detailed":
    "शेल आउटपुट र सम्पादन विस्तार गर्नुहोस्। उप-एजेन्टहरू छुट्टै देखाउनुहोस् र अन्य गतिविधि ‘प्रयोग गरिएको’ मा समूहबद्ध गर्नुहोस्।",
  "settings.timeline.description.compact": "सबै गतिविधि ‘प्रयोग गरिएको’ मा समूहबद्ध गरी विवरण सङ्कुचित राख्नुहोस्।",
  "settings.timeline.description.quiet":
    "सम्पादन र उप-एजेन्टहरू ‘प्रयोग गरिएको’ मा समूहबद्ध गर्नुहोस्। अन्य गतिविधि लुकाउनुहोस्।",
  "settings.timeline.description.text-only": "सबै गतिविधि लुकाउनुहोस्। सन्देशहरू मात्र देखाउनुहोस्।",
  "settings.timeline.description.custom": "हरेक गतिविधि वर्गका लागि तपाईंले छानेको स्थान र विवरण प्रयोग गर्नुहोस्।",
  "settings.timeline.custom": "अनुकूलित",
  "settings.timeline.advanced": "उन्नत",
  "settings.timeline.advanced.description": "हरेक गतिविधि वर्गका लागि स्थान र विवरण सेट गर्नुहोस्।",
  "settings.timeline.category.shell": "शेल",
  "settings.timeline.category.edit": "सम्पादनहरू",
  "settings.timeline.category.thinking": "सोचाइ",
  ...
  "session.review.filesChangedCount.one": "{{count}} फाइल परिवर्तन भयो",
  "session.review.filesChangedCount.other": "{{count}} फाइलहरू परिवर्तन भए",
  ...
  "settings.workspaces.deleteAll.warning":
    "मर्ज नगरिएका परिवर्तन, लिङ्क गरिएका सत्र वा सक्रिय स्थान भएका वर्कट्रीहरू राखिनेछन्।",
  "ssh.label": "SSH",
  "ssh.offline": "{{host}} मा जडान गरिएको छैन। तपाईंको मस्यौदा सुरक्षित छ; टाढाको काम अझै चलिरहेको हुन सक्छ।",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH सर्भर थप्नुहोस्",
  "ssh.server.menu.label": "SSH सर्भर",
  "ssh.target": "होस्ट वा SSH आदेश",
  "ssh.connect": "जडान गर्नुहोस्",
  "ssh.connectTo": "{{host}} मा जडान गर्नुहोस्",
  "ssh.authenticate": "SSH प्रमाणीकरण",
  "ssh.action.authenticate": "प्रमाणीकरण गर्नुहोस्",
  "ssh.session.disconnected": "SSH जडान निष्क्रिय छ",
  "ssh.session.connecting": "SSH सर्भरमा जडान गर्दै",
  "ssh.session.reconnectDescription":
    "यो सत्र हेर्न र काम जारी राख्न पुन: जडान गर्नुहोस्। तपाईंको रिमोट सत्र सुरक्षित छ।",
  "ssh.session.reconnect": "पुन: जडान गर्नुहोस्",
  "ssh.authenticationRequired": "{{host}} को लागि प्रमाणीकरण आवश्यक छ",
  "ssh.trust": "विश्वास गर्नुहोस् र जडान गर्नुहोस्",
  "ssh.continue": "जारी राख्नुहोस्",
  "ssh.retry": "पुन: प्रयास गर्नुहोस्",
  "ssh.update": "अपडेट गर्नुहोस् र पुन: जडान गर्नुहोस्",
  "ssh.openProject": "परियोजना खोल्नुहोस्",
  "ssh.project": "{{host}} मा परियोजना खोल्नुहोस्",
  "ssh.disconnect": "जडान विच्छेद गर्नुहोस्",
  "ssh.forget": "जडान बिर्सनुहोस्",
  "ssh.stage.disconnected": "विच्छेद भयो। रिमोट सर्भर चलिरहेको छ।",
  "ssh.stage.connecting": "SSH मा जडान गर्दै…",
  "ssh.stage.checking": "जाँच गर्दै OpenCode…",
  "ssh.stage.downloading": "सर्भर डाउनलोड गर्दै...",
  "ssh.stage.uploading": "सर्भर अपलोड गर्दै...",
  "ssh.stage.starting": "OpenCode मा जडान गर्दै…",
  "ssh.stage.ready": "जडान भयो",
  "ssh.stage.authentication": "प्रमाणीकरण आवश्यक छ",
  "ssh.stage.incompatible": "सर्भर अद्यावधिक आवश्यक छ",
  "ssh.stage.failed": "जडान असफल भयो",
  "ssh.error.input": "होस्ट वा SSH जडान आदेश प्रविष्ट गर्नुहोस्। रिमोट आदेशहरू र असमर्थित SSH विकल्पहरूलाई अनुमति छैन।",
  "ssh.error.connection": "SSH जडान स्थापना गर्न सकिएन। आफ्नो नेटवर्क र SSH कन्फिगरेसन जाँच गर्नुहोस्।",
  "ssh.error.platform": "यो रिमोट प्लेटफर्म समर्थित छैन। स्वचालित सेटअपलाई हाल x64 वा arm64 मा Linux वा macOS चाहिन्छ।",
  "ssh.error.version": "रिमोट सेवा जडान गर्नु अघि यो डेस्कटप संस्करण मिल्नुपर्छ।",
  "ssh.error.install": "रिमोट सर्भर स्थापना गर्न सकिएन। जडान जाँच गर्नुहोस्, डिस्क स्पेस, र त्यो टार स्थापित छ।",
  "ssh.error.unpublished":
    "यो डेस्कटप संस्करण कुनै प्रकाशित रिमोट सर्भर छैन। विकास निर्माणको लागि, होस्टमा V2 स्थापना गरी सुरु गर्नुहोस्, त्यसपछि पुन: प्रयास गर्नुहोस्।",
  "ssh.error.service": "SSH जडान भयो, तर OpenCode सर्भर तयार भएन।",
  "ssh.error.host-key":
  ...
  "command.browser.open": "ब्राउजर खोल्नुहोस्",
  "command.browser.reload": "ब्राउजर पृष्ठ पुन: लोड गर्नुहोस्",
  "command.session.summary.toggle": "सारांश टगल गर्नुहोस्",
  "common.color.orange": "सुन्तला",
  "common.color.yellow": "पहेंलो",
  "common.color.cyan": "स्यान",
  "common.color.green": "हरियो",
  "common.color.red": "रातो",
  "common.color.pink": "गुलाबी",
  "common.color.blue": "नीलो",
  "common.color.purple": "बैजनी",
  "common.color.gray": "खैरो",
  "mcp.auth.interactiveForm": "MCP सर्भर {{name}} लाई अन्तरक्रियात्मक प्रमाणीकरण फारम चाहिन्छ",
  "server.connect.title": "सर्भरमा जडान गर्नुहोस्",
  "server.connect.description": "सुरु गर्न आफ्नो सर्भर ठेगाना र पासवर्ड प्रविष्ट गर्नुहोस्।",
  ...
  "server.connect.camera": "क्यामेरा जोड्दै",
  ...
  "server.connect.camera.error":
    "क्यामेरा खोल्न सकिएन। क्यामेरा पहुँच अनुमति दिनुहोस् वा म्यानुअल रूपमा आफ्नो जडान विवरण प्रविष्ट गर्नुहोस्।",
  "dialog.server.menu.remove": "हटाउनुहोस्",
  "file.error.notFound": "फाइल फेला परेन: {{name}}",
  "toast.migration.progress.migratingSessions.current": "सत्रहरू माइग्रेट गर्दै {{current}}",
  "toast.migration.progress.migratingSessions.progress": "सत्रहरू माइग्रेट गर्दै {{current}}/{{total}}",
  "toast.migration.progress.working": "डेटा माइग्रेट गर्दै",
  "toast.migration.progress.working.current": "डेटा माइग्रेट गर्दै {{current}}",
  "toast.migration.progress.working.progress": "डेटा माइग्रेट गर्दै {{current}}/{{total}}",
  "home.workspaceTip": "परिवर्तनहरूलाई अलग राख्नको लागि नयाँ कार्यस्थानमा अर्को सत्र सुरु गर्नुहोस्",
  "session.tab.browser": "ब्राउजर",
  "session.tab.add": "ट्याब थप्नुहोस्",
  "session.queue.attachments.one": "थप {{count}} संलग्नक",
  "session.queue.attachments.other": "थप {{count}} संलग्नहरू",
  "session.browser.address": "ब्राउजर ठेगाना",
  "session.browser.replaced": "ब्राउजर नियन्त्रण अर्को डेस्कटप विन्डोमा सारियो।",
  "session.browser.unsupported": "यो डेस्कटप एपले ब्राउजर फलकलाई समर्थन गर्दैन।",
  "session.browser.suspended": "ब्राउजर निलम्बित। पुन: जडान गर्न यो सत्रसँग अन्तर्क्रिया गर्नुहोस्।",
  "session.browser.address.placeholder": "प्रविष्ट गर्नुहोस् URL",
  "settings.backToSettings": "सेटिङहरूमा फर्कनुहोस्",
  "settings.backToProjects": "परियोजनाहरूमा फर्कनुहोस्",
  "settings.search.placeholder": "खोज्नुहोस्",
  "settings.search.results": "सेटिङ परिणामहरू",
  "settings.search.group.pages": "पृष्ठहरू",
  "settings.search.group.settings": "सेटिङहरू",
  "settings.search.group.projects": "परियोजनाहरू",
  "settings.search.group.servers": "सर्भरहरू",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}} को लागि कुनै परिणाम छैन",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "थप विशिष्ट परिणामहरू हेर्न आफ्नो खोजलाई संकुचित गर्नुहोस्।",
  "settings.server.description": "यस सर्भरको जडान र प्राथमिकताहरू प्रबन्ध गर्नुहोस्",
  "settings.server.section.connection": "जडान",
  "settings.server.preferences.websearch.title": "तेस्रो-पक्ष खोज",
  "settings.server.preferences.websearch.description":
    "खोज प्रदायक एजेन्टहरूले वेब खोजी गर्न प्रयोग गर्ने चयन गर्नुहोस्",
  "settings.projects.search.placeholder": "परियोजनाहरू खोज्नुहोस्",
  "project.settings.name.title": "परियोजनाको नाम",
  "project.settings.name.description": "यस परियोजनाको नाम OpenCode भरि देखाइएको छ",
  "project.settings.icon.description": "सिफारिस गरिएको: 128×128px। छवि अपलोड गर्न क्लिक गर्नुहोस् वा तान्नुहोस्।",
  "project.settings.color.description": "कुनै अनुकूलन छवि सेट नभएको बेला परियोजना प्रतिमाको लागि प्रयोग गरिन्छ",
  "project.settings.worktree.startup.description": "नयाँ कार्य रूख सिर्जना गरेपछि एक पटक चल्छ",
  "project.settings.worktree.startup.hint.base": "आधार कार्य रूखको लागि $OPENCODE_WORKTREE_BASE प्रयोग गर्नुहोस्।",
  "project.settings.worktree.startup.hint.new": "नयाँ कार्य रूखको लागि $OPENCODE_WORKTREE_PATH प्रयोग गर्नुहोस्।",
  "project.settings.extensions.empty.mcps.title": "अहिलेसम्म कुनै MCP हरू छैनन्",
  "project.settings.extensions.empty.mcps.description": "OpenCode मा उपलब्ध MCPs यहाँ देखा पर्नेछ",
  "project.settings.extensions.empty.plugins.title": "अहिलेसम्म कुनै प्लगइनहरू छैनन्",
  "project.settings.extensions.empty.plugins.description": "OpenCode मा उपलब्ध प्लगइनहरू यहाँ देखिनेछन्",
  "project.settings.extensions.empty.skills.title": "अझै सीप छैन",
  "project.settings.extensions.empty.skills.description": "OpenCode मा उपलब्ध सीपहरू यहाँ देखिनेछन्",
  "project.settings.extensions.lsp.configured": "कन्फिगर गरिएको भाषा सर्भर",
  "project.settings.extensions.lsp.status.enabled": "कन्फिगरेसनमा सक्षम गरियो",
  "project.settings.extensions.lsp.status.disabled": "कन्फिगरेसनमा असक्षम पारियो",
  "project.settings.extensions.lsp.empty.title": "कुनै भाषा सर्भरहरू कन्फिगर गरिएको छैन",
  "project.settings.extensions.lsp.empty.description":
    "यस परियोजनाको लागि कन्फिगर गरिएका भाषा सर्भरहरू यहाँ देखा पर्नेछ",
  "project.settings.extensions.lsp.disabled.title": "भाषा सर्भरहरू असक्षम गरियो",
  "project.settings.extensions.lsp.disabled.description": "यस परियोजनाको कन्फिगरेसनमा LSP असक्षम गरिएको छ",
  "project.settings.extensions.lsp.loadFailed": "भाषा सर्भर कन्फिगरेसन लोड गर्न सकिएन",
  "project.settings.extensions.lsp.retry": "पुन: प्रयास गर्नुहोस्",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "समूह",
  "settings.timeline.collapse": "संक्षिप्त गर्नुहोस्",
  "settings.timeline.visibility.show": "देखाउनुहोस्",
  "settings.timeline.visibility.hide": "लुकाउनुहोस्",
  "settings.timeline.visibility.label": "{{activity}} दृश्यता",
  "settings.timeline.grouped.label": "{{activity}} समूहबद्ध",
  "settings.timeline.collapsed.label": "{{activity}} पतन भयो",
  "session.new.workspace.search.empty": "मिल्दो कार्य रूखहरू छैनन्",
  "settings.workspaces.description": "कार्यवृक्षहरू समीक्षा गर्नुहोस् र डिस्क प्रयोग व्यवस्थापन गर्नुहोस्",
  "settings.workspaces.empty.description": "OpenCode मा सिर्जना गरिएका Worktrees यहाँ देखिनेछन्",
  "settings.workspaces.sessions.filtered.one": "{{count}} सत्र",
  "settings.workspaces.sessions.filtered.other": "{{count}} सत्रहरू",
  "settings.workspaces.deleteAll.confirm.one": "यसले स्थायी रूपमा {{count}} चयन गरिएको कार्य रूखलाई मेटाउनेछ।",
  "settings.workspaces.deleteAll.confirm.other": "यसले सदाका लागि चयन गरिएका {{count}} कार्य रूखहरूलाई मेटाउनेछ।",
  "settings.workspaces.deleteWithoutSessions": "सत्र बिना कार्य रूखहरू मेटाउनुहोस्",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "यसले सदाका लागि लिंक गरिएको सत्रहरू बिना नै {{count}} कार्यवृक्ष मेटाउनेछ।",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "यसले लिङ्क गरिएका सत्रहरू बिना नै {{count}} कार्य रूखहरूलाई स्थायी रूपमा मेटाउनेछ।",
  "settings.workspaces.deleteWithoutSessions.warning":
    "मर्ज नगरिएका परिवर्तनहरू वा सक्रिय स्थानहरू भएका कार्य रूखहरू राखिनेछन्।",
  "settings.workspaces.delete.button": "कार्य रूखहरू मेटाउनुहोस्",
  "workspace.lifecycle.deleting": "मेट्दै...",
  "session.summary.tooltip": "सारांश",
  "session.summary.server": "विस्तारहरू",
  "session.summary.chooseProject": "एउटा परियोजना छान्नुहोस्",
  "session.summary.mcp.onCreation": "worktree सिर्जना हुँदा लागू हुन्छ",
  "session.summary.mcp.prepareFailed": "MCP सर्भरहरू तयार गर्न सकिएन",
  "session.summary.mcp.unavailable": "यो वर्कट्रीमा MCP सर्भर {{name}} उपलब्ध छैन।",
  "session.summary.mcp.signInBeforeSend": "प्रम्प्ट पठाउनु अघि {{name}} मा साइन इन गर्नुहोस्।",
  "session.summary.mcp.notReady": "MCP सर्भर {{name}} तयार छैन। प्रम्प्ट पठाउनु अघि यसको जडान समाधान गर्नुहोस्।",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "कन्फिगर गरिएको MCP सर्भरहरू",
  "session.summary.plugins": "प्लगइनहरू",
  "session.summary.plugins.configured": "कन्फिगर गरिएका प्लगइनहरू",
  "session.summary.skills": "सीपहरू",
  "session.summary.skills.configured": "कन्फिगर गरिएको कौशल",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "असफल",
  "session.summary.retry": "पुन: प्रयास गर्नुहोस्",
  "session.summary.connecting": "जडान गर्दै...",
  "session.summary.needsAuth": "साइन इन आवश्यक छ",
  "session.summary.configure": "कन्फिगरेसन फाइल",
  "session.summary.copyConfigPath": "कन्फिगरेसन फाइल पथ प्रतिलिपि गर्नुहोस्",
  "session.summary.configFileMissing": "कुनै कन्फिगरेसन फाइल फेला परेन",
  "session.summary.mcp.empty": "कुनै MCP सर्भरहरू कन्फिगर गरिएको छैन",
  "session.summary.mcp.add": "opencode.json मा सर्भरहरू थप्नुहोस्",
  "session.summary.plugins.manage": "opencode.json मा प्लगइनहरू प्रबन्ध गर्नुहोस्",
  "session.summary.plugins.empty": "कुनै प्लगइनहरू कन्फिगर गरिएको छैन",
  "session.summary.plugins.add": "opencode.json मा प्लगइनहरू थप्नुहोस्",
  "session.summary.skills.manage": "opencode.json मा सीपहरू व्यवस्थापन गर्नुहोस्",
  "session.summary.skills.empty": "कुनै सीपहरू कन्फिगर गरिएको छैन",
  "session.summary.skills.add": "opencode.json मा सीपहरू थप्नुहोस्",
  "session.summary.lsp.configured": "कन्फिगर गरिएको LSPs",
  "session.summary.lsp.empty": "कुनै LSP सर्भरहरू कन्फिगर गरिएको छैन",
  "session.summary.lsp.manage": "opencode.json मा LSP व्यवस्थापन गर्नुहोस्",
  "workspace.delete.location": "स्थान",

  "command.debugBar.toggle": "डिबग बार टगल गर्नुहोस्",
  "command.session.location.cycle": "सेसनको स्थान क्रमशः बदल्नुहोस्",
  "dialog.provider.anthropic.note": "API कुञ्जीमार्फत Claude मोडेलहरूमा प्रत्यक्ष पहुँच",
  "provider.connect.title.anthropicProMax": "Anthropic मार्फत लगइन गर्नुहोस्",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancelFile": "{{filename}} को अपलोड रद्द गर्नुहोस्",
  "prompt.toast.uploading.cancel": "अपलोड रद्द गर्नुहोस्",
  "prompt.toast.uploadFailed.title": "अपलोड असफल भयो",
  "session.browser.empty.title": "URL प्रविष्ट गर्नुहोस्",
  "session.browser.empty.description": "वा “एप ब्राउजरमा खोल्नुहोस्” भनेर प्रम्प्ट गर्नुहोस्",
  "session.browser.failed.title": "URL मा पुग्न सकिएन",
  "session.browser.failed.description": "URL र आफ्नो जडान जाँचेर फेरि प्रयास गर्नुहोस्।",
  "debugBar.providerAriaLabel": "प्रदायकको कार्यसम्पादन निदान",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "प्रदायक अनुरोध पठाइएदेखि मोडेलको पहिलो आउटपुट आउँदासम्मको समय।",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "प्रदायक अनुरोध पठाइएदेखि उत्तरको पहिलो पाठ आउँदासम्मको समय।",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "मोडेलको पहिलो आउटपुटपछि प्रति सेकेन्ड आउटपुट टोकन।",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "प्रदायक अनुरोध पठाइएदेखि यसको प्रतिक्रिया स्ट्रिम समाप्त हुँदासम्मको समय।",
  "settings.updates.action.download": "OpenCode डाउनलोड गर्नुहोस्",
  "settings.updates.migration.title": "बेटाबाट स्थिर संस्करणमा जानुहोस्",
