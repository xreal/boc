export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Չմիավորված փոփոխություններ, կապված աշխատաշրջաններ կամ ակտիվ տեղադրություններ ունեցող աշխատանքային ծառերը կպահպանվեն։",
  ...
  "session.location.worktree": "Ընտրել worktree",
  "session.location.worktreesFailed": "Չհաջողվեց բեռնել worktree-ները",
  "session.location.moving": "Նիստը տեղափոխվում է…",
  "dialog.server.menu.hide": "Թաքցնել նախագծերի ցանկից",
  "dialog.server.menu.show": "Ցույց տալ նախագծերի ցանկում",
  "session.queue.count.one": "{{count}} հերթում",
  "session.queue.count.other": "{{count}} հերթում",
  "session.queue.steer": "Ուղղորդել",
  "session.queue.send": "Ուղարկել",
  "session.queue.steerTooltip": "Ուղարկել առանց ընդհատելու",
  "session.queue.remove": "Հեռացնել",
  "session.queue.reorder": "Փոխել հերթագրված հուշման դիրքը",
  "session.new.worktree.creating": "Worktree-ի ստեղծում",
  "settings.backToApp": "Վերադառնալ հավելված",
  "settings.appearance.section.experimental": "Փորձարարական",
  "settings.appearance.row.tabs.title": "Ներդիրներ",
  "settings.appearance.row.tabs.description": "Ընտրեք նիստերի ներդիրների դասավորությունը",
  "settings.appearance.row.tabs.horizontal": "Հորիզոնական",
  "settings.appearance.row.tabs.vertical": "Ուղղահայաց",
  "settings.general.row.followUpBehavior.title": "Հետագա հաղորդագրությունների վարքագիծ",
  "settings.general.row.followUpBehavior.description":
    "Ընտրեք՝ հետագա հաղորդագրությունները հերթագրել, թե ուղղորդել ընթացիկ հերթը։ Փոխելու համար օգտագործեք {{keybind}}։",
  "settings.general.row.followUpBehavior.queue": "Հերթագրել",
  "settings.general.row.followUpBehavior.steer": "Ուղղորդել",
  "settings.general.row.reasoningMode.title": "Մոդելի հիմնավորում",
  "settings.general.row.reasoningMode.description": "Ընտրեք՝ ինչպես ցուցադրել մոդելի հիմնավորումը ժամանակագրությունում",
  "settings.general.row.reasoningMode.hidden": "Թաքցված",
  "settings.general.row.reasoningMode.compact": "Հակիրճ",
  "settings.general.row.reasoningMode.full": "Ամբողջական",
  "session.new.workspace.createFrom": "Ստեղծել այստեղից",
  "session.new.workspace.branch.search.placeholder": "Փնտրել ճյուղեր",
  "toast.migration.progress.clearingOldEvents": "Հին իրադարձությունները մաքրվում են",
  "toast.migration.progress.migratingSessions": "Նիստերը տեղափոխվում են",
  "session.new.workspace.existingLabel": "Աշխատանքային ծառ",
  "desktop.onboarding.defaultProject": "Կանխադրված նախագիծ",
  "home.projects.all": "Բոլոր նախագծերը",
  "session.tab.files": "Ֆայլեր",
  "session.files.openTabs": "Բաց ֆայլեր",
  "session.tab.usage": "Օգտագործում",
  "session.view.select": "Նիստի տեսք",
  "session.background.moveTasks": "{{tasks}}-ը տեղափոխել ֆոնային ռեժիմ",
  "session.background.moveRunning": "Տեղափոխել ֆոնային ռեժիմ",
  "session.background.inBackground": "{{tasks}}-ն աշխատում է ֆոնային ռեժիմում",
  "session.background.tasksRunning.one": "{{count}} ֆոնային առաջադրանք է աշխատում",
  "session.background.tasksRunning.other": "{{count}} ֆոնային առաջադրանքներ են աշխատում",
  ...
  "session.background.subagent.other": "{{count}} ենթագործակալներ",
  "session.timeline.working": "Աշխատում է",
  "session.review.wrapLines": "Տողերը փաթաթել",
  "session.websearch.title": "Երրորդ կողմի վեբ որոնում",
  "session.websearch.description": "Ընտրեք որոնման մատակարարին, որն գործակալները կօգտագործեն վեբում որոնելու համար",
  "session.websearch.provider": "Որոնման մատակարար",
  "session.websearch.any": "Ցանկացած",
  "session.websearch.disable": "Չօգտագործել որոնումը",
  "session.websearch.enable": "Միացնել",
  "session.websearch.loadFailed": "Չհաջողվեց բեռնել որոնման մատակարարներին։",
  "session.websearch.empty": "Որոնման հասանելի մատակարարներ չկան։",
  "session.websearch.failed": "Չհաջողվեց պահպանել ձեր ընտրությունը։ Կրկին փորձեք։",
  "session.websearch.retry": "Կրկին փորձել",
  "session.new.worktree.draftPlaceholder": "Գրեք հաջորդ հաղորդագրության սևագիրը, մինչ աշխատանքային ծառը պատրաստվում է…",
  "session.search.placeholder": "Գտնել...",
  "session.search.noResults": "Համընկնումներ չկան",
  "titlebar.tabs": "Ներդիրներ",
  "titlebar.channel.local": "Տեղական",
  "titlebar.channel.dev": "Մշակում",
  "titlebar.channel.beta": "Բետա",
  "titlebar.toggleDebugTools": "Միացնել կամ անջատել վրիպազերծման գործիքները",
  "settings.tab.experimental": "Փորձարարական",
  "settings.experimental.description": "Փորձեք փորձարարական գործառույթները",
  "settings.tab.about": "Ծրագրի մասին",
  "settings.about.version": "Տարբերակ {{version}}",
  "settings.about.devVersion": "մշակում",
  "settings.about.license": "Թողարկվել է MIT արտոնագրով",
  "settings.about.writtenBy": "Գրել է",
  "settings.about.illustratedBy": "Նկարազարդել է",
  "settings.about.and": "և",
  "settings.about.otherContributor.one": "{{count}} այլ",
  "settings.about.otherContributor.other": "{{count}} այլ",
  "settings.about.firstPublished": "Առաջին անգամ հրատարակվել է Միսուրիում, ԱՄՆ",
  "settings.about.firstIllustrated": "Առաջին անգամ նկարազարդվել է Լոնդոնում, Անգլիա",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode՝ բաց կոդով կոդավորման գործակալ",
  "settings.about.trademark": "OpenCode-ը Anomaly Innovations, Inc.-ի գրանցված ապրանքային նշանն է։",
  ...
  "settings.timeline.description":
    "Ընտրեք, թե որքան գործունեություն ցուցադրվի ժամանակագծում։ Հաղորդագրությունները մնում են տեսանելի։",
  "settings.timeline.preset.everything": "Ամեն ինչ",
  "settings.timeline.preset.detailed": "Մանրամասն",
  "settings.timeline.preset.compact": "Կոմպակտ",
  "settings.timeline.preset.quiet": "Հանգիստ",
  "settings.timeline.preset.text-only": "Միայն տեքստ",
  "settings.timeline.description.everything":
    "Ցուցադրել ամբողջ գործունեությունն առանձին։ Ընդարձակել shell-ի ելքը, խմբագրումները և մտածողությունը։",
  "settings.timeline.description.detailed":
    "Ընդարձակել shell-ի ելքը և խմբագրումները։ Ենթագործակալներին ցուցադրել առանձին, իսկ մյուս գործունեությունը խմբավորել «Օգտագործված» բաժնում։",
  "settings.timeline.description.compact":
    "Ամբողջ գործունեությունը խմբավորել «Օգտագործված» բաժնում՝ մանրամասները ծալված։",
  "settings.timeline.description.quiet":
    "Խմբագրումները և ենթագործակալներին խմբավորել «Օգտագործված» բաժնում։ Թաքցնել մյուս գործունեությունը։",
  "settings.timeline.description.text-only": "Թաքցնել ամբողջ գործունեությունը։ Ցուցադրել միայն հաղորդագրությունները։",
  "settings.timeline.description.custom":
    "Յուրաքանչյուր գործունեության կատեգորիայի համար օգտագործել ձեր ընտրած տեղադրությունն ու մանրամասները։",
  "settings.timeline.custom": "Հատուկ",
  "settings.timeline.advanced": "Ընդլայնված",
  "settings.timeline.advanced.description":
    "Սահմանեք տեղադրությունն ու մանրամասները յուրաքանչյուր գործունեության կատեգորիայի համար։",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Խմբագրումներ",
  "settings.timeline.category.thinking": "Մտածողություն",
  "settings.timeline.category.subagents": "Ենթագործակալներ",
  "settings.timeline.category.notices": "Ծանուցումներ",
  "settings.timeline.category.tools": "Այլ գործիքներ",
  "settings.general.row.mobileDiffWrap.description":
    "Բջջային diff-երում երկար տողերը փաթաթել՝ հորիզոնական ոլորելու փոխարեն",
  "provider.connect.error.unsupportedFields": "Նույնականացման այս ձևը պարունակում է չաջակցվող դաշտեր",
  "session.review.filesChangedCount.one": "{{count}} ֆայլ փոխվել է",
  "session.review.filesChangedCount.other": "{{count}} ֆայլեր փոխվել են",
  "settings.about.writtenByNames": "Գրել է՝ {{names}}",
  "settings.about.illustratedByNames": "Նկարազարդել է՝ {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Միացված չէ {{host}}-ին։ Քո նախագծած նյութը պահպանված է; հեռավոր աշխատանքը դեռ կարող է ընթանալ։",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Ավելացնել SSH սերվերը",
  "ssh.server.menu.label": "SSH սերվեր",
  "ssh.target": "Հոստ կամ SSH հրամանը",
  "ssh.connect": "Միանալ",
  "ssh.connectTo": "Միանալ {{host}}-ին",
  "ssh.authenticate": "SSH प्रमाणीकरण",
  "ssh.action.authenticate": "Հաստատել",
  "ssh.session.disconnected": "SSH կապը անգործուն է",
  "ssh.session.connecting": "Կապ հաստատվում է SSH սերվերին",
  "ssh.session.reconnectDescription":
    "Մ կրկին միացեք, որպեսզի տեսնեք այս նստաշրջանը և շարունակեք աշխատանքը: Ձեր հեռակա նստաշրջանը պահպանված է",
  "ssh.session.reconnect": "Մ կրկին միացեք",
  "ssh.authenticationRequired": "Պահանջվում է սերտիֆիկացում {{host}}-ի համար",
  "ssh.trust": "Վստահել և միանալ",
  "ssh.continue": "Շարունակել",
  "ssh.retry": "Փորձել կրկին",
  "ssh.update": "Թարմացնել և կրկին միանալ",
  "ssh.openProject": "Բացել նախագիծ",
  "ssh.project": "Բացել նախագիծը {{host}}-ում",
  "ssh.disconnect": "Անջատել",
  "ssh.forget": "Սպետել կապը",
  "ssh.stage.disconnected": "Կապը կտրված է։ Հեռավոր սերվերը շարունակում է աշխատել։",
  "ssh.stage.connecting": "Կապ հաստատում SSH-ի միջոցով…",
  "ssh.stage.checking": "Ստուգում OpenCode-ը…",
  "ssh.stage.downloading": "Ներբեռնում սերվերը…",
  "ssh.stage.uploading": "Վերբեռնում սերվերը…",
  "ssh.stage.starting": "Կապ հաստատվում է OpenCode-ին…",
  "ssh.stage.ready": "Կապ հաստատված է",
  "ssh.stage.authentication": "Պայմանավորվածություն պահանջվում է",
  "ssh.stage.incompatible": "Պահանջվում է սերվերի թարմացում",
  "ssh.stage.failed": "Կապը ձախողվեց",
  "ssh.error.input":
    "Ներմուծեք հոսթ կամ SSH կապի հրաման: Հեռավոր հրամաններ և չհամապատասխանող SSH տարբերակները թույլատրված չեն:",
  "ssh.error.connection": "Չի հաջողվել հաստատել SSH կապը: Ստուգեք ձեր ցանցը և SSH կարգավորումները:",
  "ssh.error.platform":
    "Այս հեռավոր հարթակը չի աջակցվում: Ինքնալարային կարգավորումը ներկայում պահանջում է Linux կամ macOS x64 կամ arm64 վրա:",
  "ssh.error.version": "Հեռավոր ծառայությունը պետք է համապատասխանի այս Desktop տարբերակին նախքան կապվելը:",
  "ssh.error.install": "Չի հաջողվել տեղադրել հեռավոր սերվերը: Ստուգեք կապը, սկավառակի տարածքը և որ tar- ը տեղադրված է:",
  "ssh.error.unpublished":
    "Այս Desktop տարբերակում հրապարակված հեռավոր սերվեր չկա: Օրինակային կառուցվածքների համար, տեղադրեք և սկսեք V2 հոսթում, ապա փորձեք կրկին:",
  "ssh.error.service": "SSH կապը հաստատված է, բայց OpenCode սերվերը չի պատրաստվել:",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing": "OpenSSH չի գտնվել։ Տեղադրեք OpenSSH կլիանտ և համոզվեք, որ ssh հասանելի է PATH-ում։",
  "command.browser.open": "Բացեք զննարկիչը",
  "command.browser.reload": "Թարմացրեք զննարկչի էջը",
  "command.session.summary.toggle": "Փոխել ամփոփագիրը",
  "common.color.orange": "նարնջագույն",
  "common.color.yellow": "դեղին",
  "common.color.cyan": "փիրուզագույն",
  "common.color.green": "կանաչ",
  "common.color.red": "կարմիր",
  "common.color.pink": "վարդագույն",
  "common.color.blue": "կապույտ",
  "common.color.purple": "մանուշակագույն",
  "common.color.gray": "մոխրագույն",
  "mcp.auth.interactiveForm": "MCP սերվերը {{name}} պահանջում է ինտերակտիվ հավատարմագրման ձև",
  "server.connect.title": "Կապվել սերվերի հետ",
  "server.connect.description": "Մուտքագրեք ձեր սերվերի հասցեն և գաղտնաբառը՝ սկսելու համար։",
  "server.connect.button": "Կապվել",
  "server.connect.address.invalid": "Մուտքագրեք վավեր HTTP կամ HTTPS սերվերի հասցե։",
  "server.connect.failed": "Չկապվեց. Ստուգեք սերվերի հասցեն և գաղտնաբառը, ապա փորձեք նորից։",
  "server.connect.pair.description": "Գործարկեք այս հրամանը ձեր համակարգչում՝ ստանալու ձեր կապի մանրամասները։",
  "server.connect.scan": "Սկանավորեք QR կոդը",
  "server.connect.scan.description": "Տեսախցիկն ուղղեք opencode pair-ի ցուցադրած QR կոդին։",
  "server.connect.scan.invalid": "Սա OpenCode-ի զուգակցման կոդ չէ։ Սկանավորեք opencode pair-ի ցուցադրած կոդը։",
  "server.connect.camera": "Զույգագրման վահանակը",
  "server.connect.camera.starting": "Բացվում է վահանակը…",
  "server.connect.mixedContent": "Այս HTTP սերվերին հնարավոր չէ միանալ HTTPS էջից։ Օգտագործեք HTTPS սերվերի հասցե։",
  "server.connect.camera.insecure": "QR սկանումը պահանջում է այս էջը բացել HTTPS-ով կամ տեղական հոստում։",
  "server.connect.camera.unavailable": "Այս զննարկչին վահանակ հասանելի չէ։ Մուտքագրեք ձեր կապի մանրամասները ձեռքով։",
  "server.connect.camera.error":
    "Չկարողացա բացել տեսախցիկը։ Թույլատրել տեսախցիկի մուտքը կամ ձեռքով ներմուծել ձեր կապի տվյալները։",
  "dialog.server.menu.remove": "Հեռացնել",
  "file.error.notFound": "Ֆայլը չի գտնվել՝ {{name}}",
  "toast.migration.progress.migratingSessions.current": "Աշխատաշրջանների տեղափոխում՝ {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Աշխատաշրջանների տեղափոխում՝ {{current}}/{{total}}",
  "toast.migration.progress.working": "Տվյալների տեղափոխում",
  "toast.migration.progress.working.current": "Տվյալների տեղափոխում՝ {{current}}",
  "toast.migration.progress.working.progress": "Տվյալների տեղափոխում՝ {{current}}/{{total}}",
  "home.workspaceTip": "Սկսել հաջորդ նստաշրջանը նոր աշխատանքային տարածքում՝ փոփոխությունները մեկուսացնելու համար",
  "session.tab.browser": "Դիտարկիչ",
  "session.tab.add": "Ավելացնել ներդիր",
  "session.queue.attachments.one": "Ավելացնել {{count}} կցում",
  "session.queue.attachments.other": "Ավելացնել {{count}} կցումներ",
  "session.browser.address": "Դիտարկչի հասցե",
  "session.browser.replaced": "Դիտարկիչների կառավարումը տեղափոխվել է այլ աշխատասեղանի պատուհան։",
  "session.browser.unsupported": "Այս աշխատասեղանի հավելվածը չի աջակցում դիտարկիչի վահանակը։",
  "session.browser.suspended":
    "Բրաուզերը ժամանակավորապես կանգնեցվել է։ Հետադարձ կապ հաստատեք այս նստաշրջանի հետ՝ նորից միանալու համար։",
  "session.browser.address.placeholder": "Ներմուծեք URL",
  "settings.backToSettings": "Հետ երթ դեպի կարգավորումներ",
  "settings.backToProjects": "Հետ երթ դեպի նախագծեր",
  "settings.search.placeholder": "Որոնում",
  "settings.search.results": "Կարգավորումների արդյունքներ",
  "settings.search.group.pages": "Էջեր",
  "settings.search.group.settings": "Կարգավորումներ",
  "settings.search.group.projects": "Նախագծեր",
  "settings.search.group.servers": "Ծառայակատարներ",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}}-ի համար արդյունքներ չկան",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Ժամանակացրեք ձեր որոնումը, որպեսզի տեսնեք ավելի հատուկ արդյունքներ։",
  "settings.server.description": "Կառավարեք այս սերվերի միացումն ու նախասիրությունները",
  "settings.server.section.connection": "Միացում",
  "settings.server.preferences.websearch.title": "Երրորդ կողմի որոնում",
  "settings.server.preferences.websearch.description":
    "Ընտրեք որոնման մատակարարը, որը գործակալները օգտագործում են համացանցը որոնելու համար",
  "settings.projects.search.placeholder": "Փնտրել նախագծերը",
  "project.settings.name.title": "Նախագծի անուն",
  "project.settings.name.description": "Այս անունը կցուցադրվի նախագծի համար ամբողջ OpenCode-ում",
  "project.settings.icon.description": "Խորհուրդ է տրվում՝ 128×128px. Սեղմեք կամ քաշեք պատկերը՝ վերամբեռնելու համար.",
  "project.settings.color.description": "Կիրառում է նախագծի պատկերակին, երբ հարմարեցված պատկեր չի սահմանվել",
  "project.settings.worktree.startup.description": "Շարունակվում է մեկ անգամ նոր worktree ստեղծելուց հետո",
  "project.settings.worktree.startup.hint.base": "Օգտագործեք $OPENCODE_WORKTREE_BASE հիմնական worktree-ի համար.",
  "project.settings.worktree.startup.hint.new": "Օգտագործեք $OPENCODE_WORKTREE_PATH նոր worktree-ի համար.",
  "project.settings.extensions.empty.mcps.title": "Մինչ այժմ MCP-ներ չկան",
  "project.settings.extensions.empty.mcps.description": "OpenCode-ում հասանելի MCP-ները կցուցադրվեն այստեղ",
  "project.settings.extensions.empty.plugins.title": "Ավելացումներ դեռ չկան",
  "project.settings.extensions.empty.plugins.description": "OpenCode-ի համար հասանելի ավելացումները կհայտնվեն այստեղ",
  "project.settings.extensions.empty.skills.title": "Կառավարվում հաստատված հմտություններ չունի",
  "project.settings.extensions.empty.skills.description": "OpenCode-ի համար հասանելի կարողությունները կհայտնվեն այստեղ",
  "project.settings.extensions.lsp.configured": "Պատրաստված լեզվական սերվերներ",
  "project.settings.extensions.lsp.status.enabled": "Կոնֆիգուրացիայում ակտիվացված",
  "project.settings.extensions.lsp.status.disabled": "Կոնֆիգուրացիայում անջատված",
  "project.settings.extensions.lsp.empty.title": "Լեզվական սերվերներ չեն պատրաստված",
  "project.settings.extensions.lsp.empty.description":
    "Այս նախագծի համար պատրաստված լեզվական սերվերները կհայտնվեն այստեղ",
  "project.settings.extensions.lsp.disabled.title": "Լեզվական սերվերները անջատված են",
  "project.settings.extensions.lsp.disabled.description": "LSP-ն անջատված է այս նախագծի կազմաձևում",
  "project.settings.extensions.lsp.loadFailed": "Չհաջողվեց բեռնել լեզվիսերվերի կազմաձևը",
  "project.settings.extensions.lsp.retry": "Մտնող երթ",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Խումբ",
  "settings.timeline.collapse": "Ծալել",
  "settings.timeline.visibility.show": "Ցույց տալ",
  "settings.timeline.visibility.hide": "Թաքցնել",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} նիստ",
  "settings.workspaces.sessions.filtered.other": "{{count}} նիստեր",
  "settings.workspaces.deleteAll.confirm.one": "Սա կընդմիշտ ջնջի ընտրված {{count}} աշխատանքային ծառը:",
  "settings.workspaces.deleteAll.confirm.other": "Սա կընդմիշտ ջնջի ընտրված {{count}} աշխատանքային ծառերը:",
  "settings.workspaces.deleteWithoutSessions": "Ջնջել առանց աշխատաշրջանների աշխատանքային ծառերը",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Սա ընդմիշտ կջնջի առանց կապված աշխատաշրջանների {{count}} աշխատանքային ծառ։",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Սա ընդմիշտ կջնջի առանց կապված աշխատաշրջանների {{count}} աշխատանքային ծառ։",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Չմիավորված փոփոխություններ կամ ակտիվ տեղադրություններ ունեցող աշխատանքային ծառերը կպահպանվեն։",
  "settings.workspaces.delete.button": "Ջնջել աշխատանքային ծառերը",
  "workspace.lifecycle.deleting": "Ջնջվում է…",
  "session.summary.tooltip": "Ամփոփում",
  "session.summary.server": "Ընդլայնումներ",
  "session.summary.chooseProject": "Ընտրել նախագիծ",
  "session.summary.mcp.onCreation": "Կիրառվում է աշխատանքային ծառը ստեղծելիս",
  "session.summary.mcp.prepareFailed": "Չկարողացանք պատրաստել MCP սերվերները",
  "session.summary.mcp.unavailable": "MCP սերվեր {{name}} հասանելի չէ այս աշխատանքային ծառում:",
  "session.summary.mcp.signInBeforeSend": "Մուտք գործեք {{name}}–ում, նախքան ցուցումը ուղարկելը:",
  "session.summary.mcp.notReady": "MCP սերվեր {{name}} պատրաստ չէ. Մի՛ ուղարկեք ցուցումն առանց նրա կապը լուծելու:",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Կարգավորված MCP սերվերներ",
  "session.summary.plugins": "Հավելվածներ",
  "session.summary.plugins.configured": "Կարգավորված հավելվածներ",
  "session.summary.skills": "Հմտություններ",
  "session.summary.skills.configured": "Կարգավորված հմտություններ",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Վստահեցումը ձախողվեց",
  "session.summary.retry": "Փորձել կրկին",
  "session.summary.connecting": "Կապվում է…",
  "session.summary.needsAuth": "Պահանջվում է մուտք գործել",
  "session.summary.configure": "Конֆիգուրացիայի ֆայլ",
  "session.summary.copyConfigPath": "Հարցաթղթի ֆայլի ճանապարհը պատճենել",
  "session.summary.configFileMissing": "Փնտրած конфիգուրացիայի ֆայլը չի գտվել",
  "session.summary.mcp.empty": "MCP սերվերները կոնֆիգուրացված չեն",
  "session.summary.mcp.add": "Ավելացնել սերվերներ opencode.json-ում",
  "session.summary.plugins.manage": "Կառավարել plugins-ը opencode.json-ում",
  "session.summary.plugins.empty": "Պլագիններ չեն կոնֆիգուրացված",
  "session.summary.plugins.add": "Ավելացնել plugins-ը opencode.json-ում",
  "session.summary.skills.manage": "Կառավարել ունակությունները opencode.json-ում",
  "session.summary.skills.empty": "Ունակություններ չեն կոնֆիգուրացված",
  "session.summary.skills.add": "Ավելացնել ունակություններ opencode.json-ում",
  "session.summary.lsp.configured": "Կոնֆիգուրացված LSP-ներ",
  "session.summary.lsp.empty": "LSP սերվերներ չեն կոնֆիգուրացված",
  "session.summary.lsp.manage": "Կառավարել LSP-ը opencode.json-ում",
  "workspace.delete.location": "Տեղանք",
  "command.debugBar.toggle": "Միացնել կամ անջատել վրիպազերծման վահանակը",
  "command.session.location.cycle": "Փոխել աշխատաշրջանի տեղադրությունը",
  "dialog.provider.anthropic.note": "Ուղղակի հասանելիություն Claude մոդելներին API բանալիով",
  "provider.connect.title.anthropicProMax": "Մուտք գործել Anthropic-ով",
  "prompt.toast.uploading.cancel": "Չեղարկել վերբեռնումը",
  "prompt.toast.uploading.cancelFile": "Չեղարկել {{filename}} ֆայլի վերբեռնումը",
  "prompt.toast.uploadFailed.title": "Վերբեռնումը ձախողվեց",
  "session.browser.empty.title": "Մուտքագրեք URL",
  "session.browser.empty.description": "Կամ գրեք «Բացել հավելվածի դիտարկիչում»",
  "session.browser.failed.title": "URL-ը հասանելի չէ",
  "session.browser.failed.description": "Ստուգեք URL-ը և կապը, ապա կրկին փորձեք։",
  "debugBar.providerAriaLabel": "Մատակարարի արդյունավետության ախտորոշում",
  "debugBar.ttft.tip": "Մատակարարին հարցումն ուղարկելուց մինչև մոդելի առաջին ելքը ընկած ժամանակը։",
  "debugBar.ttfa.tip": "Մատակարարին հարցումն ուղարկելուց մինչև պատասխանի առաջին տեքստը ընկած ժամանակը։",
  "debugBar.tps.tip": "Ելքային տոկենների քանակը վայրկյանում՝ մոդելի առաջին ելքից հետո։",
  "debugBar.e2e.tip": "Մատակարարին հարցումն ուղարկելուց մինչև պատասխանի հոսքի ավարտը ընկած ժամանակը։",
  "settings.updates.action.download": "Ներբեռնել OpenCode-ը",
  "settings.updates.migration.title": "Beta-ից անցնել Stable-ի",
