export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Birleşdirilmedik üýtgeşmeleri, baglanyşykly sessiýalary ýa-da işjeň ýerleşişleri bolan iş agaçlary saklanar.",
  ...
  "session.location.worktree": "Worktree saýlaň",
  "session.location.worktreesFailed": "Worktree-lary ýükläp bolmady",
  "session.location.moving": "Sessiýa geçirilýär…",
  "dialog.server.menu.hide": "Taslama sanawyndan gizläň",
  "dialog.server.menu.show": "Taslama sanawynda görkeziň",
  "session.queue.count.one": "{{count}} nobatda",
  "session.queue.count.other": "{{count}} nobatda",
  "session.queue.steer": "Ugrukdyr",
  "session.queue.send": "Iber",
  "session.queue.steerTooltip": "Arasyny kesmän iber",
  "session.queue.remove": "Aýyr",
  "session.queue.reorder": "Nobatdaky promptyň ýerini üýtget",
  "session.new.worktree.creating": "Worktree döredilýär",
  "settings.backToApp": "Programma dolan",
  "settings.appearance.section.experimental": "Synag",
  "settings.appearance.row.tabs.title": "Sahypalar",
  "settings.appearance.row.tabs.description": "Sessiýa sahypalarynyň ýerleşişini saýlaň",
  "settings.appearance.row.tabs.horizontal": "Kese",
  "settings.appearance.row.tabs.vertical": "Dik",
  "settings.general.row.followUpBehavior.title": "Dowam habarlarynyň özüni alyp barşy",
  "settings.general.row.followUpBehavior.description":
    "Dowam habarlaryny nobata goýmagy ýa-da häzirki tapgyry ugrukdyrmagy saýlaň. Üýtgetmek üçin {{keybind}} ulanyň.",
  "settings.general.row.followUpBehavior.queue": "Nobata goý",
  "settings.general.row.followUpBehavior.steer": "Ugrukdyr",
  "settings.general.row.reasoningMode.title": "Modeliň pikir ýöretmesi",
  "settings.general.row.reasoningMode.description":
    "Modeliň pikir ýöretmesiniň wagt çyzgysynda nähili görkeziljegini saýlaň",
  "settings.general.row.reasoningMode.hidden": "Gizlin",
  "settings.general.row.reasoningMode.compact": "Ykjam",
  "settings.general.row.reasoningMode.full": "Doly",
  "session.new.workspace.createFrom": "Şu ýerden döret",
  "session.new.workspace.branch.search.placeholder": "Şahalary gözle",
  "toast.migration.progress.clearingOldEvents": "Köne wakalar arassalanýar",
  "toast.migration.progress.migratingSessions": "Sessiýalar göçürilýär",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "Bellenen taslama",
  "home.projects.all": "Ähli taslamalar",
  "session.tab.files": "Faýllar",
  "session.files.openTabs": "Açyk faýllar",
  "session.tab.usage": "Ulanylyş",
  "session.view.select": "Sessiýa görnüşi",
  "session.background.moveTasks": "{{tasks}}-y fona geçir",
  "session.background.moveRunning": "Fona geçir",
  "session.background.inBackground": "{{tasks}} fonda işleýär",
  "session.background.tasksRunning.one": "{{count}} fon tabşyrygy işleýär",
  "session.background.tasksRunning.other": "{{count}} fon tabşyrygy işleýär",
  ...
  "session.background.subagent.one": "{{count}} kiçi agent",
  "session.background.subagent.other": "{{count}} kiçi agent",
  "session.timeline.working": "Işleýär",
  "session.review.wrapLines": "Setirleri dola",
  "session.websearch.title": "Üçünji tarap web gözlegi",
  "session.websearch.description": "Agentleriň webde gözlemek üçin ulanjak gözleg üpjün edijisini saýlaň",
  "session.websearch.provider": "Gözleg üpjün edijisi",
  "session.websearch.any": "Islendik",
  "session.websearch.disable": "Gözlegi ulanma",
  "session.websearch.enable": "Işlet",
  "session.websearch.loadFailed": "Gözleg üpjün edijilerini ýükläp bolmady.",
  "session.websearch.empty": "Elýeterli gözleg üpjün edijisi ýok.",
  "session.websearch.failed": "Saýlawyňyzy saklap bolmady. Täzeden synanyşyň.",
  "session.websearch.retry": "Täzeden synanyş",
  "session.new.worktree.draftPlaceholder": "Worktree taýýarlanýarka dowam habarynyň garalamasyny ýazyň…",
  "session.search.placeholder": "Tap...",
  "session.search.noResults": "Gabat gelýän zat ýok",
  "titlebar.tabs": "Sahypalar",
  "titlebar.channel.local": "Ýerli",
  "titlebar.channel.dev": "Işläp taýýarlama",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Düzediş gurallaryny aç/ýap",
  "settings.tab.experimental": "Synag",
  "settings.experimental.description": "Synag aýratynlyklaryny synap görüň",
  "settings.tab.about": "Hakynda",
  "settings.about.version": "Wersiýa {{version}}",
  "settings.about.devVersion": "işläp taýýarlama",
  "settings.about.license": "MIT ygtyýarnamasy esasynda çykaryldy",
  "settings.about.writtenBy": "Ýazan",
  "settings.about.illustratedBy": "Suratlandyran",
  "settings.about.and": "we",
  "settings.about.otherContributor.one": "{{count}} başga",
  "settings.about.otherContributor.other": "{{count}} başga",
  "settings.about.firstPublished": "Ilkinji gezek Missuri, ABŞ-da neşir edildi",
  "settings.about.firstIllustrated": "Ilkinji gezek London, Angliýada suratlandyryldy",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, açyk çeşmeli kodlaşdyrma agenti",
  "settings.about.trademark": "OpenCode Anomaly Innovations, Inc. kompaniýasynyň bellige alnan söwda nyşanydyr.",
  ...
  "settings.timeline.description":
    "Wagt çyzgysynda näçe işjeňligiň görünjekdigini saýlaň. Habarlar görünýän bolup galýar.",
  "settings.timeline.preset.everything": "Ählisi",
  "settings.timeline.preset.detailed": "Jikme-jik",
  "settings.timeline.preset.compact": "Ykjam",
  "settings.timeline.preset.quiet": "Ümsüm",
  "settings.timeline.preset.text-only": "Diňe tekst",
  ...
  "settings.timeline.description.custom":
    "Her işjeňlik kategoriýasy üçin saýlan ýerleşişiňizi we jikme-jiklikleriňizi ulanyň.",
  "settings.timeline.custom": "Ýörite",
  "settings.timeline.advanced": "Ösen",
  "settings.timeline.advanced.description": "Her işjeňlik kategoriýasy üçin ýerleşişi we jikme-jiklikleri sazlaň.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Redaktirlemeler",
  "settings.timeline.category.thinking": "Pikir ýöretme",
  "settings.timeline.category.subagents": "Kiçi agentler",
  "settings.timeline.category.notices": "Bildirişler",
  "settings.timeline.category.tools": "Beýleki gurallar",
  "settings.general.row.mobileDiffWrap.description": "Mobil diff-lerde uzyn setirleri kese süýşürmegiň ýerine dola",
  "provider.connect.error.unsupportedFields": "Bu şahsyýeti tassyklama formasynda goldanylmaýan meýdanlar bar",
  "session.review.filesChangedCount.one": "{{count}} faýl üýtgedi",
  "session.review.filesChangedCount.other": "{{count}} faýl üýtgedi",
  "settings.about.writtenByNames": "Ýazan: {{names}}",
  "settings.about.illustratedByNames": "Suratlandyran: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "{{host}} bilen baglanyşyk ýok. Taslamaňyz saklandy; uzakdaky iş henizem dowam edýän bolmagy mümkin.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH serwerini goşuň",
  "ssh.server.menu.label": "SSH serweri",
  "ssh.target": "Host ýa-da SSH buýrugy",
  "ssh.connect": "Birikdiriň",
  "ssh.connectTo": "{{host}} bilen birikdiriň",
  "ssh.authenticate": "SSH tanamak",
  "ssh.action.authenticate": "Hakyky tassyklamak",
  "ssh.session.disconnected": "SSH birikmesi hereketsiz",
  "ssh.session.connecting": "SSH serwerine birikmek",
  ...
  "ssh.session.reconnect": "Birikdiriň",
  "ssh.authenticationRequired": "{{host}} üçin autentifikasiýa zerur",
  "ssh.trust": "Ynam et we birikdir",
  "ssh.continue": "Dowam et",
  "ssh.retry": "Gaýtadan synanyşyň",
  "ssh.update": "Täzelen we täzeden birikdir",
  "ssh.openProject": "Açyk taslama",
  "ssh.project": "Taslamany {{host}}-da açyň",
  "ssh.disconnect": "Aýyr",
  "ssh.forget": "Baglanyşygy ýatdan çykaryň",
  "ssh.stage.disconnected": "Öçürildi. Uzakdaky serwer işleýär.",
  "ssh.stage.connecting": "SSH-e birikmek…",
  "ssh.stage.checking": "OpenCode barlamak…",
  "ssh.stage.downloading": "Serweri göçürip almak…",
  "ssh.stage.uploading": "Serwer ýüklemek…",
  "ssh.stage.starting": "OpenCode birikmek…",
  "ssh.stage.ready": "Birikdirildi",
  "ssh.stage.authentication": "Hakyky tassyklamak zerur",
  "ssh.stage.incompatible": "Serwer täzelenmesi zerur",
  "ssh.stage.failed": "Birikdirmek şowsuz",
  "ssh.error.input":
    "Host ýa-da SSH birikme buýrugyny giriziň. Uzakdaky buýruklar we goldanmaýan SSH opsiýalaryna rugsat berilmeýär.",
  "ssh.error.connection": "SSH birikmesini gurup bolmady. Toruňyzy we SSH konfigurasiýaňyzy barlaň.",
  "ssh.error.platform":
    "Bu uzakdaky platforma goldanylmaýar. Awtomatiki gurnama häzirki wagtda x64 ýa-da arm64-de Linux ýa-da macOS talap edýär.",
  "ssh.error.version": "Uzakdaky hyzmat birikmezden ozal bu iş stoly wersiýasyna gabat gelmelidir.",
  "ssh.error.install": "Uzak serweri gurup bolmady Baglanyşygy, disk ýerini barlaň we şol tar gurnalan.",
  ...
  "ssh.error.service": "SSH birikdirildi, ýöne OpenCode serweri taýýar bolmady.",
  "ssh.error.host-key":
    "Öý eýesiniň şahsyýetini tassyklap bolmady SSH belli öý eýeleriňizi täzelemezden ozal barmak yzyny barlaň.",
  "ssh.error.ssh-missing": "OpenSSH tapylmady OpenSSH müşderisini guruň we ssh-iň PATH-da elýeterlidigine göz ýetiriň.",
  "command.browser.open": "Brauzeri açyň",
  "command.browser.reload": "Brauzer sahypasyny täzeden ýükläň",
  "command.session.summary.toggle": "Gysgaça mazmuny üýtgetmek",
  "common.color.orange": "mämişi",
  "common.color.yellow": "sary",
  "common.color.cyan": "firuze",
  "common.color.green": "ýaşyl",
  "common.color.red": "gyzyl",
  "common.color.pink": "gülgüne",
  "common.color.blue": "gök",
  "common.color.purple": "benewşe",
  "common.color.gray": "çal",
  "mcp.auth.interactiveForm": "MCP serweri {{name}} interaktiw tanamak formasyny talap edýär",
  "server.connect.title": "Serwere birikdiriň",
  "server.connect.description": "Başlamak üçin serwer salgyňyzy we parolyňyzy giriziň.",
  ...
  "dialog.server.menu.remove": "Aýyr",
  "file.error.notFound": "Faýl tapylmady: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Sessiýalar geçirilýär {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Sessiýalar geçirilýär {{current}}/{{total}}",
  "toast.migration.progress.working": "Maglumatlar geçirilýär",
  "toast.migration.progress.working.current": "Maglumatlar geçirilýär {{current}}",
  "toast.migration.progress.working.progress": "Maglumatlar geçirilýär {{current}}/{{total}}",
  "home.workspaceTip": "Üýtgeşmeleri üzňe saklamak üçin indiki sessiýany täze iş ýerinde başlaň",
  "session.tab.browser": "Brauzer",
  "session.tab.add": "Salgy goşuň",
  "session.queue.attachments.one": "Goşmaça {{count}} goşundy",
  "session.queue.attachments.other": "Goşmaça {{count}} goşundylar",
  "session.browser.address": "Brauzeriň salgysy",
  "session.browser.replaced": "Brauzer dolandyryşy başga bir iş stolunyň penjiresine geçirildi.",
  "session.browser.unsupported": "Bu iş stoly programmasy brauzer panelini goldamaýar.",
  "session.browser.suspended": "Brauzer togtadyldy Birikdirmek üçin bu sessiýa bilen täsirleşiň.",
  "session.browser.address.placeholder": "URL giriziň",
  "settings.backToSettings": "Sazlamalara dolan",
  "settings.backToProjects": "Taslamalara dolan",
  "settings.search.placeholder": "Gözlemek",
  "settings.search.results": "Sazlamalaryň netijeleri",
  "settings.search.group.pages": "Sahypalar",
  "settings.search.group.settings": "Sazlamalar",
  "settings.search.group.projects": "Taslamalar",
  "settings.search.group.servers": "Serwerler",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}} üçin netije ýok",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Has anyk netijeleri görmek üçin gözlegiňizi daraldyň.",
  "settings.server.description": "Bu serweriň baglanyşygyny we ileri tutmalaryny dolandyryň",
  "settings.server.section.connection": "Baglanyşyk",
  "settings.server.preferences.websearch.title": "Üçünji tarap gözlegi",
  "settings.server.preferences.websearch.description": "Web gözlemek üçin ulanýan gözleg üpjün edijilerini saýlaň",
  "settings.projects.search.placeholder": "Taslamalary gözläň",
  "project.settings.name.title": "Taslamanyň ady",
  "project.settings.name.description": "OpenCode-da bu taslama üçin görkezilen at",
  "project.settings.icon.description": "Maslahat berilýär: 128 × 128px. Surat ýüklemek üçin basyň ýa-da süýräň.",
  "project.settings.color.description": "Ýörite surat bellenmedik bolsa, taslamanyň nyşany üçin ulanylýar",
  "project.settings.worktree.startup.description": "Täze iş agajy döredilenden soň bir gezek işleýär",
  "project.settings.worktree.startup.hint.base": "Esasy iş agajy üçin $OPENCODE_WORKTREE_BASE ulanyň.",
  "project.settings.worktree.startup.hint.new": "Täze iş agajy üçin $OPENCODE_WORKTREE_PATH ulanyň.",
  "project.settings.extensions.empty.mcps.title": "Entek MCP ýok",
  "project.settings.extensions.empty.mcps.description": "OpenCode üçin elýeterli MCP-ler şu ýerde peýda bolar",
  "project.settings.extensions.empty.plugins.title": "Entek plugin ýok",
  "project.settings.extensions.empty.plugins.description": "OpenCode üçin elýeterli plaginler şu ýerde peýda bolar",
  "project.settings.extensions.empty.skills.title": "Entek başarnyk ýok",
  "project.settings.extensions.empty.skills.description": "OpenCode-da bar bolan başarnyklar şu ýerde peýda bolar",
  "project.settings.extensions.lsp.configured": "Sazlanan dil serwerleri",
  "project.settings.extensions.lsp.status.enabled": "Sazlamada açyk",
  "project.settings.extensions.lsp.status.disabled": "Sazlamada ýapyk",
  "project.settings.extensions.lsp.empty.title": "Hiç bir dil serweri düzülmedi",
  "project.settings.extensions.lsp.empty.description": "Bu taslama üçin düzülen dil serwerleri şu ýerde peýda bolar",
  "project.settings.extensions.lsp.disabled.title": "Dil serwerleri ýapyk",
  "project.settings.extensions.lsp.disabled.description": "Bu taslama konfigurasiýasynda LSP ýapyk",
  "project.settings.extensions.lsp.loadFailed": "Dil serweriniň konfigurasiýasyny ýükläp bolmady",
  "project.settings.extensions.lsp.retry": "Gaýtadan synanyşyň",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Topar",
  "settings.timeline.collapse": "Apseykylmak",
  "settings.timeline.visibility.show": "Görkez",
  "settings.timeline.visibility.hide": "Gizle",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} sessiýasy",
  "settings.workspaces.sessions.filtered.other": "{{count}} seanslary",
  "settings.workspaces.deleteAll.confirm.one": "Bu {{count}} saýlanan iş agajyny hemişelik ýok eder.",
  "settings.workspaces.deleteAll.confirm.other": "Bu {{count}} saýlanan iş agaçlaryny hemişelik ýok eder.",
  "settings.workspaces.deleteWithoutSessions": "Iş sapaklaryny sessiz pozuň",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Baglanan sessiýalar bolmazdan {{count}} iş agajyny hemişelik ýok eder.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Baglanan sessiýalar bolmazdan {{count}} iş agaçlaryny hemişelik ýok eder.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Düzedilmedik üýtgeşmeler ýa-da işjeň ýerler bolan iş agaçlary saklanar.",
  "settings.workspaces.delete.button": "Iş agaçlaryny pozuň",
  "workspace.lifecycle.deleting": "Öçürmek…",
  "session.summary.tooltip": "Gysgaça mazmun",
  "session.summary.server": "Giňeldişler",
  "session.summary.chooseProject": "Taslama saýlaň",
  "session.summary.mcp.onCreation": "Iş agajy döredilende ulanylýar",
  "session.summary.mcp.prepareFailed": "MCP serwerlerini taýýarlap bolmady",
  "session.summary.mcp.unavailable": "MCP serweri {{name}} bu iş agajynda elýeterli däl.",
  "session.summary.mcp.signInBeforeSend": "Soragy ibermezden ozal {{name}} ulgamyna giriň.",
  "session.summary.mcp.notReady": "MCP serweri {{name}} taýýar däl. Sorag ibermezden ozal birikmesini çözüň.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Sazlanan MCP serwerleri",
  "session.summary.plugins": "Pluginler",
  "session.summary.plugins.configured": "Sazlanan pluginler",
  "session.summary.skills": "Ussatlyk",
  "session.summary.skills.configured": "Sazlanan başarnyklar",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Şowsuz",
  "session.summary.retry": "Gaýtadan synanyşyň",
  "session.summary.connecting": "Birikmek…",
  "session.summary.needsAuth": "Giriş zerur",
  "session.summary.configure": "Sazlama faýly",
  "session.summary.copyConfigPath": "Sazlama faýl ýoluny göçüriň",
  "session.summary.configFileMissing": "Sazlama faýly tapylmady",
  "session.summary.mcp.empty": "Hiç hili MCP serweri düzülmedi",
  "session.summary.mcp.add": "opencode.json-da serwerleri goşuň",
  "session.summary.plugins.manage": "Plaginleri opencode.json-da dolandyryň",
  "session.summary.plugins.empty": "Hiç hili plugin düzülmedi",
  "session.summary.plugins.add": "opencode.json-a plugin goşuň",
  "session.summary.skills.manage": "opencode.json-da başarnyklary dolandyryň",
  "session.summary.skills.empty": "Hiç hili hünär düzülmedi",
  "session.summary.skills.add": "opencode.json-da başarnyklary goşuň",
  "session.summary.lsp.configured": "Sazlanan LSP-ler",
  "session.summary.lsp.empty": "LSP serwerleri düzülmedi",
  "session.summary.lsp.manage": "LSP-ni opencode.json-da dolandyryň",
  "workspace.delete.location": "Ýerleşiş",
  "command.debugBar.toggle": "Düzediş zolagyny aç/ýap",
  "command.session.location.cycle": "Sessiýanyň ýerleşýän ýerini üýtget",
  "dialog.provider.anthropic.note": "API açary bilen Claude modellerine göni giriş",
  "provider.connect.title.anthropicProMax": "Anthropic arkaly giriň",
  "prompt.toast.uploading.cancel": "Ýüklemäni ýatyr",
  "prompt.toast.uploading.cancelFile": "{{filename}} faýlynyň ýüklenmegini ýatyr",
  "prompt.toast.uploadFailed.title": "Ýükleme şowsuz boldy",
  "session.browser.empty.title": "URL giriziň",
  "session.browser.empty.description": "Ýa-da “Programmanyň brauzerinde aç” diýip soraň",
  "session.browser.failed.title": "URL elýeterli däl",
  "session.browser.failed.description": "URL-i we birikmäňizi barlaň, soňra gaýtadan synanyşyň.",
  "debugBar.providerAriaLabel": "Hyzmat üpjünçiniň öndürijilik diagnostikasy",
  "debugBar.ttft.tip": "Hyzmat üpjünçä haýyş iberilenden modeliň ilkinji çykyşyna çenli wagt.",
  "debugBar.ttfa.tip": "Hyzmat üpjünçä haýyş iberilenden jogabyň ilkinji tekstine çenli wagt.",
  "debugBar.tps.tip": "Modeliň ilkinji çykyşyndan soň sekuntda çykyş tokenleriniň sany.",
  "debugBar.e2e.tip": "Hyzmat üpjünçä haýyş iberilenden jogap akymynyň tamamlanmagyna çenli wagt.",
  "settings.updates.action.download": "OpenCode-y ýükläp al",
  "settings.updates.migration.title": "Beta-dan Stable-a geç",
