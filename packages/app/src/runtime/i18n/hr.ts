...
export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Radna stabla s nespojenim promjenama, povezanim sesijama ili aktivnim lokacijama bit će zadržana.",
  ...
  "session.location.worktree": "Odaberi radno stablo",
  "session.location.worktreesFailed": "Učitavanje radnih stabala nije uspjelo",
  "session.location.moving": "Premještanje sesije…",
  "dialog.server.menu.hide": "Sakrij s popisa projekata",
  "dialog.server.menu.show": "Prikaži na popisu projekata",
  ...
  "session.new.worktree.creating": "Stvaranje radnog stabla",
  "settings.backToApp": "Natrag u aplikaciju",
  ...
  "settings.appearance.row.tabs.vertical": "Okomito",
  "settings.general.row.followUpBehavior.title": "Ponašanje naknadnih poruka",
  "settings.general.row.followUpBehavior.description":
    "Odaberite hoće li se naknadne poruke staviti u red čekanja ili usmjeriti trenutačni korak. Upotrijebite {{keybind}} za prebacivanje.",
  "settings.general.row.followUpBehavior.queue": "Red čekanja",
  "settings.general.row.followUpBehavior.steer": "Usmjeri",
  "settings.general.row.reasoningMode.title": "Obrazloženje modela",
  "settings.general.row.reasoningMode.description":
    "Odaberite kako se obrazloženje modela prikazuje na vremenskoj traci",
  "settings.general.row.reasoningMode.hidden": "Skriveno",
  "settings.general.row.reasoningMode.compact": "Sažeto",
  "settings.general.row.reasoningMode.full": "Potpuno",
  "session.new.workspace.createFrom": "Stvori iz grane",
  ...
  "session.review.change.few": "Promjene",
  ...
  "session.websearch.disable": "Ne koristite pretraživanje",
  "session.websearch.enable": "Omogući",
  "session.websearch.loadFailed": "Nije moguće učitati pružatelje usluga pretraživanja.",
  "session.websearch.empty": "Nema dostupnih pružatelja usluga pretraživanja.",
  "session.websearch.failed": "Nije moguće spremiti vaš izbor. Molimo pokušajte ponovo.",
  ...
  "session.search.placeholder": "Pronađite...",
  ...
  "titlebar.toggleDebugTools": "Uključivanje/isključivanje alata za otklanjanje pogrešaka",
  "settings.tab.experimental": "Eksperimentalno",
  "settings.experimental.description": "Isprobajte eksperimentalne značajke",
  ...
  "settings.about.illustratedBy": "Ilustrirao",
  ...
  "settings.about.firstIllustrated": "Prvi put ilustrirano u Londonu, Engleska",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, agent za kodiranje otvorenog koda",
  "settings.about.trademark": "OpenCode je registrirani zaštitni znak Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Odaberite koliko se aktivnosti pojavljuje na vremenskoj traci. Poruke ostaju vidljive.",
  "settings.timeline.preset.everything": "Sve",
  "settings.timeline.preset.detailed": "Detaljno",
  "settings.timeline.preset.compact": "Kompaktan",
  ...
  "settings.about.illustratedByNames": "Ilustrirao {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Nije uspostavljena veza s računalom domaćinom {{host}}. Vaš nacrt je spremljen; udaljeni rad možda još traje.",
  "ssh.placeholder": "ssh korisnik@primjer.com",
  "ssh.add": "Dodaj SSH poslužitelj",
  "ssh.server.menu.label": "SSH poslužitelj",
  "ssh.target": "Host ili SSH naredba",
  "ssh.connect": "Poveži se",
  "ssh.connectTo": "Poveži se s računalom domaćinom {{host}}",
  "ssh.authenticate": "SSH autentikacija",
  "ssh.action.authenticate": "Autenticiraj",
  "ssh.session.disconnected": "SSH veza nije aktivna",
  "ssh.session.connecting": "Povezivanje sa SSH poslužiteljem",
  ...
  "ssh.session.reconnect": "Ponovno se poveži",
  "ssh.authenticationRequired": "Potrebna je autentikacija za {{host}}",
  "ssh.trust": "Vjeruj i poveži se",
  "ssh.continue": "Nastavi",
  "ssh.retry": "Pokušaj ponovno",
  "ssh.update": "Ažuriraj i ponovno se poveži",
  "ssh.openProject": "Otvori projekt",
  "ssh.project": "Otvori projekt na računalu domaćinu {{host}}",
  "ssh.disconnect": "Prekini vezu",
  "ssh.forget": "Zaboravi vezu",
  "ssh.stage.disconnected": "Veza je prekinuta. Udaljeni poslužitelj je ostavljen da radi.",
  "ssh.stage.connecting": "Povezivanje putem SSH-a…",
  "ssh.stage.checking": "Provjera OpenCode-a…",
  "ssh.stage.downloading": "Preuzimanje poslužitelja…",
  "ssh.stage.uploading": "Slanje poslužitelja…",
  "ssh.stage.starting": "Povezivanje s OpenCode-om…",
  "ssh.stage.ready": "Povezano",
  "ssh.stage.authentication": "Potrebna je autentikacija",
  "ssh.stage.incompatible": "Potrebno je ažuriranje poslužitelja",
  ...
  "ssh.error.service": "SSH je povezan, ali OpenCode poslužitelj nije postao spreman.",
  "ssh.error.host-key":
  ...
  "command.browser.reload": "Ponovno učitaj stranicu preglednika",
  "command.session.summary.toggle": "Prikaži ili sakrij sažetak",
  "common.color.orange": "narančasta",
  ...
  "mcp.auth.interactiveForm": "MCP poslužitelj {{name}} zahtijeva interaktivni obrazac za autentikaciju",
  "server.connect.title": "Poveži se sa poslužiteljem",
  "server.connect.description": "Unesite adresu poslužitelja i lozinku da biste započeli.",
  ...
  "session.browser.unsupported": "Ova aplikacija za računalo ne podržava okno preglednika.",
  "session.browser.suspended":
    "Preglednik je obustavljen. Stupite u interakciju s ovom sesijom da biste se ponovno povezali.",
  ...
  "settings.server.description": "Upravljajte vezom i postavkama ovog poslužitelja",
  ...
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekt u cijelome OpenCode-u",
  "project.settings.icon.description": "Preporučeno: 128 × 128 px. Kliknite ili povucite sliku da biste je poslali.",
  "project.settings.color.description": "Koristi se za ikonu projekta kada nije postavljena prilagođena slika",
  "project.settings.worktree.startup.description": "Pokreće se jednom nakon kreiranja novog radna stabla",
  "project.settings.worktree.startup.hint.base": "Koristite $OPENCODE_WORKTREE_BASE za osnovni radno stablo.",
  "project.settings.worktree.startup.hint.new": "Koristite $OPENCODE_WORKTREE_PATH za novi radno stablo.",
  ...
  "project.settings.extensions.lsp.configured": "Konfigurirani jezični poslužitelji",
  ...
  "project.settings.extensions.lsp.empty.title": "Nema konfiguriranih jezičnih poslužitelja",
  "project.settings.extensions.lsp.empty.description":
    "Jezički poslužitelji konfigurirani za ovaj projekt pojavit će se ovdje",
  "project.settings.extensions.lsp.disabled.title": "Jezički poslužitelji su onemogućeni",
  "project.settings.extensions.lsp.disabled.description": "LSP je onemogućen u konfiguraciji ovog projekta",
  "project.settings.extensions.lsp.loadFailed": "Nije bilo moguće učitati konfiguraciju jezičkog poslužitelja",
  "project.settings.extensions.lsp.retry": "Pokušaj ponovno",
  ...
  "settings.workspaces.deleteWithoutSessions": "Izbriši radno stabloove bez sesija",
  ...
  "settings.workspaces.deleteWithoutSessions.warning":
    "Worktreeovi s nespojenim promjenama ili aktivnim lokacijama ostat će zadržani.",
  "settings.workspaces.delete.button": "Izbriši radno stabloove",
  "workspace.lifecycle.deleting": "Brisanje…",
  "session.summary.tooltip": "Sažetak",
  "session.summary.server": "Proširenja",
  "session.summary.chooseProject": "Odaberite projekt",
  "session.summary.mcp.onCreation": "Primjenjuje se pri kreiranju radna stabla",
  "session.summary.mcp.prepareFailed": "Nije bilo moguće pripremiti MCP poslužitelje",
  "session.summary.mcp.unavailable": "MCP poslužitelj {{name}} nije dostupan u ovom radnom stablu.",
  "session.summary.mcp.signInBeforeSend": "Prijavite se na {{name}} prije prijenosa upita.",
  "session.summary.mcp.notReady": "MCP poslužitelj {{name}} nije spreman. Riješite njegovu vezu prije prijenosa upita.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurirani MCP poslužitelji",
  ...
  "session.summary.retry": "Pokušaj ponovno",
  ...
  "session.summary.mcp.empty": "Nema konfiguriranih MCP poslužitelja",
  "session.summary.mcp.add": "Dodajte poslužitelje u opencode.json",
  ...
  "session.summary.lsp.empty": "Nema konfiguriranih LSP poslužitelja",
  "session.summary.lsp.manage": "Upravljajte LSP-om u opencode.json",
  "workspace.delete.location": "Lokacija",
  "command.debugBar.toggle": "Uključi/isključi traku za otklanjanje pogrešaka",
  "command.session.location.cycle": "Promijeni lokaciju sesije",
  "dialog.provider.anthropic.note": "Izravan pristup modelima Claude putem API ključa",
  "provider.connect.title.anthropicProMax": "Prijava putem Anthropic-a",
  "prompt.toast.uploading.cancel": "Otkaži prijenos",
  "prompt.toast.uploading.cancelFile": "Otkaži prijenos datoteke {{filename}}",
  "prompt.toast.uploadFailed.title": "Prijenos nije uspio",
  ...
  "session.browser.failed.description": "Provjerite URL i vezu, a zatim pokušajte ponovno.",
  "debugBar.providerAriaLabel": "Dijagnostika performansi pružatelja usluge",
  "debugBar.ttft.tip": "Vrijeme od slanja zahtjeva pružatelju do prvog izlaza modela.",
  "debugBar.ttfa.tip": "Vrijeme od slanja zahtjeva pružatelju do prvog teksta odgovora.",
  "debugBar.tps.tip": "Izlazni tokeni u sekundi nakon prvog izlaza modela.",
  "debugBar.e2e.tip": "Vrijeme od slanja zahtjeva pružatelju do završetka toka odgovora.",
  "settings.updates.action.download": "Preuzmi OpenCode",
  "settings.updates.migration.title": "Prijelaz s Beta na Stable",
