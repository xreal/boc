export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Ühendamata muudatuste, lingitud seansside või aktiivsete asukohtadega tööpuud jäetakse alles.",
  ...
  "session.location.unavailable": "Seansi asukoht pole saadaval",
  "session.location.description": "Selle seansi jätkamiseks vali teine kataloog.",
  "session.location.choose": "Vali kataloog",
  "session.location.worktree": "Vali tööpuu",
  "session.location.worktreesFailed": "Tööpuude laadimine nurjus",
  "session.location.moving": "Seansi teisaldamine…",
  "dialog.server.menu.hide": "Peida projektide loendist",
  "dialog.server.menu.show": "Kuva projektide loendis",
  "session.queue.count.one": "{{count}} järjekorras",
  "session.queue.count.other": "{{count}} järjekorras",
  "session.queue.steer": "Suuna",
  "session.queue.send": "Saada",
  "session.queue.steerTooltip": "Saada katkestamata",
  "session.queue.remove": "Eemalda",
  "session.queue.reorder": "Muuda järjekorras oleva viiba järjestust",
  "session.new.worktree.creating": "Tööpuu loomine",
  "settings.backToApp": "Tagasi rakendusse",
  "settings.appearance.section.experimental": "Katseline",
  "settings.appearance.row.tabs.title": "Vahekaardid",
  "settings.appearance.row.tabs.description": "Vali seansivahekaartide paigutus",
  "settings.appearance.row.tabs.horizontal": "Horisontaalne",
  "settings.appearance.row.tabs.vertical": "Vertikaalne",
  "settings.general.row.followUpBehavior.title": "Jätkusõnumite käitumine",
  "settings.general.row.followUpBehavior.description":
    "Vali, kas panna jätkusõnumid järjekorda või suunata praegust vooru. Vahetamiseks kasuta {{keybind}}.",
  "settings.general.row.followUpBehavior.queue": "Pane järjekorda",
  "settings.general.row.followUpBehavior.steer": "Suuna",
  "settings.general.row.reasoningMode.title": "Mudeli arutluskäik",
  "settings.general.row.reasoningMode.description": "Vali, kuidas mudeli arutluskäiku ajajoonel kuvatakse",
  "settings.general.row.reasoningMode.hidden": "Peidetud",
  "settings.general.row.reasoningMode.compact": "Kompaktne",
  "settings.general.row.reasoningMode.full": "Täielik",
  "session.new.workspace.createFrom": "Loo harust",
  "session.new.workspace.branch.search.placeholder": "Otsi harusid",
  "toast.migration.progress.clearingOldEvents": "Vanade sündmuste kustutamine",
  "toast.migration.progress.migratingSessions": "Seansside migreerimine",
  "session.new.workspace.existingLabel": "Tööpuu",
  "desktop.onboarding.defaultProject": "Vaikeprojekt",
  "home.projects.all": "Kõik projektid",
  "session.tab.files": "Failid",
  "session.files.openTabs": "Ava failid",
  "session.tab.usage": "Kasutamine",
  ...
  "session.background.tasksRunning.one": "{{count}} taustaülesanne töötab",
  "session.background.tasksRunning.other": "{{count}} taustaülesanded töötavad",
  ...
  "session.background.subagent.other": "{{count}} alamagendid",
  ...
  "session.websearch.any": "Ükskõik milline",
  "session.websearch.disable": "Ärge kasutage otsingut",
  "session.websearch.enable": "Luba",
  "session.websearch.loadFailed": "Otsingupakkujaid ei saanud laadida.",
  "session.websearch.empty": "Otsingupakkujaid pole saadaval.",
  "session.websearch.failed": "Teie valikut ei saanud salvestada. Palun proovi uuesti.",
  "session.websearch.retry": "Proovi uuesti",
  "session.new.worktree.draftPlaceholder": "Koostage tööpuu ettevalmistamise ajal järelmeetmete mustand…",
  "session.search.placeholder": "Leia…",
  "session.search.noResults": "Vasteid pole",
  "titlebar.tabs": "Vahekaardid",
  "titlebar.channel.local": "Kohalik",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Silumistööriistade sisse- ja väljalülitamine",
  "settings.tab.experimental": "Eksperimentaalne",
  "settings.experimental.description": "Proovige eksperimentaalseid funktsioone",
  "settings.tab.about": "Teave",
  "settings.about.version": "Versioon {{version}}",
  "settings.about.devVersion": "arendus",
  "settings.about.license": "Välja antud MIT-i litsentsi alusel",
  "settings.about.writtenBy": "Kirjutas",
  "settings.about.illustratedBy": "Illustreerinud",
  "settings.about.and": "ja",
  "settings.about.otherContributor.one": "{{count}} muu",
  "settings.about.otherContributor.other": "{{count}} teised",
  "settings.about.firstPublished": "Esmakordselt avaldati USA-s Missouris",
  "settings.about.firstIllustrated": "Esmakordselt illustreeritud Londonis, Inglismaal",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, avatud lähtekoodiga kodeerimisagent",
  "settings.about.trademark": "OpenCode on ettevõtte Anomaly Innovations, Inc. registreeritud kaubamärk.",
  "settings.about.typeset": "Sisestatud Inter ja IBM Plex Mono",
  "settings.about.tagline": "AI ei saa ilma sinuta suurepärast tarkvara luua",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "Redigeeri projekti",
  "settings.timeline.title": "Ajaskaala",
  "settings.timeline.detail": "Ajaskaala üksikasjad",
  "settings.timeline.description": "Valige, kui palju tegevusi ajaskaalal kuvatakse. Sõnumid jäävad nähtavaks.",
  "settings.timeline.preset.everything": "Kõik",
  "settings.timeline.preset.detailed": "Üksikasjalik",
  "settings.timeline.preset.compact": "Kompaktne",
  "settings.timeline.preset.quiet": "Vaikne",
  "settings.timeline.preset.text-only": "Ainult tekst",
  ...
  "settings.timeline.custom": "Kohandatud",
  "settings.timeline.advanced": "Täpsemalt",
  "settings.timeline.advanced.description": "Määrake iga tegevuskategooria paigutus ja üksikasjad.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Muudatused",
  ...
  "session.review.filesChangedCount.one": "{{count}} faili muudetud",
  "session.review.filesChangedCount.other": "{{count}} faili muudetud",
  "settings.about.writtenByNames": "Kirjutas {{names}}",
  "settings.about.illustratedByNames": "Illustreerinud {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Pole ühendatud võrguga {{host}}. Teie mustand on säilinud; kaugtöö võib endiselt töötada.",
  "ssh.placeholder": "ssh kasutaja@example.com",
  "ssh.add": "Lisa SSH server",
  "ssh.server.menu.label": "SSH server",
  "ssh.target": "Host või SSH käsk",
  "ssh.connect": "Ühendage",
  "ssh.connectTo": "Ühendage seadmega {{host}}",
  "ssh.authenticate": "SSH autentimine",
  "ssh.action.authenticate": "Autentida",
  "ssh.session.disconnected": "SSH ühendus inaktiivne",
  "ssh.session.connecting": "Ühendamine serveriga SSH",
  "ssh.session.reconnectDescription":
    "Ühendage uuesti selle seansi vaatamiseks ja töö jätkamiseks. Teie kaugseanss säilib.",
  "ssh.session.reconnect": "Ühendage uuesti",
  "ssh.authenticationRequired": "{{host}} jaoks on vajalik autentimine",
  "ssh.trust": "Usalda ja ühenda",
  "ssh.continue": "Jätka",
  "ssh.retry": "Proovi uuesti",
  "ssh.update": "Värskendage ja ühendage uuesti",
  "ssh.openProject": "Avatud projekt",
  "ssh.project": "Avatud projekt saidil {{host}}",
  "ssh.disconnect": "Katkesta ühendus",
  "ssh.forget": "Unusta ühendus",
  "ssh.stage.disconnected": "Ühendus katkestatud. Kaugserver jäetakse tööle.",
  "ssh.stage.connecting": "Ühendamine üle SSH…",
  "ssh.stage.checking": "OpenCode kontrollimine…",
  "ssh.stage.downloading": "Serveri allalaadimine…",
  "ssh.stage.uploading": "Serveri üleslaadimine…",
  "ssh.stage.starting": "Ühendamine seadmega OpenCode…",
  "ssh.stage.ready": "Ühendatud",
  "ssh.stage.authentication": "Nõutav autentimine",
  "ssh.stage.incompatible": "Vajalik serveri värskendus",
  "ssh.stage.failed": "Ühendus ebaõnnestus",
  "ssh.error.input": "Sisestage hosti või SSH ühenduse käsk. Kaugkäsklused ja toetamata SSH suvandid pole lubatud.",
  "ssh.error.connection": "Ühendust SSH ei õnnestunud luua. Kontrollige oma võrku ja SSH konfiguratsiooni.",
  "ssh.error.platform":
    "Seda kaugplatvormi ei toetata. Automaatne seadistamine nõuab praegu mudelit x64 või arm64 Linux või macOS.",
  "ssh.error.version": "Kaugteenus peab enne ühenduse loomist vastama sellele töölauaversioonile.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH on ühendatud, kuid server OpenCode ei saanud valmis.",
  "ssh.error.host-key":
    "Võõrustaja identiteeti ei õnnestunud kinnitada. Enne SSH teadaolevate hostide värskendamist kontrollige selle sõrmejälge.",
  "ssh.error.ssh-missing": "OpenSSH ei leitud. Installige OpenSSH klient ja veenduge, et ssh oleks PATH-il saadaval.",
  "command.browser.open": "Ava brauser",
  "command.browser.reload": "Laadi brauseri leht uuesti",
  "command.session.summary.toggle": "Lülitab kokkuvõtet",
  "mcp.auth.interactiveForm": "MCP server {{name}} nõuab interaktiivset autentimisvormi",
  "server.connect.title": "Ühendage serveriga",
  "server.connect.description": "Alustamiseks sisestage oma serveri aadress ja parool.",
  ...
  "server.connect.camera.error":
    "Kaamerat ei saanud avada. Lubage juurdepääs kaamerale või sisestage ühenduse üksikasjad käsitsi.",
  "dialog.server.menu.remove": "Eemalda",
  "file.error.notFound": "Faili ei leitud: {{name}}",
  "home.workspaceTip": "Alustage järgmist seanssi uues tööruumis, et hoida muudatused isoleerituna",
  "session.tab.browser": "Brauser",
  "session.tab.add": "Lisa vahekaart",
  "session.queue.attachments.one": "Plus {{count}} kinnitus",
  "session.queue.attachments.other": "Pluss {{count}} lisaseadmed",
  "session.browser.address": "Brauseri aadress",
  "session.browser.replaced": "Brauseri juhtimine teisaldati teise töölauaaknasse.",
  "session.browser.suspended": "Brauser peatatud. Ühendage uuesti ühenduse loomiseks selle seansiga.",
  "session.browser.address.placeholder": "Sisesta URL",
  "settings.backToSettings": "Tagasi seadete juurde",
  "settings.backToProjects": "Tagasi projektide juurde",
  "settings.search.placeholder": "Otsi",
  "settings.search.results": "Seadete tulemused",
  "settings.search.group.pages": "Leheküljed",
  "settings.search.group.settings": "Seaded",
  "settings.search.group.projects": "Projektid",
  "settings.search.group.servers": "Serverid",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Päringule {{query}}",
  "settings.search.empty.query": 'ei leitud tulemusi "{{query}}"',
  "settings.search.refine": "Kitsendage otsingut, et näha täpsemaid tulemusi.",
  "settings.server.description": "Selle serveri ühenduse ja eelistuste haldamine",
  "settings.server.section.connection": "Ühendus",
  "settings.server.preferences.websearch.title": "Kolmanda osapoole otsing",
  "settings.server.preferences.websearch.description":
    "Valige otsingupakkuja agendid, mida veebist otsimiseks kasutavad",
  "settings.projects.search.placeholder": "Otsi projekte",
  "project.settings.name.title": "Projekti nimi",
  "project.settings.name.description": "Selle projekti jaoks kuvatud nimi kogu OpenCode",
  "project.settings.icon.description": "Soovitatav: 128 × 128 pikslit. Pildi üleslaadimiseks klõpsake või lohistage.",
  "project.settings.color.description": "Kasutatakse projekti ikooni jaoks, kui kohandatud pilti pole määratud",
  "project.settings.worktree.startup.description": "Käitab üks kord pärast uue tööpuu loomist",
  "project.settings.worktree.startup.hint.base": "Kasutage põhitööpuuna $OPENCODE_WORKTREE_BASE.",
  "project.settings.worktree.startup.hint.new": "Kasutage uue tööpuu jaoks $OPENCODE_WORKTREE_PATH.",
  "project.settings.extensions.empty.mcps.title": "MCPs puudub veel",
  "project.settings.extensions.empty.mcps.description": "MCPs, mis on saadaval OpenCode jaoks, kuvatakse siin",
  "project.settings.extensions.empty.plugins.title": "Pluginaid pole veel",
  "project.settings.extensions.empty.plugins.description": "OpenCode jaoks saadaolevad pistikprogrammid kuvatakse siin",
  "project.settings.extensions.empty.skills.title": "Oskusi veel pole",
  "project.settings.extensions.empty.skills.description": "Siin kuvatakse OpenCode jaoks saadaolevad oskused",
  "project.settings.extensions.lsp.configured": "Konfigureeritud keeleserverid",
  "project.settings.extensions.lsp.status.enabled": "Lubatud konfiguratsioonis",
  "project.settings.extensions.lsp.status.disabled": "Keelatud konfiguratsioonis",
  "project.settings.extensions.lsp.empty.title": "Keeleservereid pole konfigureeritud",
  "project.settings.extensions.lsp.empty.description": "Selle projekti jaoks seadistatud keeleserverid kuvatakse siin",
  "project.settings.extensions.lsp.disabled.title": "Keeleserverid keelatud",
  "project.settings.extensions.lsp.disabled.description": "LSP on selle projekti konfiguratsioonis keelatud",
  "project.settings.extensions.lsp.loadFailed": "Keeleserveri konfiguratsiooni ei saanud laadida",
  "project.settings.extensions.lsp.retry": "Proovi uuesti",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Rühm",
  "settings.timeline.collapse": "Ahenda",
  "settings.timeline.visibility.show": "Näita",
  "settings.timeline.visibility.hide": "Peida",
  "settings.timeline.visibility.label": "{{activity}} nähtavus",
  "settings.timeline.grouped.label": "{{activity}} rühmitatud",
  "settings.timeline.collapsed.label": "{{activity}} varises kokku",
  "session.new.workspace.search.empty": "Sobivaid tööpuid pole",
  "settings.workspaces.description": "Vaadake üle tööpuud ja hallake kettakasutust",
  "settings.workspaces.empty.description": "Siin kuvatakse programmis OpenCode loodud tööpuud",
  "settings.workspaces.sessions.filtered.one": "{{count}} seanss",
  "settings.workspaces.sessions.filtered.other": "{{count}} seansid",
  "settings.workspaces.deleteAll.confirm.one": "See kustutab jäädavalt valitud tööpuu {{count}}.",
  "settings.workspaces.deleteAll.confirm.other": "See kustutab {{count}} valitud tööpuud jäädavalt.",
  "settings.workspaces.deleteWithoutSessions": "Kustuta tööpuud ilma seanssideta",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "See kustutab {{count}} tööpuu jäädavalt ilma lingitud seanssideta.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "See kustutab jäädavalt {{count}} tööpuud ilma lingitud seanssideta.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Ühendamata muudatuste või aktiivsete asukohtadega tööpuud jäetakse alles.",
  "settings.workspaces.delete.button": "Kustuta tööpuud",
  "workspace.lifecycle.deleting": "Kustutamine…",
  "session.summary.tooltip": "Kokkuvõte",
  "session.summary.server": "Laiendused",
  "session.summary.chooseProject": "Valige projekt",
  "session.summary.mcp.onCreation": "Kehtib tööpuu loomisel",
  "session.summary.mcp.prepareFailed": "MCP servereid ei saanud ette valmistada",
  "session.summary.mcp.unavailable": "MCP server {{name}} pole selles tööpuus saadaval.",
  "session.summary.mcp.signInBeforeSend": "Enne viipa saatmist logige sisse {{name}}.",
  "session.summary.mcp.notReady": "MCP server {{name}} pole valmis. Enne viipa saatmist lahendage selle ühendus.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigureeritud MCP serverid",
  "session.summary.plugins": "Pluginad",
  "session.summary.plugins.configured": "Konfigureeritud pluginad",
  "session.summary.skills": "Oskused",
  "session.summary.skills.configured": "Konfigureeritud oskused",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Ebaõnnestunud",
  "session.summary.retry": "Proovi uuesti",
  "session.summary.connecting": "Ühendamine…",
  "session.summary.needsAuth": "Sisselogimine on vajalik",
  "session.summary.configure": "Konfiguratsioonifail",
  "session.summary.copyConfigPath": "Kopeeri konfiguratsioonifaili tee",
  "session.summary.configFileMissing": "Konfiguratsioonifaili ei leitud",
  "session.summary.mcp.empty": "MCP servereid pole konfigureeritud",
  "session.summary.mcp.add": "Lisage serverid faili opencode.json",
  "session.summary.plugins.manage": "Hallake pluginaid saidil opencode.json",
  "session.summary.plugins.empty": "Ühtegi pluginat pole seadistatud",
  "session.summary.plugins.add": "Lisage pluginaid faili opencode.json",
  "session.summary.skills.manage": "Oskuste haldamine failis opencode.json",
  "session.summary.skills.empty": "Oskusi pole konfigureeritud",
  "session.summary.skills.add": "Lisage oskused failis opencode.json",
  "session.summary.lsp.configured": "Konfigureeritud LSPs",
  "session.summary.lsp.empty": "LSP servereid pole konfigureeritud",
  "session.summary.lsp.manage": "LSP haldamine failis opencode.json",
  "workspace.delete.location": "Asukoht",
  "common.color.orange": "oranž",
  "common.color.yellow": "kollane",
  "common.color.cyan": "tsüaan",
  "common.color.green": "roheline",
  "common.color.red": "punane",
  "common.color.pink": "roosa",
  "common.color.blue": "sinine",
  "common.color.purple": "lilla",
  "common.color.gray": "hall",
  "toast.migration.progress.migratingSessions.current": "Seansside üleviimine {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Seansside üleviimine {{current}}/{{total}}",
  "toast.migration.progress.working": "Andmete migreerimine",
  "toast.migration.progress.working.current": "Andmete migreerimine {{current}}",
  "toast.migration.progress.working.progress": "Andmete üleviimine {{current}}/{{total}}",
  "session.browser.unsupported": "See töölauarakendus ei toeta brauseri paani.",
  "command.debugBar.toggle": "Lülita silumisriba",
  "command.session.location.cycle": "Vaheta seansi asukohta",
  "dialog.provider.anthropic.note": "Otsejuurdepääs Claude’i mudelitele API-võtmega",
  "provider.connect.title.anthropicProMax": "Logi Anthropicuga sisse",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Tühista üleslaadimine",
  "prompt.toast.uploading.cancelFile": "Tühista faili {{filename}} üleslaadimine",
  "prompt.toast.uploadFailed.title": "Üleslaadimine nurjus",
  "session.browser.empty.title": "Sisesta URL",
  "session.browser.empty.description": "Või palu „Ava rakenduse brauseris”",
  "session.browser.failed.title": "URL-ile ei pääse juurde",
  "session.browser.failed.description": "Kontrolli URL-i ja ühendust ning proovi uuesti.",
  "debugBar.providerAriaLabel": "Pakkuja jõudluse diagnostika",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Aeg pakkujale päringu saatmisest mudeli esimese väljundini.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Aeg pakkujale päringu saatmisest esimese vastusetekstini.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Väljundmärke sekundis pärast mudeli esimest väljundit.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Aeg pakkujale päringu saatmisest vastusevoo lõppemiseni.",
  "settings.updates.action.download": "Laadi OpenCode alla",
  "settings.updates.migration.title": "Liigu beetaversioonilt stabiilsele versioonile",
