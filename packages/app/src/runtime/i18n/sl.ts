export const dict = {
  "session.queue.attachments.two": "Še {{count}} priponki",
  "session.queue.attachments.few": "Še {{count}} priponke",
  "settings.workspaces.sessions.filtered.two": "{{count}} seji",
  "settings.workspaces.sessions.filtered.few": "{{count}} seje",
  "settings.workspaces.deleteAll.confirm.two": "S tem boste trajno izbrisali {{count}} izbrani delovni drevesi.",
  "settings.workspaces.deleteAll.confirm.few": "S tem boste trajno izbrisali {{count}} izbrana delovna drevesa.",
  "settings.workspaces.deleteWithoutSessions.confirm.two":
    "S tem boste trajno izbrisali {{count}} delovni drevesi brez povezanih sej.",
  "settings.workspaces.deleteWithoutSessions.confirm.few":
    "S tem boste trajno izbrisali {{count}} delovna drevesa brez povezanih sej.",
  ...
  "session.queue.count.two": "{{count}} elementa v čakalni vrsti",
  "session.queue.count.few": "{{count}} elementi v čakalni vrsti",
  "session.review.change.two": "Spremembi",
  "session.review.change.few": "Spremembe",
  "session.background.tasksRunning.two": "{{count}} opravili se izvajata v ozadju",
  "session.background.tasksRunning.few": "{{count}} opravila se izvajajo v ozadju",
  "session.background.shell.two": "{{count}} lupini",
  "session.background.shell.few": "{{count}} lupine",
  "session.background.subagent.two": "{{count}} podagenta",
  "session.background.subagent.few": "{{count}} podagenti",
  "settings.about.otherContributor.two": "{{count}} druga",
  "settings.about.otherContributor.few": "{{count}} drugi",
  "session.review.filesChangedCount.two": "{{count}} datoteki spremenjeni",
  "session.review.filesChangedCount.few": "{{count}} datoteke spremenjene",
  ...
  "settings.workspaces.deleteAll.warning":
    "Delovna drevesa z nespojenimi spremembami, povezanimi sejami ali aktivnimi lokacijami bodo ohranjena.",
  ...
  "session.location.unavailable": "Mesto seje ni na voljo",
  "session.location.description": "Za nadaljevanje te seje izberite drugo mapo.",
  "session.location.choose": "Izberi mapo",
  "session.location.worktree": "Izberi delovno drevo",
  "session.location.worktreesFailed": "Delovnih dreves ni bilo mogoče naložiti",
  "session.location.moving": "Premikanje seje…",
  "dialog.server.menu.hide": "Skrij s seznama projektov",
  "dialog.server.menu.show": "Prikaži na seznamu projektov",
  "session.queue.count.one": "{{count}} element v čakalni vrsti",
  "session.queue.count.other": "{{count}} elementov v čakalni vrsti",
  "session.queue.steer": "Usmeri",
  "session.queue.send": "Pošlji",
  "session.queue.steerTooltip": "Pošlji brez prekinitve",
  "session.queue.remove": "Odstrani",
  "session.queue.reorder": "Spremeni vrstni red poziva v čakalni vrsti",
  "session.new.worktree.creating": "Ustvarjanje delovnega drevesa",
  "settings.backToApp": "Nazaj v aplikacijo",
  "settings.appearance.section.experimental": "Poskusno",
  "settings.appearance.row.tabs.title": "Zavihki",
  "settings.appearance.row.tabs.description": "Izberite razporeditev zavihkov sej",
  "settings.appearance.row.tabs.horizontal": "Vodoravno",
  "settings.appearance.row.tabs.vertical": "Navpično",
  "settings.general.row.followUpBehavior.title": "Obravnava nadaljnjih sporočil",
  "settings.general.row.followUpBehavior.description":
    "Izberite, ali naj se nadaljnja sporočila dodajo v čakalno vrsto ali usmerjajo trenutni korak. Za preklop uporabite {{keybind}}.",
  "settings.general.row.followUpBehavior.queue": "Dodaj v čakalno vrsto",
  "settings.general.row.followUpBehavior.steer": "Usmeri",
  "settings.general.row.reasoningMode.title": "Sklepanje modela",
  "settings.general.row.reasoningMode.description": "Izberite, kako je sklepanje modela prikazano na časovnici",
  "settings.general.row.reasoningMode.hidden": "Skrito",
  "settings.general.row.reasoningMode.compact": "Strnjeno",
  "settings.general.row.reasoningMode.full": "Celotno",
  "session.new.workspace.createFrom": "Ustvari iz veje",
  "session.new.workspace.branch.search.placeholder": "Išči veje",
  "desktop.onboarding.defaultProject": "Privzeti projekt",
  "toast.migration.progress.clearingOldEvents": "Brisanje starih dogodkov",
  "toast.migration.progress.migratingSessions": "Selitev sej",
  "session.new.workspace.existingLabel": "Delovno drevo",
  "home.projects.all": "Vsi projekti",
  "session.tab.files": "Datoteke",
  "session.files.openTabs": "Odprte datoteke",
  "session.tab.usage": "Uporaba",
  ...
  "session.background.tasksRunning.one": "{{count}} opravilo se izvaja v ozadju",
  "session.background.tasksRunning.other": "{{count}} opravil se izvaja v ozadju",
  ...
  "session.websearch.any": "Vse",
  "session.websearch.disable": "Ne uporabljajte iskanja",
  "session.websearch.enable": "Omogoči",
  "session.websearch.loadFailed": "Ponudnikov iskanja ni bilo mogoče naložiti.",
  "session.websearch.empty": "Ni ponudnikov iskanja.",
  "session.websearch.failed": "Vaše izbire ni bilo mogoče shraniti. prosim poskusite ponovno",
  "session.websearch.retry": "Poskusi znova",
  "session.new.worktree.draftPlaceholder": "Napišite nadaljnje sporočilo, medtem ko se pripravlja delovno drevo…",
  "session.search.placeholder": "Najdi...",
  "session.search.noResults": "Ni zadetkov",
  "titlebar.tabs": "Zavihki",
  "titlebar.channel.local": "Lokalno",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Preklop orodij za odpravljanje napak",
  "settings.tab.experimental": "Eksperimentalno",
  "settings.experimental.description": "Preizkusite eksperimentalne funkcije",
  "settings.tab.about": "O tem",
  "settings.about.version": "Različica {{version}}",
  "settings.about.devVersion": "razvoj",
  "settings.about.license": "Izdano pod MIT License",
  "settings.about.writtenBy": "Napisal",
  "settings.about.illustratedBy": "Ilustriral",
  "settings.about.and": "in",
  "settings.about.otherContributor.one": "{{count}} drug",
  "settings.about.otherContributor.other": "{{count}} drugih",
  "settings.about.firstPublished": "Prvič objavljeno v Missouriju, ZDA",
  "settings.about.firstIllustrated": "Prvič ilustrirano v Londonu v Angliji",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, odprtokodni agent za kodiranje",
  "settings.about.trademark": "OpenCode je registrirana blagovna znamka Anomaly Innovations, Inc.",
  "settings.about.typeset": "Vrsta v Inter in IBM Plex Mono",
  "settings.about.tagline": "AI ne more zgraditi odlične programske opreme brez vas",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "Uredi projekt",
  "settings.timeline.title": "Časovnica",
  "settings.timeline.detail": "Podrobnosti o časovnici",
  "settings.timeline.description": "Izberite, koliko aktivnosti se prikaže na časovnici. Sporočila ostanejo vidna.",
  "settings.timeline.preset.everything": "Vse",
  "settings.timeline.preset.detailed": "Podrobno",
  "settings.timeline.preset.compact": "Kompakten",
  "settings.timeline.preset.quiet": "Tiho",
  "settings.timeline.preset.text-only": "Samo besedilo",
  ...
  "settings.timeline.custom": "po meri",
  "settings.timeline.advanced": "Napredno",
  "settings.timeline.advanced.description": "Nastavite postavitev in podrobnosti za vsako kategorijo dejavnosti.",
  "settings.timeline.category.shell": "školjka",
  "settings.timeline.category.edit": "Urejanja",
  ...
  "session.review.filesChangedCount.one": "{{count}} datoteka spremenjena",
  "session.review.filesChangedCount.other": "{{count}} datotek spremenjenih",
  "settings.about.writtenByNames": "Napisal {{names}}",
  "settings.about.illustratedByNames": "Ilustriral {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Ni povezave z {{host}}. Vaš osnutek je shranjen; oddaljeno delo morda še teče.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Dodaj SSH strežnik",
  "ssh.server.menu.label": "SSH strežnik",
  "ssh.target": "Gostitelj ali SSH ukaz",
  "ssh.connect": "Poveži",
  "ssh.connectTo": "Poveži z {{host}}",
  "ssh.authenticate": "SSH overjanje",
  "ssh.action.authenticate": "Overi",
  "ssh.session.disconnected": "SSH povezava ni aktivna",
  "ssh.session.connecting": "Povezovanje s SSH strežnikom",
  ...
  "ssh.session.reconnect": "Poveži znova",
  "ssh.authenticationRequired": "Za {{host}} je zahtevano overjanje",
  "ssh.trust": "Zaupaj in poveži",
  "ssh.continue": "Nadaljuj",
  "ssh.retry": "Poskusi znova",
  "ssh.update": "Posodobi in se poveži znova",
  "ssh.openProject": "Odpri projekt",
  "ssh.project": "Odpri projekt na {{host}}",
  "ssh.disconnect": "Prekini povezavo",
  "ssh.forget": "Pozabi povezavo",
  "ssh.stage.disconnected": "Povezava prekinjena. Oddaljeni strežnik še teče.",
  "ssh.stage.connecting": "Povezovanje preko SSH…",
  "ssh.stage.checking": "Preverjam OpenCode…",
  "ssh.stage.downloading": "Pridobivanje strežnika…",
  "ssh.stage.uploading": "Nalagam strežnik…",
  "ssh.stage.starting": "Povezovanje z OpenCode…",
  "ssh.stage.ready": "Povezano",
  "ssh.stage.authentication": "Zahtevano overjanje",
  "ssh.stage.incompatible": "Zahteva se posodobitev strežnika",
  "ssh.stage.failed": "Povezava ni uspela",
  "ssh.error.input": "Vnesite gostitelja ali SSH ukaz. Oddaljeni ukazi in nepodprte SSH opcije niso dovoljene.",
  "ssh.error.connection": "Povezave SSH ni bilo mogoče vzpostaviti. Preverite omrežje in SSH nastavitve.",
  "ssh.error.platform":
    "Ta oddaljena platforma ni podprta. Samodejna nastavitev trenutno zahteva Linux ali macOS na x64 ali arm64.",
  "ssh.error.version": "Oddaljena storitev se mora ujemati s to namizno različico pred povezavo.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH povezan, vendar OpenCode strežnik ni postal pripravljen.",
  "ssh.error.host-key":
    "Osebnosti gostitelja ni bilo mogoče preveriti. Pred posodobitvijo znanih gostiteljev SSH preverite njegov prstni odtis.",
  "ssh.error.ssh-missing": "OpenSSH ni bilo najdeno. Namestite OpenSSH odjemalec in zagotovite, da je ssh na PATH.",
  "command.browser.open": "Odpri brskalnik",
  "command.browser.reload": "Osveži stran brskalnika",
  "command.session.summary.toggle": "Preklopi povzetek",
  "common.color.orange": "oranžna",
  "common.color.yellow": "rumena",
  "common.color.cyan": "cijan",
  "common.color.green": "zelena",
  "common.color.red": "rdeča",
  "common.color.pink": "roza",
  "common.color.blue": "modra",
  "common.color.purple": "vijolična",
  "common.color.gray": "siva",
  "mcp.auth.interactiveForm": "MCP strežnik {{name}} zahteva interaktivni obrazec za overjanje",
  "server.connect.title": "Poveži se s strežnikom",
  "server.connect.description": "Vnesite naslov strežnika in geslo za začetek.",
  "server.connect.button": "Poveži",
  ...
  "dialog.server.menu.remove": "Odstrani",
  "file.error.notFound": "Datoteka ni najdena: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Migriram seje {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migriram seje {{current}}/{{total}}",
  "toast.migration.progress.working": "Migriram podatke",
  "toast.migration.progress.working.current": "Migriram podatke {{current}}",
  "toast.migration.progress.working.progress": "Migriram podatke {{current}}/{{total}}",
  "home.workspaceTip": "Za naslednjo sejo začnite v novem delovnem prostoru, da ohranite spremembe ločene",
  "session.tab.browser": "Spletni brskalnik",
  "session.tab.add": "Dodaj zavihek",
  "session.queue.attachments.one": "Še {{count}} priponka",
  "session.queue.attachments.other": "Še {{count}} priponk",
  "session.browser.address": "Naslov v brskalniku",
  "session.browser.replaced": "Nadzor brskalnika je premaknjen v drugo namizno okno.",
  "session.browser.unsupported": "Ta namizna aplikacija ne podpira podokna brskalnika.",
  "session.browser.suspended": "Brskalnik je začasno ustavljen. Interakcija s sejo za ponovno povezavo.",
  "session.browser.address.placeholder": "Vnesite URL",
  "settings.backToSettings": "Nazaj na nastavitve",
  "settings.backToProjects": "Nazaj na projekte",
  "settings.search.placeholder": "Išči",
  "settings.search.results": "Rezultati nastavitev",
  "settings.search.group.pages": "Strani",
  "settings.search.group.settings": "Nastavitve",
  "settings.search.group.projects": "Projekti",
  "settings.search.group.servers": "Strežniki",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Ni rezultatov za {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Določite iskanje za bolj natančne rezultate.",
  "settings.server.description": "Upravljajte povezavo in nastavitve tega strežnika",
  "settings.server.section.connection": "Povezava",
  "settings.server.preferences.websearch.title": "Iskanje tretjih oseb",
  "settings.server.preferences.websearch.description":
    "Izberite ponudnika iskanja, ki ga agenti uporabljajo za spletno iskanje",
  "settings.projects.search.placeholder": "Išči projekte",
  "project.settings.name.title": "Ime projekta",
  "project.settings.name.description": "Ime, ki se prikaže za ta projekt v OpenCode",
  "project.settings.icon.description": "Priporočeno: 128×128px. Kliknite ali povlecite za nalaganje slike.",
  "project.settings.color.description": "Uporablja se za ikono projekta, če ni izbrane prilagojene slike",
  "project.settings.worktree.startup.description": "Izvede se enkrat po ustvarjanju novega delovnega drevesa",
  "project.settings.worktree.startup.hint.base": "Uporabite $OPENCODE_WORKTREE_BASE za osnovno delovno drevo.",
  "project.settings.worktree.startup.hint.new": "Uporabite $OPENCODE_WORKTREE_PATH za novo delovno drevo.",
  "project.settings.extensions.empty.mcps.title": "Še ni MCP-jev",
  "project.settings.extensions.empty.mcps.description": "MCP-ji, na voljo za OpenCode, se bodo prikazali tukaj",
  "project.settings.extensions.empty.plugins.title": "Še ni vtičnikov",
  "project.settings.extensions.empty.plugins.description": "Vtičniki, na voljo za OpenCode, se bodo prikazali tukaj",
  "project.settings.extensions.empty.skills.title": "Še ni veščin",
  "project.settings.extensions.empty.skills.description": "Veščine, na voljo za OpenCode, se bodo prikazale tukaj",
  "project.settings.extensions.lsp.configured": "Konfigurirani jezikovni strežniki",
  "project.settings.extensions.lsp.status.enabled": "Omogočeno v konfiguraciji",
  "project.settings.extensions.lsp.status.disabled": "Onemogočeno v konfiguraciji",
  "project.settings.extensions.lsp.empty.title": "Noben jezikovni strežnik ni konfiguriran",
  "project.settings.extensions.lsp.empty.description":
    "Za ta projekt konfigurirani jezikovni strežniki se bodo prikazali tukaj",
  "project.settings.extensions.lsp.disabled.title": "Jezikovni strežniki onemogočeni",
  "project.settings.extensions.lsp.disabled.description": "LSP je v tej projektni konfiguraciji onemogočen",
  "project.settings.extensions.lsp.loadFailed": "Ne morem naložiti konfiguracije jeznega strežnika",
  "project.settings.extensions.lsp.retry": "Poskusi znova",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Skupina",
  "settings.timeline.collapse": "Strni",
  "settings.timeline.visibility.show": "Pokaži",
  "settings.timeline.visibility.hide": "Skrij",
  "settings.timeline.visibility.label": "Vidnost: {{activity}}",
  "settings.timeline.grouped.label": "{{activity}} združeno",
  "settings.timeline.collapsed.label": "{{activity}} strnjeno",
  "session.new.workspace.search.empty": "Ni ustreznih delovnih dreves",
  "settings.workspaces.description": "Preglejte delovna drevesa in upravljajte porabo diska",
  "settings.workspaces.empty.description": "Delovna drevesa, ustvarjena v OpenCode, se bodo prikazala tukaj",
  "settings.workspaces.sessions.filtered.one": "{{count}} seja",
  "settings.workspaces.sessions.filtered.other": "{{count}} sej",
  "settings.workspaces.deleteAll.confirm.one": "S tem boste trajno izbrisali {{count}} izbrano delovno drevo.",
  "settings.workspaces.deleteAll.confirm.other": "S tem boste trajno izbrisali {{count}} izbranih delovnih dreves.",
  "settings.workspaces.deleteWithoutSessions": "Izbriši delovna drevesa brez sej",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "S tem boste trajno izbrisali {{count}} delovno drevo brez povezanih sej.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "S tem boste trajno izbrisali {{count}} delovnih dreves brez povezanih sej.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Delovna drevesa z nesinhroniziranimi spremembami ali aktivnimi lokacijami bodo ohranjena.",
  "settings.workspaces.delete.button": "Izbriši delovna drevesa",
  "workspace.lifecycle.deleting": "Brišem…",
  "session.summary.tooltip": "Povzetek",
  "session.summary.server": "Razširitve",
  "session.summary.chooseProject": "Izberite projekt",
  "session.summary.mcp.onCreation": "Velja ob ustvarjanju delovnega drevesa",
  "session.summary.mcp.prepareFailed": "Priprava MCP strežnikov ni uspela",
  "session.summary.mcp.unavailable": "MCP strežnik {{name}} ni na voljo v tem delovnem drevesu.",
  "session.summary.mcp.signInBeforeSend": "Prijavite se v {{name}} pred pošiljanjem poziva.",
  "session.summary.mcp.notReady":
    "MCP strežnik {{name}} ni pripravljen. Rešite njegovo povezavo pred pošiljanjem poziva.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurirani MCP strežniki",
  "session.summary.plugins": "Vtičniki",
  "session.summary.plugins.configured": "Konfigurirani vtičniki",
  "session.summary.skills": "Veščine",
  "session.summary.skills.configured": "Konfigurirane veščine",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Ni uspelo",
  "session.summary.retry": "Poskusi znova",
  "session.summary.connecting": "Povezujem…",
  "session.summary.needsAuth": "Zahteva prijavo",
  "session.summary.configure": "Konfiguracijska datoteka",
  "session.summary.copyConfigPath": "Kopiraj pot konfiguracijske datoteke",
  "session.summary.configFileMissing": "Konfiguracijska datoteka ni najdena",
  "session.summary.mcp.empty": "Brez konfiguriranih MCP strežnikov",
  "session.summary.mcp.add": "Dodajte strežnike v opencode.json",
  "session.summary.plugins.manage": "Upravljajte vtičnike v opencode.json",
  "session.summary.plugins.empty": "Brez konfiguriranih vtičnikov",
  "session.summary.plugins.add": "Dodajte vtičnike v opencode.json",
  "session.summary.skills.manage": "Upravljajte veščine v opencode.json",
  "session.summary.skills.empty": "Brez konfiguriranih veščin",
  "session.summary.skills.add": "Dodajte veščine v opencode.json",
  "session.summary.lsp.configured": "Konfigurirani LSP-ji",
  "session.summary.lsp.empty": "Brez konfiguriranih LSP strežnikov",
  "session.summary.lsp.manage": "Upravljajte LSP v opencode.json",
  "workspace.delete.location": "Lokacija",
  "command.debugBar.toggle": "Preklopi vrstico za razhroščevanje",
  "command.session.location.cycle": "Zamenjaj lokacijo seje",
  "dialog.provider.anthropic.note": "Neposreden dostop do modelov Claude s ključem API",
  "provider.connect.title.anthropicProMax": "Prijava prek Anthropic",
  "prompt.toast.uploading.cancel": "Prekliči nalaganje",
  "prompt.toast.uploading.cancelFile": "Prekliči nalaganje datoteke {{filename}}",
  "prompt.toast.uploadFailed.title": "Nalaganje ni uspelo",
  "session.browser.empty.title": "Vnesite URL",
  "session.browser.empty.description": "Ali vnesite poziv »Odpri v brskalniku aplikacije«",
  "session.browser.failed.title": "URL ni dosegljiv",
  "session.browser.failed.description": "Preverite URL in povezavo ter poskusite znova.",
  "debugBar.providerAriaLabel": "Diagnostika učinkovitosti ponudnika",
  "debugBar.ttft.tip": "Čas od pošiljanja zahteve ponudniku do prvega izhoda modela.",
  "debugBar.ttfa.tip": "Čas od pošiljanja zahteve ponudniku do prvega besedila odgovora.",
  "debugBar.tps.tip": "Število izhodnih žetonov na sekundo po prvem izhodu modela.",
  "debugBar.e2e.tip": "Čas od pošiljanja zahteve ponudniku do konca toka odgovora.",
  "settings.updates.action.download": "Prenesi OpenCode",
  "settings.updates.migration.title": "Prehod z Beta na Stable",
