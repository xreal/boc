export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Τα δέντρα εργασίας με μη συγχωνευμένες αλλαγές, συνδεδεμένες περιόδους σύνδεσης ή ενεργές τοποθεσίες θα διατηρηθούν.",
  ...
  "session.location.worktree": "Επιλογή δέντρου εργασίας",
  "session.location.worktreesFailed": "Αποτυχία φόρτωσης των δέντρων εργασίας",
  "session.location.moving": "Μετακίνηση συνεδρίας…",
  "dialog.server.menu.hide": "Απόκρυψη από τη λίστα έργων",
  "dialog.server.menu.show": "Εμφάνιση στη λίστα έργων",
  "session.queue.count.one": "{{count}} στην ουρά",
  "session.queue.count.other": "{{count}} στην ουρά",
  "session.queue.steer": "Καθοδήγηση",
  "session.queue.send": "Αποστολή",
  "session.queue.steerTooltip": "Αποστολή χωρίς διακοπή",
  "session.queue.remove": "Αφαίρεση",
  "session.queue.reorder": "Αναδιάταξη προτροπής στην ουρά",
  "session.new.worktree.creating": "Δημιουργία δέντρου εργασίας",
  "settings.backToApp": "Επιστροφή στην εφαρμογή",
  "settings.appearance.section.experimental": "Πειραματικά",
  "settings.appearance.row.tabs.title": "Καρτέλες",
  "settings.appearance.row.tabs.description": "Επιλέξτε πώς διατάσσονται οι καρτέλες συνεδριών",
  "settings.appearance.row.tabs.horizontal": "Οριζόντια",
  "settings.appearance.row.tabs.vertical": "Κατακόρυφα",
  "settings.general.row.followUpBehavior.title": "Συμπεριφορά επόμενων μηνυμάτων",
  "settings.general.row.followUpBehavior.description":
    "Επιλέξτε αν τα επόμενα μηνύματα θα μπαίνουν στην ουρά ή θα καθοδηγούν τον τρέχοντα γύρο. Χρησιμοποιήστε {{keybind}} για εναλλαγή.",
  "settings.general.row.followUpBehavior.queue": "Ουρά",
  "settings.general.row.followUpBehavior.steer": "Καθοδήγηση",
  "settings.general.row.reasoningMode.title": "Συλλογισμός μοντέλου",
  "settings.general.row.reasoningMode.description":
    "Επιλέξτε πώς εμφανίζεται ο συλλογισμός του μοντέλου στη λωρίδα χρόνου",
  "settings.general.row.reasoningMode.hidden": "Κρυφό",
  "settings.general.row.reasoningMode.compact": "Συμπτυγμένο",
  "settings.general.row.reasoningMode.full": "Πλήρες",
  "session.new.workspace.createFrom": "Δημιουργία από κλάδο",
  "session.new.workspace.branch.search.placeholder": "Αναζήτηση κλάδων",
  "toast.migration.progress.clearingOldEvents": "Εκκαθάριση παλιών συμβάντων",
  "toast.migration.progress.migratingSessions": "Μετεγκατάσταση συνεδριών",
  "session.new.workspace.existingLabel": "Δέντρο εργασίας",
  "desktop.onboarding.defaultProject": "Προεπιλεγμένο έργο",
  "home.projects.all": "Όλα τα έργα",
  "session.tab.files": "Αρχεία",
  "session.files.openTabs": "Άνοιγμα αρχείων",
  "session.tab.usage": "Χρήση",
  "session.view.select": "Προβολή συνεδρίας",
  "session.background.moveTasks": "Μετακινήστε το {{tasks}} στο παρασκήνιο",
  "session.background.moveRunning": "Μετακίνηση στο παρασκήνιο",
  "session.background.inBackground": "Εκτέλεση {{tasks}} στο παρασκήνιο",
  "session.background.tasksRunning.one": "Εκτέλεση εργασίας παρασκηνίου {{count}}",
  "session.background.tasksRunning.other": "Εκτελούνται εργασίες παρασκηνίου {{count}}",
  ...
  "session.websearch.provider": "Αναζήτηση παρόχου",
  "session.websearch.any": "Οποιαδήποτε",
  "session.websearch.disable": "Μην χρησιμοποιείτε την αναζήτηση",
  "session.websearch.enable": "Ενεργοποίηση",
  "session.websearch.loadFailed": "Δεν ήταν δυνατή η φόρτωση παρόχων αναζήτησης.",
  "session.websearch.empty": "Δεν υπάρχουν διαθέσιμοι πάροχοι αναζήτησης.",
  "session.websearch.failed": "Δεν ήταν δυνατή η αποθήκευση της επιλογής σας. Δοκιμάστε ξανά.",
  "session.websearch.retry": "Επανάληψη",
  "session.new.worktree.draftPlaceholder": "Σχεδιάστε μια συνέχεια ενώ προετοιμάζεται το δέντρο εργασίας…",
  "session.search.placeholder": "Βρείτε…",
  "session.search.noResults": "Δεν βρέθηκαν αντιστοιχίες",
  "titlebar.tabs": "Καρτέλες",
  "titlebar.channel.local": "Τοπικό",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Εναλλαγή εργαλείων εντοπισμού σφαλμάτων",
  "settings.tab.experimental": "Πειραματικό",
  "settings.experimental.description": "Δοκιμάστε πειραματικές λειτουργίες",
  "settings.tab.about": "Πληροφορίες",
  "settings.about.version": "Έκδοση {{version}}",
  "settings.about.devVersion": "ανάπτυξη",
  "settings.about.license": "Κυκλοφόρησε υπό την άδεια MIT",
  "settings.about.writtenBy": "Γράφτηκε από",
  "settings.about.illustratedBy": "Εικονογράφηση από",
  "settings.about.and": "και",
  "settings.about.otherContributor.one": "{{count}} άλλο",
  "settings.about.otherContributor.other": "{{count}} άλλοι",
  "settings.about.firstPublished": "Πρωτοδημοσιεύτηκε στο Μιζούρι των Η.Π.Α",
  "settings.about.firstIllustrated": "Εικονογραφήθηκε για πρώτη φορά στο Λονδίνο της Αγγλίας",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, ο παράγοντας κωδικοποίησης ανοιχτού κώδικα",
  "settings.about.trademark": "Το OpenCode είναι σήμα κατατεθέν της Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Επιλέξτε πόση δραστηριότητα θα εμφανίζεται στη γραμμή χρόνου. Τα μηνύματα παραμένουν ορατά.",
  "settings.timeline.preset.everything": "Τα πάντα",
  "settings.timeline.preset.detailed": "Αναλυτικά",
  "settings.timeline.preset.compact": "Συμπαγές",
  "settings.timeline.preset.quiet": "Ήσυχο",
  "settings.timeline.preset.text-only": "Μόνο κείμενο",
  "settings.timeline.description.everything":
    "Εμφάνιση όλων των δραστηριοτήτων ξεχωριστά. Επεκτείνετε την παραγωγή φλοιού, τις επεξεργασίες και τη σκέψη.",
  "settings.timeline.description.detailed":
    "Αναπτύξτε την έξοδο φλοιού και τις επεξεργασίες. Εμφάνιση υποπαραγόντων ξεχωριστά και ομαδοποίηση άλλης δραστηριότητας στο Χρησιμοποιήθηκαν.",
  "settings.timeline.description.compact":
    "Ομαδοποιήστε όλη τη δραστηριότητα στο Χρησιμοποιήθηκαν με τις λεπτομέρειες σε σύμπτυξη.",
  "settings.timeline.description.quiet":
    "Ομαδοποιήστε επεξεργασίες και υποπράκτορες στο Χρησιμοποιήθηκαν. Απόκρυψη άλλης δραστηριότητας.",
  "settings.timeline.description.text-only": "Απόκρυψη όλης της δραστηριότητας. Εμφάνιση μόνο μηνυμάτων.",
  "settings.timeline.description.custom":
    "Χρησιμοποιήστε την επιλεγμένη τοποθέτηση και τις λεπτομέρειες για κάθε κατηγορία δραστηριότητας.",
  "settings.timeline.custom": "Προσαρμοσμένο",
  "settings.timeline.advanced": "Προχωρημένο",
  "settings.timeline.advanced.description":
    "Ορίστε την τοποθέτηση και τις λεπτομέρειες για κάθε κατηγορία δραστηριότητας.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Επεξεργασίες",
  "settings.timeline.category.thinking": "Σκέψη",
  ...
  "session.review.filesChangedCount.one": "{{count}} αρχείο άλλαξε",
  "session.review.filesChangedCount.other": "{{count}} αρχεία άλλαξαν",
  "settings.about.writtenByNames": "Γράφτηκε από {{names}}",
  "settings.about.illustratedByNames": "Εικονογράφηση από {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Δεν είναι συνδεδεμένο στο {{host}}. Το πρόχειρό σας διατηρείται. η απομακρυσμένη εργασία μπορεί να εξακολουθεί να εκτελείται.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Προσθήκη διακομιστή SSH",
  "ssh.server.menu.label": "Διακομιστής SSH",
  "ssh.target": "Εντολή Host ή SSH",
  "ssh.connect": "Σύνδεση",
  "ssh.connectTo": "Σύνδεση στο {{host}}",
  "ssh.authenticate": "Έλεγχος ταυτότητας SSH",
  "ssh.action.authenticate": "Έλεγχος ταυτότητας",
  "ssh.session.disconnected": "Η σύνδεση SSH είναι ανενεργή",
  "ssh.session.connecting": "Σύνδεση με διακομιστή SSH",
  "ssh.session.reconnectDescription":
    "Επανασυνδεθείτε για να δείτε αυτήν την περίοδο λειτουργίας και να συνεχίσετε να εργάζεστε. Η απομακρυσμένη συνεδρία σας διατηρείται.",
  "ssh.session.reconnect": "Επανασύνδεση",
  "ssh.authenticationRequired": "Απαιτείται έλεγχος ταυτότητας για το {{host}}",
  "ssh.trust": "Εμπιστευτείτε και συνδεθείτε",
  "ssh.continue": "Συνέχεια",
  "ssh.retry": "Επανάληψη",
  "ssh.update": "Ενημέρωση και επανασύνδεση",
  "ssh.openProject": "Ανοιχτό έργο",
  "ssh.project": "Άνοιγμα έργου στο {{host}}",
  "ssh.disconnect": "Αποσύνδεση",
  "ssh.forget": "Ξεχάστε τη σύνδεση",
  "ssh.stage.disconnected": "Ασύνδετος. Ο απομακρυσμένος διακομιστής παραμένει σε λειτουργία.",
  "ssh.stage.connecting": "Σύνδεση μέσω SSH…",
  "ssh.stage.checking": "Έλεγχος OpenCode…",
  "ssh.stage.downloading": "Λήψη διακομιστή…",
  "ssh.stage.uploading": "Διακομιστής μεταφόρτωσης…",
  "ssh.stage.starting": "Σύνδεση στο OpenCode…",
  "ssh.stage.ready": "Συνδεδεμένος",
  "ssh.stage.authentication": "Απαιτείται έλεγχος ταυτότητας",
  "ssh.stage.incompatible": "Απαιτείται ενημέρωση διακομιστή",
  "ssh.stage.failed": "Η σύνδεση απέτυχε",
  "ssh.error.input":
    "Εισαγάγετε έναν κεντρικό υπολογιστή ή μια εντολή σύνδεσης SSH. Δεν επιτρέπονται οι απομακρυσμένες εντολές και οι μη υποστηριζόμενες επιλογές SSH.",
  "ssh.error.connection":
    "Δεν ήταν δυνατή η δημιουργία της σύνδεσης SSH. Ελέγξτε τη διαμόρφωση του δικτύου σας και του SSH.",
  "ssh.error.platform":
    "Αυτή η απομακρυσμένη πλατφόρμα δεν υποστηρίζεται. Η αυτόματη ρύθμιση απαιτεί επί του παρόντος Linux ή macOS σε x64 ή arm64.",
  "ssh.error.version":
    "Η απομακρυσμένη υπηρεσία πρέπει να ταιριάζει με αυτήν την έκδοση επιφάνειας εργασίας πριν από τη σύνδεση.",
  "ssh.error.install":
    "Δεν ήταν δυνατή η εγκατάσταση του απομακρυσμένου διακομιστή. Ελέγξτε τη συνδεσιμότητα, το χώρο στο δίσκο και ότι είναι εγκατεστημένο το tar.",
  "ssh.error.unpublished":
    "Αυτή η έκδοση για επιφάνεια εργασίας δεν έχει δημοσιευμένο απομακρυσμένο διακομιστή. Για εκδόσεις ανάπτυξης, εγκαταστήστε και ξεκινήστε το V2 στον κεντρικό υπολογιστή και, στη συνέχεια, δοκιμάστε ξανά.",
  "ssh.error.service": "Ο SSH συνδέθηκε, αλλά ο διακομιστής OpenCode δεν ήταν έτοιμος.",
  "ssh.error.host-key":
    "Δεν ήταν δυνατή η επαλήθευση της ταυτότητας του οικοδεσπότη. Επαληθεύστε το δακτυλικό του αποτύπωμα πριν ενημερώσετε τους γνωστούς κεντρικούς υπολογιστές SSH.",
  "ssh.error.ssh-missing":
    "Το OpenSSH δεν βρέθηκε. Εγκαταστήστε έναν πελάτη OpenSSH και βεβαιωθείτε ότι το ssh είναι διαθέσιμο στο PATH.",
  "command.browser.open": "Άνοιγμα προγράμματος περιήγησης",
  "command.browser.reload": "Επαναφόρτωση σελίδας προγράμματος περιήγησης",
  "command.session.summary.toggle": "Εναλλαγή περίληψης",
  "mcp.auth.interactiveForm": "Ο διακομιστής MCP Ο {{name}} απαιτεί μια διαδραστική φόρμα ελέγχου ταυτότητας",
  "server.connect.title": "Σύνδεση σε διακομιστή",
  "server.connect.description": "Εισαγάγετε τη διεύθυνση του διακομιστή και τον κωδικό πρόσβασης για να ξεκινήσετε.",
  "server.connect.button": "Σύνδεση",
  ...
  "server.connect.camera.error":
    "Δεν ήταν δυνατό το άνοιγμα της κάμερας. Επιτρέψτε την πρόσβαση στην κάμερα ή εισαγάγετε τα στοιχεία της σύνδεσής σας με μη αυτόματο τρόπο.",
  "dialog.server.menu.remove": "Αφαίρεση",
  "file.error.notFound": "Το αρχείο δεν βρέθηκε: {{name}}",
  "home.workspaceTip":
    "Ξεκινήστε την επόμενη συνεδρία σε νέο χώρο εργασίας για να διατηρήσετε τις αλλαγές απομονωμένες",
  "session.tab.browser": "Πρόγραμμα περιήγησης",
  "session.tab.add": "Προσθήκη καρτέλας",
  "session.queue.attachments.one": "Συν {{count}} συνημμένο",
  "session.queue.attachments.other": "Συν {{count}} συνημμένα",
  "session.browser.address": "Διεύθυνση προγράμματος περιήγησης",
  "session.browser.replaced":
    "Ο έλεγχος του προγράμματος περιήγησης μετακινήθηκε σε άλλο παράθυρο επιφάνειας εργασίας.",
  "session.browser.suspended":
    "Το πρόγραμμα περιήγησης σε αναστολή. Αλληλεπιδράστε με αυτήν την περίοδο σύνδεσης για επανασύνδεση.",
  "session.browser.address.placeholder": "Εισαγάγετε τη διεύθυνση URL",
  "settings.backToSettings": "Επιστροφή στις ρυθμίσεις",
  "settings.backToProjects": "Επιστροφή στα έργα",
  "settings.search.placeholder": "Αναζήτηση",
  "settings.search.results": "Αποτελέσματα ρυθμίσεων",
  "settings.search.group.pages": "Σελίδες",
  "settings.search.group.settings": "Ρυθμίσεις",
  "settings.search.group.projects": "Έργα",
  "settings.search.group.servers": "Διακομιστές",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Δεν υπάρχουν αποτελέσματα για {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Περιορίστε την αναζήτησή σας για να δείτε πιο συγκεκριμένα αποτελέσματα.",
  "settings.server.description": "Διαχειριστείτε τη σύνδεση και τις προτιμήσεις αυτού του διακομιστή",
  "settings.server.section.connection": "Σύνδεση",
  "settings.server.preferences.websearch.title": "Αναζήτηση τρίτων",
  "settings.server.preferences.websearch.description":
    "Επιλέξτε τους πράκτορες παροχής αναζήτησης που χρησιμοποιούν για την αναζήτηση στον ιστό",
  "settings.projects.search.placeholder": "Αναζήτηση έργων",
  "project.settings.name.title": "Όνομα έργου",
  "project.settings.name.description": "Το όνομα που εμφανίζεται για αυτό το έργο σε όλο το OpenCode",
  "project.settings.icon.description": "Προτείνεται: 128×128 px. Κάντε κλικ ή σύρετε για να ανεβάσετε μια εικόνα.",
  "project.settings.color.description":
    "Χρησιμοποιείται για το εικονίδιο του έργου όταν δεν έχει οριστεί προσαρμοσμένη εικόνα",
  "project.settings.worktree.startup.description": "Εκτελείται μία φορά μετά τη δημιουργία ενός νέου δέντρου εργασίας",
  "project.settings.worktree.startup.hint.base":
    "Χρησιμοποιήστε το $OPENCODE_WORKTREE_BASE για το βασικό δέντρο εργασίας.",
  "project.settings.worktree.startup.hint.new": "Χρησιμοποιήστε το $OPENCODE_WORKTREE_PATH για το νέο δέντρο εργασίας.",
  "project.settings.extensions.empty.mcps.title": "Όχι MCPs ακόμα",
  "project.settings.extensions.empty.mcps.description": "Το MCPs διαθέσιμο στο OpenCode θα εμφανιστεί εδώ",
  "project.settings.extensions.empty.plugins.title": "Δεν υπάρχουν πρόσθετα ακόμα",
  "project.settings.extensions.empty.plugins.description":
    "Τα πρόσθετα που είναι διαθέσιμα στο OpenCode θα εμφανιστούν εδώ",
  "project.settings.extensions.empty.skills.title": "Δεν υπάρχουν ακόμη δεξιότητες",
  "project.settings.extensions.empty.skills.description":
    "Οι δεξιότητες που είναι διαθέσιμες στο OpenCode θα εμφανιστούν εδώ",
  "project.settings.extensions.lsp.configured": "Διακομιστές γλώσσας που έχουν διαμορφωθεί",
  "project.settings.extensions.lsp.status.enabled": "Ενεργοποιήθηκε στο config",
  "project.settings.extensions.lsp.status.disabled": "Απενεργοποιήθηκε στη διαμόρφωση",
  "project.settings.extensions.lsp.empty.title": "Δεν έχουν ρυθμιστεί διακομιστές γλώσσας",
  "project.settings.extensions.lsp.empty.description":
    "Οι διακομιστές γλωσσών που έχουν ρυθμιστεί για αυτό το έργο θα εμφανιστούν εδώ",
  "project.settings.extensions.lsp.disabled.title": "Οι διακομιστές γλώσσας απενεργοποιήθηκαν",
  "project.settings.extensions.lsp.disabled.description":
    "Το LSP είναι απενεργοποιημένο στη διαμόρφωση αυτού του έργου",
  "project.settings.extensions.lsp.loadFailed": "Δεν ήταν δυνατή η φόρτωση της διαμόρφωσης διακομιστή γλώσσας",
  "project.settings.extensions.lsp.retry": "Επανάληψη",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Ομάδα",
  "settings.timeline.collapse": "Κατάρρευση",
  "settings.timeline.visibility.show": "Εμφάνιση",
  "settings.timeline.visibility.hide": "Απόκρυψη",
  ...
  "settings.workspaces.sessions.filtered.one": "Συνεδρία {{count}}",
  "settings.workspaces.sessions.filtered.other": "Συνεδρίες {{count}}",
  "settings.workspaces.deleteAll.confirm.one": "Αυτό θα διαγράψει οριστικά το επιλεγμένο δέντρο εργασίας {{count}}.",
  "settings.workspaces.deleteAll.confirm.other": "Αυτό θα διαγράψει οριστικά τα επιλεγμένα δέντρα εργασίας {{count}}.",
  "settings.workspaces.deleteWithoutSessions": "Διαγραφή δέντρων εργασίας χωρίς περιόδους λειτουργίας",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Αυτό θα διαγράψει οριστικά το δέντρο εργασίας {{count}} χωρίς συνδεδεμένες περιόδους σύνδεσης.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Αυτό θα διαγράψει οριστικά τα δέντρα εργασίας {{count}} χωρίς συνδεδεμένες περιόδους σύνδεσης.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Τα δέντρα εργασίας με μη συγχωνευμένες αλλαγές ή ενεργές τοποθεσίες θα διατηρηθούν.",
  "settings.workspaces.delete.button": "Διαγραφή δέντρων εργασίας",
  "workspace.lifecycle.deleting": "Διαγραφή…",
  "session.summary.tooltip": "Περίληψη",
  "session.summary.server": "Επεκτάσεις",
  "session.summary.chooseProject": "Επιλέξτε ένα έργο",
  "session.summary.mcp.onCreation": "Εφαρμόζεται όταν δημιουργείται το δέντρο εργασίας",
  "session.summary.mcp.prepareFailed": "Δεν ήταν δυνατή η προετοιμασία διακομιστών MCP",
  "session.summary.mcp.unavailable":
    "Ο διακομιστής MCP Ο διακομιστής {{name}} δεν είναι διαθέσιμος σε αυτό το δέντρο εργασίας.",
  "session.summary.mcp.signInBeforeSend": "Συνδεθείτε στο {{name}} πριν στείλετε το μήνυμα προτροπής.",
  "session.summary.mcp.notReady":
    "Ο διακομιστής MCP Ο διακομιστής {{name}} δεν είναι έτοιμος. Επιλύστε τη σύνδεσή του πριν στείλετε το μήνυμα.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Διαμορφωμένοι διακομιστές MCP",
  "session.summary.plugins": "Πρόσθετα",
  "session.summary.plugins.configured": "Ρυθμισμένες προσθήκες",
  "session.summary.skills": "Δεξιότητες",
  "session.summary.skills.configured": "Διαμορφωμένες δεξιότητες",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Απέτυχε",
  "session.summary.retry": "Επανάληψη",
  "session.summary.connecting": "Σύνδεση…",
  "session.summary.needsAuth": "Απαιτείται είσοδος",
  "session.summary.configure": "Αρχείο διαμόρφωσης",
  "session.summary.copyConfigPath": "Αντιγραφή διαδρομής αρχείου διαμόρφωσης",
  "session.summary.configFileMissing": "Δεν βρέθηκε αρχείο διαμόρφωσης",
  "session.summary.mcp.empty": "Δεν έχουν διαμορφωθεί διακομιστές MCP",
  "session.summary.mcp.add": "Προσθήκη διακομιστών στο opencode.json",
  "session.summary.plugins.manage": "Διαχείριση προσθηκών στο opencode.json",
  "session.summary.plugins.empty": "Δεν έχουν ρυθμιστεί πρόσθετα",
  "session.summary.plugins.add": "Προσθήκη προσθηκών στο opencode.json",
  "session.summary.skills.manage": "Διαχείριση δεξιοτήτων στο opencode.json",
  "session.summary.skills.empty": "Δεν έχουν διαμορφωθεί δεξιότητες",
  "session.summary.skills.add": "Προσθέστε δεξιότητες στο opencode.json",
  "session.summary.lsp.configured": "Διαμόρφωσε το LSPs",
  "session.summary.lsp.empty": "Δεν έχουν διαμορφωθεί διακομιστές LSP",
  "session.summary.lsp.manage": "Διαχειριστείτε το LSP στο opencode.json",
  "workspace.delete.location": "Τοποθεσία",
  ...
  "common.color.gray": "γκρι",
  "toast.migration.progress.migratingSessions.current": "Μετεγκατάσταση συνεδριών {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Μετεγκατάσταση συνεδριών {{current}}/{{total}}",
  "toast.migration.progress.working": "Μετανάστευση δεδομένων",
  "toast.migration.progress.working.current": "Μεταφορά δεδομένων {{current}}",
  "toast.migration.progress.working.progress": "Μεταφορά δεδομένων {{current}}/{{total}}",
  "session.browser.unsupported":
    "Αυτή η εφαρμογή επιφάνειας εργασίας δεν υποστηρίζει το παράθυρο του προγράμματος περιήγησης.",
  "command.debugBar.toggle": "Εναλλαγή γραμμής εντοπισμού σφαλμάτων",
  "command.session.location.cycle": "Εναλλαγή τοποθεσίας συνεδρίας",
  "dialog.provider.anthropic.note": "Άμεση πρόσβαση στα μοντέλα Claude μέσω κλειδιού API",
  "provider.connect.title.anthropicProMax": "Σύνδεση με το Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Ακύρωση μεταφόρτωσης",
  "prompt.toast.uploading.cancelFile": "Ακύρωση μεταφόρτωσης του {{filename}}",
  "prompt.toast.uploadFailed.title": "Η μεταφόρτωση απέτυχε",
  "session.browser.empty.title": "Εισαγάγετε URL",
  "session.browser.empty.description": "Ή ζητήστε «Άνοιγμα στο πρόγραμμα περιήγησης της εφαρμογής»",
  "session.browser.failed.title": "Δεν είναι δυνατή η πρόσβαση στο URL",
  "session.browser.failed.description": "Ελέγξτε το URL και τη σύνδεσή σας και δοκιμάστε ξανά.",
  "debugBar.providerAriaLabel": "Διαγνωστικά απόδοσης παρόχου",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Χρόνος από την αποστολή του αιτήματος στον πάροχο έως την πρώτη έξοδο του μοντέλου.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Χρόνος από την αποστολή του αιτήματος στον πάροχο έως το πρώτο κείμενο απάντησης.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Διακριτικά εξόδου ανά δευτερόλεπτο μετά την πρώτη έξοδο του μοντέλου.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Χρόνος από την αποστολή του αιτήματος στον πάροχο έως τη λήξη της ροής απάντησης.",
  "settings.updates.action.download": "Λήψη του OpenCode",
  "settings.updates.migration.title": "Μετάβαση από Beta σε Σταθερή",
