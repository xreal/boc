export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Нэгтгээгүй өөрчлөлт, холбогдсон сешн эсвэл идэвхтэй байршилтай ажлын моднуудыг хадгална.",
  ...
  "session.location.worktree": "Worktree сонгох",
  "session.location.worktreesFailed": "Worktree-үүдийг ачаалж чадсангүй",
  "session.location.moving": "Сессийг зөөж байна…",
  "dialog.server.menu.hide": "Төслийн жагсаалтаас нуух",
  "dialog.server.menu.show": "Төслийн жагсаалтад харуулах",
  "session.queue.count.one": "{{count}} дараалалд байна",
  "session.queue.count.other": "{{count}} дараалалд байна",
  "session.queue.steer": "Чиглүүлэх",
  "session.queue.send": "Илгээх",
  "session.queue.steerTooltip": "Тасалдуулахгүйгээр илгээх",
  "session.queue.remove": "Устгах",
  "session.queue.reorder": "Дараалалд буй промптын байрлалыг өөрчлөх",
  "session.new.worktree.creating": "Worktree үүсгэж байна",
  "settings.backToApp": "Апп руу буцах",
  "settings.appearance.section.experimental": "Туршилтын",
  "settings.appearance.row.tabs.title": "Табууд",
  "settings.appearance.row.tabs.description": "Сессийн табуудын байрлалыг сонгоно уу",
  "settings.appearance.row.tabs.horizontal": "Хэвтээ",
  "settings.appearance.row.tabs.vertical": "Босоо",
  "settings.general.row.followUpBehavior.title": "Нэмэлт мессежийн үйлдэл",
  "settings.general.row.followUpBehavior.description":
    "Нэмэлт мессежийг дараалалд оруулах эсвэл одоогийн ээлжийг чиглүүлэхээ сонгоно уу. Солихын тулд {{keybind}} ашиглана уу.",
  "settings.general.row.followUpBehavior.queue": "Дараалалд оруулах",
  "settings.general.row.followUpBehavior.steer": "Чиглүүлэх",
  "settings.general.row.reasoningMode.title": "Загварын үндэслэл",
  "settings.general.row.reasoningMode.description": "Загварын үндэслэлийг цагийн шугамд хэрхэн харуулахыг сонгоно уу",
  "settings.general.row.reasoningMode.hidden": "Нууцлагдсан",
  "settings.general.row.reasoningMode.compact": "Хураангуй",
  "settings.general.row.reasoningMode.full": "Бүрэн",
  "session.new.workspace.createFrom": "Эндээс үүсгэх",
  "session.new.workspace.branch.search.placeholder": "Салаа хайх",
  "toast.migration.progress.clearingOldEvents": "Хуучин үйл явдлуудыг цэвэрлэж байна",
  "toast.migration.progress.migratingSessions": "Сессүүдийг шилжүүлж байна",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "Өгөгдмөл төсөл",
  "home.projects.all": "Бүх төсөл",
  "session.tab.files": "Файлууд",
  "session.files.openTabs": "Нээлттэй файлууд",
  "session.tab.usage": "Ашиглалт",
  "session.view.select": "Сессийн харагдац",
  "session.background.moveTasks": "{{tasks}}-г арын горимд шилжүүлэх",
  "session.background.moveRunning": "Арын горимд шилжүүлэх",
  "session.background.inBackground": "{{tasks}} арын горимд ажиллаж байна",
  "session.background.tasksRunning.one": "{{count}} арын даалгавар ажиллаж байна",
  "session.background.tasksRunning.other": "{{count}} арын даалгавар ажиллаж байна",
  ...
  "session.timeline.working": "Ажиллаж байна",
  "session.review.wrapLines": "Мөрүүдийг нугалах",
  "session.websearch.title": "Гуравдагч талын веб хайлт",
  "session.websearch.description": "Агентууд вебээс хайхад ашиглах хайлтын үйлчилгээ үзүүлэгчийг сонгоно уу",
  "session.websearch.provider": "Хайлтын үйлчилгээ үзүүлэгч",
  "session.websearch.any": "Аль нь ч",
  "session.websearch.disable": "Хайлт бүү ашигла",
  "session.websearch.enable": "Идэвхжүүлэх",
  "session.websearch.loadFailed": "Хайлтын үйлчилгээ үзүүлэгчдийг ачаалж чадсангүй.",
  "session.websearch.empty": "Хайлтын үйлчилгээ үзүүлэгч алга.",
  "session.websearch.failed": "Таны сонголтыг хадгалж чадсангүй. Дахин оролдоно уу.",
  "session.websearch.retry": "Дахин оролдох",
  "session.new.worktree.draftPlaceholder": "Worktree бэлтгэгдэж байх хооронд үргэлжлүүлэх мессежийн ноорог бичнэ үү…",
  "session.search.placeholder": "Хайх...",
  "session.search.noResults": "Тохирох зүйл алга",
  "titlebar.tabs": "Табууд",
  "titlebar.channel.local": "Локал",
  "titlebar.channel.dev": "Хөгжүүлэлт",
  "titlebar.channel.beta": "Бета",
  "titlebar.toggleDebugTools": "Дибаг хийх хэрэгслүүдийг сэлгэх",
  "settings.tab.experimental": "Туршилтын",
  "settings.experimental.description": "Туршилтын боломжуудыг туршина уу",
  "settings.tab.about": "Тухай",
  "settings.about.version": "Хувилбар {{version}}",
  "settings.about.devVersion": "хөгжүүлэлт",
  "settings.about.license": "MIT лицензээр гаргасан",
  "settings.about.writtenBy": "Бичсэн",
  "settings.about.illustratedBy": "Зурагласан",
  "settings.about.and": "ба",
  "settings.about.otherContributor.one": "өөр {{count}}",
  "settings.about.otherContributor.other": "өөр {{count}}",
  "settings.about.firstPublished": "Анх АНУ-ын Миссури мужид хэвлэгдсэн",
  "settings.about.firstIllustrated": "Анх Английн Лондон хотод зурагласан",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, нээлттэй эхийн кодчиллын агент",
  "settings.about.trademark": "OpenCode нь Anomaly Innovations, Inc.-ийн бүртгэлтэй барааны тэмдэг юм.",
  ...
  "settings.timeline.description":
    "Цагийн шугамд хэр их үйл ажиллагаа харагдахыг сонгоно уу. Мессежүүд харагдсан хэвээр байна.",
  "settings.timeline.preset.everything": "Бүх зүйл",
  "settings.timeline.preset.detailed": "Дэлгэрэнгүй",
  "settings.timeline.preset.compact": "Хураангуй",
  "settings.timeline.preset.quiet": "Чимээгүй",
  "settings.timeline.preset.text-only": "Зөвхөн текст",
  "settings.timeline.description.everything":
    "Бүх үйл ажиллагааг тусад нь харуулна. Shell-ийн гаралт, засвар, бодолтыг дэлгэнэ.",
  "settings.timeline.description.detailed":
    "Shell-ийн гаралт ба засварыг дэлгэнэ. Дэд агентуудыг тусад нь харуулж, бусад үйл ажиллагааг «Ашигласан» хэсэгт бүлэглэнэ.",
  "settings.timeline.description.compact":
    "Бүх үйл ажиллагааг дэлгэрэнгүйг нь хураасан байдлаар «Ашигласан» хэсэгт бүлэглэнэ.",
  "settings.timeline.description.quiet":
    "Засвар ба дэд агентуудыг «Ашигласан» хэсэгт бүлэглэнэ. Бусад үйл ажиллагааг нууна.",
  "settings.timeline.description.text-only": "Бүх үйл ажиллагааг нууна. Зөвхөн мессеж харуулна.",
  "settings.timeline.description.custom": "Үйл ажиллагааны ангилал бүрт сонгосон байрлал, дэлгэрэнгүйг ашиглана.",
  "settings.timeline.custom": "Тусгай",
  "settings.timeline.advanced": "Нарийвчилсан",
  "settings.timeline.advanced.description": "Үйл ажиллагааны ангилал бүрийн байрлал ба дэлгэрэнгүйг тохируулна уу.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Засварууд",
  "settings.timeline.category.thinking": "Бодолт",
  "settings.timeline.category.subagents": "Дэд агентууд",
  "settings.timeline.category.notices": "Мэдэгдлүүд",
  "settings.timeline.category.tools": "Бусад хэрэгсэл",
  "settings.general.row.mobileDiffWrap.description": "Мобайл diff дээр урт мөрүүдийг хэвтээ гүйлгэхийн оронд нугалах",
  "provider.connect.error.unsupportedFields": "Энэ баталгаажуулалтын маягтад дэмжигдээгүй талбар байна",
  "session.review.filesChangedCount.one": "{{count}} файл өөрчлөгдсөн",
  "session.review.filesChangedCount.other": "{{count}} файл өөрчлөгдсөн",
  "settings.about.writtenByNames": "Бичсэн: {{names}}",
  "settings.about.illustratedByNames": "Зурагласан: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "{{host}}-т холбогдоогүй байна. Таны ноорог хадгалагдсан; алсын ажил нь үргэлжилж байж магадгүй.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH сервер нэмэх",
  "ssh.server.menu.label": "SSH сервер",
  "ssh.target": "Хост эсвэл SSH команд",
  "ssh.connect": "Холбох",
  "ssh.connectTo": "«{{host}}»-д холбогдох",
  "ssh.authenticate": "SSH баталгаажуулалт",
  "ssh.action.authenticate": "Баталгаажуулах",
  "ssh.session.disconnected": "SSH холболт идэвхгүй",
  "ssh.session.connecting": "SSH серверт холбогдож байна",
  "ssh.session.reconnectDescription":
    "Энэ сессийг үзэж ажилласаар байх үүднээс дахин холбогдоно уу. Таны алсын сессийг хадгалсан байна.",
  "ssh.session.reconnect": "Дахин холбогдох",
  "ssh.authenticationRequired": "{{host}}-д нэвтрэх баталгаажуулалт шаардлагатай",
  "ssh.trust": "Итгэлцэл болон холболт",
  "ssh.continue": "Үргэлжлүүлэх",
  "ssh.retry": "Дахин оролдох",
  "ssh.update": "Шинэчлэх болон дахин холбох",
  "ssh.openProject": "Төслийг нээх",
  "ssh.project": "{{host}} дээр төслийг нээх",
  "ssh.disconnect": "Таслах",
  "ssh.forget": "Холболтыг март",
  "ssh.stage.disconnected": "Холбогдоогүй. Алсын сервер ажиллахад үлдсэн байна.",
  "ssh.stage.connecting": "SSH-р холбож байна…",
  "ssh.stage.checking": "OpenCode-г шалгаж байна…",
  "ssh.stage.downloading": "Сервер татаж байна…",
  "ssh.stage.uploading": "Сервер рүү байршуулах…",
  "ssh.stage.starting": "OpenCode-т холбогдож байна…",
  "ssh.stage.ready": "Холбогдсон",
  "ssh.stage.authentication": "Нэвтрэх хэрэгтэй",
  "ssh.stage.incompatible": "Серверийн шинэчлэл шаардлагатай",
  "ssh.stage.failed": "Холболт амжилтгүй боллоо",
  "ssh.error.input":
    "Хост эсвэл SSH холболтын командыг оруулна уу. Алслагдсан команд болон дэмжигдээгүй SSH сонголтуудыг ашиглахийг зөвшөөрөхгүй.",
  "ssh.error.connection": "SSH холболт тогтоож чадаагүй. Сүлжээ ба SSH тохиргоогоо шалгаарай.",
  "ssh.error.platform":
    "Энэ алсын платформыг дэмждэггүй. Автомат тохиргоо одоогоор x64 эсвэл arm64 дээр Linux эсвэл macOS шаарддаг.",
  "ssh.error.version": "Холбогдохын өмнө алсын үйлчилгээ нь энэ Десктоп хувилбартай нийцсэн байх ёстой.",
  "ssh.error.install": "Алсын серверийг суулгаж чадсангүй. Холболт, дискний зай, tar суусан эсэхийг шалгаарай.",
  "ssh.error.unpublished":
    "Энэ Desktop хувилбар нь нийтлэгдсэн алсын сервергүй байна. Хөгжүүлэлтийн хувилбаруудад V2-г хост дээр суулгаж, эхлүүлээд дахин оролдно уу.",
  "ssh.error.service": "SSH холбогдсон, гэхдээ OpenCode сервер бэлэн болоогүй байна.",
  "ssh.error.host-key":
    "Зочны танилт баталгаажсангүй. SSH-т танигдсан хостыг шинэчлэхээсээ өмнө түүний хурууны хээг баталгаажуулна уу.",
  "ssh.error.ssh-missing": "OpenSSH олдсонгүй. OpenSSH клиент суулгаж, ssh PATH-д байгаа эсэхийг шалгана уу.",
  "command.browser.open": "Браузерээ нээнэ үү",
  "command.browser.reload": "Браузерын хуудасыг дахин ачаалах",
  "command.session.summary.toggle": "Хураангуйг сэлгэх",
  "common.color.orange": "улбар шар",
  "common.color.yellow": "шар",
  "common.color.cyan": "цэнхэр ногоон",
  "common.color.green": "ногоон",
  "common.color.red": "улаан",
  "common.color.pink": "ягаан",
  "common.color.blue": "цэнхэр",
  "common.color.purple": "нил ягаан",
  "common.color.gray": "саарал",
  "mcp.auth.interactiveForm": "MCP сервер {{name}} интерактив баталгаажуулах маягт шаарддаг",
  "server.connect.title": "Серверт холбогдох",
  "server.connect.description": "Эхлэхийн тулд серверийн хаяг ба нууц үгээ оруулна уу.",
  ...
  "dialog.server.menu.remove": "Арилгах",
  "file.error.notFound": "Файл олдсонгүй: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Сешнүүдийг шилжүүлж байна {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Сешнүүдийг шилжүүлж байна {{current}}/{{total}}",
  "toast.migration.progress.working": "Өгөгдлийг шилжүүлж байна",
  "toast.migration.progress.working.current": "Өгөгдлийг шилжүүлж байна {{current}}",
  "toast.migration.progress.working.progress": "Өгөгдлийг шилжүүлж байна {{current}}/{{total}}",
  "home.workspaceTip": "Өөрчлөлтүүдийг тусгаарлахын тулд шинэ ажлын орчинд дараагийн сессийг эхлүүлнэ үү",
  "session.tab.browser": "Хөтөч",
  "session.tab.add": "Шинэ таб нэмэх",
  "session.queue.attachments.one": "Нэмэлт {{count}} хавсралт",
  "session.queue.attachments.other": "Нэмэлт {{count}} хавсралт",
  "session.browser.address": "Хөтчийн хаяг",
  "session.browser.replaced": "Хөтчийн хяналт өөр ширээний цонхны руу шилжсэн.",
  "session.browser.unsupported": "Энэ десктоп апп хөтчийн самбарыг дэмждэггүй.",
  "session.browser.suspended": "Браузер түр зогсоогдлоо. Дахин холбогдохын тулд энэ сесситэй харьцана уу.",
  "session.browser.address.placeholder": "URL оруулах",
  "settings.backToSettings": "Тохиргоонд буцах",
  "settings.backToProjects": "Төслүүд рүү буцах",
  "settings.search.placeholder": "Хайх",
  "settings.search.results": "Тохиргооны үр дүнгүүд",
  "settings.search.group.pages": "Хуудсууд",
  "settings.search.group.settings": "Тохиргоо",
  "settings.search.group.projects": "Төслүүд",
  "settings.search.group.servers": "Серверүүд",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}}-н хувьд үр дүн байхгүй",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Илүү тодорхой үр дүнг харахын тулд хайлтаа нарийсга.",
  "settings.server.description": "Энэ серверийн холболт ба тохиргоог удирдах",
  "settings.server.section.connection": "Холболт",
  "settings.server.preferences.websearch.title": "Гуравдагч талын хайлт",
  "settings.server.preferences.websearch.description":
    "Агентууд вэбийг хайхад ашиглах хайлтын үйлчилгээ үзүүлэгчийг сонгоно уу",
  "settings.projects.search.placeholder": "Төслүүдийг хайх",
  "project.settings.name.title": "Төслийн нэр",
  "project.settings.name.description": "Энэхүү төслийн нэрийг OpenCode-д бүхэлд нь харуулсан",
  "project.settings.icon.description": "Зөвлөж байна: 128×128 пиксел. Зураг оруулахын тулд дарж эсвэл чирнэ үү.",
  "project.settings.color.description": "Өөрчлөн зураг тогтоогоогүй үед төсөлд зориулсан дүрсэнд ашиглана",
  "project.settings.worktree.startup.description": "Шинэ ажлын мод үүсгэсний дараа нэг удаа ажиллана",
  "project.settings.worktree.startup.hint.base": "Үндсэн ажиллах модыг заахын тулд $OPENCODE_WORKTREE_BASE-ийг ашигла.",
  "project.settings.worktree.startup.hint.new": "Шинэ ажиллах модны хувьд $OPENCODE_WORKTREE_PATH-г ашиглана уу.",
  "project.settings.extensions.empty.mcps.title": "Одоогоор MCP байхгүй",
  "project.settings.extensions.empty.mcps.description": "OpenCode-д зориулсан MCP-ууд энд гарч ирнэ",
  "project.settings.extensions.empty.plugins.title": "Одоогоор нэмэлтүүд байхгүй",
  "project.settings.extensions.empty.plugins.description": "OpenCode-д ашиглах боломжтой нэмэлтүүд энд гарч ирнэ",
  "project.settings.extensions.empty.skills.title": "Одоогоор ур чадваргүй",
  "project.settings.extensions.empty.skills.description": "OpenCode-д ашиглах боломжтой ур чадварууд энд гарч ирнэ",
  "project.settings.extensions.lsp.configured": "Тохируулагдсан хэлний серверүүд",
  "project.settings.extensions.lsp.status.enabled": "Тохиргоонд идэвхжүүлсэн",
  "project.settings.extensions.lsp.status.disabled": "Тохиргоонд идэвхгүй болсон",
  "project.settings.extensions.lsp.empty.title": "Хэлний серверүүд тохируулагдаагүй",
  "project.settings.extensions.lsp.empty.description":
    "Энэхүү төслийн хувьд тохируулагдсан хэлний серверүүд энд харагдана",
  "project.settings.extensions.lsp.disabled.title": "Хэлний серверүүдийг идэвхгүй болгов",
  "project.settings.extensions.lsp.disabled.description": "Энэхүү төслийн тохиргоонд LSP идэвхгүй болгогдсон байна",
  "project.settings.extensions.lsp.loadFailed": "Хэлний серверийн тохиргоог ачааллаж чадсангүй",
  "project.settings.extensions.lsp.retry": "Дахин оролдох",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Бүлэг",
  "settings.timeline.collapse": "Нурах",
  "settings.timeline.visibility.show": "Үзүүлэх",
  "settings.timeline.visibility.hide": "Нуух",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} хичээл",
  "settings.workspaces.sessions.filtered.other": "{{count}} хичээл",
  "settings.workspaces.deleteAll.confirm.one": "Энэ нь сонгогдсон {{count}} ажлын модыг байнгын устгана.",
  "settings.workspaces.deleteAll.confirm.other": "Энэ нь сонгогдсон {{count}} ажлын модыг байнга устгана.",
  "settings.workspaces.deleteWithoutSessions": "Сессгүй ажиллах модыг устгах",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Энэ нь холбоосгүй хуралдаангүй {{count}} ажлын модыг байнга устгана.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Энэ нь холбоосгүй хуралдаантай {{count}} ажлын модыг байнга устгана.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Нэгдээгүй өөрчлөлттэй эсвэл идэвхтэй байрлалттай ажиллах модыг хадгална.",
  "settings.workspaces.delete.button": "Ажлын модыг устгах",
  "workspace.lifecycle.deleting": "Устгаж байна…",
  "session.summary.tooltip": "Товчоо",
  "session.summary.server": "Өргөтгөлүүд",
  "session.summary.chooseProject": "Төслийг сонгох",
  "session.summary.mcp.onCreation": "Ажиллаж буй модыг үүсгэсэн үед хэрэглэнэ",
  "session.summary.mcp.prepareFailed": "MCP серверүүдийг бэлтгэж чадсангүй",
  "session.summary.mcp.unavailable": "MCP сервер {{name}} энэ ажлын модод ашиглах боломжгүй байна.",
  "session.summary.mcp.signInBeforeSend": "Санал хүсэлтийг илгээхээс өмнө {{name}} руу нэвтэрнэ үү.",
  "session.summary.mcp.notReady":
    "MCP сервер {{name}} бэлэн биш байна. Санал хүсэлт илгээхээс өмнө түүний холболтыг шийдээрэй.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Тохируулагдсан MCP серверүүд",
  "session.summary.plugins": "Плагинууд",
  "session.summary.plugins.configured": "Тохируулагдсан нэмэлт програмууд",
  "session.summary.skills": "Чадварууд",
  "session.summary.skills.configured": "Тохируулагдсан ур чадварууд",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Амжилтгүй болсон",
  "session.summary.retry": "Дахин оролдох",
  "session.summary.connecting": "Холбож байна…",
  "session.summary.needsAuth": "Нэвтрэх шаардлагатай",
  "session.summary.configure": "Тохиргооны файл",
  "session.summary.copyConfigPath": "Тохиргооны файлын замыг хуулбарлах",
  "session.summary.configFileMissing": "Тохиргооны файл олдсонгүй",
  "session.summary.mcp.empty": "MCP серверүүд тохируулагдаагүй",
  "session.summary.mcp.add": "opencode.json-д серверүүдийг нэмэх",
  "session.summary.plugins.manage": "opencode.json-д залгаасуудыг удирдах",
  "session.summary.plugins.empty": "Плагинууд тохируулагдаагүй",
  "session.summary.plugins.add": "opencode.json-д залгаас нэмэх",
  "session.summary.skills.manage": "opencode.json дахь ур чадварыг удирдах",
  "session.summary.skills.empty": "Шуурхай ур чадвар тохируулагдаагүй",
  "session.summary.skills.add": "opencode.json-д ур чадвар нэмэх",
  "session.summary.lsp.configured": "Тохируулах LSP-ууд",
  "session.summary.lsp.empty": "LSP серверүүд тохируулагдаагүй",
  "session.summary.lsp.manage": "opencode.json дахь LSP-ийг удирдах",
  "workspace.delete.location": "Байршил",
  "command.debugBar.toggle": "Дибагийн мөрийг сэлгэх",
  "command.session.location.cycle": "Сешний байршлыг солих",
  "dialog.provider.anthropic.note": "API түлхүүрээр Claude загваруудад шууд хандах",
  "provider.connect.title.anthropicProMax": "Anthropic-оор нэвтрэх",
  "prompt.toast.uploading.cancel": "Байршуулалтыг цуцлах",
  "prompt.toast.uploading.cancelFile": "{{filename}} файлын байршуулалтыг цуцлах",
  "prompt.toast.uploadFailed.title": "Байршуулж чадсангүй",
  "session.browser.empty.title": "URL оруулна уу",
  "session.browser.empty.description": "Эсвэл “Аппын хөтөч дээр нээ” гэж хүсэлт өгнө үү",
  "session.browser.failed.title": "URL-д хандах боломжгүй",
  "session.browser.failed.description": "URL болон холболтоо шалгаад дахин оролдоно уу.",
  "debugBar.providerAriaLabel": "Үйлчилгээ үзүүлэгчийн гүйцэтгэлийн оношилгоо",
  "debugBar.ttft.tip": "Үйлчилгээ үзүүлэгч рүү хүсэлт илгээснээс загварын эхний гаралт хүртэлх хугацаа.",
  "debugBar.ttfa.tip": "Үйлчилгээ үзүүлэгч рүү хүсэлт илгээснээс хариултын эхний бичвэр хүртэлх хугацаа.",
  "debugBar.tps.tip": "Загварын эхний гаралтын дараах секунд тутмын гаралтын токены тоо.",
  "debugBar.e2e.tip": "Үйлчилгээ үзүүлэгч рүү хүсэлт илгээснээс хариултын урсгал дуусах хүртэлх хугацаа.",
  "settings.updates.action.download": "OpenCode татах",
  "settings.updates.migration.title": "Beta хувилбараас Stable хувилбар руу шилжих",
