export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Birləşdirilməmiş dəyişiklikləri, əlaqəli sessiyaları və ya aktiv məkanları olan iş ağacları saxlanılacaq.",
  ...
  "session.location.unavailable": "Sessiyanın yeri əlçatan deyil",
  "session.location.description": "Bu sessiyanı davam etdirmək üçün başqa qovluq seçin.",
  "session.location.choose": "Qovluq seç",
  "session.location.worktree": "Worktree seç",
  "session.location.worktreesFailed": "Worktree-lər yüklənə bilmədi",
  "session.location.moving": "Sessiya köçürülür…",
  "dialog.server.menu.hide": "Layihə siyahısından gizlət",
  "dialog.server.menu.show": "Layihə siyahısında göstər",
  "session.queue.count.one": "{{count}} növbədədir",
  "session.queue.count.other": "{{count}} növbədədir",
  "session.queue.steer": "İstiqamətləndir",
  "session.queue.send": "Göndər",
  "session.queue.steerTooltip": "Dayandırmadan göndər",
  "session.queue.remove": "Sil",
  "session.queue.reorder": "Növbədəki promptun sırasını dəyiş",
  "session.new.worktree.creating": "Worktree yaradılır",
  "settings.backToApp": "Tətbiqə qayıt",
  "settings.appearance.section.experimental": "Eksperimental",
  "settings.appearance.row.tabs.title": "Tablar",
  "settings.appearance.row.tabs.description": "Sessiya tablarının necə düzüləcəyini seçin",
  "settings.appearance.row.tabs.horizontal": "Üfüqi",
  "settings.appearance.row.tabs.vertical": "Şaquli",
  "settings.general.row.followUpBehavior.title": "Davam mesajlarının davranışı",
  "settings.general.row.followUpBehavior.description":
    "Davam mesajlarını növbəyə əlavə etməyi və ya cari gedişi istiqamətləndirməyi seçin. Dəyişmək üçün {{keybind}} istifadə edin.",
  "settings.general.row.followUpBehavior.queue": "Növbəyə əlavə et",
  "settings.general.row.followUpBehavior.steer": "İstiqamətləndir",
  "settings.general.row.reasoningMode.title": "Modelin düşünməsi",
  "settings.general.row.reasoningMode.description": "Modelin düşünməsinin zaman xəttində necə göstəriləcəyini seçin",
  "settings.general.row.reasoningMode.hidden": "Gizli",
  "settings.general.row.reasoningMode.compact": "Yığcam",
  "settings.general.row.reasoningMode.full": "Tam",
  "session.new.workspace.createFrom": "Buradan yarat",
  "session.new.workspace.branch.search.placeholder": "Branch-ləri axtar",
  "toast.migration.progress.clearingOldEvents": "Köhnə hadisələr təmizlənir",
  "toast.migration.progress.migratingSessions": "Sessiyalar miqrasiya edilir",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "Standart Layihə",
  "home.projects.all": "Bütün layihələr",
  "session.tab.files": "Fayllar",
  "session.files.openTabs": "Açıq fayllar",
  "session.tab.usage": "İstifadə",
  "session.view.select": "Sessiya görünüşü",
  "session.background.moveTasks": "{{tasks}} tapşırıqlarını arxa plana keçir",
  "session.background.moveRunning": "Arxa plana keçir",
  "session.background.inBackground": "{{tasks}} arxa planda işləyir",
  "session.background.tasksRunning.one": "{{count}} arxa plan tapşırığı işləyir",
  "session.background.tasksRunning.other": "{{count}} arxa plan tapşırığı işləyir",
  ...
  "session.websearch.any": "İstənilən",
  "session.websearch.disable": "Axtarışdan istifadə etmə",
  "session.websearch.enable": "Aktivləşdir",
  "session.websearch.loadFailed": "Axtarış provayderlərini yükləmək mümkün olmadı.",
  "session.websearch.empty": "Əlçatan axtarış provayderi yoxdur.",
  "session.websearch.failed": "Seçiminizi saxlamaq mümkün olmadı. Yenidən cəhd edin.",
  "session.websearch.retry": "Yenidən cəhd et",
  "session.new.worktree.draftPlaceholder": "Worktree hazırlanarkən növbəti mesajın qaralamasını yazın…",
  "session.search.placeholder": "Tap...",
  "session.search.noResults": "Uyğun nəticə yoxdur",
  "titlebar.tabs": "Tablar",
  "titlebar.channel.local": "Yerli",
  "titlebar.channel.dev": "Tərtibat",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Sazlama alətlərini göstər/gizlət",
  "settings.tab.experimental": "Eksperimental",
  "settings.experimental.description": "Eksperimental funksiyaları sınayın",
  "settings.tab.about": "Haqqında",
  "settings.about.version": "Versiya {{version}}",
  "settings.about.devVersion": "tərtibat",
  "settings.about.license": "MIT Lisenziyası ilə yayımlanıb",
  "settings.about.writtenBy": "Müəllif",
  "settings.about.illustratedBy": "İllüstrasiyalar",
  "settings.about.and": "və",
  "settings.about.otherContributor.one": "{{count}} digər",
  "settings.about.otherContributor.other": "{{count}} digər",
  "settings.about.firstPublished": "İlk dəfə Missuri, ABŞ-da nəşr olunub",
  "settings.about.firstIllustrated": "İlk dəfə London, İngiltərədə illüstrasiya olunub",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, açıq mənbəli kodlaşdırma agenti",
  "settings.about.trademark": "OpenCode, Anomaly Innovations, Inc. şirkətinin qeydiyyatdan keçmiş ticarət nişanıdır.",
  "settings.about.typeset": "Inter və IBM Plex Mono şriftləri ilə tərtib olunub",
  "settings.about.tagline": "Siz olmadan AI möhtəşəm proqram təminatı yarada bilməz",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "Layihəni redaktə et",
  "settings.timeline.title": "Zaman xətti",
  "settings.timeline.detail": "Zaman xəttinin təfərrüatı",
  "settings.timeline.description": "Zaman xəttində nə qədər fəaliyyət göstəriləcəyini seçin. Mesajlar görünən qalır.",
  "settings.timeline.preset.everything": "Hər şey",
  "settings.timeline.preset.detailed": "Ətraflı",
  "settings.timeline.preset.compact": "Yığcam",
  "settings.timeline.preset.quiet": "Sakit",
  "settings.timeline.preset.text-only": "Yalnız mətn",
  ...
  "settings.timeline.description.custom":
    "Hər fəaliyyət kateqoriyası üçün seçdiyiniz yerləşdirmə və təfərrüatlardan istifadə et.",
  "settings.timeline.custom": "Fərdi",
  "settings.timeline.advanced": "Qabaqcıl",
  "settings.timeline.advanced.description": "Hər fəaliyyət kateqoriyası üçün yerləşdirmə və təfərrüatları təyin edin.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Redaktələr",
  "settings.timeline.category.thinking": "Düşünmə",
  ...
  "session.review.filesChangedCount.one": "{{count}} fayl dəyişdi",
  "session.review.filesChangedCount.other": "{{count}} fayl dəyişdi",
  "settings.about.writtenByNames": "Müəllif: {{names}}",
  "settings.about.illustratedByNames": "İllüstrasiyalar: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "{{host}} ilə qoşulmayıb. Sizin layihə saxlanıldı; uzaq iş hələ də işləyə bilər.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH server əlavə et",
  "ssh.server.menu.label": "SSH server",
  "ssh.target": "Host və ya SSH komandası",
  "ssh.connect": "Qoşul",
  "ssh.connectTo": "{{host}} ilə qoşul",
  "ssh.authenticate": "SSH autentifikasiyası",
  "ssh.action.authenticate": "Autentifikasiya et",
  "ssh.session.disconnected": "SSH bağlantısı aktiv deyil",
  "ssh.session.connecting": "SSH serverinə qoşulur",
  "ssh.session.reconnectDescription":
    "Bu sessiyanı görmək və işləməyə davam etmək üçün yenidən qoşulun. Uzaq sessiyanız qorunur.",
  "ssh.session.reconnect": "Yenidən qoşul",
  "ssh.authenticationRequired": "{{host}} üçün autentifikasiya tələb olunur",
  "ssh.trust": "Etibar et və qoşul",
  "ssh.continue": "Davam et",
  "ssh.retry": "Təkrar cəhd et",
  "ssh.update": "Yenilə və yenidən qoşul",
  "ssh.openProject": "Layihəni aç",
  "ssh.project": "Layihəni {{host}} üzərində aç",
  "ssh.disconnect": "Bağlan",
  "ssh.forget": "Əlaqəni unut",
  "ssh.stage.disconnected": "Bağlantı kəsildi. Uzaq server işləməyə davam edir.",
  "ssh.stage.connecting": "SSH üzərindən qoşulur…",
  "ssh.stage.checking": "OpenCode yoxlanılır…",
  "ssh.stage.downloading": "Server yüklənir…",
  "ssh.stage.uploading": "Server yüklənir…",
  "ssh.stage.starting": "OpenCode-a qoşulur…",
  "ssh.stage.ready": "Qoşuldu",
  "ssh.stage.authentication": "Doğrulama tələb olunur",
  "ssh.stage.incompatible": "Server yeniləməsi tələb olunur",
  "ssh.stage.failed": "Bağlantı uğursuz oldu",
  "ssh.error.input":
    "Bir host və ya SSH bağlantı əmri daxil edin. Uzaq əmrlər və dəstəklənməyən SSH seçimlərinə icazə verilmir.",
  "ssh.error.connection": "SSH bağlantısı qurula bilmədi. Şəbəkə və SSH tənzimləmələrinizi yoxlayın.",
  "ssh.error.platform":
    "Bu uzaq platforma dəstəklənmir. Avtomatik quraşdırma hazırda x64 və ya arm64 üzərində Linux və ya macOS tələb edir.",
  "ssh.error.version": "Bağlantıdan əvvəl uzaq xidmət bu Desktop versiyası ilə uyğun olmalıdır.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH bağlantısı quruldu, lakin OpenCode serveri hazır vəziyyətə gəlmədi.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Brauzeri açın",
  "command.browser.reload": "Brauzer səhifəsini yeniləyin",
  "command.session.summary.toggle": "Xülasəni dəyişdirin",
  "common.color.orange": "narıncı",
  "common.color.yellow": "sarı",
  "common.color.cyan": "firuzəyi",
  "common.color.green": "yaşıl",
  "common.color.red": "qırmızı",
  "common.color.pink": "çəhrayı",
  "common.color.blue": "mavi",
  "common.color.purple": "bənövşəyi",
  "common.color.gray": "boz",
  "mcp.auth.interactiveForm": "MCP server {{name}} interaktiv autentifikasiya forması tələb edir",
  "server.connect.title": "Serverə qoşulun",
  "server.connect.description": "Başlamaq üçün server ünvanınızı və şifrənizi daxil edin.",
  ...
  "server.connect.camera.error":
    "Kameranı aça bilmədi. Kameraya giriş icazəsi verin və ya əlaqə məlumatlarınızı əllə daxil edin.",
  "dialog.server.menu.remove": "Sil",
  "file.error.notFound": "Fayl tapılmadı: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Sessiyalar köçürülür {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Sessiyalar köçürülür {{current}}/{{total}}",
  "toast.migration.progress.working": "Məlumatlar köçürülür",
  "toast.migration.progress.working.current": "Məlumatlar köçürülür {{current}}",
  "toast.migration.progress.working.progress": "Məlumatlar köçürülür {{current}}/{{total}}",
  "home.workspaceTip": "Dəyişiklikləri izolə etmək üçün növbəti sessiyanı yeni iş sahəsində başlayın",
  "session.tab.browser": "Brauzer",
  "session.tab.add": "Tab əlavə et",
  "session.queue.attachments.one": "{{count}} əlavə əlavə et",
  "session.queue.attachments.other": "{{count}} əlavə əlavələr əlavə et",
  "session.browser.address": "Brauzer ünvanı",
  "session.browser.replaced": "Brauzer idarəsi başqa masaüstü pəncərəsinə köçürüldü.",
  "session.browser.unsupported": "Bu masaüstü tətbiq brauzer panelini dəstəkləmir.",
  "session.browser.suspended": "Brauzer dayandırıldı. Təkrar qoşulmaq üçün bu sessiya ilə qarşılıqlı əlaqə qurun.",
  "session.browser.address.placeholder": "URL daxil edin",
  "settings.backToSettings": "Parametrlərə qayıt",
  "settings.backToProjects": "Layihələrə qayıt",
  "settings.search.placeholder": "Axtarış",
  "settings.search.results": "Parametrlər nəticələri",
  "settings.search.group.pages": "Səhifələr",
  "settings.search.group.settings": "Parametrlər",
  "settings.search.group.projects": "Layihələr",
  "settings.search.group.servers": "Serverlər",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}} üçün nəticə yoxdur",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Daha spesifik nəticələr görmək üçün axtarışınızı daraldın.",
  "settings.server.description": "Bu serverin əlaqəsini və seçimlərini idarə edin",
  "settings.server.section.connection": "Əlaqə",
  "settings.server.preferences.websearch.title": "Üçüncü tərəf axtarışı",
  "settings.server.preferences.websearch.description":
    "Agentlərin vebi axtarmaq üçün istifadə etdiyi axtarış təminatçısını seçin",
  "settings.projects.search.placeholder": "Layihələri axtarın",
  "project.settings.name.title": "Layihə adı",
  "project.settings.name.description": "Bu layihə üçün OpenCode boyunca göstərilən ad",
  "project.settings.icon.description": "Tövsiyə olunur: 128×128px. Şəkil yükləmək üçün klikləyin və ya sürükləyin.",
  "project.settings.color.description": "Özəl şəkil təyin olunmadıqda layihə ikonunda istifadə olunur",
  "project.settings.worktree.startup.description": "Yeni iş ağacı yaradıldıqdan sonra bir dəfə işləyir",
  "project.settings.worktree.startup.hint.base": "Əsas iş ağacı üçün $OPENCODE_WORKTREE_BASE istifadə edin.",
  "project.settings.worktree.startup.hint.new": "Yeni iş ağacı üçün $OPENCODE_WORKTREE_PATH istifadə edin.",
  "project.settings.extensions.empty.mcps.title": "Hələ MCP yoxdur",
  "project.settings.extensions.empty.mcps.description": "OpenCode üçün mövcud MCP-lər burada görünəcək",
  "project.settings.extensions.empty.plugins.title": "Hələ plagin yoxdur",
  "project.settings.extensions.empty.plugins.description": "OpenCode üçün mövcud plaginlər burada görünəcək",
  "project.settings.extensions.empty.skills.title": "Hələ bacarıq yoxdur",
  "project.settings.extensions.empty.skills.description": "OpenCode üçün mövcud bacarıqlar burada görünəcək",
  "project.settings.extensions.lsp.configured": "Konfiqurasiya edilmiş dil serverləri",
  "project.settings.extensions.lsp.status.enabled": "Konfiqurasiyada aktivdir",
  "project.settings.extensions.lsp.status.disabled": "Konfiqurasiyada deaktivdir",
  "project.settings.extensions.lsp.empty.title": "Hələ dil serverləri konfiqurasiya olunmayıb",
  "project.settings.extensions.lsp.empty.description":
    "Bu layihə üçün konfiqurasiya edilmiş dil serverləri burada görünəcək",
  "project.settings.extensions.lsp.disabled.title": "Dil serverləri deaktivdir",
  "project.settings.extensions.lsp.disabled.description": "LSP bu layihənin konfiqurasiyasında deaktiv edilmişdir",
  "project.settings.extensions.lsp.loadFailed": "Dil serverinin konfiqurasiyasını yükləmək mümkün olmadı",
  "project.settings.extensions.lsp.retry": "Yenidən cəhd et",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Qrup",
  "settings.timeline.collapse": "Yığı",
  "settings.timeline.visibility.show": "Göstər",
  "settings.timeline.visibility.hide": "Gizlət",
  "settings.timeline.visibility.label": "{{activity}} görünüşü",
  "settings.timeline.grouped.label": "{{activity}} qruplaşdırılmış",
  "settings.timeline.collapsed.label": "{{activity}} çöktü",
  "session.new.workspace.search.empty": "Uyğun iş ağacları yoxdur",
  "settings.workspaces.description": "İş ağaclarını nəzərdən keçirin və disk istifadəsini idarə edin",
  "settings.workspaces.empty.description": "OpenCode-da yaradılan iş ağacları burada görünəcək",
  "settings.workspaces.sessions.filtered.one": "{{count}} sessiya",
  "settings.workspaces.sessions.filtered.other": "{{count}} sessiyalar",
  "settings.workspaces.deleteAll.confirm.one": "Bu, seçilmiş {{count}} iş ağacını daimi olaraq siləcək.",
  "settings.workspaces.deleteAll.confirm.other": "Bu, seçilmiş {{count}} iş ağaclarını daimi olaraq siləcək.",
  "settings.workspaces.deleteWithoutSessions": "Sessiyasız iş ağaclarını silmək",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Bu, {{count}} sessiya ilə əlaqəsi olmayan iş ağacını daimi olaraq siləcək.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Bu, {{count}} sessiya ilə əlaqəsi olmayan iş ağaclarını daimi olaraq siləcək.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Birləşdirilməmiş dəyişiklikləri və ya aktiv yerləri olan iş ağacları saxlanılacaq.",
  "settings.workspaces.delete.button": "İş ağaclarını silmək",
  "workspace.lifecycle.deleting": "Silinir…",
  "session.summary.tooltip": "Xülasə",
  "session.summary.server": "Genişlənmələr",
  "session.summary.chooseProject": "Layihə seçin",
  "session.summary.mcp.onCreation": "İş ağacı yaradıldıqda tətbiq olunur",
  "session.summary.mcp.prepareFailed": "MCP serverlərini hazırlamaq mümkün olmadı",
  "session.summary.mcp.unavailable": "MCP serveri {{name}} bu iş ağacında mövcud deyil.",
  "session.summary.mcp.signInBeforeSend": "Promtu göndərmədən əvvəl {{name}} hesabınıza daxil olun.",
  "session.summary.mcp.notReady":
    "MCP serveri {{name}} hazır deyil. Promtu göndərmədən əvvəl onun bağlantısını həll edin.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfiqurasiya edilmiş MCP serverləri",
  "session.summary.plugins": "Pluginlər",
  "session.summary.plugins.configured": "Konfiqurasiya edilmiş pluginlər",
  "session.summary.skills": "Bacarıqlar",
  "session.summary.skills.configured": "Konfiqurasiya edilmiş bacarıqlar",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Uğursuz oldu",
  "session.summary.retry": "Təkrar cəhd et",
  "session.summary.connecting": "Qoşulur…",
  "session.summary.needsAuth": "Giriş tələb olunur",
  "session.summary.configure": "Konfiqurasiya faylı",
  "session.summary.copyConfigPath": "Konfiqurasiya faylı yolunu kopyala",
  "session.summary.configFileMissing": "Konfiqurasiya faylı tapılmadı",
  "session.summary.mcp.empty": "MCP serverləri konfiqurasiya edilməyib",
  "session.summary.mcp.add": "opencode.json faylında serverləri əlavə et",
  "session.summary.plugins.manage": "opencode.json-da plaginləri idarə et",
  "session.summary.plugins.empty": "Heç bir plagin qurulmayıb",
  "session.summary.plugins.add": "opencode.json-da plagin əlavə et",
  "session.summary.skills.manage": "opencode.json-da bacarıqları idarə et",
  "session.summary.skills.empty": "Heç bir bacarıq qurulmayıb",
  "session.summary.skills.add": "opencode.json-da bacarıq əlavə et",
  "session.summary.lsp.configured": "Qurulmuş LSP-lər",
  "session.summary.lsp.empty": "Heç bir LSP serveri qurulmayıb",
  "session.summary.lsp.manage": "opencode.json-da LSP-ni idarə et",
  "workspace.delete.location": "Yer",
  "command.debugBar.toggle": "Sazlama panelini göstər/gizlət",
  "command.session.location.cycle": "Sessiyanın yerini dəyiş",
  "dialog.provider.anthropic.note": "API açarı ilə Claude modellərinə birbaşa giriş",
  "provider.connect.title.anthropicProMax": "Anthropic ilə daxil olun",
  "prompt.toast.uploading.cancel": "Yükləməni ləğv et",
  "prompt.toast.uploading.cancelFile": "{{filename}} faylının yüklənməsini ləğv et",
  "prompt.toast.uploadFailed.title": "Yükləmə alınmadı",
  "session.browser.empty.title": "URL daxil edin",
  "session.browser.empty.description": "Və ya “Tətbiq brauzerində aç” sorğusunu göndərin",
  "session.browser.failed.title": "URL əlçatan deyil",
  "session.browser.failed.description": "URL-i və bağlantınızı yoxlayın, sonra yenidən cəhd edin.",
  "debugBar.providerAriaLabel": "Provayder performansının diaqnostikası",
  "debugBar.ttft.tip": "Provayder sorğusunun göndərilməsindən modelin ilk çıxışına qədər olan vaxt.",
  "debugBar.ttfa.tip": "Provayder sorğusunun göndərilməsindən cavabın ilk mətninə qədər olan vaxt.",
  "debugBar.tps.tip": "Modelin ilk çıxışından sonra saniyədə çıxış tokenlərinin sayı.",
  "debugBar.e2e.tip": "Provayder sorğusunun göndərilməsindən cavab axınının bitməsinə qədər olan vaxt.",
  "settings.updates.action.download": "OpenCode-u endir",
  "settings.updates.migration.title": "Beta-dan Stable-a keçin",
