export const dict = {
  ...
  "settings.workspaces.deleteAll.warning": "ያልተዋሃዱ ለውጦች፣ የተገናኙ ክፍለ ጊዜዎች ወይም ንቁ አካባቢዎች ያሏቸው የሥራ ዛፎች ይቀመጣሉ።",
  ...
  "session.location.unavailable": "የክፍለ ጊዜው ቦታ አይገኝም",
  "session.location.description": "ይህን ክፍለ ጊዜ ለመቀጠል ሌላ ማውጫ ይምረጡ።",
  "session.location.choose": "ማውጫ ይምረጡ",
  "session.location.worktree": "worktree ይምረጡ",
  "session.location.worktreesFailed": "worktree-ዎችን መጫን አልተሳካም",
  "session.location.moving": "ክፍለ ጊዜው እየተንቀሳቀሰ ነው…",
  "dialog.server.menu.hide": "ከፕሮጀክት ዝርዝር ደብቅ",
  "dialog.server.menu.show": "በፕሮጀክት ዝርዝር ውስጥ አሳይ",
  "session.queue.count.one": "{{count}} ወረፋ ላይ",
  "session.queue.count.other": "{{count}} ወረፋ ላይ",
  "session.queue.steer": "አቅጣጫ ስጥ",
  "session.queue.send": "ላክ",
  "session.queue.steerTooltip": "ሳያቋርጡ ይላኩ",
  "session.queue.remove": "አስወግድ",
  "session.queue.reorder": "ወረፋ ላይ ያለውን ፕሮምፕት እንደገና ደርድር",
  "session.new.worktree.creating": "worktree በመፍጠር ላይ",
  "settings.backToApp": "ወደ መተግበሪያው ተመለስ",
  "settings.appearance.section.experimental": "ሙከራዊ",
  "settings.appearance.row.tabs.title": "ትሮች",
  "settings.appearance.row.tabs.description": "የክፍለ ጊዜ ትሮች እንዴት እንደሚደረደሩ ይምረጡ",
  "settings.appearance.row.tabs.horizontal": "አግድም",
  "settings.appearance.row.tabs.vertical": "ቁመታዊ",
  "settings.general.row.followUpBehavior.title": "የተከታይ መልዕክት ባህሪ",
  "settings.general.row.followUpBehavior.description":
    "ተከታይ መልዕክቶችን ወረፋ ላይ ለማስቀመጥ ወይም የአሁኑን ዙር ለመምራት ይምረጡ። ለመቀየር {{keybind}} ይጠቀሙ።",
  "settings.general.row.followUpBehavior.queue": "ወረፋ",
  "settings.general.row.followUpBehavior.steer": "አቅጣጫ ስጥ",
  "settings.general.row.reasoningMode.title": "የሞዴል ማመዛዘን",
  "settings.general.row.reasoningMode.description": "የሞዴሉ ማመዛዘን በጊዜ መስመሩ ላይ እንዴት እንደሚታይ ይምረጡ",
  "settings.general.row.reasoningMode.hidden": "የተደበቀ",
  "settings.general.row.reasoningMode.compact": "የታመቀ",
  "settings.general.row.reasoningMode.full": "ሙሉ",
  "session.new.workspace.createFrom": "ከዚህ ፍጠር",
  "session.new.workspace.branch.search.placeholder": "ቅርንጫፎችን ፈልግ",
  "toast.migration.progress.clearingOldEvents": "የቆዩ ክስተቶችን በማጽዳት ላይ",
  "toast.migration.progress.migratingSessions": "ክፍለ ጊዜዎችን በማዛወር ላይ",
  "session.new.workspace.existingLabel": "Git worktree",
  "desktop.onboarding.defaultProject": "ነባሪ ፕሮጀክት",
  "home.projects.all": "ሁሉም ፕሮጀክቶች",
  "session.tab.files": "ፋይሎች",
  "session.files.openTabs": "ክፍት ፋይሎች",
  "session.tab.usage": "አጠቃቀም",
  "session.view.select": "የክፍለ ጊዜ እይታ",
  "session.background.moveTasks": "{{tasks}}ን ወደ ዳራ አንቀሳቅስ",
  "session.background.moveRunning": "ወደ ዳራ አንቀሳቅስ",
  "session.background.inBackground": "{{tasks}} በዳራ እየሰሩ ነው",
  "session.background.tasksRunning.one": "{{count}} የዳራ ተግባር እየሰራ ነው",
  "session.background.tasksRunning.other": "{{count}} የዳራ ተግባራት እየሰሩ ናቸው",
  "session.background.combine": "{{first}} እና {{second}}",
  "session.background.shell.one": "{{count}} shell",
  "session.background.shell.other": "{{count}} shell-ዎች",
  "session.background.subagent.one": "{{count}} ንዑስ ወኪል",
  "session.background.subagent.other": "{{count}} ንዑስ ወኪሎች",
  "session.timeline.working": "በመስራት ላይ",
  "session.review.wrapLines": "መስመሮችን አጠፍ",
  "session.websearch.title": "የሶስተኛ ወገን ድር ፍለጋ",
  "session.websearch.description": "ወኪሎች ድሩን ለመፈለግ የሚጠቀሙበትን የፍለጋ አቅራቢ ይምረጡ",
  "session.websearch.provider": "የፍለጋ አቅራቢ",
  "session.websearch.any": "ማንኛውም",
  "session.websearch.disable": "ፍለጋን አትጠቀም",
  "session.websearch.enable": "አንቃ",
  "session.websearch.loadFailed": "የፍለጋ አቅራቢዎችን መጫን አልተቻለም።",
  "session.websearch.empty": "ምንም የፍለጋ አቅራቢ የለም።",
  "session.websearch.failed": "ምርጫዎን ማስቀመጥ አልተቻለም። እንደገና ይሞክሩ።",
  "session.websearch.retry": "እንደገና ሞክር",
  "session.new.worktree.draftPlaceholder": "worktree እየተዘጋጀ ሳለ ተከታይ መልዕክት ያርቅቁ…",
  "session.search.placeholder": "ፈልግ...",
  "session.search.noResults": "ምንም ተዛማጅ የለም",
  "titlebar.tabs": "ትሮች",
  "titlebar.channel.local": "አካባቢያዊ",
  "titlebar.channel.dev": "ልማት",
  "titlebar.channel.beta": "ቤታ",
  "titlebar.toggleDebugTools": "የማረሚያ መሳሪያዎችን ቀይር",
  "settings.tab.experimental": "ሙከራዊ",
  "settings.experimental.description": "ሙከራዊ ባህሪያትን ይሞክሩ",
  "settings.tab.about": "ስለ",
  "settings.about.version": "ስሪት {{version}}",
  "settings.about.devVersion": "ልማት",
  "settings.about.license": "በMIT ፈቃድ የተለቀቀ",
  "settings.about.writtenBy": "የተጻፈው በ",
  "settings.about.illustratedBy": "ምስሎች በ",
  "settings.about.and": "እና",
  "settings.about.otherContributor.one": "{{count}} ሌላ",
  "settings.about.otherContributor.other": "{{count}} ሌሎች",
  "settings.about.firstPublished": "መጀመሪያ የታተመው በሚዙሪ፣ አሜሪካ",
  "settings.about.firstIllustrated": "መጀመሪያ ምስል የተሰራለት በለንደን፣ እንግሊዝ",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode፣ ክፍት ምንጭ የኮድ ወኪል",
  "settings.about.trademark": "OpenCode የAnomaly Innovations, Inc. የተመዘገበ የንግድ ምልክት ነው።",
  "settings.about.typeset": "በInter እና IBM Plex Mono ተሰድሯል",
  "settings.about.tagline": "ያለ እርስዎ AI ምርጥ ሶፍትዌር መገንባት አይችልም",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "ፕሮጀክት አርትዕ",
  "settings.timeline.title": "የጊዜ መስመር",
  "settings.timeline.detail": "የጊዜ መስመር ዝርዝር",
  "settings.timeline.description": "በጊዜ መስመሩ ላይ ምን ያህል እንቅስቃሴ እንደሚታይ ይምረጡ። መልዕክቶች ይታያሉ።",
  "settings.timeline.preset.everything": "ሁሉም ነገር",
  "settings.timeline.preset.detailed": "ዝርዝር",
  "settings.timeline.preset.compact": "የታመቀ",
  "settings.timeline.preset.quiet": "ጸጥ ያለ",
  "settings.timeline.preset.text-only": "ጽሑፍ ብቻ",
  ...
  "settings.timeline.custom": "ብጁ",
  "settings.timeline.advanced": "የላቀ",
  "settings.timeline.advanced.description": "ለእያንዳንዱ የእንቅስቃሴ ምድብ አቀማመጥ እና ዝርዝር ያዘጋጁ።",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "አርትዖቶች",
  "settings.timeline.category.thinking": "ማሰብ",
  "settings.timeline.category.subagents": "ንዑስ ወኪሎች",
  "settings.timeline.category.notices": "ማሳወቂያዎች",
  "settings.timeline.category.tools": "ሌሎች መሳሪያዎች",
  "settings.general.row.mobileDiffWrap.description": "በአግድም ከማሸብለል ይልቅ በሞባይል diff ውስጥ ረጅም መስመሮችን አጠፍ",
  "provider.connect.error.unsupportedFields": "ይህ የማረጋገጫ ቅጽ የማይደገፉ መስኮችን ይዟል",
  "session.review.filesChangedCount.one": "{{count}} ፋይል ተቀይሯል",
  "session.review.filesChangedCount.other": "{{count}} ፋይሎች ተቀይረዋል",
  "settings.about.writtenByNames": "የተጻፈው በ{{names}}",
  "settings.about.illustratedByNames": "ምስሎች በ{{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "ከ{{host}} ጋር አልተገናኘም። ረቂቅዎ ተጠብቆ ይቆያል; የርቀት ስራ አሁንም እየሰራ ሊሆን ይችላል።",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "የSSH አገልጋይ ያክሉ",
  "ssh.server.menu.label": "SSH አገልጋይ",
  "ssh.target": "አስተናጋጅ ወይም የSSH ትዕዛዝ",
  "ssh.connect": "መገናኘት",
  "ssh.connectTo": "ከ{{host}} ጋር ይገናኙ",
  "ssh.authenticate": "SSH ማረጋገጫ",
  "ssh.action.authenticate": "ያረጋግጡ",
  "ssh.session.disconnected": "SSH ግንኙነት የቦዘነ",
  "ssh.session.connecting": "ከSSH አገልጋይ ጋር በመገናኘት ላይ",
  "ssh.session.reconnectDescription": "ይህን ክፍለ ጊዜ ለማየትና ሥራዎን ለመቀጠል እንደገና ይገናኙ። የርቀት ክፍለ ጊዜዎ ተጠብቆ ይቆያል።",
  "ssh.session.reconnect": "እንደገና ይገናኙ",
  "ssh.authenticationRequired": "ለ{{host}} ማረጋገጫ ያስፈልጋል",
  "ssh.trust": "ይመኑ እና ይገናኙ",
  "ssh.continue": "ቀጥል",
  "ssh.retry": "እንደገና ሞክር",
  "ssh.update": "ያዘምኑ እና እንደገና ያገናኙ",
  "ssh.openProject": "ክፍት ፕሮጀክት",
  "ssh.project": "በ{{host}} ላይ ፕሮጀክት ክፈት",
  "ssh.disconnect": "ግንኙነት አቋርጥ",
  "ssh.forget": "ግንኙነትን እርሳ",
  "ssh.stage.disconnected": "ግንኙነቱ ተቋርጧል። የርቀት አገልጋዩ እየሰራ ነው።",
  "ssh.stage.connecting": "በSSH በመገናኘት ላይ...",
  "ssh.stage.checking": "የOpenCode በመፈተሽ ላይ...",
  "ssh.stage.downloading": "አገልጋይ በማውረድ ላይ...",
  "ssh.stage.uploading": "አገልጋይን በመጫን ላይ...",
  "ssh.stage.starting": "ከOpenCode ጋር በመገናኘት ላይ...",
  "ssh.stage.ready": "ተገናኝቷል",
  "ssh.stage.authentication": "ማረጋገጫ ያስፈልጋል",
  "ssh.stage.incompatible": "የአገልጋይ ዝመና ያስፈልጋል",
  "ssh.stage.failed": "ግንኙነት አልተሳካም",
  "ssh.error.input": "የአስተናጋጅ ወይም የSSH ግንኙነት ትዕዛዝ ያስገቡ። የርቀት ትዕዛዞች እና የማይደገፉ የSSH አማራጮች አይፈቀዱም።",
  "ssh.error.connection": "የSSH ግንኙነት መመስረት አልተቻለም። የእርስዎን አውታረ መረብ እና የSSH ውቅር ያረጋግጡ።",
  "ssh.error.platform": "ይህ የርቀት መድረክ አይደገፍም። ራስ-ሰር ማዋቀር በአሁኑ ጊዜ Linux ወይም macOS በ x64 ወይም arm64 ያስፈልገዋል።",
  "ssh.error.version": "ከመገናኘትዎ በፊት የርቀት አገልግሎቱ ከዚህ የዴስክቶፕ ስሪት ጋር መዛመድ አለበት።",
  "ssh.error.install": "የርቀት አገልጋዩን መጫን አልተቻለም። ግንኙነትን፣ የዲስክ ቦታን ያረጋግጡ እና ያ ሬንጅ መጫኑን ያረጋግጡ።",
  "ssh.error.unpublished":
    "ይህ የዴስክቶፕ ስሪት የታተመ የርቀት አገልጋይ የለውም። ለልማት ግንባታዎች በአስተናጋጁ ላይ V2 ን ይጫኑ እና ያስጀምሩ እና ከዚያ እንደገና ይሞክሩ።",
  "ssh.error.service": "SSH ተገናኝቷል፣ ነገር ግን የOpenCode አገልጋዩ ዝግጁ አልሆነም።",
  "ssh.error.host-key": "የአስተናጋጁ ማንነት ሊረጋገጥ አልቻለም። የSSH የታወቁ አስተናጋጆችዎን ከማዘመንዎ በፊት የጣት አሻራውን ያረጋግጡ።",
  "ssh.error.ssh-missing": "OpenSSH አልተገኘም። የOpenSSH ደንበኛን ይጫኑ እና ssh በPATH ላይ መገኘቱን ያረጋግጡ።",
  "command.browser.open": "አሳሽ ክፈት",
  "command.browser.reload": "የአሳሽ ገጽን እንደገና ጫን",
  "command.session.summary.toggle": "ማጠቃለያ ቀያይር",
  "common.color.orange": "ብርቱካናማ",
  "common.color.yellow": "ቢጫ",
  "common.color.cyan": "ሳይያን",
  "common.color.green": "አረንጓዴ",
  "common.color.red": "ቀይ",
  "common.color.pink": "ሮዝ",
  "common.color.blue": "ሰማያዊ",
  "common.color.purple": "ሐምራዊ",
  "common.color.gray": "ግራጫ",
  "mcp.auth.interactiveForm": "MCP አገልጋይ {{name}} በይነተገናኝ የማረጋገጫ ቅጽ ያስፈልገዋል",
  "server.connect.title": "ከአገልጋይ ጋር ይገናኙ",
  "server.connect.description": "ለመጀመር የአገልጋይ አድራሻዎን እና የይለፍ ቃልዎን ያስገቡ።",
  "server.connect.button": "መገናኘት",
  "server.connect.address.invalid": "የሚሰራ የኤችቲቲፒ ወይም የኤችቲቲፒኤስ አገልጋይ አድራሻ ያስገቡ።",
  "server.connect.failed": "መገናኘት አልተቻለም። የአገልጋዩን አድራሻ እና የይለፍ ቃል ያረጋግጡ እና ከዚያ እንደገና ይሞክሩ።",
  "server.connect.pair.description": "የግንኙነት ዝርዝሮችዎን ለማግኘት ይህንን ትዕዛዝ በኮምፒተርዎ ላይ ያሂዱ።",
  "server.connect.scan": "QR ኮድ ይቃኙ",
  "server.connect.scan.description": "ካሜራዎን opencode pair ወደሚያሳየው QR ኮድ ያነጣጥሩ።",
  "server.connect.scan.invalid": "ይህ የOpenCode ማጣመሪያ ኮድ አይደለም። opencode pair የሚያሳየውን ኮድ ይቃኙ።",
  "server.connect.camera": "ማጣመር ካሜራ",
  "server.connect.camera.starting": "ካሜራ በመክፈት ላይ...",
  "server.connect.mixedContent": "ከዚህ ኤችቲቲፒኤስ አገልጋይ ጋር ከኤችቲቲፒኤስ ገጽ ጋር መገናኘት አልተቻለም። በምትኩ የኤችቲቲፒኤስ አገልጋይ አድራሻ ይጠቀሙ።",
  "server.connect.camera.insecure": "QR ቅኝት ይህንን ገጽ በኤችቲቲፒኤስ ወይም በአካባቢያዊ አስተናጋጅ መክፈት ይጠይቃል።",
  "server.connect.camera.unavailable": "ለዚህ አሳሽ ምንም ካሜራ አይገኝም። የግንኙነት ዝርዝሮችዎን እራስዎ ያስገቡ።",
  "server.connect.camera.error": "ካሜራውን መክፈት አልተቻለም። የካሜራ መዳረሻ ይፍቀዱ ወይም የግንኙነት ዝርዝሮችዎን እራስዎ ያስገቡ።",
  "dialog.server.menu.remove": "አስወግድ",
  "file.error.notFound": "ፋይል አልተገኘም {{name}}",
  "toast.migration.progress.migratingSessions.current": "ክፍለ ጊዜዎችን በማዛወር ላይ {{current}}",
  "toast.migration.progress.migratingSessions.progress": "ክፍለ ጊዜዎችን በማዛወር ላይ {{current}}/{{total}}",
  "toast.migration.progress.working": "ውሂብ በማዛወር ላይ",
  "toast.migration.progress.working.current": "ውሂብ በማዛወር ላይ {{current}}",
  "toast.migration.progress.working.progress": "ውሂብ በማዛወር ላይ {{current}}/{{total}}",
  "home.workspaceTip": "ለውጦችን ለብለል ለማቆየት ቀጣዩን ክፍለ ጊዜ በአዲስ የስራ ቦታ ይጀምሩ",
  "session.tab.browser": "አሳሽ",
  "session.tab.add": "ትር አክል",
  "session.queue.attachments.one": "ፕላስ {{count}} አባሪ",
  "session.queue.attachments.other": "ፕላስ {{count}} አባሪዎች",
  "session.browser.address": "የአሳሽ አድራሻ",
  "session.browser.replaced": "የአሳሽ መቆጣጠሪያ ወደ ሌላ የዴስክቶፕ መስኮት ተንቀሳቅሷል።",
  "session.browser.unsupported": "ይህ የዴስክቶፕ መተግበሪያ የአሳሽ ፓነሉን አይደግፍም።",
  "session.browser.suspended": "አሳሽ ታግዷል። እንደገና ለመገናኘት ከዚህ ክፍለ ጊዜ ጋር ይገናኙ።",
  "session.browser.address.placeholder": "URL ያስገቡ",
  "settings.backToSettings": "ወደ ቅንብሮች ተመለስ",
  "settings.backToProjects": "ወደ ፕሮጀክቶች ተመለስ",
  "settings.search.placeholder": "ፍለጋ",
  "settings.search.results": "ቅንብሮች ውጤቶች",
  "settings.search.group.pages": "ገጾች",
  "settings.search.group.settings": "ቅንብሮች",
  "settings.search.group.projects": "ፕሮጀክቶች",
  "settings.search.group.servers": "አገልጋዮች",
  "settings.search.result": "{{title}}፣ {{scope}}፣ {{page}}",
  "settings.search.page": "{{title}}፣ {{scope}}",
  "settings.search.result.unscoped": "{{title}}፣ {{page}}",
  "settings.search.empty": "ለ{{query}} ምንም ውጤት የለም",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "የበለጠ የተወሰኑ ውጤቶችን ለማየት ፍለጋዎን ያጥቡ።",
  "settings.server.description": "የዚህን አገልጋይ ግንኙነት እና ምርጫዎች ያስተዳድሩ",
  "settings.server.section.connection": "ግንኙነት",
  "settings.server.preferences.websearch.title": "የሶስተኛ ወገን ፍለጋ",
  "settings.server.preferences.websearch.description": "ድሩን ለመፈለግ ወኪሎች የሚጠቀሙበትን የፍለጋ አቅራቢ ይምረጡ",
  "settings.projects.search.placeholder": "ፍለጋ ፕሮጀክቶች",
  "project.settings.name.title": "የፕሮጀክት ስም",
  "project.settings.name.description": "በመላው OpenCode ውስጥ ለዚህ ፕሮጀክት የሚታየው ስም",
  "project.settings.icon.description": "የሚመከር 128×128 ፒክስል. ምስል ለመስቀል ጠቅ ያድርጉ ወይም ይጎትቱ።",
  "project.settings.color.description": "ምንም ብጁ ምስል በማይዘጋጅበት ጊዜ ለፕሮጀክት አዶ ጥቅም ላይ ይውላል",
  "project.settings.worktree.startup.description": "አዲስ የስራ ዛፍ ከፈጠረ በኋላ አንድ ጊዜ ይሰራል",
  "project.settings.worktree.startup.hint.base": "$OPENCODE_WORKTREE_BASE ለ መሰረታዊ የስራ ዛፍ ይጠቀሙ።",
  "project.settings.worktree.startup.hint.new": "ለአዲሱ የስራ ዛፍ $OPENCODE_WORKTREE_PATH ይጠቀሙ።",
  "project.settings.extensions.empty.mcps.title": "እስካሁን ምንም MCPs የሉም\nለOpenCode የሚገኙ",
  "project.settings.extensions.empty.mcps.description": "ለOpenCode የሚገኙ MCP-ዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.plugins.title": "እስካሁን ምንም ተሰኪዎች የሉም\nለOpenCode የሚገኙ",
  "project.settings.extensions.empty.plugins.description": "ለOpenCode የሚገኙ ተሰኪዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.skills.title": "እስካሁን ምንም ችሎታ የለም\nለOpenCode የሚገኙ",
  "project.settings.extensions.empty.skills.description": "ለOpenCode የሚገኙ ክህሎቶች እዚህ ይታያሉ",
  "project.settings.extensions.lsp.configured": "የተዋቀሩ የቋንቋ አገልጋዮች",
  "project.settings.extensions.lsp.status.enabled": "በማዋቀር ውስጥ ነቅቷል",
  "project.settings.extensions.lsp.status.disabled": "በማዋቀር ውስጥ ተሰናክሏል",
  "project.settings.extensions.lsp.empty.title": "ምንም የቋንቋ አገልጋዮች አልተዋቀሩም\nለዚህ ፕሮጀክት የተዋቀሩ",
  "project.settings.extensions.lsp.empty.description": "የቋንቋ አገልጋዮች እዚህ ይታያሉ",
  "project.settings.extensions.lsp.disabled.title": "ቋንቋ አገልጋዮች ተሰናክለዋል",
  "project.settings.extensions.lsp.disabled.description": "LSP በዚህ ፕሮጀክት ውቅር ውስጥ ተሰናክሏል",
  "project.settings.extensions.lsp.loadFailed": "የቋንቋ አገልጋይ ውቅር መጫን አልተቻለም",
  "project.settings.extensions.lsp.retry": "እንደገና ሞክር",
  "settings.timeline.summary": "{{preset}}",
  "settings.timeline.group": "ቡድን",
  "settings.timeline.collapse": "ውድቅ",
  "settings.timeline.visibility.show": "አሳይ",
  "settings.timeline.visibility.hide": "ደብቅ",
  "settings.timeline.visibility.label": "{{activity}} ታይነት",
  "settings.timeline.grouped.label": "{{activity}} ተቧቧል",
  "settings.timeline.collapsed.label": "{{activity}} ወድቋል",
  "session.new.workspace.search.empty": "ምንም ተዛማጅ የስራ ዛፎች የሉም",
  "settings.workspaces.description": "የስራ ዛፎችን ይገምግሙ እና የዲስክ አጠቃቀምን ያስተዳድሩ",
  "settings.workspaces.empty.description": "በOpenCode የተፈጠሩ የሥራ ዛፎች እዚህ ይታያሉ",
  "settings.workspaces.sessions.filtered.one": "{{count}} ክፍለ ጊዜ",
  "settings.workspaces.sessions.filtered.other": "{{count}} ክፍለ ጊዜዎች",
  "settings.workspaces.deleteAll.confirm.one": "ይህ የተመረጠውን የስራ ዛፍ {{count}} በቋሚነት ይሰርዛል።",
  "settings.workspaces.deleteAll.confirm.other": "ይህ {{count}} የተመረጡ የስራ ዛፎችን በቋሚነት ይሰርዛል።",
  "settings.workspaces.deleteWithoutSessions": "ያለ ክፍለ ጊዜዎች የስራ ዛፎችን ሰርዝ",
  "settings.workspaces.deleteWithoutSessions.confirm.one": "ይህ ያለ ተገናኙ ክፍለ ጊዜዎች {{count}} worktreeን በቋሚነት ይሰርዛል።",
  "settings.workspaces.deleteWithoutSessions.confirm.other": "ይህ ያለ ተገናኙ ክፍለ ጊዜዎች {{count}} የስራ ዛፎችን በቋሚነት ይሰርዛል።",
  "settings.workspaces.deleteWithoutSessions.warning": "ያልተዋሃዱ ለውጦች ወይም ንቁ ቦታዎች ያሏቸው የስራ ዛፎች ይቀመጣሉ።",
  "settings.workspaces.delete.button": "የስራ ዛፎችን ሰርዝ",
  "workspace.lifecycle.deleting": "በመሰረዝ ላይ ...",
  "session.summary.tooltip": "ማጠቃለያ",
  "session.summary.server": "ቅጥያዎች",
  "session.summary.chooseProject": "ፕሮጀክት ይምረጡ",
  "session.summary.mcp.onCreation": "የስራ ዛፉ ሲፈጠር ተፈጻሚ ይሆናል",
  "session.summary.mcp.prepareFailed": "የMCP አገልጋዮችን ማዘጋጀት አልተቻለም",
  "session.summary.mcp.unavailable": "MCP አገልጋይ {{name}} በዚህ የስራ ዛፍ ውስጥ አይገኝም።",
  "session.summary.mcp.signInBeforeSend": "ጥያቄውን ከመላክዎ በፊት ወደ {{name}} ይግቡ።",
  "session.summary.mcp.notReady": "MCP አገልጋይ {{name}} ዝግጁ አይደለም። ጥያቄውን ከመላክዎ በፊት ግንኙነቱን ይፍቱ።",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "የተዋቀሩ MCP አገልጋዮች",
  "session.summary.plugins": "ተሰኪዎች",
  "session.summary.plugins.configured": "የተዋቀሩ ተሰኪዎች",
  "session.summary.skills": "ችሎታ",
  "session.summary.skills.configured": "የተዋቀሩ ክህሎቶች",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "አልተሳካም",
  "session.summary.retry": "እንደገና ሞክር",
  "session.summary.connecting": "በመገናኘት ላይ ...",
  "session.summary.needsAuth": "ይግቡ ያስፈልጋል",
  "session.summary.configure": "ውቅር ፋይል",
  "session.summary.copyConfigPath": "የውቅረት ፋይል ዱካ ይቅዱ",
  "session.summary.configFileMissing": "ምንም የውቅር ፋይል አልተገኘም",
  "session.summary.mcp.empty": "ምንም የMCP አገልጋዮች አልተዋቀሩም",
  "session.summary.mcp.add": "በ opencode.json ውስጥ አገልጋዮችን ያክሉ",
  "session.summary.plugins.manage": "በ opencode.json ውስጥ ተሰኪዎችን ያስተዳድሩ",
  "session.summary.plugins.empty": "ምንም ተሰኪዎች አልተዋቀሩ",
  "session.summary.plugins.add": "በ opencode.json ውስጥ ተሰኪዎችን ያክሉ",
  "session.summary.skills.manage": "በ opencode.json ውስጥ ክህሎቶችን ያስተዳድሩ",
  "session.summary.skills.empty": "ምንም ችሎታዎች አልተዋቀሩም",
  "session.summary.skills.add": "በ opencode.json ውስጥ ክህሎቶችን ያክሉ",
  "session.summary.lsp.configured": "የተዋቀሩ LSPs",
  "session.summary.lsp.empty": "ምንም የLSP አገልጋዮች አልተዋቀሩም።",
  "session.summary.lsp.manage": "በ opencode.json ውስጥ LSPን ያስተዳድሩ",
  "workspace.delete.location": "አካባቢ",
  "command.debugBar.toggle": "የማረሚያ አሞሌን ቀይር",
  "command.session.location.cycle": "የክፍለ ጊዜውን መገኛ ቀይር",
  "dialog.provider.anthropic.note": "የAPI ቁልፍ በመጠቀም ወደ Claude ሞዴሎች ቀጥተኛ መዳረሻ",
  "provider.connect.title.anthropicProMax": "በAnthropic ግባ",
  "prompt.toast.uploading.cancel": "ስቀላን ሰርዝ",
  "prompt.toast.uploading.cancelFile": "የ{{filename}} ስቀላን ሰርዝ",
  "prompt.toast.uploadFailed.title": "ስቀላው አልተሳካም",
  "session.browser.empty.title": "URL ያስገቡ",
  "session.browser.empty.description": "ወይም «በመተግበሪያው አሳሽ ክፈት» ብለው ይጠይቁ",
  "session.browser.failed.title": "URL ላይ መድረስ አልተቻለም",
  "session.browser.failed.description": "URL-ውን እና ግንኙነትዎን ይፈትሹ፣ ከዚያ እንደገና ይሞክሩ።",
  "debugBar.providerAriaLabel": "የአቅራቢ አፈጻጸም ምርመራ",
  "debugBar.ttft.tip": "የአቅራቢው ጥያቄ ከተላከበት ጊዜ እስከ ሞዴሉ የመጀመሪያ ውጤት ድረስ ያለው ጊዜ።",
  "debugBar.ttfa.tip": "የአቅራቢው ጥያቄ ከተላከበት ጊዜ እስከ የመጀመሪያው የመልስ ጽሑፍ ድረስ ያለው ጊዜ።",
  "debugBar.tps.tip": "ከሞዴሉ የመጀመሪያ ውጤት በኋላ በሰከንድ የሚወጡ ቶከኖች።",
  "debugBar.e2e.tip": "የአቅራቢው ጥያቄ ከተላከበት ጊዜ እስከ የምላሽ ዥረቱ መጨረሻ ድረስ ያለው ጊዜ።",
  "settings.updates.action.download": "OpenCodeን አውርድ",
  "settings.updates.migration.title": "ከBeta ወደ Stable ይዛወሩ",
