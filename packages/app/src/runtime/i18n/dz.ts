export const dict: Record<string, string> = {
  ...
  "settings.workspaces.deleteAll.warning":
    "མཉམ་བསྡོམས་མ་འབད་བའི་བསྒྱུར་བཅོས་ཚུ་དང་ འབྲེལ་མཐུད་འབད་ཡོད་པའི་ལཱ་ཡུན་ཚུ་ ཡང་ན་ ཤུགས་ལྡན་གནས་ཁོངས་ཚུ་ཡོད་པའི་ ལཱ་གི་ཤིང་ཚུ་བཞག་འོང་།",
  ...
  "session.location.unavailable": "ལཱ་ཡུན་གྱི་ས་གནས་འདི་མི་ཐོབ་པས།",
  "session.location.description": "ལཱ་ཡུན་འདི་འཕྲོ་མཐུད་ནི་ལུ་ སྣོད་ཐོ་གཞན་ཅིག་གདམ་ཁ་རྐྱབས།",
  "session.location.choose": "སྣོད་ཐོ་གདམ་ཁ་རྐྱབས།",
  "session.location.worktree": "Git worktree གདམ་ཁ་རྐྱབས།",
  "session.location.worktreesFailed": "Git worktree ཚུ་མངོན་གསལ་འབད་མ་ཚུགས།",
  "session.location.moving": "ལཱ་ཡུན་སྤོ་བཤུད་འབད་དོ…",
  "dialog.server.menu.hide": "ལས་འགུལ་ཐོ་ཡིག་ནང་ལས་སྦ་བཞག།",
  "dialog.server.menu.show": "ལས་འགུལ་ཐོ་ཡིག་ནང་སྟོན།",
  "session.queue.count.one": "{{count}} བསྒུག་ཐོ་ནང་།",
  "session.queue.count.other": "{{count}} བསྒུག་ཐོ་ནང་།",
  "session.queue.steer": "ཁ་སྒྱུར།",
  "session.queue.send": "གཏང་།",
  "session.queue.steerTooltip": "བར་ཆད་མ་བཏོན་པར་གཏང་།",
  "session.queue.remove": "རྩ་བསྐྲད་གཏང་།",
  "session.queue.reorder": "བསྒུག་ཐོ་ནང་གི་བརྡ་སྟོན་གོ་རིམ་སྒྲིག།",
  "session.new.worktree.creating": "Git worktree གསར་བསྐྲུན་འབད་དོ།",
  "settings.backToApp": "གློག་རིམ་ལུ་ལོག།",
  "settings.appearance.section.experimental": "ཚོད་བརྟག།",
  "settings.appearance.row.tabs.title": "མཆོང་ལྡེ་ཚུ།",
  "settings.appearance.row.tabs.description": "ལཱ་ཡུན་མཆོང་ལྡེ་ཚུ་ག་དེ་སྦེ་བཀོད་ནི་ཨིན་ན་གདམ་ཁ་རྐྱབས།",
  "settings.appearance.row.tabs.horizontal": "ཐད་སྙོམས།",
  "settings.appearance.row.tabs.vertical": "ཀེར་ཕྲང་།",
  "settings.general.row.followUpBehavior.title": "འཕྲོ་མཐུད་འཕྲིན་དོན་གྱི་སྤྱོད་ལམ།",
  "settings.general.row.followUpBehavior.description":
    "འཕྲོ་མཐུད་འཕྲིན་དོན་ཚུ་བསྒུག་ཐོ་ནང་བཙུགས་ནི་ཡང་ན་ ད་ལྟོའི་ལཱ་ཐེངས་ཁ་སྒྱུར་ནི་གདམ་ཁ་རྐྱབས། སོར་ནི་ལུ་ {{keybind}} ལག་ལེན་འཐབ།",
  "settings.general.row.followUpBehavior.queue": "བསྒུག་ཐོ་ནང་བཙུགས།",
  "settings.general.row.followUpBehavior.steer": "ཁ་སྒྱུར།",
  "settings.general.row.reasoningMode.title": "དཔེ་ཚད་ཀྱི་རྒྱུ་མཚན།",
  "settings.general.row.reasoningMode.description":
    "དཔེ་ཚད་ཀྱི་རྒྱུ་མཚན་འདི་དུས་ཐིག་ནང་ག་དེ་སྦེ་སྟོན་ནི་ཨིན་ན་གདམ་ཁ་རྐྱབས།",
  "settings.general.row.reasoningMode.hidden": "སྦ་བཞག་ཡོདཔ།",
  "settings.general.row.reasoningMode.compact": "བསྡུས་པ།",
  "settings.general.row.reasoningMode.full": "ཆ་ཚང་།",
  "session.new.workspace.createFrom": "ཡན་ལག་ལས་གསར་བསྐྲུན་འབད།",
  "session.new.workspace.branch.search.placeholder": "ཡན་ལག་ཚུ་འཚོལ།",
  "toast.migration.progress.clearingOldEvents": "ཧེ་མའི་བྱུང་ལས་ཚུ་བསལ་དོ།",
  "toast.migration.progress.migratingSessions": "ལཱ་ཡུན་ཚུ་གནས་སྤོ་འབད་དོ།",
  "session.new.workspace.existingLabel": "Git worktree",
  "desktop.onboarding.defaultProject": "སྔོན་སྒྲིག་ལས་འགུལ",
  "home.projects.all": "ལས་གཞི་ཚང་མ།",
  "session.tab.files": "ཡིག་སྣོད་ཚུ།",
  "session.files.openTabs": "ཡིག་སྣོད་ཚུ་ཁ་ཕྱེ།",
  "session.tab.usage": "བེད་སྤྱོད།",
  "session.view.select": "ལཱ་ཡུན་མཐོང་སྣང་།",
  "session.background.moveTasks": "{{tasks}} རྒྱབ་གཞི་ལུ་སྤོ་བཤུད་འབད།",
  "session.background.moveRunning": "རྒྱབ་གཞི་ལུ་སྤོ་བཤུད་འབད།",
  "session.background.inBackground": "རྒྱབ་གཞི་ནང་ {{tasks}} གཡོག་བཀོལ་དོ།",
  "session.background.tasksRunning.one": "{{count}} རྒྱབ་གཞིའི་ལས་འགན་གཡོག་བཀོལ་དོ།",
  "session.background.tasksRunning.other": "{{count}} རྒྱབ་གཞིའི་ལས་འགན་ཚུ་གཡོག་བཀོལ་དོ།",
  ...
  "session.background.subagent.other": "{{count}} ཡན་ལག་ལས་ཚབ་ཚུ།",
  ...
  "session.websearch.any": "གང་རུང་།",
  "session.websearch.disable": "འཚོལ་ཞིབ་ལག་ལེན་མ་འཐབ།",
  "session.websearch.enable": "ལྕོགས་ཅན་བཟོ།",
  "session.websearch.loadFailed": "འཚོལ་ཞིབ་བྱིན་མི་ཚུ་ མངོན་གསལ་འབད་མ་ཚུགས།",
  "session.websearch.empty": "འཚོལ་ཞིབ་བྱིན་མི་ཚུ་འཐོབ་མི་ཚུགས།",
  "session.websearch.failed": "ཁྱོད་རའི་གདམ་ཁ་སྲུང་མ་ཚུགས། ལོག་སྟེ་འབད་རྩོལ་བསྐྱེད་གནང་།",
  "session.websearch.retry": "ཡང་བསྐྱར་འབད་རྩོལ་བསྐྱེད།",
  "session.new.worktree.draftPlaceholder": "ལས་ཀའི་ཤིང་འདི་གྲ་སྒྲིག་འབད་བའི་སྐབས་ལུ་ རྗེས་འཇུག་ཅིག་ཟིན་བྲིས་བཏབ།",
  "session.search.placeholder": "འཚོལ།",
  "session.search.noResults": "མཐུན་སྒྲིག་མེད།",
  "titlebar.tabs": "མཆོང་ལྡེ་ཚུ།",
  "titlebar.channel.local": "ས་གནས།",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "རྐྱེན་སེལ་ལག་ཆས་ཚུ་སོར་སྟོན་འབད།",
  "settings.tab.experimental": "བརྟག་དཔྱད་འབད་མི།",
  "settings.experimental.description": "བརྟག་ཞིབ་ཁྱད་རྣམ་ཚུ་འབད་རྩོལ་བསྐྱེད།",
  "settings.tab.about": "སྐོར།",
  "settings.about.version": "ཐོན་རིམ་ {{version}} .",
  "settings.about.devVersion": "གོང་འཕེལ།",
  "settings.about.license": "ཨེམ་ཨའི་ཊི་ཆོག་ཐམ་གྱི་འོག་ལུ་བཏོན་ཡོདཔ།",
  "settings.about.writtenBy": "བྲིས།",
  "settings.about.illustratedBy": "པར་རིས་བཀོད་མཁན།",
  "settings.about.and": "དང་ །",
  "settings.about.otherContributor.one": "{{count}} གཞན།",
  "settings.about.otherContributor.other": "{{count}} གཞན།",
  "settings.about.firstPublished": "འགོ་དང་པ་ ཡུ་ཨེས་ཨེ་གི་ མི་སོ་རི་ལུ་ དཔར་བསྐྲུན་འབད་ཡོདཔ།",
  "settings.about.firstIllustrated": "འགོ་དང་པ་ ཨིང་ལེནཌ་གི་ ལོན་ཌོན་ལུ་ པར་རིས་བཀོད་ཡོདཔ།",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, ཁ་ཕྱེ་ཡོད་པའི་ཐོན་ཁུངས་གསང་ཡིག་ལས་ཚབ་པ།",
  "settings.about.trademark": "OpenCode འདི་ Anomaly Innovations, Inc གི་ཐོ་བཀོད་ཚོང་རྟགས་ཅིག་ཨིན།",
  ...
  "settings.timeline.description":
    "དུས་ཚོད་གྲལ་ཐིག་ནང་ ལས་སྣ་ག་དེམ་ཅིག་འབྱུངམ་ཨིན་ན་ གདམ་ཁ་རྐྱབས། འཕྲིན་དོན་ཚུ་མཐོང་ཚུགསཔ་སྦེ་སྡོདཔ་ཨིན།",
  "settings.timeline.preset.everything": "ག་ར།",
  "settings.timeline.preset.detailed": "ཁ་གསལ།",
  "settings.timeline.preset.compact": "བསྡུ་སྒྲིག།",
  "settings.timeline.preset.quiet": "ཁུ་སིམ་སིམ།",
  "settings.timeline.preset.text-only": "ཚིག་ཡིག་རྐྱངམ་གཅིག།",
  "settings.timeline.description.everything":
    "ལས་རིམ་ཆ་མཉམ་སོ་སོ་སྦེ་སྟོན། ཤེལ་གྱི་ཨའུཊི་པུཊི་དང་ཞུན་དག་ དེ་ལས་བསམ་བློ་གཏང་ནི་ཚུ་རྒྱ་བསྐྱེད་འབད།",
  "settings.timeline.description.detailed":
    "ཤལ་ཨའུཊི་པུཊི་དང་ཞུན་དག་ཚུ་རྒྱ་བསྐྱེད་འབད། ཡན་ལག་ལས་ཚབ་ཚུ་སོ་སོ་སྦེ་སྟོན་ཞིནམ་ལས་ ལག་ལེན་འཐབ་ཡོད་པའི་ནང་ལུ་ ལས་སྣ་གཞན་མི་ཚུ་སྡེ་ཚན་བཟོ།",
  "settings.timeline.description.compact":
    "ཁ་གསལ་ཚུ་བསྡམ་བཞག་ཡོད་མི་དང་གཅིག་ཁར་ལག་ལེན་འཐབ་ཡོད་པའི་ནང་ལུ་ ལས་སྣ་ཆ་མཉམ་སྡེ་ཚན་བཟོ།",
  "settings.timeline.description.quiet":
    "ལག་ལེན་འཐབ་ཡོད་པའི་ནང་ སྡེ་ཚན་ཞུན་དག་ཚུ་དང་ ཡན་ལག་ལས་ཚབ་ཚུ། ལས་སྣ་གཞན་སྦ་བཞག།",
  "settings.timeline.description.text-only": "ལས་རིམ་ཆ་མཉམ་སྦ་བཞག། འཕྲིན་དོན་ཚུ་རྐྱངམ་ཅིག་སྟོན།",
  "settings.timeline.description.custom":
    "ལས་རིམ་དབྱེ་རིམ་རེ་རེ་གི་དོན་ལུ་ ཁྱོད་ཀྱིས་སེལ་འཐུ་འབད་ཡོད་པའི་གནས་ས་དང་ཁ་གསལ་ཚུ་ལག་ལེན་འཐབ།",
  "settings.timeline.custom": "སྲོལ་སྒྲིག།",
  "settings.timeline.advanced": "ཡར་རྒྱས།",
  "settings.timeline.advanced.description": "ལས་རིམ་དབྱེ་རིམ་རེ་རེ་གི་དོན་ལུ་ ས་གནས་དང་ཁ་གསལ་ཚུ་གཞི་སྒྲིག་འབད།",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "ཞུན་དག་ཚུ།",
  ...
  "session.review.filesChangedCount.one": "{{count}} ཡིག་སྣོད་བསྒྱུར་བཅོས་འབད་ཡོདཔ།",
  "session.review.filesChangedCount.other": "{{count}} ཡིག་སྣོད་ཚུ་བསྒྱུར་བཅོས་འབད་ཡོདཔ།",
  "settings.about.writtenByNames": "{{names}}གིས་བྲིས།",
  "settings.about.illustratedByNames": "{{names}} གིས་པར་རིས་བཀོད་ཡོད།",
  "ssh.label": "SSH",
  "ssh.offline":
    "{{host}} ལུ་མཐུད་མེད། ཁྱོད་ཀྱི་ཟིན་བྲིས་འདི་ཉར་ཚགས་འབད་ཡོདཔ་ཨིན། ཐག་རིང་གི་ལཱ་འདི་ད་ལྟོ་ཡང་གཡོག་བཀོལ་དོ་འོང་།",
  "ssh.placeholder": "ssh ལག་ལེན་པ@དཔེ།com",
  "ssh.add": "SSH སར་བར་ཁ་སྐོང་འབད།",
  "ssh.server.menu.label": "SSH སར་བར་",
  "ssh.target": "ཧོསིཊི་ཡང་ན་ SSH བརྡ་བཀོད་",
  "ssh.connect": "མཐུད།",
  "ssh.connectTo": "{{host}} ལུ་མཐུད།",
  "ssh.authenticate": "SSH བདེན་བཤད་",
  "ssh.action.authenticate": "བདེན་བཤད་འབད།",
  "ssh.session.disconnected": "SSH མཐུད་ལམ་ཤུགས་མེད་",
  "ssh.session.connecting": "SSH སར་བར་ལུ་མཐུད་དོ",
  "ssh.session.reconnectDescription":
    "ལཱ་ཡུན་འདི་བལྟ་ནི་དང་ལཱ་འཕྲོ་མཐུད་འབད་ནི་ལུ་ ལོག་སྟེ་མཐུད། ཁྱོད་ཀྱི་ཐག་རིང་ལཱ་ཡུན་འདི་ཉམས་སྲུང་འབད་དེ་ཡོད།",
  "ssh.session.reconnect": "ལོག་མཐུད།",
  "ssh.authenticationRequired": "{{host}} གི་དོན་ལུ་བདེན་བཤད་དགོཔ་ཨིན།",
  "ssh.trust": "བློ་གཏད་དང་འབྲེལ་མཐུད།",
  "ssh.continue": "འཕྲོ་མཐུད།",
  "ssh.retry": "བསྐྱར་དུ་ཚོད་ལྟ་",
  "ssh.update": "དུས་མཐུན་བཟོ་སྟེ་ ལོག་སྟེ་མཐུད།",
  "ssh.openProject": "ལས་གཞི་ཁ་ཕྱེ།",
  "ssh.project": "{{host}} གུ་ལས་འགུལ་ཁ་ཕྱེ།",
  "ssh.disconnect": "མཐུད་ལམ་བཏོག",
  "ssh.forget": "མཐུད་ལམ་བརྗེད།",
  "ssh.stage.disconnected": "མཐུད་ལམ་བཏོག་ཡོདཔ། ཐག་རིང་གི་སར་བར་འདི་གཡོག་བཀོལ་བའི་བསྒང་རང་བཞགཔ་ཨིན།",
  "ssh.stage.connecting": "SSH བརྒྱུད་དེ་མཐུད་དོ...",
  "ssh.stage.checking": "OpenCode བརྟག་དཔྱད་འབད་དོ།...",
  "ssh.stage.downloading": "སར་བར་ཕབ་ལེན་འབད་དོ།...",
  "ssh.stage.uploading": "སར་བར་སྐྱེལ་བཙུགས་འབད་དོ།...",
  "ssh.stage.starting": "OpenCode ལུ་མཐུད་དོ...",
  "ssh.stage.ready": "འབྲེལ་མཐུད་འབད་ཡོདཔ།",
  "ssh.stage.authentication": "བདེན་བཤད་འབད་དགོ",
  "ssh.stage.incompatible": "སར་བར་དུས་མཐུན་བཟོ་དགོ",
  "ssh.stage.failed": "མཐུད་ལམ་འཐུས་ཤོར་བྱུང་ཡོདཔ།",
  "ssh.error.input":
    "ཧོསིཊི་ཡང་ན་ SSH མཐུད་ལམ་བརྡ་བཀོད་ཅིག་བཙུགས། ཐག་རིང་བརྡ་བཀོད་དང་རྒྱབ་སྐྱོར་མ་འབད་བའི་ SSH གདམ་ཁ་ཚུ་ འབད་མི་ཆོག།",
  "ssh.error.connection": "SSH མཐུད་ལམ་གཞི་བཙུགས་འབད་མ་ཚུགས། ཁྱོད་རའི་ཡོངས་འབྲེལ་དང་ SSH རིམ་སྒྲིག་ཞིབ་དཔྱད་འབད།",
  "ssh.error.platform":
    "ཐག་རིང་སྟེགས་རིས་འདི་ལུ་རྒྱབ་སྐྱོར་མི་འབད། རང་བཞིན་གཞི་སྒྲིག་ལུ་ད་ལྟོ་ x64 ཡང་ན་ arm64 གུ་ Linux ཡང་ན་ macOS དགོཔ་ཨིན།",
  "ssh.error.version": "ཐག་རིང་ཞབས་ཏོག་འདི་ མཐུད་མ་འབད་བའི་ཧེ་མ་ ཌེཀསི་ཊོཔ་ཐོན་རིམ་འདི་དང་ མཐུན་སྒྲིག་འབད་དགོ།",
  "ssh.error.install":
    "ཐག་རིང་སར་བར་ གཞི་བཙུགས་འབད་མ་ཚུགས། མཐུད་ལམ་དང་ ཌིཀསི་གི་ས་སྟོང་ དེ་ལས་ tar དེ་གཞི་བཙུགས་འབད་ཡོདཔ་ཨིན་ན་ ཞིབ་དཔྱད་འབད།",
  "ssh.error.unpublished":
    "ཌེཀསི་ཊོཔ་ཐོན་རིམ་འདི་ལུ་ དཔར་བསྐྲུན་འབད་ཡོད་པའི་ཐག་རིང་སར་བར་མེད། གོང་འཕེལ་བཟོ་བསྐྲུན་ཚུ་གི་དོན་ལུ་ ཧོསིཊི་གུ་ V2 གཞི་བཙུགས་འབད་དེ་འགོ་བཙུགས་ཞིནམ་ལས་ ལོག་སྟེ་འབད་རྩོལ་བསྐྱེད།",
  "ssh.error.service": "SSH མཐུད་ཡོད་རུང་ OpenCode སར་བར་འདི་གྲ་སྒྲིག་མ་འགྱོ་བས།",
  "ssh.error.host-key":
    "ཧོསིཊི་གི་ངོ་རྟགས་འདི་བདེན་དཔྱད་འབད་མ་ཚུགས། ཁྱོད་ཀྱི་ SSH ཤེས་རྟོགས་ཡོད་པའི་ཧོསིཊི་ཚུ་དུས་མཐུན་མ་བཟོ་བའི་ཧེ་མ་ དེ་གི་མཛུབ་མོའི་པར་བཤུས་བདེན་དཔྱད་འབད།",
  "ssh.error.ssh-missing":
    "OpenSSH མ་ཐོབ། OpenSSH མཁོ་སྤྲོད་པ་ཅིག་གཞི་བཙུགས་འབད་ཞིནམ་ལས་ ssh འདི་ PATH གུ་འཐོབ་ཚུགསཔ་ངེས་གཏན་བཟོ།",
  "command.browser.open": "བརའུ་ཟར་ཁ་ཕྱེ།",
  "command.browser.reload": "བརའུ་ཟར་ཤོག་ལེབ་ལོག་བཙུགས་",
  "command.session.summary.toggle": "བཅུད་དོན་སོར་བསྒྱུར་",
  "mcp.auth.interactiveForm": "MCP སར་བར་ {{name}} ལུ་ འབྲེལ་མཐུན་བདེན་བཤད་འབྲི་ཤོག་ཅིག་དགོཔ་ཨིན།",
  "server.connect.title": "སར་བར་ཅིག་ལུ་མཐུད།",
  "server.connect.description": "འགོ་བཙུགས་ནིའི་དོན་ལུ་ ཁྱོད་རའི་སར་བར་ཁ་བྱང་དང་ཆོག་ཡིག་བཙུགས།",
  ...
  "dialog.server.menu.remove": "བཏོན་བཏང་",
  "file.error.notFound": "ཡིག་སྣོད་འཚོལ་མ་ཐོབ།: {{name}}",
  "home.workspaceTip": "བསྒྱུར་བཅོས་ཚུ་སོ་སོ་སྦེ་བཞག་ནི་ལུ་ ལཱ་གི་ས་སྒོ་གསརཔ་ཅིག་ནང་ ཤུལ་མམ་གྱི་ལཱ་ཡུན་འགོ་བཙུགས།",
  "session.tab.browser": "བརའུ་ཟར་",
  "session.tab.add": "མཆོང་ལྡེ་ཁ་སྐོང་",
  "session.queue.attachments.one": "པ་ལཱསི་ {{count}} མཐུད་སྣེ།",
  "session.queue.attachments.other": "དེ་ལས་ {{count}} མཐུད་སྣེ་ཚུ་",
  "session.browser.address": "བརྡ་འཚོལ་ཁ་བྱང་",
  "session.browser.replaced": "བརའུ་ཟར་ཚད་འཛིན་འདི་ ཌེཀསི་ཊོཔ་སྒོ་སྒྲིག་གཞན་མི་ཅིག་ནང་ སྤོ་བཤུད་འབད་ཡི།",
  "session.browser.suspended": "བརའུ་ཟར་བཀག་བཞག་ཡོདཔ། ལོག་སྟེ་མཐུད་ནིའི་དོན་ལུ་ ལཱ་ཡུན་འདི་དང་གཅིག་ཁར་ འབྲེལ་བ་འཐབ།",
  "session.browser.address.placeholder": "ཡུ་ཨར་ཨེལ་བཙུགས།",
  "settings.backToSettings": "གཞི་སྒྲིག་ལུ་ལོག་འགྱོ།",
  "settings.backToProjects": "ལས་འགུལ་ཚུ་ལུ་ལོག་འགྱོ།",
  "settings.search.placeholder": "འཚོལ་ཞིབ་",
  "settings.search.results": "སྒྲིག་སྟངས་གྲུབ་འབྲས།",
  "settings.search.group.pages": "ཤོག་ངོས་",
  "settings.search.group.settings": "སྒྲིག་སྟངས་",
  "settings.search.group.projects": "ལས་གཞི།",
  "settings.search.group.servers": "སར་བར",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "{{query}} གི་དོན་ལུ་གྲུབ་འབྲས་མེད།",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "དམིགས་བསལ་གྱི་གྲུབ་འབྲས་མངམ་བལྟ་ནི་ལུ་ ཁྱོད་རའི་འཚོལ་ཞིབ་འདི་ཕྲང་ཕྲངམ་བཟོ།",
  "settings.server.description": "སར་བར་འདི་གི་མཐུད་ལམ་དང་དགའ་གདམ་ཚུ་འཛིན་སྐྱོང་འཐབ།",
  "settings.server.section.connection": "མཐུད་ལམ་",
  "settings.server.preferences.websearch.title": "ཕྱོགས་གསུམ་པའི་འཚོལ་ཞིབ།",
  "settings.server.preferences.websearch.description":
    "ཝེབ་འཚོལ་ཞིབ་འབད་ནི་ལུ་ལག་ལེན་འཐབ་མི་ འཚོལ་ཞིབ་བྱིན་མི་ལས་ཚབ་ཚུ་སེལ་འཐུ་འབད།",
  "settings.projects.search.placeholder": "ལས་གཞི་འཚོལ་ཞིབ་",
  "project.settings.name.title": "ལས་འགུལ་གྱི་མིང་",
  "project.settings.name.description": "ལས་འགུལ་འདི་གི་དོན་ལུ་ OpenCode ཡོངས་རྫོགས་ནང་སྟོན་ཡོད་པའི་མིང་།",
  "project.settings.icon.description": "གྲོས་འཆར་: ༡༢༨×༡༢༨px. གཟུགས་བརྙན་ཅིག་སྐྱེལ་བཙུགས་འབད་ནི་ལུ་ཨེབ་གཏང་ཡང་ན་འདྲུད།",
  "project.settings.color.description":
    "སྲོལ་སྒྲིག་གཟུགས་བརྙན་གཞི་སྒྲིག་མ་འབད་བའི་སྐབས་ལས་འགུལ་ངོས་དཔར་གྱི་དོན་ལུ་ལག་ལེན་འཐབ་ཡོདཔ་ཨིན།",
  "project.settings.worktree.startup.description": "ལཱ་གི་ཤིང་གསརཔ་གསར་བསྐྲུན་འབད་བའི་ཤུལ་ལས་ཚར་གཅིག་གཡོག་བཀོལཝ་ཨིན།",
  "project.settings.worktree.startup.hint.base": "གཞི་རྟེན་ལཱ་ཤིང་གི་དོན་ལུ་ $OPENCODE_WORKTREE_BASE ལག་ལེན་འཐབ།",
  "project.settings.worktree.startup.hint.new": "ལཱ་གི་ཤིང་གསརཔ་གི་དོན་ལུ་ $OPENCODE_WORKTREE_PATH ལག་ལེན་འཐབ།",
  "project.settings.extensions.empty.mcps.title": "ད་ལྟོ་ MCPs མེད།",
  "project.settings.extensions.empty.mcps.description": "MCPs ལུ་ཐོབ་ཚུགས་པའི་ OpenCode འདི་ན་འབྱུངམ་ཨིན།",
  "project.settings.extensions.empty.plugins.title": "ད་ལྟོ་པ་ལག་ཨིནསི་མེད།",
  "project.settings.extensions.empty.plugins.description": "OpenCode ལུ་ཡོད་པའི་པ་ལག་ཨིན་ཚུ་ ནཱ་ལུ་འབྱུངམ་ཨིན།",
  "project.settings.extensions.empty.skills.title": "ད་ལྟོ་རིག་རྩལ་མེད།",
  "project.settings.extensions.empty.skills.description": "OpenCode ལུ་ཡོད་པའི་རིག་རྩལ་ཚུ་ ནཱ་ལུ་འབྱུང་འོང་།",
  "project.settings.extensions.lsp.configured": "རིམ་སྒྲིག་འབད་ཡོད་པའི་སྐད་ཡིག་སར་བར་ཚུ།",
  "project.settings.extensions.lsp.status.enabled": "རིམ་སྒྲིག་ནང་ལུ་ལྕོགས་ཅན་བཟོ་ཡོདཔ།",
  "project.settings.extensions.lsp.status.disabled": "རིམ་སྒྲིག་ནང་ལུ་ལྕོགས་མིན་བཟོ་ཡོདཔ།",
  "project.settings.extensions.lsp.empty.title": "སྐད་ཡིག་སར་བར་ཚུ་རིམ་སྒྲིག་མ་འབད་བས།",
  "project.settings.extensions.lsp.empty.description":
    "ལས་འགུལ་འདི་གི་དོན་ལུ་རིམ་སྒྲིག་འབད་ཡོད་པའི་སྐད་ཡིག་སར་བར་ཚུ་ནཱ་ལུ་འབྱུངམ་ཨིན།",
  "project.settings.extensions.lsp.disabled.title": "སྐད་ཡིག་སར་བར་ཚུ་ལྕོགས་མིན་བཟོ་ཡོདཔ།",
  "project.settings.extensions.lsp.disabled.description":
    "LSP འདི་ལས་འགུལ་འདི་གི་རིམ་སྒྲིག་ནང་ལུ་ལྕོགས་མིན་བཟོ་ཡོདཔ་ཨིན།",
  "project.settings.extensions.lsp.loadFailed": "སྐད་ཡིག་སར་བར་རིམ་སྒྲིག་མངོན་གསལ་འབད་མ་ཚུགས།",
  "project.settings.extensions.lsp.retry": "བསྐྱར་དུ་ཚོད་ལྟ་",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "སྡེ་ཚན་",
  "settings.timeline.collapse": "བརྡིབས་",
  "settings.timeline.visibility.show": "སྟོན།",
  "settings.timeline.visibility.hide": "སྦ་བཞག",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} ལཱ་ཡུན་",
  "settings.workspaces.sessions.filtered.other": "{{count}} ལཱ་ཡུན་ཚུ་",
  "settings.workspaces.deleteAll.confirm.one":
    "འདི་གིས་ {{count}} སེལ་འཐུ་འབད་ཡོད་པའི་ལཱ་གི་ཤིང་འདི་ རྟག་བརྟན་སྦེ་བཏོན་གཏང་འོང་།",
  "settings.workspaces.deleteAll.confirm.other":
    "འདི་གིས་ {{count}} སེལ་འཐུ་འབད་ཡོད་པའི་ལཱ་གི་ཤིང་ཚུ་ རྟག་བརྟན་སྦེ་བཏོན་གཏང་འོང་།",
  "settings.workspaces.deleteWithoutSessions": "ལཱ་ཡུན་མེད་པའི་ལཱ་ཤིང་ཚུ་བཏོན་གཏང་།",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "འདི་གིས་ འབྲེལ་མཐུད་ཡོད་པའི་ལཱ་ཡུན་ཚུ་མེད་པར་ {{count}} ལཱ་ཤིང་འདི་རྟག་བརྟན་སྦེ་བཏོན་གཏང་འོང་།",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "འདི་གིས་ འབྲེལ་མཐུད་ཡོད་པའི་ལཱ་ཡུན་ཚུ་མེད་པའི་ {{count}} ལཱ་ཤིང་ཚུ་ རྟག་བརྟན་སྦེ་བཏོན་གཏང་འོང་།",
  "settings.workspaces.deleteWithoutSessions.warning":
    "མཉམ་བསྡོམས་མ་འབད་བའི་བསྒྱུར་བཅོས་ཚུ་ཡང་ན་ ཤུགས་ལྡན་གནས་ཁོངས་ཚུ་ཡོད་པའི་ལཱ་གི་ཤིང་ཚུ་བཞག་འོང་།",
  "settings.workspaces.delete.button": "ལཱ་གི་ཤིང་ཚུ་བཏོན་གཏང་།",
  "workspace.lifecycle.deleting": "བཏོན་གཏང་དོ...",
  "session.summary.tooltip": "བཅུད་བསྡུས།",
  "session.summary.server": "རྒྱ་བསྐྱེད་",
  "session.summary.chooseProject": "ལས་འགུལ་གདམ་ཁ་རྐྱབས།",
  "session.summary.mcp.onCreation": "ལཱ་གི་ཤིང་འདི་གསར་བསྐྲུན་འབད་བའི་སྐབས་འཇུག་སྤྱོད་འབདཝ་ཨིན།",
  "session.summary.mcp.prepareFailed": "MCP སར་བར་ཚུ་གྲ་སྒྲིག་འབད་མ་ཚུགས།",
  "session.summary.mcp.unavailable": "MCP སར་བར་ {{name}} འདི་ལཱ་ཤིང་འདི་ནང་འཐོབ་མི་ཚུགས།",
  "session.summary.mcp.signInBeforeSend": "བརྡ་སྟོན་མ་གཏང་པའི་ཧེ་མ་ {{name}} ལུ་ནང་བསྐྱོད་འབད།",
  "session.summary.mcp.notReady":
    "MCP སར་བར་ {{name}} འདི་གྲ་སྒྲིག་མེདཔ་ཨིན། བརྡ་སྟོན་མ་གཏང་པའི་ཧེ་མ་ དེ་གི་མཐུད་ལམ་འདི་སེལ་འཐུ་འབད།",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "རིམ་སྒྲིག་འབད་ཡོད་པའི་ MCP སར་བར་ཚུ་",
  "session.summary.plugins": "པ་ལག་ཨིན་",
  "session.summary.plugins.configured": "རིམ་སྒྲིག་འབད་ཡོད་པའི་པ་ལག་ཨིན་ཚུ་",
  "session.summary.skills": "རིག་རྩལ།",
  "session.summary.skills.configured": "རིམ་སྒྲིག་འབད་ཡོད་པའི་རིག་རྩལ།",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "འཐུས་ཤོར་བྱུང་ཡོདཔ།",
  "session.summary.retry": "བསྐྱར་དུ་ཚོད་ལྟ་",
  "session.summary.connecting": "མཐུད་པའི་...",
  "session.summary.needsAuth": "ནང་བསྐྱོད་འབད་དགོ",
  "session.summary.configure": "རིམ་སྒྲིག་ཡིག་སྣོད་",
  "session.summary.copyConfigPath": "རིམ་སྒྲིག་ཡིག་སྣོད་འགྲུལ་ལམ་འདྲ་བཤུས་རྐྱབས།",
  "session.summary.configFileMissing": "རིམ་སྒྲིག་ཡིག་སྣོད་འཚོལ་མ་ཐོབ།",
  "session.summary.mcp.empty": "MCP སར་བར་ཚུ་རིམ་སྒྲིག་མ་འབད་བས།",
  "session.summary.mcp.add": "opencode.json ནང་ལུ་སར་བར་ཚུ་ཁ་སྐོང་འབད།",
  "session.summary.plugins.manage": "opencode.json ནང་ལུ་ པ་ལག་ཨིན་ཚུ་འཛིན་སྐྱོང་འཐབ།",
  "session.summary.plugins.empty": "པ་ལག་ཨིན་ཚུ་རིམ་སྒྲིག་མ་འབད་བས།",
  "session.summary.plugins.add": "opencode.json ནང་ལུ་ པ་ལག་ཨིན་ཚུ་ཁ་སྐོང་འབད།",
  "session.summary.skills.manage": "opencode.json ནང་རིག་རྩལ་འཛིན་སྐྱོང་འཐབ།",
  "session.summary.skills.empty": "རིག་རྩལ་རིམ་སྒྲིག་མ་འབད་བས།",
  "session.summary.skills.add": "opencode.json ནང་ལུ་རིག་རྩལ་ཁ་སྐོང་འབད།",
  "session.summary.lsp.configured": "རིམ་སྒྲིག་འབད་ཡོད་པའི་ LSPs",
  "session.summary.lsp.empty": "LSP སར་བར་ཚུ་རིམ་སྒྲིག་མ་འབད་བས།",
  "session.summary.lsp.manage": "opencode.json ནང་ལུ་ LSP འཛིན་སྐྱོང་འཐབ།",
  "workspace.delete.location": "ས་གནས་",
  "common.color.orange": "ལི་ཝང་",
  "common.color.yellow": "སེར་པོ་",
  "common.color.cyan": "སྔོ་ལྗང་",
  "common.color.green": "ལྗང་ཁུ",
  "common.color.red": "དམརཔོ་",
  "common.color.pink": "ཤ་ཁ་",
  "common.color.blue": "སྔོན་པོ་",
  "common.color.purple": "མུ་མེན་",
  "common.color.gray": "སྐྱ་ཐལ་",
  "toast.migration.progress.migratingSessions.current": "ལཱ་ཡུན་ཚུ་གནས་སྤོ་འབད་དོ་ {{current}}",
  "toast.migration.progress.migratingSessions.progress": "ལཱ་ཡུན་ཚུ་གནས་སོར་འབད་དོ་ {{current}}/{{total}}",
  "toast.migration.progress.working": "གནད་སྡུད་གནས་སྤོ་འབད་དོ་",
  "toast.migration.progress.working.current": "གནད་སྡུད་གནས་སྤོ་འབད་དོ་ {{current}}",
  "toast.migration.progress.working.progress": "གནད་སྡུད་གནས་སྤོ་འབད་དོ་ {{current}}/{{total}}",
  "session.browser.unsupported": "ཌེཀསི་ཊོཔ་གློག་རིམ་འདི་གིས་ བརའུ་ཟར་པེན་ལུ་རྒྱབ་སྐྱོར་མི་འབད།",
  "command.debugBar.toggle": "རྐྱེན་སེལ་ཕྲ་རིང་སྟོན་ནི་ཡང་ན་སྦ་ནི།",
  "command.session.location.cycle": "ལཱ་ཡུན་གྱི་ས་གནས་སོར།",
  "dialog.provider.anthropic.note": "API ལྡེ་མིག་བརྒྱུད་དེ་ Claude དཔེ་ཚད་ཚུ་ལུ་ཐད་ཀར་འཛུལ་སྤྱོད།",
  "provider.connect.title.anthropicProMax": "Anthropic ཐོག་ལས་ནང་བསྐྱོད།",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "སྐྱེལ་བཙུགས་ཆ་མེད་བཏང་།",
  ...
  "session.browser.empty.title": "URL བཙུགས།",
  "session.browser.empty.description": "ཡང་ན་ “གློག་རིམ་བརའུ་ཟར་ནང་ཁ་ཕྱེ” ཟེར་བའི་ནུས་སྤེལ་བྱིན།",
  "session.browser.failed.title": "URL ལུ་ལྷོད་མི་ཚུགས།",
  "session.browser.failed.description": "URL དང་ཁྱོད་ཀྱི་མཐུད་ལམ་ཞིབ་དཔྱད་འབད་དེ་ལོག་སྟེ་འབད།",
  "debugBar.providerAriaLabel": "བྱིན་མིའི་ལཱ་ཤུགས་བརྟག་དཔྱད།",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "བྱིན་མི་ལུ་ཞུ་བ་བཏང་བ་ལས་དཔེ་ཚད་ཀྱི་ཐོན་འབྲས་དང་པ་ཚུན་གྱི་དུས་ཚོད།",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "བྱིན་མི་ལུ་ཞུ་བ་བཏང་བ་ལས་ལན་གྱི་ཚིག་ཡིག་དང་པ་ཚུན་གྱི་དུས་ཚོད།",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "དཔེ་ཚད་ཀྱི་ཐོན་འབྲས་དང་པའི་ཤུལ་ལས་སྐར་ཆ་རེར་ཐོན་འབྲས་ཊོ་ཀེན།",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "བྱིན་མི་ལུ་ཞུ་བ་བཏང་བ་ལས་ལན་གྱི་རྒྱུན་ལམ་མཇུག་བསྡུ་ཚུན་གྱི་དུས་ཚོད།",
  "settings.updates.action.download": "OpenCode ཕབ་ལེན་འབད།",
  "settings.updates.migration.title": "Beta ལས་ Stable ལུ་སྤོ།",
