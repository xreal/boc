export const dict = {
  ...
  "command.debugBar.toggle": "Bật/tắt thanh gỡ lỗi",
  ...
  "command.session.location.cycle": "Chuyển lần lượt vị trí phiên",
  ...
  "provider.connect.title.anthropicProMax": "Đăng nhập bằng Anthropic",
  ...
  "prompt.toast.uploading.cancel": "Hủy tải lên",
  "prompt.toast.uploading.cancelFile": "Hủy tải lên {{filename}}",
  "prompt.toast.uploadFailed.title": "Tải lên thất bại",
  ...
  "debugBar.providerAriaLabel": "Chẩn đoán hiệu suất nhà cung cấp",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Thời gian từ khi gửi yêu cầu đến nhà cung cấp cho đến đầu ra đầu tiên của mô hình.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Thời gian từ khi gửi yêu cầu đến nhà cung cấp cho đến văn bản trả lời đầu tiên.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Số token đầu ra mỗi giây sau đầu ra đầu tiên của mô hình.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Thời gian từ khi gửi yêu cầu đến nhà cung cấp cho đến khi luồng phản hồi kết thúc.",
  ...
  "settings.updates.action.download": "Tải OpenCode xuống",
  "settings.updates.migration.title": "Chuyển từ Beta sang bản ổn định",
  ...
  "settings.workspaces.deleteAll.warning":
    "Các worktree có thay đổi chưa hợp nhất, phiên được liên kết hoặc vị trí đang hoạt động sẽ được giữ lại.",
  ...
  "session.location.unavailable": "Vị trí phiên không khả dụng",
  "session.location.description": "Chọn một thư mục khác để tiếp tục phiên này.",
  "session.location.choose": "Chọn thư mục",
  "session.location.worktree": "Chọn worktree",
  "session.location.worktreesFailed": "Không thể tải worktree",
  "session.location.moving": "Đang di chuyển phiên…",
  "dialog.server.menu.hide": "Ẩn khỏi danh sách dự án",
  "dialog.server.menu.show": "Hiển thị trong danh sách dự án",
  "session.queue.count.one": "{{count}} mục đang chờ",
  "session.queue.count.other": "{{count}} mục đang chờ",
  "session.queue.steer": "Điều hướng",
  "session.queue.send": "Gửi",
  "session.queue.steerTooltip": "Gửi mà không gián đoạn",
  "session.queue.remove": "Xóa",
  "session.queue.reorder": "Sắp xếp lại prompt đang chờ",
  "session.new.worktree.creating": "Đang tạo worktree",
  "settings.backToApp": "Quay lại ứng dụng",
  "settings.appearance.section.experimental": "Thử nghiệm",
  "settings.appearance.row.tabs.title": "Tab",
  "settings.appearance.row.tabs.description": "Chọn cách sắp xếp các tab phiên",
  "settings.appearance.row.tabs.horizontal": "Ngang",
  "settings.appearance.row.tabs.vertical": "Dọc",
  "settings.general.row.followUpBehavior.title": "Cách xử lý nội dung tiếp theo",
  "settings.general.row.followUpBehavior.description":
    "Chọn xếp hàng nội dung tiếp theo hoặc điều hướng lượt hiện tại. Dùng {{keybind}} để chuyển đổi.",
  "settings.general.row.followUpBehavior.queue": "Xếp hàng",
  "settings.general.row.followUpBehavior.steer": "Điều hướng",
  "settings.general.row.reasoningMode.title": "Suy luận của mô hình",
  "settings.general.row.reasoningMode.description": "Chọn cách hiển thị suy luận của mô hình trong dòng thời gian",
  "settings.general.row.reasoningMode.hidden": "Ẩn",
  "settings.general.row.reasoningMode.compact": "Thu gọn",
  "settings.general.row.reasoningMode.full": "Đầy đủ",
  "session.new.workspace.createFrom": "Tạo từ",
  "session.new.workspace.branch.search.placeholder": "Tìm kiếm nhánh",
  "toast.migration.progress.clearingOldEvents": "Đang xóa các sự kiện cũ",
  "toast.migration.progress.migratingSessions": "Đang di chuyển các phiên",
  "session.new.workspace.existingLabel": "cây làm việc",
  "desktop.onboarding.defaultProject": "Dự án mặc định",
  "home.projects.all": "Tất cả các dự án",
  "session.tab.files": "Tập tin",
  "session.files.openTabs": "Mở tập tin",
  "session.tab.usage": "Cách sử dụng",
  "session.view.select": "Chế độ xem phiên",
  "session.background.moveTasks": "Di chuyển {{tasks}} xuống nền",
  "session.background.moveRunning": "Di chuyển đến nền",
  "session.background.inBackground": "Đang chạy {{tasks}} ở chế độ nền",
  "session.background.tasksRunning.one": "{{count}} tác vụ nền đang chạy",
  "session.background.tasksRunning.other": "{{count}} tác vụ nền đang chạy",
  ...
  "session.websearch.any": "Bất kì",
  "session.websearch.disable": "Không sử dụng tìm kiếm",
  "session.websearch.enable": "Cho phép",
  "session.websearch.loadFailed": "Không thể tải nhà cung cấp dịch vụ tìm kiếm.",
  "session.websearch.empty": "Không có nhà cung cấp dịch vụ tìm kiếm nào",
  "session.websearch.failed": "Không thể lưu lựa chọn của bạn. Vui lòng thử lại.",
  "session.websearch.retry": "Thử lại",
  "session.new.worktree.draftPlaceholder": "Soạn thảo nội dung tiếp theo trong khi sơ đồ công việc đang được chuẩn bị…",
  "session.search.placeholder": "Tìm thấy...",
  "session.search.noResults": "Không có kết quả phù hợp",
  "titlebar.tabs": "Tab",
  "titlebar.channel.local": "Địa phương",
  "titlebar.channel.dev": "Nhà phát triển",
  "titlebar.channel.beta": "bản thử nghiệm",
  "titlebar.toggleDebugTools": "Chuyển đổi công cụ gỡ lỗi",
  "settings.tab.experimental": "thực nghiệm",
  "settings.experimental.description": "Hãy thử các tính năng thử nghiệm",
  "settings.tab.about": "Về",
  "settings.about.version": "Phiên bản {{version}}",
  "settings.about.devVersion": "phát triển",
  "settings.about.license": "Được phát hành theo Giấy phép MIT",
  "settings.about.writtenBy": "Được viết bởi",
  "settings.about.illustratedBy": "Minh họa bởi",
  "settings.about.and": "Và",
  "settings.about.otherContributor.one": "{{count}} người khác",
  "settings.about.otherContributor.other": "{{count}} người khác",
  "settings.about.firstPublished": "Xuất bản lần đầu ở Missouri, Mỹ",
  "settings.about.firstIllustrated": "Minh họa đầu tiên ở London, Anh",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, tác nhân mã hóa nguồn mở",
  "settings.about.trademark": "OpenCode là nhãn hiệu đã đăng ký của Anomaly Innovations, Inc.",
  "settings.about.typeset": "Bộ sắp chữ trong Inter và IBM Plex Mono",
  "settings.about.tagline": "AI không thể xây dựng phần mềm tuyệt vời nếu không có bạn",
  "settings.about.copyright": "© Anomaly Đổi mới, Inc.",
  "project.settings.title": "Chỉnh sửa dự án",
  "settings.timeline.title": "Dòng thời gian",
  "settings.timeline.detail": "Chi tiết dòng thời gian",
  "settings.timeline.description": "Chọn lượng hoạt động xuất hiện trong dòng thời gian. Tin nhắn vẫn hiển thị.",
  "settings.timeline.preset.everything": "Mọi thứ",
  "settings.timeline.preset.detailed": "Chi tiết",
  "settings.timeline.preset.compact": "Nhỏ gọn",
  "settings.timeline.preset.quiet": "Im lặng",
  "settings.timeline.preset.text-only": "Chỉ văn bản",
  ...
  "settings.timeline.description.custom":
    "Sử dụng vị trí và thông tin chi tiết đã chọn của bạn cho từng danh mục hoạt động.",
  "settings.timeline.custom": "Phong tục",
  "settings.timeline.advanced": "Trình độ cao",
  "settings.timeline.advanced.description": "Đặt vị trí và chi tiết cho từng danh mục hoạt động.",
  "settings.timeline.category.shell": "Vỏ bọc",
  "settings.timeline.category.edit": "Chỉnh sửa",
  "settings.timeline.category.thinking": "suy nghĩ",
  ...
  "session.review.filesChangedCount.one": "{{count}} tệp đã thay đổi",
  "session.review.filesChangedCount.other": "{{count}} tệp đã thay đổi",
  "settings.about.writtenByNames": "Được viết bởi {{names}}",
  "settings.about.illustratedByNames": "Minh họa bởi {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Chưa kết nối với {{host}}. Bản nháp của bạn đã được lưu; công việc từ xa có thể vẫn đang chạy.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Thêm máy chủ SSH",
  "ssh.server.menu.label": "Máy chủ SSH",
  "ssh.target": "Host hoặc lệnh SSH",
  "ssh.connect": "Kết nối",
  "ssh.connectTo": "Kết nối với {{host}}",
  "ssh.authenticate": "Xác thực SSH",
  "ssh.action.authenticate": "Xác thực",
  "ssh.session.disconnected": "Kết nối SSH không hoạt động",
  "ssh.session.connecting": "Đang kết nối với máy chủ SSH",
  "ssh.session.reconnectDescription":
    "Kết nối lại để xem phiên này và tiếp tục làm việc. Phiên làm việc từ xa của bạn đã được lưu.",
  "ssh.session.reconnect": "Kết nối lại",
  "ssh.authenticationRequired": "Cần xác thực cho {{host}}",
  "ssh.trust": "Tin cậy và kết nối",
  "ssh.continue": "Tiếp tục",
  "ssh.retry": "Thử lại",
  "ssh.update": "Cập nhật và kết nối lại",
  "ssh.openProject": "Mở dự án",
  "ssh.project": "Mở dự án trên {{host}}",
  "ssh.disconnect": "Ngắt kết nối",
  "ssh.forget": "Quên kết nối",
  "ssh.stage.disconnected": "Đã ngắt kết nối. Máy chủ từ xa vẫn đang chạy.",
  "ssh.stage.connecting": "Đang kết nối qua SSH…",
  "ssh.stage.checking": "Đang kiểm tra OpenCode…",
  "ssh.stage.downloading": "Đang tải máy chủ xuống…",
  "ssh.stage.uploading": "Đang tải máy chủ lên…",
  "ssh.stage.starting": "Đang kết nối với OpenCode…",
  "ssh.stage.ready": "Đã kết nối",
  "ssh.stage.authentication": "Cần xác thực",
  "ssh.stage.incompatible": "Cần cập nhật máy chủ",
  "ssh.stage.failed": "Kết nối thất bại",
  "ssh.error.input":
    "Nhập một máy chủ hoặc lệnh kết nối SSH. Các lệnh từ xa và tùy chọn SSH không được hỗ trợ sẽ không được phép.",
  "ssh.error.connection": "Không thể thiết lập kết nối SSH. Kiểm tra mạng và cấu hình SSH của bạn.",
  "ssh.error.platform":
    "Nền tảng từ xa này không được hỗ trợ. Việc thiết lập tự động hiện yêu cầu Linux hoặc macOS trên x64 hoặc arm64.",
  "ssh.error.version": "Dịch vụ từ xa phải khớp với phiên bản Desktop này trước khi kết nối.",
  "ssh.error.install":
  ...
  "ssh.error.service": "Đã kết nối SSH, nhưng máy chủ OpenCode chưa sẵn sàng.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing": "Không tìm thấy OpenSSH. Cài đặt một khách hàng OpenSSH và đảm bảo ssh có sẵn trên PATH.",
  "command.browser.open": "Mở trình duyệt",
  "command.browser.reload": "Tải lại trang trình duyệt",
  "command.session.summary.toggle": "Chuyển đổi tóm tắt",
  "common.color.orange": "cam",
  "common.color.yellow": "vàng",
  "common.color.cyan": "xanh lơ",
  "common.color.green": "xanh lá",
  "common.color.red": "đỏ",
  "common.color.pink": "hồng",
  "common.color.blue": "xanh dương",
  "common.color.purple": "tím",
  "common.color.gray": "xám",
  "mcp.auth.interactiveForm": "Máy chủ MCP {{name}} yêu cầu một biểu mẫu xác thực tương tác",
  "server.connect.title": "Kết nối đến máy chủ",
  "server.connect.description": "Nhập địa chỉ máy chủ và mật khẩu của bạn để bắt đầu.",
  ...
  "server.connect.camera": "Ghép cặp camera",
  ...
  "dialog.server.menu.remove": "Xóa",
  "file.error.notFound": "Không tìm thấy tệp: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Đang di chuyển phiên {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Đang di chuyển phiên {{current}}/{{total}}",
  "toast.migration.progress.working": "Đang di chuyển dữ liệu",
  "toast.migration.progress.working.current": "Đang di chuyển dữ liệu {{current}}",
  "toast.migration.progress.working.progress": "Đang di chuyển dữ liệu {{current}}/{{total}}",
  "home.workspaceTip": "Bắt đầu phiên tiếp theo trong một không gian làm việc mới để giữ các thay đổi riêng biệt",
  "session.tab.browser": "Trình duyệt",
  "session.tab.add": "Thêm tab",
  "session.queue.attachments.one": "Thêm {{count}} tệp đính kèm",
  "session.queue.attachments.other": "Thêm {{count}} tệp đính kèm",
  "session.browser.address": "Địa chỉ trình duyệt",
  "session.browser.replaced": "Điều khiển trình duyệt đã được chuyển sang cửa sổ máy tính để bàn khác.",
  "session.browser.unsupported": "Ứng dụng máy tính để bàn này không hỗ trợ ngăn trình duyệt.",
  "session.browser.suspended": "Trình duyệt bị tạm dừng. Tương tác với phiên này để kết nối lại.",
  "session.browser.address.placeholder": "Nhập URL",
  "session.browser.empty.title": "Nhập URL",
  "session.browser.empty.description": 'Hoặc nhập lời nhắc "Mở trong trình duyệt của ứng dụng"',
  "session.browser.failed.title": "Không thể truy cập URL",
  "session.browser.failed.description": "Kiểm tra URL và kết nối, rồi thử lại.",
  "settings.backToSettings": "Quay lại cài đặt",
  "settings.backToProjects": "Quay lại dự án",
  "settings.search.placeholder": "Tìm kiếm",
  "settings.search.results": "Kết quả cài đặt",
  "settings.search.group.pages": "Trang",
  "settings.search.group.settings": "Cài đặt",
  "settings.search.group.projects": "Dự án",
  "settings.search.group.servers": "Máy chủ",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Không có kết quả cho {{query}}",
  "settings.search.refine": "Hạn chế tìm kiếm của bạn để xem kết quả cụ thể hơn.",
  "settings.server.description": "Quản lý kết nối và các tùy chọn của máy chủ này",
  "settings.server.section.connection": "Kết nối",
  "settings.server.preferences.websearch.title": "Tìm kiếm bên thứ ba",
  "settings.server.preferences.websearch.description":
    "Chọn nhà cung cấp tìm kiếm mà tác nhân dùng để tìm kiếm trên web",
  "settings.projects.search.placeholder": "Tìm kiếm dự án",
  "project.settings.name.title": "Tên dự án",
  "project.settings.name.description": "Tên hiển thị cho dự án này trên toàn OpenCode",
  "project.settings.icon.description": "Khuyến nghị: 128×128px. Nhấp hoặc kéo để tải lên hình ảnh.",
  "project.settings.color.description": "Được sử dụng làm biểu tượng dự án khi chưa đặt hình ảnh tùy chỉnh",
  "project.settings.worktree.startup.description": "Chạy một lần sau khi tạo worktree mới",
  "project.settings.worktree.startup.hint.base": "Sử dụng $OPENCODE_WORKTREE_BASE cho worktree cơ sở.",
  "project.settings.worktree.startup.hint.new": "Sử dụng $OPENCODE_WORKTREE_PATH cho worktree mới.",
  "project.settings.extensions.empty.mcps.title": "Chưa có MCP nào",
  "project.settings.extensions.empty.mcps.description": "Các MCP có sẵn cho OpenCode sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.plugins.title": "Chưa có plugin nào",
  "project.settings.extensions.empty.plugins.description": "Các plugin có sẵn cho OpenCode sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.skills.title": "Chưa có kỹ năng nào",
  "project.settings.extensions.empty.skills.description": "Các kỹ năng có sẵn cho OpenCode sẽ xuất hiện ở đây",
  "project.settings.extensions.lsp.configured": "Các máy chủ ngôn ngữ đã cấu hình",
  "project.settings.extensions.lsp.status.enabled": "Đã bật trong cấu hình",
  "project.settings.extensions.lsp.status.disabled": "Đã tắt trong cấu hình",
  "project.settings.extensions.lsp.empty.title": "Chưa có máy chủ ngôn ngữ nào được cấu hình",
  "project.settings.extensions.lsp.empty.description":
    "Các máy chủ ngôn ngữ được cấu hình cho dự án này sẽ xuất hiện ở đây",
  "project.settings.extensions.lsp.disabled.title": "Máy chủ ngôn ngữ bị tắt",
  "project.settings.extensions.lsp.disabled.description": "LSP bị vô hiệu trong cấu hình dự án này",
  "project.settings.extensions.lsp.loadFailed": "Không thể tải cấu hình máy chủ ngôn ngữ",
  "project.settings.extensions.lsp.retry": "Thử lại",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Nhóm",
  "settings.timeline.collapse": "Thu gọn",
  "settings.timeline.visibility.show": "Hiện",
  "settings.timeline.visibility.hide": "Ẩn",
  "settings.timeline.visibility.label": "Hiển thị {{activity}}",
  "settings.timeline.grouped.label": "{{activity}} đã được nhóm",
  "settings.timeline.collapsed.label": "{{activity}} đã được thu gọn",
  "session.new.workspace.search.empty": "Không có worktree phù hợp",
  "settings.workspaces.description": "Xem lại các worktree và quản lý mức sử dụng ổ đĩa",
  "settings.workspaces.empty.description": "Các worktree được tạo trong OpenCode sẽ xuất hiện ở đây",
  "settings.workspaces.sessions.filtered.one": "{{count}} phiên",
  "settings.workspaces.sessions.filtered.other": "{{count}} phiên",
  "settings.workspaces.deleteAll.confirm.one": "Thao tác này sẽ xóa vĩnh viễn {{count}} worktree đã chọn.",
  "settings.workspaces.deleteAll.confirm.other": "Thao tác này sẽ xóa vĩnh viễn {{count}} worktree đã chọn.",
  "settings.workspaces.deleteWithoutSessions": "Xóa worktree không có phiên",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Thao tác này sẽ xóa vĩnh viễn {{count}} worktree không có phiên liên kết.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Thao tác này sẽ xóa vĩnh viễn {{count}} worktree không có phiên liên kết.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Các worktree có thay đổi chưa hợp nhất hoặc vị trí đang hoạt động sẽ được giữ lại.",
  "settings.workspaces.delete.button": "Xóa worktree",
  "workspace.lifecycle.deleting": "Đang xóa…",
  "session.summary.tooltip": "Tóm tắt",
  "session.summary.server": "Tiện ích mở rộng",
  "session.summary.chooseProject": "Chọn một dự án",
  "session.summary.mcp.onCreation": "Áp dụng khi worktree được tạo",
  "session.summary.mcp.prepareFailed": "Không thể chuẩn bị các máy chủ MCP",
  "session.summary.mcp.unavailable": "Máy chủ MCP {{name}} không khả dụng trong worktree này.",
  "session.summary.mcp.signInBeforeSend": "Đăng nhập vào {{name}} trước khi gửi lời nhắc.",
  "session.summary.mcp.notReady":
    "MCP server {{name}} chưa sẵn sàng. Hãy giải quyết kết nối của nó trước khi gửi prompt.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Máy chủ MCP đã cấu hình",
  "session.summary.plugins": "Tiện ích",
  "session.summary.plugins.configured": "Tiện ích đã cấu hình",
  "session.summary.skills": "Kỹ năng",
  "session.summary.skills.configured": "Kỹ năng đã cấu hình",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Thất bại",
  "session.summary.retry": "Thử lại",
  "session.summary.connecting": "Đang kết nối…",
  "session.summary.needsAuth": "Cần đăng nhập",
  "session.summary.configure": "Tệp cấu hình",
  "session.summary.copyConfigPath": "Sao chép đường dẫn tệp cấu hình",
  "session.summary.configFileMissing": "Không tìm thấy tệp cấu hình",
  "session.summary.mcp.empty": "Chưa cấu hình máy chủ MCP nào",
  "session.summary.mcp.add": "Thêm máy chủ trong opencode.json",
  "session.summary.plugins.manage": "Quản lý tiện ích trong opencode.json",
  "session.summary.plugins.empty": "Chưa cấu hình tiện ích nào",
  "session.summary.plugins.add": "Thêm tiện ích trong opencode.json",
  "session.summary.skills.manage": "Quản lý kỹ năng trong opencode.json",
  "session.summary.skills.empty": "Chưa cấu hình kỹ năng nào",
  "session.summary.skills.add": "Thêm kỹ năng trong opencode.json",
  "session.summary.lsp.configured": "LSP đã cấu hình",
  "session.summary.lsp.empty": "Chưa cấu hình máy chủ LSP nào",
  "session.summary.lsp.manage": "Quản lý LSP trong opencode.json",
  "workspace.delete.confirm": "Xóa “{{name}}”?",
  "workspace.delete.location": "Vị trí",
