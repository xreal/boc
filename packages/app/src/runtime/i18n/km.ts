export const dict = {
  ...
  "command.debugBar.toggle": "បិទ/បើករបារបំបាត់កំហុស",
  ...
  "command.session.location.cycle": "ប្តូរទីតាំងសម័យជាបន្តបន្ទាប់",
  ...
  "provider.connect.title.anthropicProMax": "ចូលដោយប្រើ Anthropic",
  ...
  "prompt.toast.uploading.cancel": "បោះបង់ការផ្ទុកឡើង",
  "prompt.toast.uploading.cancelFile": "បោះបង់ការផ្ទុកឡើង {{filename}}",
  "prompt.toast.uploadFailed.title": "ការផ្ទុកឡើងបានបរាជ័យ",
  ...
  "debugBar.providerAriaLabel": "ការវិនិច្ឆ័យដំណើរការរបស់អ្នកផ្តល់សេវា",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "ពេលវេលាចាប់ពីផ្ញើសំណើទៅអ្នកផ្តល់សេវា រហូតដល់លទ្ធផលដំបូងរបស់ម៉ូដែល។",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "ពេលវេលាចាប់ពីផ្ញើសំណើទៅអ្នកផ្តល់សេវា រហូតដល់អត្ថបទចម្លើយដំបូង។",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "ចំនួនថូខឹនលទ្ធផលក្នុងមួយវិនាទី បន្ទាប់ពីលទ្ធផលដំបូងរបស់ម៉ូដែល។",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "ពេលវេលាចាប់ពីផ្ញើសំណើទៅអ្នកផ្តល់សេវា រហូតដល់ស្ទ្រីមឆ្លើយតបបញ្ចប់។",
  "debugBar.na": "n/a",
  ...
  "settings.updates.action.download": "ទាញយក OpenCode",
  "settings.updates.migration.title": "ផ្លាស់ប្តូរពី Beta ទៅ Stable",
  ...
  "settings.workspaces.deleteAll.warning":
    "Worktree ដែលមានការផ្លាស់ប្តូរមិនទាន់បញ្ចូលគ្នា សម័យដែលបានភ្ជាប់ ឬទីតាំងកំពុងប្រើ នឹងត្រូវរក្សាទុក។",
  ...
  "session.location.unavailable": "ទីតាំងសម័យមិនអាចប្រើបាន",
  "session.location.description": "ជ្រើសថតមួយផ្សេងទៀត ដើម្បីបន្តសម័យនេះ។",
  "session.location.choose": "ជ្រើសថត",
  "session.location.worktree": "ជ្រើស worktree",
  "session.location.worktreesFailed": "មិនអាចផ្ទុក worktree បានទេ",
  "session.location.moving": "កំពុងផ្លាស់ទីសម័យ…",
  "dialog.server.menu.hide": "លាក់ពីបញ្ជីគម្រោង",
  "dialog.server.menu.show": "បង្ហាញក្នុងបញ្ជីគម្រោង",
  "session.queue.count.one": "បានដាក់ក្នុងជួរ {{count}}",
  "session.queue.count.other": "បានដាក់ក្នុងជួរ {{count}}",
  "session.queue.steer": "ណែនាំ",
  "session.queue.send": "ផ្ញើ",
  "session.queue.steerTooltip": "ផ្ញើដោយមិនរំខាន",
  "session.queue.remove": "ដកចេញ",
  "session.queue.reorder": "រៀបលំដាប់ prompt ក្នុងជួរឡើងវិញ",
  "session.new.worktree.creating": "កំពុងបង្កើត worktree",
  "settings.backToApp": "ត្រឡប់ទៅកម្មវិធី",
  "settings.appearance.section.experimental": "សាកល្បង",
  "settings.appearance.row.tabs.title": "ផ្ទាំង",
  "settings.appearance.row.tabs.description": "ជ្រើសរបៀបរៀបចំផ្ទាំងសម័យ",
  "settings.appearance.row.tabs.horizontal": "ផ្ដេក",
  "settings.appearance.row.tabs.vertical": "បញ្ឈរ",
  "settings.general.row.followUpBehavior.title": "ឥរិយាបថបន្ត",
  "settings.general.row.followUpBehavior.description":
    "ជ្រើសដាក់សារបន្តក្នុងជួរ ឬណែនាំវេនបច្ចុប្បន្ន។ ប្រើ {{keybind}} ដើម្បីប្ដូរ។",
  "settings.general.row.followUpBehavior.queue": "ដាក់ក្នុងជួរ",
  "settings.general.row.followUpBehavior.steer": "ណែនាំ",
  "settings.general.row.reasoningMode.title": "ការពិចារណារបស់ម៉ូដែល",
  "settings.general.row.reasoningMode.description": "ជ្រើសរបៀបបង្ហាញការពិចារណារបស់ម៉ូដែលក្នុងបន្ទាត់ពេលវេលា",
  "settings.general.row.reasoningMode.hidden": "លាក់",
  "settings.general.row.reasoningMode.compact": "សង្ខេប",
  "settings.general.row.reasoningMode.full": "ពេញលេញ",
  "session.new.workspace.createFrom": "បង្កើតពី",
  "session.new.workspace.branch.search.placeholder": "ស្វែងរកសាខា",
  "toast.migration.progress.clearingOldEvents": "កំពុងសម្អាតព្រឹត្តិការណ៍ចាស់ៗ",
  "toast.migration.progress.migratingSessions": "កំពុងផ្ទេរសម័យ",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "គម្រោងលំនាំដើម",
  "home.projects.all": "គម្រោងទាំងអស់។",
  "session.tab.files": "ឯកសារ",
  "session.files.openTabs": "បើកឯកសារ",
  "session.tab.usage": "ការប្រើប្រាស់",
  "session.view.select": "ទិដ្ឋភាពសម័យ",
  "session.background.moveTasks": "ផ្លាស់ទី {{tasks}} ទៅផ្ទៃខាងក្រោយ",
  "session.background.moveRunning": "ផ្លាស់ទីទៅផ្ទៃខាងក្រោយ",
  "session.background.inBackground": "កំពុងដំណើរការ {{tasks}} នៅផ្ទៃខាងក្រោយ",
  "session.background.tasksRunning.one": "កិច្ចការផ្ទៃខាងក្រោយ {{count}} កំពុងដំណើរការ",
  "session.background.tasksRunning.other": "កិច្ចការផ្ទៃខាងក្រោយ {{count}} កំពុងដំណើរការ",
  "session.background.combine": "{{first}} និង {{second}}",
  "session.background.shell.one": "សែល {{count}}",
  "session.background.shell.other": "សំបក {{count}}",
  "session.background.subagent.one": "ភ្នាក់ងាររង {{count}}",
  "session.background.subagent.other": "ភ្នាក់ងាររង {{count}}",
  "session.timeline.working": "ធ្វើការ",
  "session.review.wrapLines": "រុំបន្ទាត់",
  "session.websearch.title": "ការស្វែងរកគេហទំព័រភាគីទីបី",
  "session.websearch.description": "ជ្រើសរើសភ្នាក់ងារផ្តល់សេវាស្វែងរកប្រើដើម្បីស្វែងរកគេហទំព័រ",
  "session.websearch.provider": "ស្វែងរកអ្នកផ្តល់សេវា",
  "session.websearch.any": "ណាមួយ។",
  "session.websearch.disable": "កុំប្រើការស្វែងរក",
  "session.websearch.enable": "បើក",
  "session.websearch.loadFailed": "មិនអាចផ្ទុកអ្នកផ្តល់សេវាស្វែងរកបានទេ។",
  "session.websearch.empty": "មិនមានអ្នកផ្តល់សេវាស្វែងរកទេ។",
  "session.websearch.failed": "មិនអាចរក្សាទុកជម្រើសរបស់អ្នកបានទេ។ សូមព្យាយាមម្តងទៀត។",
  "session.websearch.retry": "ព្យាយាមម្តងទៀត",
  "session.new.worktree.draftPlaceholder": "ពង្រាង​ការ​តាមដាន ខណៈ​ដែល​មែកធាង​ការងារ​កំពុង​រៀបចំ…",
  "session.search.placeholder": "ស្វែងរក...",
  "session.search.noResults": "គ្មានការប្រកួត",
  "titlebar.tabs": "ផ្ទាំង",
  "titlebar.channel.local": "ក្នុងស្រុក",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "បេតា",
  "titlebar.toggleDebugTools": "បិទបើកឧបករណ៍បំបាត់កំហុស",
  "settings.tab.experimental": "ពិសោធន៍",
  "settings.experimental.description": "សាកល្បងមុខងារពិសោធន៍",
  "settings.tab.about": "អំពី",
  "settings.about.version": "កំណែ {{version}}",
  "settings.about.devVersion": "ការអភិវឌ្ឍន៍",
  "settings.about.license": "ចេញផ្សាយក្រោមអាជ្ញាប័ណ្ណ MIT",
  "settings.about.writtenBy": "សរសេរដោយ",
  "settings.about.illustratedBy": "គូររូបដោយ",
  "settings.about.and": "និង",
  "settings.about.otherContributor.one": "{{count}} ផ្សេងទៀត។",
  "settings.about.otherContributor.other": "{{count}} ផ្សេងទៀត។",
  "settings.about.firstPublished": "បោះពុម្ព​លើក​ដំបូង​នៅ​រដ្ឋ Missouri សហរដ្ឋ​អាមេរិក",
  "settings.about.firstIllustrated": "គូរដំបូងនៅទីក្រុងឡុង ប្រទេសអង់គ្លេស",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode ដែលជាភ្នាក់ងារសរសេរកូដប្រភពបើកចំហ",
  "settings.about.trademark": "OpenCode គឺជាពាណិជ្ជសញ្ញាដែលបានចុះបញ្ជីរបស់ Anomaly Innovations, Inc.",
  "settings.about.typeset": "Typeset នៅក្នុង Inter និង IBM Plex Mono",
  "settings.about.tagline": "AI មិនអាចបង្កើតកម្មវិធីដ៏អស្ចារ្យបានទេ បើគ្មានអ្នក",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "កែសម្រួលគម្រោង",
  "settings.timeline.title": "បន្ទាត់ពេលវេលា",
  "settings.timeline.detail": "ព័ត៌មានលម្អិតអំពីពេលវេលា",
  "settings.timeline.description": "ជ្រើសរើសសកម្មភាពដែលបង្ហាញនៅក្នុងបន្ទាត់ពេលវេលា។ សារនៅតែអាចមើលឃើញ។",
  "settings.timeline.preset.everything": "អ្វីគ្រប់យ៉ាង",
  "settings.timeline.preset.detailed": "លម្អិត",
  "settings.timeline.preset.compact": "បង្រួម",
  "settings.timeline.preset.quiet": "ស្ងាត់",
  "settings.timeline.preset.text-only": "អត្ថបទតែប៉ុណ្ណោះ",
  ...
  "settings.timeline.description.custom":
    "ប្រើទីតាំងដែលបានជ្រើសរើស និងព័ត៌មានលម្អិតរបស់អ្នកសម្រាប់ប្រភេទសកម្មភាពនីមួយៗ។",
  "settings.timeline.custom": "ផ្ទាល់ខ្លួន",
  "settings.timeline.advanced": "កម្រិតខ្ពស់",
  "settings.timeline.advanced.description": "កំណត់ទីតាំង និងព័ត៌មានលម្អិតសម្រាប់ប្រភេទសកម្មភាពនីមួយៗ។",
  "settings.timeline.category.shell": "សែល",
  "settings.timeline.category.edit": "ការកែសម្រួល",
  "settings.timeline.category.thinking": "ការគិត",
  "settings.timeline.category.subagents": "ភ្នាក់ងាររង",
  "settings.timeline.category.notices": "សេចក្តីជូនដំណឹង",
  "settings.timeline.category.tools": "ឧបករណ៍ផ្សេងទៀត។",
  "settings.general.row.mobileDiffWrap.description": "រុំបន្ទាត់វែងនៅក្នុងភាពខុសគ្នានៃទូរស័ព្ទជំនួសឱ្យការរមូរផ្ដេក",

  "provider.connect.error.unsupportedFields": "ទម្រង់​ការ​ផ្ទៀងផ្ទាត់​នេះ​មាន​វាល​ដែល​មិន​អាច​ប្រើ​បាន។",
  "session.review.filesChangedCount.one": "ឯកសារ {{count}} បានផ្លាស់ប្តូរ",
  "session.review.filesChangedCount.other": "ឯកសារ {{count}} បានផ្លាស់ប្តូរ",
  "settings.about.writtenByNames": "សរសេរដោយ {{names}}",
  "settings.about.illustratedByNames": "គូររូបដោយ {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "មិនបានភ្ជាប់ទៅ {{host}}។ ខ្សែប្រយ័ត្នរបស់អ្នកត្រូវបានរក្សាទុក; ការងារពីចម្ងាយមិនទាន់បញ្ចប់អាចនៅតែដំណើរការ។",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "បន្ថែមម៉ាស៊ីនបម្រើ SSH",
  "ssh.server.menu.label": "ម៉ាស៊ីនបម្រើ SSH",
  "ssh.target": "ម៉ាស៊ីនបម្រើ ឬពាក្យបញ្ជា SSH",
  "ssh.connect": "ភ្ជាប់",
  "ssh.connectTo": "ភ្ជាប់ទៅ {{host}}",
  "ssh.authenticate": "ការផ្ទៀងផ្ទាត់ SSH",
  "ssh.action.authenticate": "ផ្ទៀងផ្ទាត់",
  "ssh.session.disconnected": "ការភ្ជាប់ SSH មិនសកម្ម",
  "ssh.session.connecting": "កំពុងភ្ជាប់ទៅម៉ាស៊ីនបម្រើ SSH",
  "ssh.session.reconnectDescription":
    "ភ្ជាប់ម្តងទៀតដើម្បីមើលកិច្ចប្រជុំនេះ និងបន្តការងារ។ កិច្ចប្រជុំពីចម្ងាយរបស់អ្នកត្រូវបានរក្សាទុក។",
  "ssh.session.reconnect": "ភ្ជាប់ម្តងទៀត",
  "ssh.authenticationRequired": "តម្រូវការផ្ទៀងផ្ទាត់សម្រាប់ {{host}}",
  "ssh.trust": "ទុកចិត្ត និងភ្ជាប់",
  "ssh.continue": "បន្ត",
  "ssh.retry": "ព្យាយាមម្តងទៀត",
  "ssh.update": "ធ្វើបច្ចុប្បន្នភាព និងភ្ជាប់ម្តងទៀត",
  "ssh.openProject": "បើកគម្រោង",
  "ssh.project": "បើកគម្រោងនៅលើ {{host}}",
  "ssh.disconnect": "ផ្តាច់",
  "ssh.forget": "ភ្លេចការតភ្ជាប់",
  "ssh.stage.disconnected": "បានផ្តាច់។ ម៉ាស៊ីនមេពីចម្ងាយនៅតែដំណើរការ។",
  "ssh.stage.connecting": "កំពុងតភ្ជាប់តាម SSH…",
  "ssh.stage.checking": "កំពុងពិនិត្យ OpenCode…",
  "ssh.stage.downloading": "កំពុងទាញយកម៉ាស៊ីនមេ…",
  "ssh.stage.uploading": "កំពុងផ្ទុកម៉ាស៊ីនមេឡើង…",
  "ssh.stage.starting": "កំពុងតភ្ជាប់ទៅ OpenCode…",
  "ssh.stage.ready": "បានតភ្ជាប់",
  "ssh.stage.authentication": "ត្រូវការការផ្ទៀងផ្ទាត់",
  "ssh.stage.incompatible": "ត្រូវការការបច្ចុប្បន្នភាពម៉ាស៊ីនមេ",
  "ssh.stage.failed": "ការតភ្ជាប់បរាជ័យ",
  "ssh.error.input":
    "បញ្ចូលភ្ញៀវ ឬ ពាក្យបញ្ជាតភ្ជាប់ SSH។ ពាក្យបញ្ជាដែលនៅចម្ងាយ និងជម្រើស SSH ដែលមិនគាំទ្រមិនអនុញ្ញាត។",
  "ssh.error.connection": "មិនអាចបង្កើតការតភ្ជាប់ SSH បានទេ។ សូមពិនិត្យបណ្ដាញ និងការកំណត់រចនាសម្ព័ន្ធ SSH របស់អ្នក។",
  "ssh.error.platform":
    "វេទិកាចម្ងាយនេះមិនត្រូវបានគាំទ្រ។ ការតម្លើងស្វ័យប្រវត្តិពេលនេះត្រូវការលីនុច ឬ macOS លើ x64 ឬ arm64។",
  "ssh.error.version": "សេវាចម្ងាយត្រូវតែត្រូវគ្នាជាមួយកំណែ Desktop នេះ មុនពេលភ្ជាប់។",
  "ssh.error.install":
    "មិនអាចដំឡើងម៉ាស៊ីនបម្រើចម្ងាយបានទេ។ សូមពិនិត្យការតភ្ជាប់, កន្លែងក្នុងថាស, និងថាតើ tar ត្រូវបានដំឡើង។",
  "ssh.error.unpublished":
    "កំណែ Desktop នេះមិនមានម៉ាស៊ីនបម្រើចម្ងាយផ្សាយរួចទេ។ សម្រាប់ការផលិតជាការអភិវឌ្ឍ, ដំឡើង និងចាប់ផ្តើម V2 នៅលើម៉ាស៊ីនចុងក្រោយ, បន្ទាប់មកព្យាយាមម្ដងទៀត។",
  "ssh.error.service": "SSH បានភ្ជាប់, ប៉ុន្តែម៉ាស៊ីនបម្រើ OpenCode មិនបានត្រៀមខ្លួនទេ។",
  "ssh.error.host-key":
    "មិនអាចផ្ទៀងផ្ទាត់អត្តសញ្ញាណរបស់ម៉ាស៊ីនចុងក្រោយបានទេ។ សូមផ្ទៀងផ្ទាត់អោយបានត្រឹមត្រូវ fingerprint របស់វាមុនពេលធ្វើបច្ចុប្បន្នភាព SSH known hosts របស់អ្នក។",
  "ssh.error.ssh-missing": "មិនមាន OpenSSH ទេ។ សូមដំឡើងអ្នកប្រើ OpenSSH ហើយប្រាកដថា ssh មាននៅលើ PATH។",
  "command.browser.open": "បើកកម្មវិធីរុករក",
  "command.browser.reload": "ផ្ទុកទំព័រកម្មវិធីរុករកឡើងវិញ",
  "command.session.summary.toggle": "បិទ/បើកការជាអង្អែល",
  "common.color.orange": "ពណ៌ទឹកក្រូច",
  "common.color.yellow": "លឿង",
  "common.color.cyan": "សាយ៉ាន់",
  "common.color.green": "បៃតង",
  "common.color.red": "ក្រហម",
  "common.color.pink": "ផ្កាឈូក",
  "common.color.blue": "ខៀវ",
  "common.color.purple": "ពណ៌ស្វាយ",
  "common.color.gray": "ប្រផេះ",
  "mcp.auth.interactiveForm": "MCP server {{name}} ត្រូវការផ្ទៀងផ្ទាត់ជាមួយទម្រង់ផ្ទាល់ខ្លួន",
  "server.connect.title": "ភ្ជាប់ទៅម៉ាស៊ីនមេ",
  "server.connect.description": "បញ្ចូលអាសយដ្ឋានម៉ាស៊ីនមេ និងពាក្យសម្ងាត់របស់អ្នកដើម្បីចាប់ផ្តើម។",
  ...
  "dialog.server.menu.remove": "ផ្អាក",
  "file.error.notFound": "មិនឃើញឯកសារ: {{name}}",
  "toast.migration.progress.migratingSessions.current": "កំពុងផ្ទេរពត៌មានប្រតិបត្តិការ {{current}}",
  "toast.migration.progress.migratingSessions.progress": "កំពុងផ្ទេរពត៌មានប្រតិបត្តិការ {{current}}/{{total}}",
  "toast.migration.progress.working": "កំពុងផ្ទេរទិន្នន័យ",
  "toast.migration.progress.working.current": "កំពុងផ្ទេរទិន្នន័យ {{current}}",
  "toast.migration.progress.working.progress": "កំពុងផ្ទេរទិន្នន័យ {{current}}/{{total}}",
  "home.workspaceTip": "ចាប់ផ្តើមសម័យក្រោយនៅក្នុងកន្លែងធ្វើការថ្មីដើម្បីរក្សា​ការ​ផ្លាស់ប្តូរ​ឲ្យ​ផ្ទាល់ខ្លួន",
  "session.tab.browser": "កម្មវិធីរុករក",
  "session.tab.add": "បន្ថែមផ្ទាំង",
  "session.queue.attachments.one": "បូក {{count}} ភ្ជាប់ឯកសារ",
  "session.queue.attachments.other": "បូក {{count}} ភ្ជាប់ឯកសារ",
  "session.browser.address": "អាសយដ្ឋានកម្មវិធីរុករក",
  "session.browser.replaced": "ការត្រួតពិនិត្យរុករកបានផ្លាស់ទៅវីនដូតែមួយផ្សេងទៀតលើឌេស្គ្ទុប។",
  "session.browser.unsupported": "កម្មវិធីដេស្គ្ទុបនេះមិនគាំទ្របានផ្ទាំងរុករកទេ។",
  "session.browser.suspended": "កម្មវិធីរុករកបានផ្អាក។ សូមអន្តរកម្មជាមួយសម័យនេះដើម្បីភ្ជាប់ឡើងវិញ។",
  "session.browser.address.placeholder": "បញ្ចូល URL",
  "session.browser.empty.title": "បញ្ចូល URL",
  "session.browser.empty.description": 'ឬបញ្ចូល prompt "បើកក្នុងកម្មវិធីរុករករបស់កម្មវិធី"',
  "session.browser.failed.title": "មិនអាចចូលដល់ URL បានទេ",
  "session.browser.failed.description": "ពិនិត្យ URL និងការតភ្ជាប់របស់អ្នក រួចសាកល្បងម្តងទៀត។",
  "settings.backToSettings": "ត្រឡប់ទៅការកំណត់",
  "settings.backToProjects": "ត្រឡប់ទៅគម្រោង",
  "settings.search.placeholder": "ស្វែងរក",
  "settings.search.results": "លទ្ធផលការកំណត់",
  "settings.search.group.pages": "ទំព័រ",
  "settings.search.group.settings": "ការកំណត់",
  "settings.search.group.projects": "គម្រោង",
  "settings.search.group.servers": "ម៉ាស៊ីនមេ",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "គ្មានលទ្ធផលសម្រាប់ {{query}}",
  "settings.search.refine": "ត្រូវកាត់បន្ថយការស្វែងរករបស់អ្នកដើម្បីមើលលទ្ធផលដែលច្បាស់លាស់ជាងនេះ។",
  "settings.server.description": "គ្រប់គ្រងការតភ្ជាប់ និងចំណង់ចំណូលចិត្តរបស់ម៉ាស៊ីនមេនេះ",
  "settings.server.section.connection": "ការតភ្ជាប់",
  "settings.server.preferences.websearch.title": "ការស្វែងរកភាគីទីបី",
  "settings.server.preferences.websearch.description":
    "ជ្រើសរើសអ្នកផ្គត់ផ្គង់ស្វែងរកដែលរត់ភ្នាក់ងារប្រើក្នុងការស្វែងរកបណ្ដាញ",
  "settings.projects.search.placeholder": "គម្រោងស្វែងរក",
  "project.settings.name.title": "ឈ្មោះគម្រោង",
  "project.settings.name.description": "ឈ្មោះដែលបង្ហាញសម្រាប់គម្រោងនេះទូទាំង OpenCode",
  "project.settings.icon.description": "ណែនាំ៖ 128×128px។ ចុច ឬ ទាញដើម្បីផ្ទុករូបភាពមួយឡើង។",
  "project.settings.color.description": "ប្រើសម្រាប់រូបតំណាងគម្រោងនៅពេលមិនមានរូបភាពប្ដូរតាមបំណង",
  "project.settings.worktree.startup.description": "រត់មួយដង បន្ទាប់ពីបង្កើត worktree ថ្មី",
  "project.settings.worktree.startup.hint.base": "ប្រើ $OPENCODE_WORKTREE_BASE សម្រាប់ worktree មូលដ្ឋាន។",
  "project.settings.worktree.startup.hint.new": "ប្រើ $OPENCODE_WORKTREE_PATH សម្រាប់ worktree ថ្មី។",
  "project.settings.extensions.empty.mcps.title": "មិនមាន MCPs ទេ",
  "project.settings.extensions.empty.mcps.description": "MCPs ដែលអាចប្រើសម្រាប់ OpenCode នឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.empty.plugins.title": "មិនមានផ្លាស៊ីនទេ",
  "project.settings.extensions.empty.plugins.description": "ផ្លាស៊ីនដែលអាចប្រើសម្រាប់ OpenCode នឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.empty.skills.title": "មិនមានជំនាញទេ",
  "project.settings.extensions.empty.skills.description": "ជំនាញដែលអាចប្រើសម្រាប់ OpenCode នឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.lsp.configured": "ម៉ាស៊ីនមេភាសាដែលបានកំណត់",
  "project.settings.extensions.lsp.status.enabled": "បានបើកនៅក្នុងការកំណត់",
  "project.settings.extensions.lsp.status.disabled": "បានបិទនៅក្នុងការកំណត់",
  "project.settings.extensions.lsp.empty.title": "មិនមានម៉ាស៊ីនមេភាសាត្រូវបានកំណត់ទេ",
  "project.settings.extensions.lsp.empty.description": "ម៉ាស៊ីនមេភាសាដែលបានកំណត់សម្រាប់គម្រោងនេះនឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.lsp.disabled.title": "ម៉ាស៊ីនមេភាសាត្រូវបានបិទ",
  "project.settings.extensions.lsp.disabled.description": "LSP ត្រូវបានបិទនៅក្នុងការកំណត់គម្រោងនេះ",
  "project.settings.extensions.lsp.loadFailed": "មិនអាចផ្ទុកការកំណត់ម៉ាស៊ីនបម្រើភាសា",
  "project.settings.extensions.lsp.retry": "ព្យាយាមម្តងទៀត",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "ក្រុម",
  "settings.timeline.collapse": "បង្រួម",
  "settings.timeline.visibility.show": "បង្ហាញ",
  "settings.timeline.visibility.hide": "លាក់",
  "settings.timeline.visibility.label": "ភាពច្បាស់លាស់របស់ {{activity}}",
  "settings.timeline.grouped.label": "{{activity}} បានក្រុម",
  "settings.timeline.collapsed.label": "{{activity}} បានបង្រួម",
  "session.new.workspace.search.empty": "មិនមាន worktrees ត្រូវគ្នា",
  "settings.workspaces.description": "ពិនិត្យមើល worktrees និងគ្រប់គ្រងការប្រើប្រាស់ឌីស",
  "settings.workspaces.empty.description": "Worktrees ដែលបានបង្កើតក្នុង OpenCode នឹងបង្ហាញនៅទីនេះ",
  "settings.workspaces.sessions.filtered.one": "{{count}} សម័យ",
  "settings.workspaces.sessions.filtered.other": "{{count}} សម័យ",
  "settings.workspaces.deleteAll.confirm.one": "វានឹងលុប worktree ដែលបានជ្រើសរើសចំនួន {{count}} ជាអចិន្ត្រៃយ៍។",
  "settings.workspaces.deleteAll.confirm.other": "វានឹងលុប worktree ដែលបានជ្រើសរើសចំនួន {{count}} ជាអចិន្ត្រៃយ៍។",
  "settings.workspaces.deleteWithoutSessions": "លុប worktrees ដោយគ្មានសម័យ",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "វានឹងលុប worktree ចំនួន {{count}} ដែលគ្មានសម័យភ្ជាប់ជាអចិន្ត្រៃយ៍។",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "វានឹងលុប worktree ចំនួន {{count}} ដែលគ្មានសម័យភ្ជាប់ជាអចិន្ត្រៃយ៍។",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Worktrees ដែលមានការផ្លាស់ប្តូរមិនបានបញ្ចូលឬទីតាំងដែលសកម្មនឹងត្រូវរក្សាទុក។",
  "settings.workspaces.delete.button": "លុប worktrees",
  "workspace.lifecycle.deleting": "កំពុងលុប…",
  "session.summary.tooltip": "សង្ខេប",
  "session.summary.server": "ផ្នែកបន្ថែម",
  "session.summary.chooseProject": "ជ្រើសរើសគម្រោង",
  "session.summary.mcp.onCreation": "អនុវត្តនៅពេល worktree ត្រូវបានបង្កើត",
  "session.summary.mcp.prepareFailed": "មិនអាចរៀបចំម៉ាស៊ីនបម្រើ MCP បាន",
  "session.summary.mcp.unavailable": "MCP server {{name}} មិនអាចប្រើបានក្នុង worktree នេះ។",
  "session.summary.mcp.signInBeforeSend": "ចូលទៅកាន់ {{name}} មុនពេលផ្ញើប្រអប់សំណើ។",
  "session.summary.mcp.notReady": "ម៉ាស៊ីនមេ MCP {{name}} មិនត្រៀមរួចទេ។ សូមដោះសោការតភ្ជាប់របស់វាមុនពេលផ្ញើបញ្ជា។",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "ម៉ាស៊ីនមេ MCP ដែលបានកំណត់រចនាសម្ព័ន្ធ",
  "session.summary.plugins": "ផ្លុយអ៊ីន",
  "session.summary.plugins.configured": "ផ្លុយអ៊ីនដែលបានកំណត់រចនាសម្ព័ន្ធ",
  "session.summary.skills": "ជំនាញ",
  "session.summary.skills.configured": "ជំនាញបានកំណត់",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "បរាជ័យ",
  "session.summary.retry": "សាកលើកម្តងទៀត",
  "session.summary.connecting": "កំពុងភ្ជាប់…",
  "session.summary.needsAuth": "តើត្រូវចូលក្នុងគណនី",
  "session.summary.configure": "កំណត់រចនាសម្ព័ន្ធ​ឯកសារ",
  "session.summary.copyConfigPath": "ចម្លងផ្លូវឯកសារ​កំណត់រចនាសម្ព័ន្ធ",
  "session.summary.configFileMissing": "មិនបានឃើញឯកសារ​កំណត់រចនាសម្ព័ន្ធ",
  "session.summary.mcp.empty": "មិនមានម៉ាស៊ីន​បម្រើ MCP ត្រូវបានកំណត់",
  "session.summary.mcp.add": "បន្ថែមម៉ាស៊ីនបម្រើក្នុង opencode.json",
  "session.summary.plugins.manage": "គ្រប់គ្រងផ្លាតថ្ន័ក្នុង opencode.json",
  "session.summary.plugins.empty": "មិនមានផ្លាតថ្ន័ណាមួយត្រូវបានកំណត់",
  "session.summary.plugins.add": "បន្ថែមផ្លាតថ្ន័ក្នុង opencode.json",
  "session.summary.skills.manage": "គ្រប់គ្រងជំនាញនៅក្នុង opencode.json",
  "session.summary.skills.empty": "មិនមានជំនាញដែលបានកំណត់ទេ",
  "session.summary.skills.add": "បន្ថែមជំនាញនៅក្នុង opencode.json",
  "session.summary.lsp.configured": "LSPs ដែលបានកំណត់",
  "session.summary.lsp.empty": "មិនមានម៉ាស៊ីនមេ LSP ត្រូវបានកំណត់ទេ",
  "session.summary.lsp.manage": "គ្រប់គ្រង LSP ក្នុង opencode.json",
  "workspace.delete.confirm": "លុប “{{name}}” ទេទេ?",
  "workspace.delete.location": "ទីតាំង",
