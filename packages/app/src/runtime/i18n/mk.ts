export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Работните стебла со неспоени промени, поврзани сесии или активни локации ќе бидат зачувани.",
  ...
  "session.location.unavailable": "Локацијата на сесијата не е достапна",
  "session.location.description": "Изберете друг директориум за да ја продолжите оваа сесија.",
  "session.location.choose": "Избери директориум",
  "session.location.worktree": "Избери работно дрво",
  "session.location.worktreesFailed": "Работните дрва не можеа да се вчитаат",
  "session.location.moving": "Преместување на сесијата…",
  "dialog.server.menu.hide": "Скриј од списокот на проекти",
  "dialog.server.menu.show": "Прикажи во списокот на проекти",
  "session.queue.count.one": "{{count}} ставка во редот",
  "session.queue.count.other": "{{count}} ставки во редот",
  "session.queue.steer": "Насочи",
  "session.queue.send": "Испрати",
  "session.queue.steerTooltip": "Испрати без прекинување",
  "session.queue.remove": "Отстрани",
  "session.queue.reorder": "Промени го редоследот на барањето во редот",
  "session.new.worktree.creating": "Креирање работно дрво",
  "settings.backToApp": "Назад кон апликацијата",
  "settings.appearance.section.experimental": "Експериментално",
  "settings.appearance.row.tabs.title": "Картички",
  "settings.appearance.row.tabs.description": "Изберете како да бидат распоредени картичките на сесиите",
  "settings.appearance.row.tabs.horizontal": "Хоризонтално",
  "settings.appearance.row.tabs.vertical": "Вертикално",
  "settings.general.row.followUpBehavior.title": "Однесување на дополнителните пораки",
  "settings.general.row.followUpBehavior.description":
    "Изберете дали дополнителните пораки да се стават во ред или да го насочат тековниот чекор. Користете {{keybind}} за префрлање.",
  "settings.general.row.followUpBehavior.queue": "Стави во ред",
  "settings.general.row.followUpBehavior.steer": "Насочи",
  "settings.general.row.reasoningMode.title": "Расудување на моделот",
  "settings.general.row.reasoningMode.description":
    "Изберете како да се прикажува расудувањето на моделот во временската линија",
  "settings.general.row.reasoningMode.hidden": "Скриено",
  "settings.general.row.reasoningMode.compact": "Компактно",
  "settings.general.row.reasoningMode.full": "Целосно",
  "session.new.workspace.createFrom": "Креирај од гранка",
  "session.new.workspace.branch.search.placeholder": "Пребарај гранки",
  "desktop.onboarding.defaultProject": "Стандарден проект",
  "toast.migration.progress.clearingOldEvents": "Бришење на старите настани",
  "toast.migration.progress.migratingSessions": "Мигрирање на сесиите",
  "session.new.workspace.existingLabel": "Работно дрво",
  "home.projects.all": "Сите проекти",
  "session.tab.files": "Датотеки",
  "session.files.openTabs": "Отворени датотеки",
  "session.tab.usage": "Употреба на",
  ...
  "session.background.tasksRunning.one": "{{count}} задача во заднина се извршува",
  "session.background.tasksRunning.other": "{{count}} задачи во заднина се извршуваат",
  ...
  "session.websearch.provider": "Провајдер за пребарување",
  "session.websearch.any": "Секое",
  "session.websearch.disable": "Не користете пребарување",
  "session.websearch.enable": "Овозможи",
  "session.websearch.loadFailed": "Не може да се вчитаат давателите на пребарување.",
  "session.websearch.empty": "Нема достапни обезбедувачи на пребарување.",
  "session.websearch.failed": "Не можев да го зачувам вашиот избор. Ве молиме обидете се повторно.",
  "session.websearch.retry": "Обидете се повторно",
  "session.new.worktree.draftPlaceholder": "Напишете дополнителна порака додека се подготвува работното дрво…",
  "session.search.placeholder": "Најдете...",
  "session.search.noResults": "Нема совпаѓања",
  "titlebar.tabs": "Картички",
  "titlebar.channel.local": "Локално",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Вклучете ги алатките за отстранување грешки",
  "settings.tab.experimental": "Експериментален",
  "settings.experimental.description": "Обидете се со експериментални функции",
  "settings.tab.about": "За",
  "settings.about.version": "верзија {{version}}",
  "settings.about.devVersion": "Развој на",
  "settings.about.license": "Објавен под MIT License",
  "settings.about.writtenBy": "Напишано од",
  "settings.about.illustratedBy": "Илустрирано од",
  "settings.about.and": "и",
  "settings.about.otherContributor.one": "{{count}} друг",
  "settings.about.otherContributor.other": "{{count}} други",
  "settings.about.firstPublished": "Прво објавено во Мисури, САД",
  "settings.about.firstIllustrated": "Прво илустрирано во Лондон, Англија",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, агент за кодирање со отворен код",
  "settings.about.trademark": "OpenCode е регистрирана трговска марка на Anomaly Innovations, Inc.",
  "settings.about.typeset": "Типови во Inter и IBM Plex Mono",
  "settings.about.tagline": "AI не може да изгради одличен софтвер, без вас",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "Уреди проект",
  "settings.timeline.title": "Времеплов",
  "settings.timeline.detail": "Детали за временската линија",
  "settings.timeline.description":
    "Изберете колку активност ќе се појавува во временската линија. Пораките остануваат видливи.",
  "settings.timeline.preset.everything": "Сè",
  "settings.timeline.preset.detailed": "Детално",
  "settings.timeline.preset.compact": "Компактен",
  "settings.timeline.preset.quiet": "Тивко",
  ...
  "settings.timeline.description.custom":
    "Користете ја вашата избрана поставеност и детали за секоја категорија на активности.",
  "settings.timeline.custom": "Прилагодено",
  "settings.timeline.advanced": "Напредно",
  "settings.timeline.advanced.description": "Поставете поставеност и детали за секоја категорија на активности.",
  "settings.timeline.category.shell": "Школка",
  "settings.timeline.category.edit": "Уреди",
  ...
  "session.review.filesChangedCount.one": "{{count}} датотека е променета",
  "session.review.filesChangedCount.other": "{{count}} датотеки се променети",
  "settings.about.writtenByNames": "Напишано од {{names}}",
  "settings.about.illustratedByNames": "Илустрирано од {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Не сте поврзани на {{host}}. Вашиот нацрт е зачуван; далечинската работа сè уште може да продолжи.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Додај SSH сервер",
  "ssh.server.menu.label": "SSH сервер",
  "ssh.target": "Домаќин или SSH команда",
  "ssh.connect": "Поврзи се",
  "ssh.connectTo": "Поврзи се на {{host}}",
  "ssh.authenticate": "SSH автентикација",
  "ssh.action.authenticate": "Автентицирај се",
  "ssh.session.disconnected": "SSH конекција неактивна",
  "ssh.session.connecting": "Се поврзува на SSH сервер",
  "ssh.session.reconnectDescription":
    "Поврзи се повторно за да ја видиш оваа сесија и продолжиш со работа. Вашата далечинска сесија е зачувана.",
  "ssh.session.reconnect": "Поврзи се повторно",
  "ssh.authenticationRequired": "Потребна е автентикација за {{host}}",
  "ssh.trust": "Доверба и поврзи се",
  "ssh.continue": "Продолжи",
  "ssh.retry": "Обиди се повторно",
  "ssh.update": "Ажурирај и поврзи се повторно",
  "ssh.openProject": "Отвори проект",
  "ssh.project": "Отвори проект на {{host}}",
  "ssh.disconnect": "Исклучи се",
  "ssh.forget": "Заборави конекцијата",
  "ssh.stage.disconnected": "Исклучено. Далечинскиот сервер е оставен да работи.",
  "ssh.stage.connecting": "Се поврзува преку SSH…",
  "ssh.stage.checking": "Проверка на OpenCode…",
  "ssh.stage.downloading": "Преземање на сервер…",
  "ssh.stage.uploading": "Серверот се поставува…",
  "ssh.stage.starting": "Се поврзува со OpenCode…",
  "ssh.stage.ready": "Поврзано",
  "ssh.stage.authentication": "Потребна е автентикација",
  "ssh.stage.incompatible": "Потребно е ажурирање на серверот",
  "ssh.stage.failed": "Поврзувањето не успеа",
  "ssh.error.input":
    "Внесете хост или SSH команда за поврзување. Дистанциските команди и неподдржаните SSH опции не се дозволени.",
  "ssh.error.connection": "Не можеше да се воспостави SSH врската. Проверете ја вашата мрежа и SSH конфигурација.",
  "ssh.error.platform":
    "Оваа далечинска платформа не е поддржана. Автоматската поставка моментално бара Linux или macOS на x64 или arm64.",
  "ssh.error.version": "Далечинската услуга мора да ја совпаѓа оваа верзија на Desktop пред да се поврзете.",
  "ssh.error.install":
    "Не можеше да се инсталира далечинскиот сервер. Проверете ја конектибилноста, слободниот простор на дискот и дали tar е инсталиран.",
  "ssh.error.unpublished":
    "Оваа верзија на Desktop нема објавен далечински сервер. За верзии за развој, инсталирајте и стартувајте V2 на хостот, потоа обидете се повторно.",
  "ssh.error.service": "SSH е поврзан, но серверот OpenCode не стана подготвен.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Отвори прелистувач",
  "command.browser.reload": "Освежи страна на прелистувач",
  "command.session.summary.toggle": "Префрли преглед на резиме",
  "common.color.orange": "портокалова",
  "common.color.yellow": "жолта",
  "common.color.cyan": "цијан",
  "common.color.green": "зелена",
  "common.color.red": "црвена",
  "common.color.pink": "розова",
  "common.color.blue": "сина",
  "common.color.purple": "пурпурна",
  "common.color.gray": "сива",
  "mcp.auth.interactiveForm": "MCP сервер {{name}} бара интерактивна форма за автентикација",
  "server.connect.title": "Поврзи се со сервер",
  "server.connect.description": "Внесете ја вашата адреса на серверот и лозинка за да започнете.",
  "server.connect.button": "Поврзи се",
  ...
  "server.connect.camera.error":
    "Не можев да ја отворам камерата. Дозволете пристап до камерата или внесете ги деталите за вашата конекција рачно.",
  "dialog.server.menu.remove": "Отстрани",
  "file.error.notFound": "Фајлот не е пронајден: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Миграција на сесии {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Миграција на сесии {{current}}/{{total}}",
  "toast.migration.progress.working": "Миграција на податоци",
  "toast.migration.progress.working.current": "Мигрирање на податоци {{current}}",
  "toast.migration.progress.working.progress": "Мигрирање на податоци {{current}}/{{total}}",
  "home.workspaceTip": "Започнете ја следната сесија во нов работен простор за да ги одделите промените",
  "session.tab.browser": "Прелистувач",
  "session.tab.add": "Додај јазиче",
  "session.queue.attachments.one": "Плус {{count}} прилог",
  "session.queue.attachments.other": "Плус {{count}} прилози",
  "session.browser.address": "Адреса на прелистувач",
  "session.browser.replaced": "Контролата на прелистувачот е преместена во друг прозорец на десктопот.",
  "session.browser.unsupported": "Оваа десктоп апликација не поддржува панел за прелистувач.",
  "session.browser.suspended":
    "Прелистувачот е суспендиран. Интеракцијата со оваа сесија ќе овозможи повторно поврзување.",
  "session.browser.address.placeholder": "Внесете URL",
  "settings.backToSettings": "Назад на поставки",
  "settings.backToProjects": "Назад на проекти",
  "settings.search.placeholder": "Пребарување",
  "settings.search.results": "Резултати од поставките",
  "settings.search.group.pages": "Страници",
  "settings.search.group.settings": "Поставки",
  ...
  "settings.search.empty": "Нема резултати за {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Стеснете го пребарувањето за да видите поспецифични резултати.",
  "settings.server.description": "Управувајте ја врската и преференците на овој сервер",
  "settings.server.section.connection": "Врска",
  "settings.server.preferences.websearch.title": "Претражување од трети страни",
  "settings.server.preferences.websearch.description":
    "Изберете го провајдерот за пребарување кој агентите ќе го користат за пребарување на Интернет",
  "settings.projects.search.placeholder": "Проекти за пребарување",
  "project.settings.name.title": "Име на проектот",
  "project.settings.name.description": "Името што се прикажува за овој проект низ OpenCode",
  "project.settings.icon.description": "Препорачано: 128×128px. Кликнете или влечете за да отпочнете слика.",
  "project.settings.color.description": "Се користи за иконата на проектот кога не е поставена сопствена слика",
  "project.settings.worktree.startup.description": "Се извршува еднаш по создавањето на нов worktree",
  "project.settings.worktree.startup.hint.base": "Користете $OPENCODE_WORKTREE_BASE за базниот worktree.",
  "project.settings.worktree.startup.hint.new": "Користете $OPENCODE_WORKTREE_PATH за новиот worktree.",
  "project.settings.extensions.empty.mcps.title": "Сè уште нема MCPs",
  "project.settings.extensions.empty.mcps.description": "MCPs достапни за OpenCode ќе се појават тука",
  "project.settings.extensions.empty.plugins.title": "Сè уште нема приклучоци",
  "project.settings.extensions.empty.plugins.description": "Приклучоци достапни за OpenCode ќе се појават тука",
  "project.settings.extensions.empty.skills.title": "Сè уште нема вештини",
  "project.settings.extensions.empty.skills.description": "Вештини достапни за OpenCode ќе се појават тука",
  "project.settings.extensions.lsp.configured": "Конфигурирани сервери за јазик",
  "project.settings.extensions.lsp.status.enabled": "Овозможено во конфигурацијата",
  "project.settings.extensions.lsp.status.disabled": "Оневозможено во конфигурацијата",
  "project.settings.extensions.lsp.empty.title": "Нема конфигурирани јазични сервери",
  "project.settings.extensions.lsp.empty.description":
    "Јазичните сервери конфигурирани за овој проект ќе се прикажат тука",
  "project.settings.extensions.lsp.disabled.title": "Јазичните сервери се оневозможени",
  "project.settings.extensions.lsp.disabled.description": "LSP е оневозможен во конфигурацијата на овој проект",
  "project.settings.extensions.lsp.loadFailed": "Не можеше да се вчита конфигурацијата на јазичниот сервер",
  "project.settings.extensions.lsp.retry": "Обиди се повторно",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Група",
  "settings.timeline.collapse": "Склопи",
  "settings.timeline.visibility.show": "Прикажи",
  "settings.timeline.visibility.hide": "Сокриј",
  "settings.timeline.visibility.label": "Видливост на {{activity}}",
  "settings.timeline.grouped.label": "{{activity}} групирано",
  "settings.timeline.collapsed.label": "{{activity}} склопено",
  "session.new.workspace.search.empty": "Нема соодветни worktrees",
  "settings.workspaces.description": "Прегледај worktrees и управувај со употребата на дискот",
  "settings.workspaces.empty.description": "Worktrees креирани во OpenCode ќе се прикажат тука",
  "settings.workspaces.sessions.filtered.one": "{{count}} сесија",
  "settings.workspaces.sessions.filtered.other": "{{count}} сесии",
  "settings.workspaces.deleteAll.confirm.one": "Ова трајно ќе го избрише {{count}} избрано работно стебло.",
  "settings.workspaces.deleteAll.confirm.other": "Ова трајно ќе избрише {{count}} избрани работни стебла.",
  "settings.workspaces.deleteWithoutSessions": "Избриши worktrees без сесии",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ова ќе ги избрише трајно {{count}} worktree без поврзани сесии.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ова ќе ги избрише трајно {{count}} worktrees без поврзани сесии.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Worktrees со неслиани промени или активни локации ќе бидат зачувани.",
  "settings.workspaces.delete.button": "Избриши worktrees",
  "workspace.lifecycle.deleting": "Бришење…",
  "session.summary.tooltip": "Резиме",
  "session.summary.server": "Проширувања",
  "session.summary.chooseProject": "Избери проект",
  "session.summary.mcp.onCreation": "Се применува кога се создава worktree",
  "session.summary.mcp.prepareFailed": "Не можеше да се подготват MCP сервери",
  "session.summary.mcp.unavailable": "MCP сервер {{name}} не е достапен во овој worktree.",
  "session.summary.mcp.signInBeforeSend": "Најави се на {{name}} пред да го испратиш прашањето.",
  "session.summary.mcp.notReady":
    "MCP сервер {{name}} не е подготвен. Реши ја неговата врска пред да го испратиш прашањето.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Конфигурирани MCP сервери",
  "session.summary.plugins": "Плагини",
  "session.summary.plugins.configured": "Конфигурирани плагини",
  "session.summary.skills": "Вештини",
  "session.summary.skills.configured": "Конфигурирани вештини",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Неуспешно",
  "session.summary.retry": "Обиди повторно",
  "session.summary.connecting": "Се поврзува…",
  "session.summary.needsAuth": "Потребно е најавување",
  "session.summary.configure": "Датотека за конфигурација",
  "session.summary.copyConfigPath": "Копирај патека до датотека за конфигурација",
  "session.summary.configFileMissing": "Не е пронајдена датотека за конфигурација",
  "session.summary.mcp.empty": "Не се конфигурирани MCP сервери",
  "session.summary.mcp.add": "Додај сервери во opencode.json",
  "session.summary.plugins.manage": "Управувај со приклучоци во opencode.json",
  "session.summary.plugins.empty": "Не се конфигурирани приклучоци",
  "session.summary.plugins.add": "Додај приклучоци во opencode.json",
  "session.summary.skills.manage": "Управувај со вештини во opencode.json",
  "session.summary.skills.empty": "Не се конфигурирани вештини",
  "session.summary.skills.add": "Додај вештини во opencode.json",
  "session.summary.lsp.configured": "Конфигурирани LSP",
  "session.summary.lsp.empty": "Не се конфигурирани LSP сервери",
  "session.summary.lsp.manage": "Управувај со LSP во opencode.json",
  "workspace.delete.location": "Локација",
  "command.debugBar.toggle": "Вклучи/исклучи ја лентата за отстранување грешки",
  "command.session.location.cycle": "Смени ја локацијата на сесијата",
  "dialog.provider.anthropic.note": "Директен пристап до моделите Claude преку API-клуч",
  "provider.connect.title.anthropicProMax": "Најави се со Anthropic",
  "prompt.toast.uploading.cancel": "Откажи го поставувањето",
  ...
  "session.browser.empty.title": "Внесете URL",
  "session.browser.empty.description": "Или внесете барање „Отвори во прелистувачот на апликацијата“",
  "session.browser.failed.title": "URL-адресата не е достапна",
  "session.browser.failed.description": "Проверете ги URL-адресата и врската, па обидете се повторно.",
  "debugBar.providerAriaLabel": "Дијагностика на перформансите на давателот",
  "debugBar.ttft.tip": "Време од испраќањето на барањето до давателот до првиот излез од моделот.",
  "debugBar.ttfa.tip": "Време од испраќањето на барањето до давателот до првиот текст на одговорот.",
  "debugBar.tps.tip": "Излезни токени во секунда по првиот излез од моделот.",
  "debugBar.e2e.tip": "Време од испраќањето на барањето до давателот до завршувањето на текот на одговорот.",
  "settings.updates.action.download": "Преземи OpenCode",
  "settings.updates.migration.title": "Премини од Beta на Stable",
