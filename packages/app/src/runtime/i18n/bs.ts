export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Radna stabla s nespojenim promjenama, povezanim sesijama ili aktivnim lokacijama bit će sačuvana.",
  ...
  "session.location.description": "Odaberite drugi direktorij da nastavite ovu sesiju.",
  "session.location.choose": "Odaberi direktorij",
  "session.location.worktree": "Odaberi worktree",
  "session.location.worktreesFailed": "Učitavanje worktreeova nije uspjelo",
  "session.location.moving": "Premještanje sesije…",
  "dialog.server.menu.hide": "Sakrij sa spiska projekata",
  "dialog.server.menu.show": "Prikaži na spisku projekata",
  "session.queue.count.one": "{{count}} stavka u redu čekanja",
  "session.queue.count.few": "{{count}} stavke u redu čekanja",
  "session.queue.count.other": "{{count}} stavki u redu čekanja",
  "session.queue.steer": "Usmjeri",
  "session.queue.send": "Pošalji",
  "session.queue.steerTooltip": "Pošalji bez prekidanja",
  "session.queue.remove": "Ukloni",
  "session.queue.reorder": "Promijeni redoslijed upita u redu čekanja",
  "session.new.worktree.creating": "Kreiranje worktreea",
  "settings.backToApp": "Nazad u aplikaciju",
  "settings.appearance.section.experimental": "Eksperimentalno",
  "settings.appearance.row.tabs.title": "Kartice",
  "settings.appearance.row.tabs.description": "Odaberite raspored kartica sesija",
  "settings.appearance.row.tabs.horizontal": "Vodoravno",
  "settings.appearance.row.tabs.vertical": "Uspravno",
  "settings.general.row.followUpBehavior.title": "Ponašanje naknadnih poruka",
  "settings.general.row.followUpBehavior.description":
    "Odaberite hoće li se naknadne poruke staviti u red čekanja ili usmjeriti trenutni korak. Koristite {{keybind}} za prebacivanje.",
  "settings.general.row.followUpBehavior.queue": "Red čekanja",
  "settings.general.row.followUpBehavior.steer": "Usmjeri",
  "settings.general.row.reasoningMode.title": "Rasuđivanje modela",
  "settings.general.row.reasoningMode.description":
    "Odaberite kako se rasuđivanje modela prikazuje na vremenskoj traci",
  "settings.general.row.reasoningMode.hidden": "Sakriveno",
  "settings.general.row.reasoningMode.compact": "Sažeto",
  "settings.general.row.reasoningMode.full": "Potpuno",
  "session.new.workspace.createFrom": "Kreiraj iz grane",
  "session.new.workspace.branch.search.placeholder": "Pretraži grane",
  "desktop.onboarding.defaultProject": "Podrazumijevani projekat",
  "toast.migration.progress.clearingOldEvents": "Brisanje starih događaja",
  "toast.migration.progress.migratingSessions": "Migracija sesija",
  "session.new.workspace.existingLabel": "Radno stablo",
  "session.review.change.few": "Izmjene",
  "home.projects.all": "Svi projekti",
  "session.tab.files": "Datoteke",
  "session.files.openTabs": "Otvorene datoteke",
  "session.tab.usage": "Upotreba",
  ...
  "session.background.tasksRunning.one": "{{count}} pozadinski zadatak je pokrenut",
  "session.background.tasksRunning.other": "{{count}} pozadinskih zadataka je pokrenuto",
  "session.background.combine": "{{first}} i {{second}}",
  "session.background.shell.one": "{{count}} ljuska",
  "session.background.shell.other": "{{count}} ljuski",
  "session.background.subagent.one": "{{count}} podagent",
  "session.background.subagent.other": "{{count}} podagenata",
  ...
  "session.websearch.any": "Bilo koji",
  "session.websearch.disable": "Nemojte koristiti pretragu",
  "session.websearch.enable": "Omogući",
  "session.websearch.loadFailed": "Nije moguće učitati provajdere pretraživanja.",
  "session.websearch.empty": "Nema dostupnih provajdera pretrage.",
  "session.websearch.failed": "Nije moguće sačuvati vaš izbor. Molimo pokušajte ponovo.",
  "session.websearch.retry": "Pokušaj ponovo",
  "session.new.worktree.draftPlaceholder": "Napišite naknadnu poruku dok se radno stablo priprema…",
  "session.search.placeholder": "Pronađi...",
  "session.search.noResults": "Nema podudaranja",
  "titlebar.tabs": "Kartice",
  "titlebar.channel.local": "Lokalno",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Prebaci alate za otklanjanje grešaka",
  "settings.tab.experimental": "Eksperimentalno",
  "settings.experimental.description": "Isprobajte eksperimentalne funkcije",
  "settings.tab.about": "O programu",
  "settings.about.version": "Verzija {{version}}",
  "settings.about.devVersion": "razvoj",
  "settings.about.license": "Izdan pod MIT License",
  "settings.about.writtenBy": "Napisao",
  "settings.about.illustratedBy": "Ilustrovao",
  "settings.about.and": "i",
  "settings.about.otherContributor.one": "{{count}} drugi",
  "settings.about.otherContributor.other": "{{count}} drugih",
  "settings.about.firstPublished": "Prvi put objavljeno u Missouriju, SAD",
  "settings.about.firstIllustrated": "Prvi put ilustrovan u Londonu, Engleska",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, agent za kodiranje otvorenog koda",
  "settings.about.trademark": "OpenCode je registrovani zaštitni znak Anomaly Innovations, Inc.",
  "settings.about.typeset": "Postavljen u Inter i IBM Plex Mono",
  "settings.about.tagline": "AI ne može napraviti odličan softver bez vas",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "project.settings.title": "Uredi projekat",
  "settings.timeline.title": "Vremenska linija",
  "settings.timeline.detail": "Detalji vremenske linije",
  "settings.timeline.description":
    "Odaberite koliko aktivnosti se pojavljuje na vremenskoj liniji. Poruke ostaju vidljive.",
  "settings.timeline.preset.everything": "Sve",
  "settings.timeline.preset.detailed": "Detaljno",
  "settings.timeline.preset.compact": "Sažeto",
  "settings.timeline.preset.quiet": "Tiho",
  "settings.timeline.preset.text-only": "Samo tekst",
  ...
  "settings.timeline.custom": "Prilagođeno",
  "settings.timeline.advanced": "Napredno",
  "settings.timeline.advanced.description": "Postavite položaj i detalje za svaku kategoriju aktivnosti.",
  "settings.timeline.category.shell": "Ljuska",
  "settings.timeline.category.edit": "Uređivanja",
  ...
  "session.background.tasksRunning.few": "{{count}} pozadinska zadatka su pokrenuta",
  ...
  "provider.connect.error.unsupportedFields": "Ovaj obrazac za autentifikaciju sadrži nepodržana polja",
  "session.review.filesChangedCount.one": "{{count}} datoteka je izmijenjena",
  "session.review.filesChangedCount.few": "{{count}} datoteke su izmijenjene",
  "session.review.filesChangedCount.other": "{{count}} datoteka je izmijenjeno",
  "settings.about.writtenByNames": "Napisao {{names}}",
  "settings.about.illustratedByNames": "Ilustrovao {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Nije uspostavljena veza s hostom {{host}}. Vaš nacrt je sačuvan; udaljeni rad možda još traje.",
  "ssh.placeholder": "ssh korisnik@primjer.com",
  "ssh.add": "Dodaj SSH server",
  "ssh.server.menu.label": "SSH server",
  "ssh.target": "Host ili SSH naredba",
  "ssh.connect": "Poveži se",
  "ssh.connectTo": "Poveži se s hostom {{host}}",
  "ssh.authenticate": "SSH autentifikacija",
  "ssh.action.authenticate": "Autentificiraj",
  "ssh.session.disconnected": "SSH veza nije aktivna",
  "ssh.session.connecting": "Povezivanje sa SSH serverom",
  "ssh.session.reconnectDescription":
    "Ponovo se povežite da biste vidjeli ovu sesiju i nastavili raditi. Vaša udaljena sesija je sačuvana.",
  "ssh.session.reconnect": "Ponovo se poveži",
  "ssh.authenticationRequired": "Potrebna je autentifikacija za {{host}}",
  "ssh.trust": "Vjeruj i poveži se",
  "ssh.continue": "Nastavi",
  "ssh.retry": "Pokušaj ponovo",
  "ssh.update": "Ažuriraj i ponovo se poveži",
  "ssh.openProject": "Otvori projekat",
  "ssh.project": "Otvori projekat na hostu {{host}}",
  "ssh.disconnect": "Prekini vezu",
  "ssh.forget": "Zaboravi vezu",
  "ssh.stage.disconnected": "Veza je prekinuta. Udaljeni server je ostavljen da radi.",
  "ssh.stage.connecting": "Povezivanje putem SSH-a…",
  "ssh.stage.checking": "Provjera OpenCode-a…",
  "ssh.stage.downloading": "Preuzimanje servera…",
  "ssh.stage.uploading": "Slanje servera…",
  "ssh.stage.starting": "Povezivanje s OpenCode-om…",
  "ssh.stage.ready": "Povezano",
  "ssh.stage.authentication": "Potrebna je autentifikacija",
  "ssh.stage.incompatible": "Potrebno je ažuriranje servera",
  "ssh.stage.failed": "Povezivanje nije uspjelo",
  "ssh.error.input":
    "Unesite host ili naredbu za SSH povezivanje. Udaljene naredbe i nepodržane SSH opcije nisu dozvoljene.",
  "ssh.error.connection": "Nije bilo moguće uspostaviti SSH vezu. Provjerite mrežu i SSH konfiguraciju.",
  "ssh.error.platform":
  ...
  "ssh.error.version": "Udaljena usluga mora odgovarati ovoj verziji Desktopa prije povezivanja.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH je povezan, ali OpenCode server nije postao spreman.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Otvori preglednik",
  "command.browser.reload": "Ponovo učitaj stranicu preglednika",
  "command.session.summary.toggle": "Prikaži ili sakrij sažetak",
  "common.color.orange": "narandžasta",
  "common.color.yellow": "žuta",
  "common.color.cyan": "cijan",
  "common.color.green": "zelena",
  "common.color.red": "crvena",
  "common.color.pink": "ružičasta",
  "common.color.blue": "plava",
  "common.color.purple": "ljubičasta",
  "common.color.gray": "siva",
  "mcp.auth.interactiveForm": "MCP server {{name}} zahtijeva interaktivni obrazac za autentifikaciju",
  "server.connect.title": "Poveži se sa serverom",
  "server.connect.description": "Unesite adresu servera i lozinku da biste započeli.",
  ...
  "dialog.server.menu.remove": "Ukloni",
  "file.error.notFound": "Datoteka nije pronađena: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Migracija sesija {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migracija sesija {{current}}/{{total}}",
  "toast.migration.progress.working": "Migracija podataka",
  "toast.migration.progress.working.current": "Migracija podataka {{current}}",
  "toast.migration.progress.working.progress": "Migracija podataka {{current}}/{{total}}",
  "home.workspaceTip": "Pokrenite sljedeću sesiju u novom radnom prostoru kako bi promjene ostale izolovane",
  "session.tab.browser": "Preglednik",
  "session.tab.add": "Dodaj karticu",
  "session.queue.attachments.one": "Još {{count}} prilog",
  "session.queue.attachments.few": "Još {{count}} priloga",
  "session.queue.attachments.other": "Još {{count}} priloga",
  "session.browser.address": "Adresa preglednika",
  "session.browser.replaced": "Upravljanje preglednikom premješteno je u drugi prozor Desktopa.",
  "session.browser.unsupported": "Ova aplikacija za računar ne podržava okno preglednika.",
  "session.browser.suspended":
    "Preglednik je obustavljen. Stupite u interakciju s ovom sesijom da biste se ponovo povezali.",
  "session.browser.address.placeholder": "Unesite URL",
  "settings.backToSettings": "Nazad na postavke",
  "settings.backToProjects": "Nazad na projekte",
  "settings.search.placeholder": "Pretraži",
  "settings.search.results": "Rezultati postavki",
  "settings.search.group.pages": "Stranice",
  "settings.search.group.settings": "Postavke",
  ...
  "settings.search.empty": "Nema rezultata za {{query}}",
  "settings.search.empty.query": "„{{query}}“",
  "settings.search.refine": "Suzite pretragu da biste vidjeli određenije rezultate.",
  "settings.server.description": "Upravljajte vezom i postavkama ovog servera",
  "settings.server.section.connection": "Veza",
  "settings.server.preferences.websearch.title": "Pretraga treće strane",
  "settings.server.preferences.websearch.description":
    "Odaberite pružatelja pretrage kojeg agenti koriste za pretraživanje weba",
  "settings.projects.search.placeholder": "Pretraži projekte",
  "project.settings.name.title": "Naziv projekta",
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekat u cijelom OpenCode-u",
  "project.settings.icon.description": "Preporučeno: 128 × 128 px. Kliknite ili prevucite sliku da biste je poslali.",
  "project.settings.color.description": "Koristi se za ikonu projekta kada nije postavljena prilagođena slika",
  "project.settings.worktree.startup.description": "Pokreće se jednom nakon kreiranja novog worktreea",
  "project.settings.worktree.startup.hint.base": "Koristite $OPENCODE_WORKTREE_BASE za osnovni worktree.",
  "project.settings.worktree.startup.hint.new": "Koristite $OPENCODE_WORKTREE_PATH za novi worktree.",
  "project.settings.extensions.empty.mcps.title": "Još nema MCP-ova",
  "project.settings.extensions.empty.mcps.description": "MCP-ovi dostupni OpenCode-u pojavit će se ovdje",
  "project.settings.extensions.empty.plugins.title": "Još nema dodataka",
  "project.settings.extensions.empty.plugins.description": "Dodaci dostupni OpenCode-u pojavit će se ovdje",
  "project.settings.extensions.empty.skills.title": "Još nema vještina",
  "project.settings.extensions.empty.skills.description": "Vještine dostupne OpenCode-u pojavit će se ovdje",
  "project.settings.extensions.lsp.configured": "Konfigurirani jezički serveri",
  "project.settings.extensions.lsp.status.enabled": "Omogućeno u konfiguraciji",
  "project.settings.extensions.lsp.status.disabled": "Onemogućeno u konfiguraciji",
  "project.settings.extensions.lsp.empty.title": "Nema konfiguriranih jezičkih servera",
  "project.settings.extensions.lsp.empty.description":
    "Jezički serveri konfigurirani za ovaj projekat pojavit će se ovdje",
  "project.settings.extensions.lsp.disabled.title": "Jezički serveri su onemogućeni",
  "project.settings.extensions.lsp.disabled.description": "LSP je onemogućen u konfiguraciji ovog projekta",
  "project.settings.extensions.lsp.loadFailed": "Nije bilo moguće učitati konfiguraciju jezičkog servera",
  "project.settings.extensions.lsp.retry": "Pokušaj ponovo",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Grupiši",
  "settings.timeline.collapse": "Sažmi",
  "settings.timeline.visibility.show": "Prikaži",
  "settings.timeline.visibility.hide": "Sakrij",
  "settings.timeline.visibility.label": "Vidljivost aktivnosti {{activity}}",
  "settings.timeline.grouped.label": "Aktivnost {{activity}} je grupisana",
  "settings.timeline.collapsed.label": "Aktivnost {{activity}} je sažeta",
  "session.new.workspace.search.empty": "Nema odgovarajućih worktreeova",
  "settings.workspaces.description": "Pregledajte worktreeove i upravljajte korištenjem diska",
  ...
  "settings.workspaces.sessions.filtered.few": "{{count}} sesije",
  "settings.workspaces.sessions.filtered.other": "{{count}} sesija",
  "settings.workspaces.deleteAll.confirm.one": "Ovim ćete trajno izbrisati {{count}} odabrano radno stablo.",
  "settings.workspaces.deleteAll.confirm.few": "Ovim ćete trajno izbrisati {{count}} odabrana radna stabla.",
  "settings.workspaces.deleteAll.confirm.other": "Ovim ćete trajno izbrisati {{count}} odabranih radnih stabala.",
  "settings.workspaces.deleteWithoutSessions": "Izbriši worktreeove bez sesija",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ovim ćete trajno izbrisati {{count}} radno stablo bez povezanih sesija.",
  "settings.workspaces.deleteWithoutSessions.confirm.few":
    "Ovim ćete trajno izbrisati {{count}} radna stabla bez povezanih sesija.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ovim ćete trajno izbrisati {{count}} radnih stabala bez povezanih sesija.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Worktreeovi s nespojenim promjenama ili aktivnim lokacijama bit će zadržani.",
  "settings.workspaces.delete.button": "Izbriši worktreeove",
  "workspace.lifecycle.deleting": "Brisanje…",
  "session.summary.tooltip": "Sažetak",
  "session.summary.server": "Proširenja",
  "session.summary.chooseProject": "Odaberite projekat",
  "session.summary.mcp.onCreation": "Primjenjuje se pri kreiranju worktreea",
  "session.summary.mcp.prepareFailed": "Nije bilo moguće pripremiti MCP servere",
  "session.summary.mcp.unavailable": "MCP server {{name}} nije dostupan u ovom worktreeu.",
  "session.summary.mcp.signInBeforeSend": "Prijavite se na {{name}} prije slanja upita.",
  "session.summary.mcp.notReady": "MCP server {{name}} nije spreman. Riješite njegovu vezu prije slanja upita.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurirani MCP serveri",
  "session.summary.plugins": "Dodaci",
  "session.summary.plugins.configured": "Konfigurirani dodaci",
  "session.summary.skills": "Vještine",
  "session.summary.skills.configured": "Konfigurirane vještine",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Neuspješno",
  "session.summary.retry": "Pokušaj ponovo",
  "session.summary.connecting": "Povezivanje…",
  "session.summary.needsAuth": "Potrebna je prijava",
  "session.summary.configure": "Konfiguracijska datoteka",
  "session.summary.copyConfigPath": "Kopiraj putanju konfiguracijske datoteke",
  "session.summary.configFileMissing": "Konfiguracijska datoteka nije pronađena",
  "session.summary.mcp.empty": "Nema konfiguriranih MCP servera",
  "session.summary.mcp.add": "Dodajte servere u opencode.json",
  "session.summary.plugins.manage": "Upravljajte dodacima u opencode.json",
  "session.summary.plugins.empty": "Nema konfiguriranih dodataka",
  "session.summary.plugins.add": "Dodajte dodatke u opencode.json",
  "session.summary.skills.manage": "Upravljajte vještinama u opencode.json",
  "session.summary.skills.empty": "Nema konfiguriranih vještina",
  "session.summary.skills.add": "Dodajte vještine u opencode.json",
  "session.summary.lsp.configured": "Konfigurirani LSP-ovi",
  "session.summary.lsp.empty": "Nema konfiguriranih LSP servera",
  "session.summary.lsp.manage": "Upravljajte LSP-om u opencode.json",
  "workspace.delete.location": "Lokacija",
  "command.debugBar.toggle": "Uključi/isključi traku za otklanjanje grešaka",
  "command.session.location.cycle": "Promijeni lokaciju sesije",
  "dialog.provider.anthropic.note": "Direktan pristup Claude modelima putem API ključa",
  "provider.connect.title.anthropicProMax": "Prijava putem Anthropic-a",
  "prompt.toast.uploading.cancel": "Otkaži otpremanje",
  "prompt.toast.uploading.cancelFile": "Otkaži otpremanje datoteke {{filename}}",
  "prompt.toast.uploadFailed.title": "Otpremanje nije uspjelo",
  "session.browser.empty.title": "Unesite URL",
  "session.browser.empty.description": "Ili zadajte upit „Otvori u pregledniku aplikacije“",
  "session.browser.failed.title": "URL nije dostupan",
  "session.browser.failed.description": "Provjerite URL i vezu, a zatim pokušajte ponovo.",
  "debugBar.providerAriaLabel": "Dijagnostika performansi pružaoca usluge",
  "debugBar.ttft.tip": "Vrijeme od slanja zahtjeva pružaocu do prvog izlaza modela.",
  "debugBar.ttfa.tip": "Vrijeme od slanja zahtjeva pružaocu do prvog teksta odgovora.",
  "debugBar.tps.tip": "Izlazni tokeni u sekundi nakon prvog izlaza modela.",
  "debugBar.e2e.tip": "Vrijeme od slanja zahtjeva pružaocu do završetka toka odgovora.",
  "settings.updates.action.download": "Preuzmi OpenCode",
  "settings.updates.migration.title": "Prelazak sa Beta na Stable",
