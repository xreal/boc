export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Els arbres de treball amb canvis no combinats, sessions enllaçades o ubicacions actives es mantindran.",
  ...
  "session.location.worktree": "Tria un arbre de treball",
  ...
  "settings.appearance.row.tabs.description": "Trieu com s'organitzen les pestanyes de sessió",
  "settings.appearance.row.tabs.horizontal": "Horitzontals",
  "settings.appearance.row.tabs.vertical": "Verticals",
  "settings.general.row.followUpBehavior.title": "Comportament dels seguiments",
  "settings.general.row.followUpBehavior.description":
    "Trieu si voleu posar els seguiments a la cua o redirigir el torn actual. Feu servir {{keybind}} per canviar.",
  "settings.general.row.followUpBehavior.queue": "Posa a la cua",
  "settings.general.row.followUpBehavior.steer": "Redirigeix",
  "settings.general.row.reasoningMode.title": "Raonament del model",
  "settings.general.row.reasoningMode.description": "Trieu com es mostra el raonament del model a la cronologia",
  "settings.general.row.reasoningMode.hidden": "Ocult",
  ...
  "session.review.change.many": "Canvis",
  "toast.migration.progress.clearingOldEvents": "Es netegen els esdeveniments antics",
  "toast.migration.progress.migratingSessions": "S'estan migrant les sessions",
  "session.new.workspace.existingLabel": "Arbre de treball",
  "desktop.onboarding.defaultProject": "Projecte predeterminat",
  "home.projects.all": "Tots els projectes",
  "session.tab.files": "Fitxers",
  "session.files.openTabs": "Obre els fitxers",
  "session.tab.usage": "Ús",
  "session.view.select": "Visualització de sessió",
  "session.background.moveTasks": "Mou {{tasks}} al fons",
  "session.background.moveRunning": "Vés al fons",
  "session.background.inBackground": "S'està executant {{tasks}} en segon pla",
  "session.background.tasksRunning.one": "Tarea de fons {{count}} en execució",
  "session.background.tasksRunning.other": "S'estan executant les tasques de fons {{count}}",
  "session.background.combine": "{{first}} i {{second}}",
  "session.background.shell.one": "Shell {{count}}",
  "session.background.shell.other": "Shell {{count}}",
  ...
  "session.websearch.disable": "No facis servir la cerca",
  "session.websearch.enable": "Habilita",
  "session.websearch.loadFailed": "No s'han pogut carregar els proveïdors de cerca",
  "session.websearch.empty": "No hi ha proveïdors de cerca disponibles.",
  "session.websearch.failed": "No s'ha pogut desar l'elecció. Torna-ho a provar.",
  "session.websearch.retry": "Torna-ho a provar",
  "session.new.worktree.draftPlaceholder": "Redacta un seguiment mentre s'està preparant l'arbre de treball…",
  "session.search.placeholder": "Cerca…",
  "session.search.noResults": "No hi ha coincidències",
  ...
  "settings.experimental.description": "Prova les funcions experimentals",
  "settings.tab.about": "Quant a",
  "settings.about.version": "Versió {{version}}",
  "settings.about.devVersion": "desenvolupament",
  "settings.about.license": "Publicat sota la llicència del MIT",
  "settings.about.writtenBy": "Escrit per",
  "settings.about.illustratedBy": "Il·lustrat per",
  "settings.about.and": "i",
  "settings.about.otherContributor.one": "{{count}} altre",
  "settings.about.otherContributor.other": "{{count}} altres",
  ...
  "settings.about.description": "OpenCode, l'agent de codificació de codi obert",
  "settings.about.trademark": "OpenCode és una marca registrada de Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Tria quanta activitat apareix a la línia de temps. Els missatges es mantenen visibles.",
  ...
  "settings.timeline.preset.quiet": "Tranquil·la",
  "settings.timeline.preset.text-only": "Només text",
  ...
  "settings.timeline.description.custom":
    "Utilitza la ubicació i les dades seleccionades per a cada categoria d'activitat.",
  "settings.timeline.custom": "Personalitzat",
  "settings.timeline.advanced": "Avançat",
  "settings.timeline.advanced.description": "Estableix la ubicació i els detalls per a cada categoria d'activitat.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Modifica",
  "settings.timeline.category.thinking": "Pensament",
  ...
  "session.background.tasksRunning.many": "S'estan executant {{count}} tasques en segon pla",
  "session.background.shell.many": "{{count}} shells",
  "session.background.subagent.many": "{{count}} subagents",
  "settings.about.otherContributor.many": "{{count}} altres",
  "provider.connect.error.unsupportedFields": "Aquest formulari d'autenticació conté camps no admesos",
  "session.review.filesChangedCount.one": "{{count}} fitxer ha canviat",
  "session.review.filesChangedCount.other": "S'han canviat {{count}} fitxers",
  "settings.about.writtenByNames": "Escrit per {{names}}",
  "settings.about.illustratedByNames": "Il·lustrat per {{names}}",
  "session.review.filesChangedCount.many": "{{count}} fitxers han canviat",
  "ssh.label": "SSH",
  "ssh.offline": "No connectat a {{host}}. El vostre esborrany es conserva; el treball remot encara s'està executant.",
  "ssh.placeholder": "ssh usuari@exemple.com",
  "ssh.add": "Afegeix el servidor SSH",
  "ssh.server.menu.label": "Servidor SSH",
  "ssh.target": "Amfitrió o comanda SSH",
  "ssh.connect": "Connecta",
  "ssh.connectTo": "Connecteu-vos a {{host}}",
  "ssh.authenticate": "Autenticació SSH",
  "ssh.action.authenticate": "Autenticar",
  "ssh.session.disconnected": "Connexió SSH inactiva",
  "ssh.session.connecting": "S'està connectant al servidor SSH",
  "ssh.session.reconnectDescription":
    "Torneu a connectar-vos per veure aquesta sessió i continuar treballant. La vostra sessió remota es conserva.",
  "ssh.session.reconnect": "Torna a connectar",
  "ssh.authenticationRequired": "Cal autenticació per a {{host}}",
  "ssh.trust": "Confia i connecta",
  "ssh.continue": "Continuar",
  "ssh.retry": "Torna-ho a provar",
  "ssh.update": "Actualitza i torna a connectar",
  "ssh.openProject": "Projecte obert",
  "ssh.project": "Projecte obert a {{host}}",
  "ssh.disconnect": "Desconnectar",
  "ssh.forget": "Oblida la connexió",
  "ssh.stage.disconnected": "Desconnectat. El servidor remot es deixa en funcionament.",
  "ssh.stage.connecting": "S'està connectant a través de SSH…",
  "ssh.stage.checking": "S'està comprovant OpenCode…",
  "ssh.stage.downloading": "S'està baixant el servidor…",
  "ssh.stage.uploading": "S'està carregant el servidor…",
  ...
  "ssh.error.input":
    "Introduïu un host o una ordre de connexió SSH. Les ordres remotes i les opcions SSH no admeses no es permeten.",
  "ssh.error.connection": "No s'ha pogut establir la connexió SSH. Comproveu la vostra xarxa i la configuració de SSH.",
  "ssh.error.platform":
    "Aquesta plataforma remota no és compatible. Actualment, la configuració automàtica requereix Linux o macOS a x64 o arm64.",
  "ssh.error.version": "El servei remot ha de coincidir amb aquesta versió d'escriptori abans de connectar-se.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH s'ha connectat, però el servidor OpenCode no està preparat.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "No s'ha trobat OpenSSH. Instal·leu un client OpenSSH i assegureu-vos que ssh estigui disponible a PATH.",
  ...
  "server.connect.title": "Connecta't a un servidor",
  "server.connect.description": "Introduïu l'adreça del servidor i la contrasenya per començar.",
  ...
  "server.connect.camera.error":
    "No s'ha pogut obrir la càmera. Permet l'accés a la càmera o introdueix els detalls de connexió manualment.",
  "dialog.server.menu.remove": "Elimina",
  "file.error.notFound": "No s'ha trobat el fitxer: {{name}}",
  "home.workspaceTip": "Inicieu la propera sessió en un nou espai de treball per mantenir els canvis aïllats",
  "session.tab.browser": "Navegador",
  "session.tab.add": "Afegeix una pestanya",
  "session.queue.attachments.one": "Més adjunt {{count}}",
  "session.queue.attachments.other": "Més fitxers adjunts {{count}}",
  "session.browser.address": "Adreça del navegador",
  "session.browser.replaced": "El control del navegador s'ha mogut a una altra finestra d'escriptori.",
  "session.browser.suspended": "Navegador suspès. Interacciona amb aquesta sessió per tornar a connectar.",
  "session.browser.address.placeholder": "Introduïu l'URL",
  "settings.backToSettings": "Tornar a la configuració",
  "settings.backToProjects": "Tornar als projectes",
  ...
  "settings.search.empty": "No hi ha resultats per a {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Limiteu la cerca per veure resultats més específics.",
  ...
  "settings.server.preferences.websearch.description":
    "Seleccioneu el proveïdor de cerca que utilitzen els agents per cercar al web",
  "settings.projects.search.placeholder": "Cerca projectes",
  "project.settings.name.title": "Nom del projecte",
  "project.settings.name.description": "El nom mostrat per a aquest projecte a tot OpenCode",
  "project.settings.icon.description": "Recomanat: 128×128px. Feu clic o arrossegueu per pujar una imatge.",
  "project.settings.color.description":
    "S'utilitza per a la icona del projecte quan no s'ha establert cap imatge personalitzada",
  "project.settings.worktree.startup.description": "S'executa una vegada després de crear un nou arbre de treball",
  "project.settings.worktree.startup.hint.base": "Utilitzeu $OPENCODE_WORKTREE_BASE per a l'arbre de treball base.",
  "project.settings.worktree.startup.hint.new": "Utilitzeu $OPENCODE_WORKTREE_PATH per al nou arbre de treball.",
  "project.settings.extensions.empty.mcps.title": "Encara no MCPs",
  "project.settings.extensions.empty.mcps.description": "MCPs disponible per a OpenCode apareixerà aquí",
  "project.settings.extensions.empty.plugins.title": "Encara no hi ha connectors",
  "project.settings.extensions.empty.plugins.description": "Els connectors disponibles per a OpenCode apareixeran aquí",
  "project.settings.extensions.empty.skills.title": "Encara no hi ha habilitats",
  "project.settings.extensions.empty.skills.description": "Les habilitats disponibles per a OpenCode apareixeran aquí",
  "project.settings.extensions.lsp.configured": "Servidors d'idiomes configurats",
  "project.settings.extensions.lsp.status.enabled": "Habilitat a la configuració",
  "project.settings.extensions.lsp.status.disabled": "Desactivat a la configuració",
  "project.settings.extensions.lsp.empty.title": "No s'ha configurat cap servidor d'idiomes",
  "project.settings.extensions.lsp.empty.description":
    "Els servidors d'idiomes configurats per a aquest projecte apareixeran aquí",
  "project.settings.extensions.lsp.disabled.title": "Servidors d'idiomes desactivats",
  "project.settings.extensions.lsp.disabled.description": "LSP està desactivat a la configuració d'aquest projecte",
  "project.settings.extensions.lsp.loadFailed": "No s'ha pogut carregar la configuració del servidor d'idiomes",
  "project.settings.extensions.lsp.retry": "Torna-ho a provar",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Grup",
  "settings.timeline.collapse": "Col·lapse",
  ...
  "settings.workspaces.sessions.filtered.one": "Sessió {{count}}",
  "settings.workspaces.sessions.filtered.other": "{{count}} sessions",
  "settings.workspaces.deleteAll.confirm.one":
    "Això suprimirà permanentment l'arbre de treball seleccionat de {{count}}.",
  "settings.workspaces.deleteAll.confirm.other":
    "Això suprimirà permanentment els arbres de treball seleccionats de {{count}}.",
  ...
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Això suprimirà permanentment l'arbre de treball {{count}} sense sessions enllaçades.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Això suprimirà permanentment els arbres de treball {{count}} sense sessions enllaçades.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Es mantindran els arbres de treball amb canvis no combinats o ubicacions actives.",
  ...
  "session.summary.mcp.signInBeforeSend": "Inicieu la sessió a {{name}} abans d'enviar la sol·licitud.",
  "session.summary.mcp.notReady":
    "El servidor MCP {{name}} no està preparat. Resol la seva connexió abans d'enviar la sol·licitud.",
  ...
  "session.summary.needsAuth": "Cal iniciar sessió",
  ...
  "session.summary.mcp.empty": "No s'ha configurat cap servidor MCP",
  ...
  "session.summary.plugins.empty": "No s'ha configurat cap connector",
  ...
  "session.summary.skills.empty": "No s'ha configurat cap habilitat",
  "session.summary.skills.add": "Afegiu habilitats a opencode.json",
  "session.summary.lsp.configured": "LSPs configurat",
  "session.summary.lsp.empty": "No s'ha configurat cap servidor LSP",
  "session.summary.lsp.manage": "Gestioneu LSP a opencode.json",
  "workspace.delete.location": "Ubicació",
  "session.queue.attachments.many": "Més fitxers adjunts {{count}}",
  ...
  "settings.workspaces.deleteWithoutSessions.confirm.many":
    "Això suprimirà permanentment els arbres de treball {{count}} sense sessions enllaçades.",
  "common.color.orange": "taronja",
  "common.color.yellow": "groc",
  "common.color.cyan": "cian",
  "common.color.green": "verd",
  "common.color.red": "vermell",
  "common.color.pink": "rosa",
  "common.color.blue": "blau",
  "common.color.purple": "violeta",
  "common.color.gray": "gris",
  "toast.migration.progress.migratingSessions.current": "Sessions de migració {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migració de sessions {{current}}/{{total}}",
  "toast.migration.progress.working": "Migració de dades",
  "toast.migration.progress.working.current": "Migració de dades {{current}}",
  "toast.migration.progress.working.progress": "S'estan migrant dades {{current}}/{{total}}",
  "session.browser.unsupported": "Aquesta aplicació d'escriptori no admet el panell del navegador.",
  "command.debugBar.toggle": "Commuta la barra de depuració",
  "command.session.location.cycle": "Canvia la ubicació de la sessió",
  "dialog.provider.anthropic.note": "Accés directe als models Claude mitjançant una clau d’API",
  "provider.connect.title.anthropicProMax": "Inicia la sessió amb Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Cancel·la la pujada",
  "prompt.toast.uploading.cancelFile": "Cancel·la la pujada de {{filename}}",
  "prompt.toast.uploadFailed.title": "Ha fallat la pujada",
  ...
  "debugBar.providerAriaLabel": "Diagnòstic del rendiment del proveïdor",
  ...
  "debugBar.tps.tip": "Fitxes de sortida per segon després de la primera sortida del model.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Temps des de l’enviament de la sol·licitud al proveïdor fins que finalitza el flux de resposta.",
  "settings.updates.action.download": "Baixa l’OpenCode",
  "settings.updates.migration.title": "Passa de Beta a Estable",
