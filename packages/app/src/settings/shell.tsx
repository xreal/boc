...
const serverTabs = [
  ...
  { value: "boc", icon: pageIcons.boc, label: "boc.settings.title", boc: true },
] as const
      ...
      : [
          {
            items: [
              ...serverTabs.map((item) => ({
                ...item,
                label: "boc" in item ? boc(item.label) : language.t(item.label),
                disabled: !single(),
        ...
        {(server) => (
          <SettingsServerDataScope server={server}>
            ...
            <Tabs.Content value="boc" class="settings-panel">
              <BocSettings directory={sourceServer() === server ? sourceDirectory() : undefined} />
            </Tabs.Content>
      ...
      <Show when={props.entry.connection} keyed>
        {(server) => (
          <SettingsServerDataScope server={server}>
            ...
            <Tabs.Content value="boc" class="settings-panel">
              <BocSettings directory={activeDirectory()} />
            </Tabs.Content>
          </SettingsServerDataScope>
        )}
      </Show>
