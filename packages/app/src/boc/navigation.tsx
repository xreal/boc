...
export function BocNavigationBridge(props: { orientation: "horizontal" | "vertical" }) {
  ...
  if (props.orientation === "vertical") {
    return (
      <div data-slot="boc-nav" class="flex w-full shrink-0 flex-col">
        ...
        <div
          data-slot="boc-nav-separator"
          class="mx-1.5 my-1.5 h-px shrink-0 bg-v2-border-border-muted"
          aria-hidden="true"
        />
      </div>
    )
  ...
  return (
    <>
      ...
      <div
        data-slot="boc-nav-separator"
        class="mx-0.5 h-4 w-px shrink-0 self-center bg-v2-border-border-muted"
        aria-hidden="true"
      />
    </>
  )
