export const dict: Record<string, string> = {
  ...
  "ui.promptInput.cancelUpload": "Batalkan pengunggahan",
  ...
  "ui.promptInput.placeholder.followUp": "Tambahkan tindak lanjut, {{slash}} untuk perintah, {{at}} untuk konteks...",
  "ui.promptInput.steer": "Arahkan",
  "ui.promptInput.queue": "Antrekan",
  "ui.promptInput.steerHint": "Kirim tanpa menginterupsi",
  "ui.tool.loadedSkills.one": "Memuat keahlian {{name}}",
  "ui.tool.loadedSkills.other": "Memuat keahlian {{name}}",
  "ui.tool.shell.exit": "Perintah keluar dengan kode {{code}}",
  "ui.tool.shell.timeout": "Waktu perintah habis",
  "ui.tool.shell.cancelled": "Perintah dibatalkan",
  "ui.message.thought": "Pemikiran",
  "ui.sessionTimeline.notice.modelSwitched": "Beralih ke {{model}}",
  "ui.sessionTurn.retry.attemptLabel": "Percobaan {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Percobaan {{attempt}} - {{line}}",
  "ui.messagePart.context.notice.one": "{{count}} Pemberitahuan",
  "ui.messagePart.context.notice.other": "{{count}} Pemberitahuan",
  "ui.messagePart.context.thought.one": "Pemikiran",
  "ui.messagePart.context.thought.other": "Pemikiran",
  "ui.promptInput.dropFiles.image": "Jatuhkan gambar atau file untuk ditambahkan",
  "ui.promptInput.dropFiles.pdf": "Jatuhkan PDF atau file untuk ditambahkan",
  "ui.promptInput.dropFiles.imagePdf": "Jatuhkan gambar, PDF, atau file untuk ditambahkan",
  "ui.promptInput.exitShell": "Keluar",
  "ui.sessionTimeline.notice.agentChanged": "Agen diubah",

  "ui.sessionTurn.retry.attemptWaiting.one": "Percobaan {{attempt}} - mencoba lagi dalam {{count}}s",
  "ui.sessionTurn.retry.attemptWaiting.other": "Percobaan {{attempt}} - mencoba lagi dalam {{count}}s",
  "ui.sessionTurn.retry.attemptRetryingNow": "Coba {{attempt}} - mencoba lagi",
  "ui.messagePart.compaction.started": "Pengompakan sesi dimulai",
  "ui.messagePart.compaction.running": "Mengepak",
  "ui.messagePart.compaction.failed": "Pengompakan sesi gagal",
  "ui.messagePart.compaction.cancelled": "Pengompakan sesi dibatalkan",
  "ui.messagePart.compaction.interrupted": "Pengompakan sesi terganggu",
  "ui.messagePart.providerCompaction": "Sesi dikompak oleh penyedia",
  "ui.messagePart.compaction.usage": "{{input}} masuk · {{output}} keluar",
  "ui.messagePart.context.updates": "Pembaruan",
