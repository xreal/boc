export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Legg framhaldsboð afturat, {{slash}} fyri boð, {{at}} fyri samanhang...",
  "ui.promptInput.steer": "Stýr",
  "ui.promptInput.queue": "Set í bíðirøð",
  "ui.promptInput.steerHint": "Send uttan at steðga",
  "ui.tool.loadedSkills.one": "Las førleikan {{name}} inn",
  "ui.tool.loadedSkills.other": "Las førleikarnar {{name}} inn",
  "ui.tool.shell.exit": "Boðið endaði við kotu {{code}}",
  "ui.tool.shell.timeout": "Tíðin hjá boðnum gekk út",
  "ui.tool.shell.cancelled": "Boðið varð avlýst",
  "ui.message.thought": "Hugsan",
  ...
  "ui.promptInput.dropFiles.image": "Slepp myndum ella fílum at leggja til",
  "ui.promptInput.dropFiles.pdf": "Slepp PDF-fílum ella fílum at leggja til",
  "ui.promptInput.dropFiles.imagePdf": "Slepp myndum, PDF-fílum ella fílum at leggja til",
  "ui.promptInput.exitShell": "Út",
  "ui.sessionTimeline.notice.agentChanged": "Umboðsmaður broyttur",
  "ui.sessionTurn.retry.attemptRetryingNow": "Roynd {{attempt}} - royna aftur",
  "ui.sessionTurn.retry.attemptWaiting.one": "Roynd {{attempt}} – roynir aftur um {{count}} s",
  "ui.sessionTurn.retry.attemptWaiting.other": "Roynd {{attempt}} – roynir aftur um {{count}} s",
  "ui.messagePart.compaction.started": "Session komprimering byrjað",
  "ui.messagePart.compaction.running": "Komprimerandi",
  "ui.messagePart.compaction.failed": "Setukomprimeringin miseydnaðist",
  "ui.messagePart.compaction.cancelled": "Setukomprimeringin avlýst",
  "ui.messagePart.compaction.interrupted": "Session komprimering avbrotin",
  "ui.messagePart.providerCompaction": "Session komprimerað av veitara",
  "ui.messagePart.compaction.usage": "{{input}} í · {{output}} út",
  "ui.messagePart.tools.used.one": "Brúkt {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Brúkt {{count}} {{tools}}",
