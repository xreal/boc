...
export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "Dodaj naknadnu poruku, {{slash}} za komande, {{at}} za kontekst...",
  ...
  "ui.promptInput.dropFiles.image": "Ispustite slike ili datoteke da ih dodate",
  ...
  "ui.sessionTimeline.notice.agentChanged": "Agent je promijenjen",
  ...
  "ui.messagePart.providerCompaction": "Provajder je sažeo sesiju",
  "ui.messagePart.compaction.usage": "{{input}} ulaz · {{output}} izlaz",
  "ui.messagePart.tools.used.one": "Korišten {{count}} alat: {{tools}}",
  "ui.messagePart.tools.used.few": "Korištena {{count}} alata: {{tools}}",
  "ui.messagePart.tools.used.other": "Korišteno {{count}} alata: {{tools}}",
