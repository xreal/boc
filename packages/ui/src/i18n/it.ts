export const dict: Record<string, string> = {
  ...
  "ui.messagePart.compaction.started": "È iniziata la compattazione della sessione",
  "ui.messagePart.compaction.running": "Compattazione",
  "ui.messagePart.compaction.failed": "La compattazione della sessione non è riuscita",
  "ui.messagePart.compaction.cancelled": "Compattazione della sessione annullata",
  "ui.messagePart.compaction.interrupted": "Compattazione della sessione interrotta",
  "ui.messagePart.providerCompaction": "Sessione compattata dal provider",
  "ui.messagePart.compaction.usage": "{{input}} dentro · {{output}} fuori",
  "ui.messagePart.tools.used.one": "{{count}} {{tools}} utilizzato",
  "ui.messagePart.tools.used.other": "{{count}} {{tools}} utilizzati",
  "ui.tool.browser": "Navigatore",
  "ui.messagePart.context.thought.one": "Pensiero",
  "ui.messagePart.context.thought.other": "Pensieri",
  "ui.messagePart.context.thought.many": "Pensieri",
  "ui.messagePart.tools.used.many": "{{count}} {{tools}} utilizzati",
  "ui.sessionTurn.retry.attemptWaiting.one": "Il tentativo {{attempt}} verrà ripetuto tra {{count}} secondo",
  "ui.sessionTurn.retry.attemptWaiting.many": "Il tentativo {{attempt}} verrà ripetuto tra {{count}} secondi",
  "ui.sessionTurn.retry.attemptWaiting.other": "Il tentativo {{attempt}} verrà ripetuto tra {{count}} secondi",
  ...
  "ui.promptInput.dropFiles.pdf": "Trascina PDF o file per aggiungerli",
  "ui.promptInput.dropFiles.imagePdf": "Trascina immagini, PDF o file per aggiungerli",
  "ui.promptInput.exitShell": "Esci",
  "ui.sessionTimeline.notice.agentChanged": "Agente cambiato",
  "ui.messagePart.context.notice.many": "{{count}} avvisi",
  "ui.promptInput.placeholder.followUp":
    "Aggiungi un messaggio successivo, {{slash}} per i comandi, {{at}} per il contesto…",
  "ui.promptInput.steer": "Guida",
  "ui.promptInput.queue": "Coda",
  "ui.promptInput.steerHint": "Invia senza interrompere",
  "ui.tool.loadedSkills.one": "Caricata la skill {{name}}",
  "ui.tool.loadedSkills.many": "Caricate le skill {{name}}",
  "ui.tool.loadedSkills.other": "Caricate le skill {{name}}",
  "ui.tool.shell.exit": "Comando terminato con codice {{code}}",
  "ui.tool.shell.timeout": "Tempo massimo del comando scaduto",
  "ui.tool.shell.cancelled": "Comando annullato",
  "ui.message.thought": "Ragionamento",
  "ui.sessionTimeline.notice.modelSwitched": "Passaggio a {{model}}",
  ...
  "ui.common.file.many": "file",
  "ui.common.file.other": "file",
  "ui.common.question.one": "domanda",
  "ui.common.question.many": "domande",
