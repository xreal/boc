export const dict = {
  ...
  "ui.promptInput.cancelUpload": "アップロードをキャンセル",
  ...
  "ui.promptInput.placeholder.followUp": "フォローアップを追加。{{slash}}でコマンド、{{at}}でコンテキストを追加...",
  "ui.promptInput.steer": "方向を指示",
  "ui.promptInput.queue": "キューに追加",
  "ui.promptInput.steerHint": "中断せずに送信",
  "ui.tool.loadedSkills.one": "{{name}}スキルを読み込みました",
  "ui.tool.loadedSkills.other": "{{name}}スキルを読み込みました",
  "ui.tool.shell.exit": "コマンドは終了コード{{code}}で終了しました",
  "ui.tool.shell.timeout": "コマンドがタイムアウトしました",
  "ui.tool.shell.cancelled": "コマンドがキャンセルされました",
  "ui.message.thought": "思考",
  "ui.sessionTimeline.notice.modelSwitched": "{{model}}に切り替えました",
  "ui.sessionTurn.retry.attemptLabel": "試行 {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "試行 {{attempt}} - {{line}}",
  "ui.messagePart.context.notice.one": "{{count}} 通知",
  "ui.messagePart.context.notice.other": "{{count}} 件の通知",
  "ui.messagePart.context.thought.one": "思考",
  "ui.messagePart.context.thought.other": "思考",
  "ui.promptInput.dropFiles.image": "画像またはファイルをドロップして追加します",
  "ui.promptInput.dropFiles.pdf": "PDF またはファイルをドロップして追加します",
  "ui.promptInput.dropFiles.imagePdf": "画像、PDF、またはファイルをドロップして追加します",
  "ui.promptInput.exitShell": "出口",
  "ui.sessionTimeline.notice.agentChanged": "エージェントが変更されました",

  "ui.sessionTurn.retry.attemptWaiting.one": "試行 {{attempt}} - {{count}} 秒後に再試行します",
  "ui.sessionTurn.retry.attemptWaiting.other": "試行 {{attempt}} - {{count}} 秒後に再試行します",
  "ui.sessionTurn.retry.attemptRetryingNow": "試行 {{attempt}} - 再試行中",
  "ui.messagePart.compaction.started": "セッション圧縮が開始されました",
  "ui.messagePart.compaction.running": "圧縮中",
  "ui.messagePart.compaction.failed": "セッション圧縮に失敗しました",
  "ui.messagePart.compaction.cancelled": "セッション圧縮がキャンセルされました",
  "ui.messagePart.compaction.interrupted": "セッション圧縮が中断されました",
  "ui.messagePart.providerCompaction": "プロバイダーによってセッションが圧縮されました",
  "ui.messagePart.compaction.usage": "{{input}} 入力 · {{output}} 出力",
  "ui.messagePart.context.updates": "更新",
  "ui.messagePart.tools.used.one": "{{count}} {{tools}} 使用済み",
  "ui.messagePart.tools.used.other": "{{count}} {{tools}} 使用済み",
