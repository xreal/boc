export const dict: Record<string, string> = {
  ...
  "ui.messagePart.compaction.running": "Tiivistetään",
  "ui.messagePart.compaction.failed": "Istunnon tiivistys epäonnistui",
  "ui.messagePart.compaction.cancelled": "Istunnon tiivistys peruutettu",
  "ui.messagePart.compaction.interrupted": "Istunnon tiivistys keskeytetty",
  "ui.messagePart.providerCompaction": "Palveluntarjoajan tiivistämä istunto",
  "ui.messagePart.compaction.usage": "{{input}} sisään · {{output}} ulos",
  "ui.messagePart.tools.used.one": "Käytettiin {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Käytettiin {{count}} {{tools}}",
  "ui.tool.browser": "Selain",
  "ui.messagePart.context.thought.one": "Ajatus",
  "ui.messagePart.context.thought.other": "Ajatuksia",
  "ui.sessionTurn.retry.attemptWaiting.one": "Yritys {{attempt}} toistetaan {{count}} sekunnin kuluttua",
  "ui.sessionTurn.retry.attemptWaiting.other": "Yritys {{attempt}} toistetaan {{count}} sekunnin kuluttua",
  "ui.sessionTurn.retry.attemptRetryingNow": "Yritys {{attempt}} – yritetään uudelleen",
  "ui.sessionTurn.retry.attemptLabel": "Yritys {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Yritys {{attempt}} - {{line}}",
  "ui.messagePart.context.notice.one": "{{count}} ilmoitus",
  "ui.messagePart.context.notice.other": "{{count}} ilmoitusta",
  "ui.promptInput.dropFiles.image": "Lisää kuvia tai tiedostoja pudottamalla",
  "ui.promptInput.dropFiles.pdf": "Lisää PDF-tiedostoja tai muita tiedostoja pudottamalla",
  "ui.promptInput.dropFiles.imagePdf": "Lisää kuvia, PDF-tiedostoja tai muita tiedostoja pudottamalla",
  "ui.promptInput.exitShell": "Poistu",
  "ui.sessionTimeline.notice.agentChanged": "Agentti vaihdettu",
  "ui.promptInput.placeholder.followUp": "Lisää jatkokysymys, {{slash}} komennoille, {{at}} kontekstille…",
  "ui.promptInput.steer": "Ohjaa",
  "ui.promptInput.queue": "Jono",
  "ui.promptInput.steerHint": "Lähetä keskeyttämättä",
  "ui.tool.loadedSkills.one": "Ladattiin {{name}}-taito",
  "ui.tool.loadedSkills.other": "Ladattiin {{name}}-taidot",
  "ui.tool.shell.exit": "Komento päättyi koodilla {{code}}",
  "ui.tool.shell.timeout": "Komennon aikakatkaisu",
  "ui.tool.shell.cancelled": "Komento peruutettu",
  "ui.message.thought": "Ajatus",
  "ui.sessionTimeline.notice.modelSwitched": "Vaihdettiin malliin {{model}}",
