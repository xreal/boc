export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "Dodaj kolejną wiadomość, {{slash}} dla poleceń, {{at}} dla kontekstu...",
  "ui.promptInput.steer": "Steruj",
  "ui.promptInput.queue": "Dodaj do kolejki",
  "ui.promptInput.steerHint": "Wyślij bez przerywania",
  "ui.tool.loadedSkills.one": "Wczytano umiejętność {{name}}",
  "ui.tool.loadedSkills.few": "Wczytano umiejętności {{name}}",
  "ui.tool.loadedSkills.many": "Wczytano umiejętności {{name}}",
  "ui.tool.loadedSkills.other": "Wczytano umiejętności {{name}}",
  "ui.tool.shell.exit": "Polecenie zakończyło się z kodem {{code}}",
  "ui.tool.shell.timeout": "Przekroczono limit czasu polecenia",
  "ui.tool.shell.cancelled": "Polecenie anulowano",
  "ui.message.thought": "Myśl",
  ...
  "ui.messagePart.context.thought.other": "myśli",
  "ui.promptInput.dropFiles.image": "Upuść obrazy lub pliki, które chcesz dodać",
  "ui.promptInput.dropFiles.pdf": "Upuść pliki PDF lub inne pliki do dodania",
  "ui.promptInput.dropFiles.imagePdf": "Upuść obrazy, pliki PDF lub inne pliki do dodania",
  "ui.promptInput.exitShell": "Wyjdź",
  "ui.sessionTimeline.notice.agentChanged": "Zmiana agenta",
  "ui.messagePart.context.notice.few": "{{count}} powiadomienia",
  "ui.messagePart.context.notice.many": "{{count}} powiadomień",
  "ui.messagePart.context.thought.few": "myśli",
  "ui.messagePart.context.thought.many": "myśli",
  "ui.sessionTurn.retry.attemptRetryingNow": "Próba {{attempt}} – ponawianie",
  "ui.sessionTurn.retry.attemptWaiting.one": "Próba {{attempt}} – ponowienie za {{count}} sekundę",
  "ui.sessionTurn.retry.attemptWaiting.few": "Próba {{attempt}} – ponowienie za {{count}} sekundy",
  "ui.sessionTurn.retry.attemptWaiting.many": "Próba {{attempt}} – ponowienie za {{count}} sekund",
  "ui.sessionTurn.retry.attemptWaiting.other": "Próba {{attempt}} – ponowienie za {{count}} sekundy",
  "ui.messagePart.compaction.started": "Rozpoczęto kompaktowanie sesji",
  "ui.messagePart.compaction.running": "Kompaktowanie",
  "ui.messagePart.compaction.failed": "Kompaktowanie sesji nie powiodło się",
  "ui.messagePart.compaction.cancelled": "Kompaktowanie sesji anulowane",
  "ui.messagePart.compaction.interrupted": "Kompaktowanie sesji przerwane",
  "ui.messagePart.providerCompaction": "Sesja skompaktowana przez dostawcę",
  "ui.messagePart.compaction.usage": "{{input}} w · {{output}} na zewnątrz",
  "ui.messagePart.tools.used.one": "Użyto {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Użyto {{count}} {{tools}}",
  "ui.tool.browser": "Przeglądarka",
  "ui.common.fileCount.one": "{{count}} plik",
  "ui.common.fileCount.other": "{{count}} pliku",
  "ui.messagePart.tools.used.few": "Użyto {{count}} {{tools}}",
