...
export const dict: Record<Keys, string> = {
  ...
  "ui.messagePart.compaction.started": "Sesjonskomprimering startet",
  "ui.messagePart.compaction.running": "Komprimering",
  "ui.messagePart.compaction.failed": "Øktkomprimering mislyktes",
  "ui.messagePart.compaction.cancelled": "Sesjonskomprimering avbrutt",
  "ui.messagePart.compaction.interrupted": "Sesjonskomprimering avbrutt",
  "ui.messagePart.providerCompaction": "Økt komprimert av leverandør",
  "ui.messagePart.compaction.usage": "{{input}} inn · {{output}} ut",
  "ui.messagePart.tools.used.one": "Brukte {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Brukte {{count}} {{tools}}",
  "ui.tool.browser": "Nettleser",
